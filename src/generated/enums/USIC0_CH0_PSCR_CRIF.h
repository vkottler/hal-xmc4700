...
static constexpr uint16_t USIC0_CH0_PSCR_CRIF_id = 3406;
...
inline const char *to_string(USIC0_CH0_PSCR_CRIF instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_PSCR_CRIF::value1:
        result = "value1";
        break;
    case USIC0_CH0_PSCR_CRIF::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_PSCR_CRIF &output)
{
    ...
    {
        output = USIC0_CH0_PSCR_CRIF::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = USIC0_CH0_PSCR_CRIF::value2;
    }
