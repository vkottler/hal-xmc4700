...
static constexpr uint16_t SCU_RESET_RSTCLR_HIBRS_id = 2026;
...
inline const char *to_string(SCU_RESET_RSTCLR_HIBRS instance)
{
    ...
    switch (instance)
    {
    case SCU_RESET_RSTCLR_HIBRS::value1:
        result = "value1";
        break;
    case SCU_RESET_RSTCLR_HIBRS::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, SCU_RESET_RSTCLR_HIBRS &output)
{
    ...
    {
        output = SCU_RESET_RSTCLR_HIBRS::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SCU_RESET_RSTCLR_HIBRS::value2;
    }
