 ...
 *     },
 *     "value2": {
 *       "description": "Disable reset when Lockup gets asserted",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t SCU_RESET_RSTCLR_LCKEN_id = 2025;
...
inline const char *to_string(SCU_RESET_RSTCLR_LCKEN instance)
{
    ...
    switch (instance)
    {
    case SCU_RESET_RSTCLR_LCKEN::value1:
        result = "value1";
        break;
    case SCU_RESET_RSTCLR_LCKEN::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, SCU_RESET_RSTCLR_LCKEN &output)
{
    ...
    {
        output = SCU_RESET_RSTCLR_LCKEN::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SCU_RESET_RSTCLR_LCKEN::value2;
    }
