...
{
    value1 /*!< MPU is disabled during hard fault, NMI, and FAULTMASK handlers,
              regardless of the value of the ENABLE bit */
        ,
    value2 = 1 /*!< the MPU is enabled during hard fault, NMI, and FAULTMASK
                  handlers. */
};
static_assert(sizeof(PPB_MPU_CTRL_HFNMIENA) == 1);

static constexpr uint16_t PPB_MPU_CTRL_HFNMIENA_id = 2598;
