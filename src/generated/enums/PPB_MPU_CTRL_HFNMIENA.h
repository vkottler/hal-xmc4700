...
{
    disabled_during_hard_fault_nmi_faultmask__cont /*!< MPU is disabled during
                                                      hard fault, NMI, and
                                                      FAULTMASK handlers,
...
inline const char *to_string(PPB_MPU_CTRL_HFNMIENA instance)
{
    ...
    switch (instance)
    {
    case PPB_MPU_CTRL_HFNMIENA::disabled_during_hard_fault_nmi_faultmask__cont:
        result = "disabled_during_hard_fault_nmi_faultmask__cont";
        break;
    case PPB_MPU_CTRL_HFNMIENA::enabled_during_hard_fault_nmi_faultmask_h_cont:
        result = "enabled_during_hard_fault_nmi_faultmask_h_cont";
        break;
    }
...
inline bool from_string(const char *data, PPB_MPU_CTRL_HFNMIENA &output)
{
    ...
    if ((result = !strncmp(
             data, "disabled_during_hard_fault_nmi_faultmask__cont", 46)))
    {
        output = PPB_MPU_CTRL_HFNMIENA::
            disabled_during_hard_fault_nmi_faultmask__cont;
    }
    else if ((result = !strncmp(
                  data, "enabled_during_hard_fault_nmi_faultmask_h_cont", 46)))
    {
        output = PPB_MPU_CTRL_HFNMIENA::
            enabled_during_hard_fault_nmi_faultmask_h_cont;
    }
