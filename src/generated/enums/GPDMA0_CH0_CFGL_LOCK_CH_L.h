...
static constexpr uint16_t GPDMA0_CH0_CFGL_LOCK_CH_L_id = 1807;
...
inline const char *to_string(GPDMA0_CH0_CFGL_LOCK_CH_L instance)
{
    ...
    switch (instance)
    {
    case GPDMA0_CH0_CFGL_LOCK_CH_L::value1:
        result = "value1";
        break;
    case GPDMA0_CH0_CFGL_LOCK_CH_L::value2:
        result = "value2";
        break;
    case GPDMA0_CH0_CFGL_LOCK_CH_L::value3:
        result = "value3";
        break;
    }
...
inline bool from_string(const char *data, GPDMA0_CH0_CFGL_LOCK_CH_L &output)
{
    ...
    {
        output = GPDMA0_CH0_CFGL_LOCK_CH_L::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = GPDMA0_CH0_CFGL_LOCK_CH_L::value2;
    }
    else if ((result = !strncmp(data, "value3", 6)))
    {
        output = GPDMA0_CH0_CFGL_LOCK_CH_L::value3;
    }
