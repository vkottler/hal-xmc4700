...
inline const char *to_string(USIC0_CH0_CCR_RIEN instance)
{
    ...
    case USIC0_CH0_CCR_RIEN::disabled:
        result = "disabled";
        break;
    case USIC0_CH0_CCR_RIEN::
        enabled_case_receive_event_service_request_ou_cont:
        result = "enabled_case_receive_event_service_request_ou_cont";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_CCR_RIEN &output)
{
    ...
    if ((result = !strncmp(data, "disabled", 8)))
    {
        output = USIC0_CH0_CCR_RIEN::disabled;
                  ...
                  data, "enabled_case_receive_event_service_request_ou_cont",
                  50)))
    {
        output = USIC0_CH0_CCR_RIEN::
            enabled_case_receive_event_service_request_ou_cont;
    }
