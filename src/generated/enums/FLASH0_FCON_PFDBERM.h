...
enum class FLASH0_FCON_PFDBERM : uint8_t
{
    ...
    enabled_especially_intended_margin_check =
        1 /*!< Double-Bit Error interrupt for PFLASH enabled. Especially
...
inline const char *to_string(FLASH0_FCON_PFDBERM instance)
{
    ...
    case FLASH0_FCON_PFDBERM::not_enabled:
        result = "not_enabled";
        break;
    case FLASH0_FCON_PFDBERM::enabled_especially_intended_margin_check:
        result = "enabled_especially_intended_margin_check";
        break;
    }
...
inline bool from_string(const char *data, FLASH0_FCON_PFDBERM &output)
{
    ...
    if ((result = !strncmp(data, "not_enabled", 11)))
    {
        output = FLASH0_FCON_PFDBERM::not_enabled;
                  ...
                  data, "enabled_especially_intended_margin_check", 40)))
    {
        output = FLASH0_FCON_PFDBERM::enabled_especially_intended_margin_check;
    }
