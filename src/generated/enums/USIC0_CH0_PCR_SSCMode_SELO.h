...
inline const char *to_string(USIC0_CH0_PCR_SSCMode_SELO instance)
{
    ...
    case USIC0_CH0_PCR_SSCMode_SELO::not_be_activated:
        ...
        break;
    case USIC0_CH0_PCR_SSCMode_SELO::_be_activated_acc_cont:
        result = "_be_activated_acc_cont";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_PCR_SSCMode_SELO &output)
{
    ...
    else if ((result = !strncmp(data, "_be_activated_acc_cont", 22)))
    {
        output = USIC0_CH0_PCR_SSCMode_SELO::_be_activated_acc_cont;
    }
