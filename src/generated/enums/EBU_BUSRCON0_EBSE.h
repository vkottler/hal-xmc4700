...
static constexpr uint16_t EBU_BUSRCON0_EBSE_id = 403;
...
inline const char *to_string(EBU_BUSRCON0_EBSE instance)
{
    ...
    switch (instance)
    {
    case EBU_BUSRCON0_EBSE::value1:
        result = "value1";
        break;
    case EBU_BUSRCON0_EBSE::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, EBU_BUSRCON0_EBSE &output)
{
    ...
    {
        output = EBU_BUSRCON0_EBSE::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = EBU_BUSRCON0_EBSE::value2;
    }
