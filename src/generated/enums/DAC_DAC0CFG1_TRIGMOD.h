...
{
    internal_trigger_integer_divided_clock___see__cont /*!< internal Trigger
                                                          (integer divided
                                                          clock - see FREQ
                                                          parameter) */
        ,
...
inline const char *to_string(DAC_DAC0CFG1_TRIGMOD instance)
{
    ...
    case DAC_DAC0CFG1_TRIGMOD::
        internal_trigger_integer_divided_clock___see__cont:
        result = "internal_trigger_integer_divided_clock___see__cont";
        break;
    case DAC_DAC0CFG1_TRIGMOD::
        external_trigger_preselected_trigger_by_trigs_cont:
...
inline bool from_string(const char *data, DAC_DAC0CFG1_TRIGMOD &output)
{
    ...
    if ((result = !strncmp(
             data, "internal_trigger_integer_divided_clock___see__cont", 50)))
    {
