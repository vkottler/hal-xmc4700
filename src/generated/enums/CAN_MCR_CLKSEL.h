...
enum class CAN_MCR_CLKSEL : uint8_t
{
    ...
    hard_wired_0_ = 8 /*!< hard wired to 0 */
};
...
inline const char *to_string(CAN_MCR_CLKSEL instance)
{
    ...
    case CAN_MCR_CLKSEL::hard_wired_0:
        result = "hard_wired_0";
        break;
    case CAN_MCR_CLKSEL::hard_wired_0_:
        result = "hard_wired_0_";
        break;
    }
...
inline bool from_string(const char *data, CAN_MCR_CLKSEL &output)
{
    ...
    else if ((result = !strncmp(data, "hard_wired_0_", 13)))
    {
        output = CAN_MCR_CLKSEL::hard_wired_0_;
    }
