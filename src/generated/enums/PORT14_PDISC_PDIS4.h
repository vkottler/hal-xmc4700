 ...
 *     },
 *     "value2": {
 *       "description": "Pad is disabled, ADC 0 analog input 4 and ADC 2 analog input 0 and DAC Reference selected.",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t PORT14_PDISC_PDIS4_id = 706;
