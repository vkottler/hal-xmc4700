...
static constexpr uint16_t SCU_RESET_RSTSTAT_HIBRS_id = 2019;
...
inline const char *to_string(SCU_RESET_RSTSTAT_HIBRS instance)
{
    ...
    switch (instance)
    {
    case SCU_RESET_RSTSTAT_HIBRS::value1:
        result = "value1";
        break;
    case SCU_RESET_RSTSTAT_HIBRS::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, SCU_RESET_RSTSTAT_HIBRS &output)
{
    ...
    {
        output = SCU_RESET_RSTSTAT_HIBRS::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SCU_RESET_RSTSTAT_HIBRS::value2;
    }
