...
{
    mechanism_disabled_buffer_does_not_accep_cont /*!< The FIFO mechanism is
                                                     disabled. The buffer does
                                                     not accept any request for
                                                     data. */
        ,
...
inline const char *to_string(USIC0_CH0_TBCTR_SIZE instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_TBCTR_SIZE::mechanism_disabled_buffer_does_not_accep_cont:
        result = "mechanism_disabled_buffer_does_not_accep_cont";
        break;
...
inline bool from_string(const char *data, USIC0_CH0_TBCTR_SIZE &output)
{
    ...
    if ((result = !strncmp(
             data, "mechanism_disabled_buffer_does_not_accep_cont", 45)))
    {
        output = USIC0_CH0_TBCTR_SIZE::
            mechanism_disabled_buffer_does_not_accep_cont;
    }
