...
static constexpr uint16_t SCU_PLL_PLLSTAT_BY_id = 1286;
...
inline const char *to_string(SCU_PLL_PLLSTAT_BY instance)
{
    ...
    switch (instance)
    {
    case SCU_PLL_PLLSTAT_BY::value1:
        result = "value1";
        break;
    case SCU_PLL_PLLSTAT_BY::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, SCU_PLL_PLLSTAT_BY &output)
{
    ...
    {
        output = SCU_PLL_PLLSTAT_BY::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SCU_PLL_PLLSTAT_BY::value2;
    }
