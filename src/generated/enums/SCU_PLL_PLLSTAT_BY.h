...
enum class SCU_PLL_PLLSTAT_BY : uint8_t
{
    ...
    entered_input_fosc_selected_outpu_cont =
...
inline const char *to_string(SCU_PLL_PLLSTAT_BY instance)
{
    ...
    case SCU_PLL_PLLSTAT_BY::not_entered:
        result = "not_entered";
        break;
    case SCU_PLL_PLLSTAT_BY::entered_input_fosc_selected_outpu_cont:
        result = "entered_input_fosc_selected_outpu_cont";
        break;
    }
...
inline bool from_string(const char *data, SCU_PLL_PLLSTAT_BY &output)
{
    ...
    else if ((result = !strncmp(data, "entered_input_fosc_selected_outpu_cont",
                                38)))
    {
        output = SCU_PLL_PLLSTAT_BY::entered_input_fosc_selected_outpu_cont;
    }
