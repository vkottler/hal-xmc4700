...
{
    30v_not_supported /*!< 3.0V not supported */
};
...
inline const char *to_string(SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3V instance)
{
    ...
    switch (instance)
    {
    case SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3V::30v_not_supported:
        result = "30v_not_supported";
        break;
    }
                        ...
                        SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3V &output)
{
    ...
    if ((result = !strncmp(data, "30v_not_supported", 17)))
    {
        output = SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3V::30v_not_supported;
    }
