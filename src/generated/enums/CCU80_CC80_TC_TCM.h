...
static constexpr uint16_t CCU80_CC80_TC_TCM_id = 1866;
...
inline const char *to_string(CCU80_CC80_TC_TCM instance)
{
    ...
    switch (instance)
    {
    case CCU80_CC80_TC_TCM::value1:
        result = "value1";
        break;
    case CCU80_CC80_TC_TCM::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, CCU80_CC80_TC_TCM &output)
{
    ...
    {
        output = CCU80_CC80_TC_TCM::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = CCU80_CC80_TC_TCM::value2;
    }
