 ...
 *   "enum": {
 *     "value1": {
 *       "description": "fCPU=fSYS",
 *       "value": 0
 *     },
 *     "value2": {
 *       "description": "fCPU=fSYS/ 2",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t SCU_CLK_MLINKCLKCR_CPUDIV_id = 1155;
...
inline const char *to_string(SCU_CLK_MLINKCLKCR_CPUDIV instance)
{
    ...
    switch (instance)
    {
    case SCU_CLK_MLINKCLKCR_CPUDIV::value1:
        result = "value1";
        break;
    case SCU_CLK_MLINKCLKCR_CPUDIV::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, SCU_CLK_MLINKCLKCR_CPUDIV &output)
{
    ...
    {
        output = SCU_CLK_MLINKCLKCR_CPUDIV::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SCU_CLK_MLINKCLKCR_CPUDIV::value2;
    }
