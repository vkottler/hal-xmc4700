...
static constexpr uint16_t VADC_BRSCTRL_XTMODE_id = 3534;
...
inline const char *to_string(VADC_BRSCTRL_XTMODE instance)
{
    ...
    switch (instance)
    {
    case VADC_BRSCTRL_XTMODE::value1:
        result = "value1";
        break;
    case VADC_BRSCTRL_XTMODE::value2:
        result = "value2";
        break;
    case VADC_BRSCTRL_XTMODE::value3:
        result = "value3";
        break;
    case VADC_BRSCTRL_XTMODE::value4:
        result = "value4";
        break;
    }
...
inline bool from_string(const char *data, VADC_BRSCTRL_XTMODE &output)
{
    ...
    {
        output = VADC_BRSCTRL_XTMODE::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = VADC_BRSCTRL_XTMODE::value2;
    }
    else if ((result = !strncmp(data, "value3", 6)))
    {
        output = VADC_BRSCTRL_XTMODE::value3;
    }
    else if ((result = !strncmp(data, "value4", 6)))
    {
        output = VADC_BRSCTRL_XTMODE::value4;
    }
