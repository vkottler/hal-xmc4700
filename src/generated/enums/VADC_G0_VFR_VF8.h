...
enum class VADC_G0_VFR_VF8 : uint8_t
{
...
static_assert(sizeof(VADC_G0_VFR_VF8) == 1);

static constexpr uint16_t VADC_G0_VFR_VF8_id = 1097;

/**
 * Converts VADC_G0_VFR_VF8 to a C string.
 *
 * \param[in] instance Value to convert.
 * \return             A C string representation of the value.
 */
inline const char *to_string(VADC_G0_VFR_VF8 instance)
{
    const char *result = "UNKNOWN VADC_G0_VFR_VF8";

    switch (instance)
    {
    case VADC_G0_VFR_VF8::value1:
        result = "value1";
        break;
    case VADC_G0_VFR_VF8::value2:
        result = "value2";
        break;
    }
...
/**
 * Converts a C string to VADC_G0_VFR_VF8.
 *
 * \param[in]  data   A C string to convert.
 * \param[out] output The enumeration element to write.
 * \return            Whether or not the output was written.
 */
inline bool from_string(const char *data, VADC_G0_VFR_VF8 &output)
{
    bool result = false;

    if ((result = !strncmp(data, "value1", 6)))
    {
        output = VADC_G0_VFR_VF8::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = VADC_G0_VFR_VF8::value2;
    }
