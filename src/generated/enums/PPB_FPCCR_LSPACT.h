...
enum class PPB_FPCCR_LSPACT : uint8_t
{
    ...
    active_floating_point_stack_frame_has_been_al_cont =
...
inline const char *to_string(PPB_FPCCR_LSPACT instance)
{
    ...
    case PPB_FPCCR_LSPACT::not_active:
        result = "not_active";
        break;
    case PPB_FPCCR_LSPACT::active_floating_point_stack_frame_has_been_al_cont:
        result = "active_floating_point_stack_frame_has_been_al_cont";
        break;
    }
...
inline bool from_string(const char *data, PPB_FPCCR_LSPACT &output)
{
    ...
    if ((result = !strncmp(data, "not_active", 10)))
    {
        output = PPB_FPCCR_LSPACT::not_active;
                  ...
                  data, "active_floating_point_stack_frame_has_been_al_cont",
                  50)))
    {
        output = PPB_FPCCR_LSPACT::
            active_floating_point_stack_frame_has_been_al_cont;
    }
