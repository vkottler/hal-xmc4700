...
{
    value1 /*!< USB PLL Clock */,
    value2 = 1 /*!< PLL Clock */
};
static_assert(sizeof(SCU_CLK_USBCLKCR_USBSEL) == 1);

static constexpr uint16_t SCU_CLK_USBCLKCR_USBSEL_id = 1148;
...
inline const char *to_string(SCU_CLK_USBCLKCR_USBSEL instance)
{
    ...
    switch (instance)
    {
    case SCU_CLK_USBCLKCR_USBSEL::value1:
        result = "value1";
        break;
    case SCU_CLK_USBCLKCR_USBSEL::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, SCU_CLK_USBCLKCR_USBSEL &output)
{
    ...
    {
        output = SCU_CLK_USBCLKCR_USBSEL::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SCU_CLK_USBCLKCR_USBSEL::value2;
    }
