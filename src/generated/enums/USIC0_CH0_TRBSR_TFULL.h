...
static constexpr uint16_t USIC0_CH0_TRBSR_TFULL_id = 3468;
...
inline const char *to_string(USIC0_CH0_TRBSR_TFULL instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_TRBSR_TFULL::value1:
        result = "value1";
        break;
    case USIC0_CH0_TRBSR_TFULL::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_TRBSR_TFULL &output)
{
    ...
    {
        output = USIC0_CH0_TRBSR_TFULL::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = USIC0_CH0_TRBSR_TFULL::value2;
    }
