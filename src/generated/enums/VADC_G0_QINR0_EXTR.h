 ...
 *     },
 *     "value2": {
 *       "description": "A valid queue entry waits for a trigger event to occur before issuing a conversion request.",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
enum class VADC_G0_QINR0_EXTR : uint8_t
{
    ...
    value2 = 1 /*!< A valid queue entry waits for a trigger event to occur before issuing a conversion request. */
};
