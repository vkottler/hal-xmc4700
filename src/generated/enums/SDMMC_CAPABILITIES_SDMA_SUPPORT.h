 ...
 *   "enum": {
 *     "value1": {
 *       "description": "SDMA not supported",
 *       "value": 0
 *     }
 *   },
 *   "unit_test": false,
...
{
    value1 /*!< SDMA not supported */
};
static_assert(sizeof(SDMMC_CAPABILITIES_SDMA_SUPPORT) == 1);

static constexpr uint16_t SDMMC_CAPABILITIES_SDMA_SUPPORT_id = 1545;
...
inline const char *to_string(SDMMC_CAPABILITIES_SDMA_SUPPORT instance)
{
    ...
    switch (instance)
    {
    case SDMMC_CAPABILITIES_SDMA_SUPPORT::value1:
        result = "value1";
        break;
    }
 ...
 */
inline bool from_string(const char *data, SDMMC_CAPABILITIES_SDMA_SUPPORT &output)
{
    bool result = false;

    if ((result = !strncmp(data, "value1", 6)))
    {
        output = SDMMC_CAPABILITIES_SDMA_SUPPORT::value1;
    }
