...
static constexpr uint16_t SCU_PARITY_PEFLAG_PESD1_id = 2436;
...
inline const char *to_string(SCU_PARITY_PEFLAG_PESD1 instance)
{
    ...
    switch (instance)
    {
    case SCU_PARITY_PEFLAG_PESD1::value1:
        result = "value1";
        break;
    case SCU_PARITY_PEFLAG_PESD1::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, SCU_PARITY_PEFLAG_PESD1 &output)
{
    ...
    {
        output = SCU_PARITY_PEFLAG_PESD1::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SCU_PARITY_PEFLAG_PESD1::value2;
    }
