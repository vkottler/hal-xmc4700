 ...
 *     },
 *     "value2": {
 *       "description": "Pad is disabled, ADC0 analog input 7 selected.",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
enum class PORT14_PDISC_PDIS7 : uint8_t
{
    ...
    value2 = 1 /*!< Pad is disabled, ADC0 analog input 7 selected. */
};
static_assert(sizeof(PORT14_PDISC_PDIS7) == 1);

static constexpr uint16_t PORT14_PDISC_PDIS7_id = 703;
...
inline const char *to_string(PORT14_PDISC_PDIS7 instance)
{
    ...
    switch (instance)
    {
    case PORT14_PDISC_PDIS7::value1:
        result = "value1";
        break;
    case PORT14_PDISC_PDIS7::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, PORT14_PDISC_PDIS7 &output)
{
    ...
    {
        output = PORT14_PDISC_PDIS7::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = PORT14_PDISC_PDIS7::value2;
    }
