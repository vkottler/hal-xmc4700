...
static constexpr uint16_t VADC_G0_CHASS_ASSCH7_id = 901;
...
inline const char *to_string(VADC_G0_CHASS_ASSCH7 instance)
{
    ...
    switch (instance)
    {
    case VADC_G0_CHASS_ASSCH7::value1:
        result = "value1";
        break;
    case VADC_G0_CHASS_ASSCH7::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, VADC_G0_CHASS_ASSCH7 &output)
{
    ...
    {
        output = VADC_G0_CHASS_ASSCH7::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = VADC_G0_CHASS_ASSCH7::value2;
    }
