...
{
    does_not_contain_data_has_not__cont /*!< Register RBUF1 does not contain
                                           data that has not yet been read out.
                                         */
        ,
...
inline const char *to_string(USIC0_CH0_RBUF01SR_RDV11 instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_RBUF01SR_RDV11::does_not_contain_data_has_not__cont:
        result = "does_not_contain_data_has_not__cont";
        break;
...
inline bool from_string(const char *data, USIC0_CH0_RBUF01SR_RDV11 &output)
{
    ...
    if ((result = !strncmp(data, "does_not_contain_data_has_not__cont", 35)))
    {
        output = USIC0_CH0_RBUF01SR_RDV11::does_not_contain_data_has_not__cont;
    }
    else if ((result =
