...
{
    1 /*!< The last error led to an error counter increment of 1. */,
    8 = 1 /*!< The last error led to an error counter increment of 8. */
};
...
inline const char *to_string(CAN_NODE0_NECNT_LEINC instance)
{
    ...
    switch (instance)
    {
    case CAN_NODE0_NECNT_LEINC::1:
        result = "1";
        break;
    case CAN_NODE0_NECNT_LEINC::8:
        result = "8";
        break;
    }
...
inline bool from_string(const char *data, CAN_NODE0_NECNT_LEINC &output)
{
    ...
    {
        output = CAN_NODE0_NECNT_LEINC::1;
    }
    else if ((result = !strncmp(data, "8", 1)))
    {
        output = CAN_NODE0_NECNT_LEINC::8;
    }
