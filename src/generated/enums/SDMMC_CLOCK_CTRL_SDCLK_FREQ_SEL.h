...
{
    _10mhz_63mhz /*!< base clock(10MHz-63MHz) */,
...
inline const char *to_string(SDMMC_CLOCK_CTRL_SDCLK_FREQ_SEL instance)
{
    ...
    switch (instance)
    {
    case SDMMC_CLOCK_CTRL_SDCLK_FREQ_SEL::_10mhz_63mhz:
        result = "_10mhz_63mhz";
        break;
                        ...
                        SDMMC_CLOCK_CTRL_SDCLK_FREQ_SEL &output)
{
    ...
    if ((result = !strncmp(data, "_10mhz_63mhz", 12)))
    {
        output = SDMMC_CLOCK_CTRL_SDCLK_FREQ_SEL::_10mhz_63mhz;
    }
