...
static constexpr uint16_t GPDMA0_MASKTFR_CH7_id = 2160;
...
inline const char *to_string(GPDMA0_MASKTFR_CH7 instance)
{
    ...
    switch (instance)
    {
    case GPDMA0_MASKTFR_CH7::value1:
        result = "value1";
        break;
    case GPDMA0_MASKTFR_CH7::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, GPDMA0_MASKTFR_CH7 &output)
{
    ...
    {
        output = GPDMA0_MASKTFR_CH7::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = GPDMA0_MASKTFR_CH7::value2;
    }
