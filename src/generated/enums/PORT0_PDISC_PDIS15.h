...
static constexpr uint16_t PORT0_PDISC_PDIS15_id = 1670;
...
inline const char *to_string(PORT0_PDISC_PDIS15 instance)
{
    ...
    switch (instance)
    {
    case PORT0_PDISC_PDIS15::value1:
        result = "value1";
        break;
    case PORT0_PDISC_PDIS15::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, PORT0_PDISC_PDIS15 &output)
{
    ...
    {
        output = PORT0_PDISC_PDIS15::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = PORT0_PDISC_PDIS15::value2;
    }
