...
enum class VADC_G0_QMR0_ENGT : uint8_t
{
    ...
    conversion_requests_issued_if_valid_conversio_cont =
        ...
        ,
    conversion_requests_issued_if_valid_conversio_cont_x =
        2 /*!< Conversion requests are issued if a valid conversion request is
             ...
             REQGTx = 1 */
        ,
    conversion_requests_issued_if_valid_conversio_cont_x_x =
...
inline const char *to_string(VADC_G0_QMR0_ENGT instance)
{
    ...
    case VADC_G0_QMR0_ENGT::
        conversion_requests_issued_if_valid_conversio_cont_x:
        result = "conversion_requests_issued_if_valid_conversio_cont_x";
        break;
    case VADC_G0_QMR0_ENGT::
        conversion_requests_issued_if_valid_conversio_cont_x_x:
        result = "conversion_requests_issued_if_valid_conversio_cont_x_x";
        break;
    }
                  ...
                  50)))
    {
        output = VADC_G0_QMR0_ENGT::
            conversion_requests_issued_if_valid_conversio_cont;
                  ...
                  data, "conversion_requests_issued_if_valid_conversio_cont_x",
                  52)))
    {
        output = VADC_G0_QMR0_ENGT::
            conversion_requests_issued_if_valid_conversio_cont_x;
