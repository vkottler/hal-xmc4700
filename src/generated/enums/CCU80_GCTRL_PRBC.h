...
enum class CCU80_GCTRL_PRBC : uint8_t
{
    ...
    value2 = 1 /*!< GSTATThe register contains the status of the prescaler and
                  ...
                  registers are cleared when the Run Bit of CC80 is cleared. */
        ,
    value3 = 2 /*!< GSTATThe register contains the status of the prescaler and
                  each timer slice (idle mode or running)..PRB and prescaler
                  registers are cleared when the Run Bit of CC81 is cleared. */
        ,
    value4 = 3 /*!< GSTATThe register contains the status of the prescaler and
                  each timer slice (idle mode or running)..PRB and prescaler
                  registers are cleared when the Run Bit of CC82 is cleared. */
        ,
    value5 = 4 /*!< GSTATThe register contains the status of the prescaler and
                  each timer slice (idle mode or running)..PRB and prescaler
                  registers are cleared when the Run Bit of CC83 is cleared. */
};
