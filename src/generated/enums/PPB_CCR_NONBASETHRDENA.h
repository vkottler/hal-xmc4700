...
{
    only_when_no__cont /*!< processor can enter Thread mode only when no
                          exception is active. */
        ,
    any_level_und_cont =
...
inline const char *to_string(PPB_CCR_NONBASETHRDENA instance)
{
    ...
    switch (instance)
    {
    case PPB_CCR_NONBASETHRDENA::only_when_no__cont:
        result = "only_when_no__cont";
        break;
    case PPB_CCR_NONBASETHRDENA::any_level_und_cont:
        result = "any_level_und_cont";
        break;
    }
...
inline bool from_string(const char *data, PPB_CCR_NONBASETHRDENA &output)
{
    ...
    if ((result = !strncmp(data, "only_when_no__cont", 18)))
    {
        output = PPB_CCR_NONBASETHRDENA::only_when_no__cont;
    }
    else if ((result = !strncmp(data, "any_level_und_cont", 18)))
    {
        output = PPB_CCR_NONBASETHRDENA::any_level_und_cont;
    }
