...
static constexpr uint16_t SCU_PLL_PLLCON0_FINDIS_id = 2783;
...
inline const char *to_string(SCU_PLL_PLLCON0_FINDIS instance)
{
    ...
    switch (instance)
    {
    case SCU_PLL_PLLCON0_FINDIS::value1:
        result = "value1";
        break;
    case SCU_PLL_PLLCON0_FINDIS::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, SCU_PLL_PLLCON0_FINDIS &output)
{
    ...
    {
        output = SCU_PLL_PLLCON0_FINDIS::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SCU_PLL_PLLCON0_FINDIS::value2;
    }
