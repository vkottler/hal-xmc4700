...
static constexpr uint16_t DSD_CH0_RECTCFG_RFEN_id = 1605;
...
inline const char *to_string(DSD_CH0_RECTCFG_RFEN instance)
{
    ...
    switch (instance)
    {
    case DSD_CH0_RECTCFG_RFEN::value1:
        result = "value1";
        break;
    case DSD_CH0_RECTCFG_RFEN::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, DSD_CH0_RECTCFG_RFEN &output)
{
    ...
    {
        output = DSD_CH0_RECTCFG_RFEN::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = DSD_CH0_RECTCFG_RFEN::value2;
    }
