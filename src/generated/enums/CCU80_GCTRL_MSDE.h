...
inline const char *to_string(CCU80_GCTRL_MSDE instance)
{
    ...
    switch (instance)
    {
    case CCU80_GCTRL_MSDE::only_shadow_transfer_period_compare_values_re_cont:
        result = "only_shadow_transfer_period_compare_values_re_cont";
        break;
    case CCU80_GCTRL_MSDE::shadow_transfer_compare_period_prescaler_comp_cont:
        result = "shadow_transfer_compare_period_prescaler_comp_cont";
        break;
    case CCU80_GCTRL_MSDE::shadow_transfer_compare_period_prescaler_dith_cont:
