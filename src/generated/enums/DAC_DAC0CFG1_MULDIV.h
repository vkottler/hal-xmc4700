...
static constexpr uint16_t DAC_DAC0CFG1_MULDIV_id = 2146;
...
inline const char *to_string(DAC_DAC0CFG1_MULDIV instance)
{
    ...
    switch (instance)
    {
    case DAC_DAC0CFG1_MULDIV::value1:
        result = "value1";
        break;
    case DAC_DAC0CFG1_MULDIV::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, DAC_DAC0CFG1_MULDIV &output)
{
    ...
    {
        output = DAC_DAC0CFG1_MULDIV::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = DAC_DAC0CFG1_MULDIV::value2;
    }
