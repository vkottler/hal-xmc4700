 ...
 *   "enum": {
 *     "value1": {
 *       "description": "Disables automatic reload of the LENGTH field.",
 *       "value": 0
 *     },
 *     "value2": {
 *       "description": "Enables automatic reload of the LENGTH field at the end of a message.",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t FCE_KE0_CFG_ALR_id = 2012;
