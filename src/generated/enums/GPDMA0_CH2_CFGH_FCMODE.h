...
static constexpr uint16_t GPDMA0_CH2_CFGH_FCMODE_id = 900;
...
inline const char *to_string(GPDMA0_CH2_CFGH_FCMODE instance)
{
    ...
    switch (instance)
    {
    case GPDMA0_CH2_CFGH_FCMODE::value1:
        result = "value1";
        break;
    case GPDMA0_CH2_CFGH_FCMODE::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, GPDMA0_CH2_CFGH_FCMODE &output)
{
    ...
    {
        output = GPDMA0_CH2_CFGH_FCMODE::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = GPDMA0_CH2_CFGH_FCMODE::value2;
    }
