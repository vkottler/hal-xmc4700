...
inline const char *to_string(GPDMA0_CH2_CFGH_FCMODE instance)
{
    ...
    switch (instance)
    {
    case GPDMA0_CH2_CFGH_FCMODE::serviced_when_the_cont:
        result = "serviced_when_the_cont";
        break;
    case GPDMA0_CH2_CFGH_FCMODE::not_serviced_unti_cont:
...
inline bool from_string(const char *data, GPDMA0_CH2_CFGH_FCMODE &output)
{
    ...
    {
        output = GPDMA0_CH2_CFGH_FCMODE::serviced_when_the_cont;
    }
    else if ((result = !strncmp(data, "not_serviced_unti_cont", 22)))
    {
        output = GPDMA0_CH2_CFGH_FCMODE::not_serviced_unti_cont;
    }
