...
static constexpr uint16_t SDMMC_ACMD_ERR_STATUS_ACMD12_NOT_EXEC_ERR_id = 3041;
 ...
 */
inline const char *to_string(SDMMC_ACMD_ERR_STATUS_ACMD12_NOT_EXEC_ERR instance)
{
 ...
 */
inline bool from_string(const char *data, SDMMC_ACMD_ERR_STATUS_ACMD12_NOT_EXEC_ERR &output)
{
    bool result = false;
