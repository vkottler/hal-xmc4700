...
static constexpr uint16_t SCU_TRAP_TRAPSTAT_BWERR1T_id = 2903;
...
inline const char *to_string(SCU_TRAP_TRAPSTAT_BWERR1T instance)
{
    ...
    switch (instance)
    {
    case SCU_TRAP_TRAPSTAT_BWERR1T::value1:
        result = "value1";
        break;
    case SCU_TRAP_TRAPSTAT_BWERR1T::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, SCU_TRAP_TRAPSTAT_BWERR1T &output)
{
    ...
    {
        output = SCU_TRAP_TRAPSTAT_BWERR1T::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SCU_TRAP_TRAPSTAT_BWERR1T::value2;
    }
