...
inline const char *to_string(CCU40_CC40_TC_ECM instance)
{
    ...
    switch (instance)
    {
    case CCU40_CC40_TC_ECM::normal_capture_mode_clear_full_flag_each_capt_cont:
        result = "normal_capture_mode_clear_full_flag_each_capt_cont";
        break;
    case CCU40_CC40_TC_ECM::extended_capture_mode_clear_full_flag_each_ca_cont:
