...
{
    clearing_cc4yst_bit /*!< External Modulation functionality is clearing the
                           CC4yST bit. */
        ,
    gating_outputs =
...
inline const char *to_string(CCU40_CC40_TC_EMT instance)
{
    ...
    switch (instance)
    {
    case CCU40_CC40_TC_EMT::clearing_cc4yst_bit:
        result = "clearing_cc4yst_bit";
        break;
...
inline bool from_string(const char *data, CCU40_CC40_TC_EMT &output)
{
    ...
    if ((result = !strncmp(data, "clearing_cc4yst_bit", 19)))
    {
        output = CCU40_CC40_TC_EMT::clearing_cc4yst_bit;
    }
