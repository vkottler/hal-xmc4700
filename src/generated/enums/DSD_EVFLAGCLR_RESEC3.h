...
static constexpr uint16_t DSD_EVFLAGCLR_RESEC3_id = 2380;
...
inline const char *to_string(DSD_EVFLAGCLR_RESEC3 instance)
{
    ...
    switch (instance)
    {
    case DSD_EVFLAGCLR_RESEC3::value1:
        result = "value1";
        break;
    case DSD_EVFLAGCLR_RESEC3::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, DSD_EVFLAGCLR_RESEC3 &output)
{
    ...
    {
        output = DSD_EVFLAGCLR_RESEC3::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = DSD_EVFLAGCLR_RESEC3::value2;
    }
