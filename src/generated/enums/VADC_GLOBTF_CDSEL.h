...
enum class VADC_GLOBTF_CDSEL : uint8_t
{
    ...
    13rd_varef = 2 /*!< Connected to 1/3rd VAREF */,
    23rd_varef = 3 /*!< Connected to 2/3rd VAREF */
};
...
inline const char *to_string(VADC_GLOBTF_CDSEL instance)
{
    ...
    case VADC_GLOBTF_CDSEL::vagnd:
        result = "vagnd";
        break;
    case VADC_GLOBTF_CDSEL::13rd_varef:
        result = "13rd_varef";
        break;
    case VADC_GLOBTF_CDSEL::23rd_varef:
        result = "23rd_varef";
        break;
    }
...
inline bool from_string(const char *data, VADC_GLOBTF_CDSEL &output)
{
    ...
    else if ((result = !strncmp(data, "13rd_varef", 10)))
    {
        output = VADC_GLOBTF_CDSEL::13rd_varef;
    }
    else if ((result = !strncmp(data, "23rd_varef", 10)))
    {
        output = VADC_GLOBTF_CDSEL::23rd_varef;
    }
