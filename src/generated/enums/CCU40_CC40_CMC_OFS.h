...
static constexpr uint16_t CCU40_CC40_CMC_OFS_id = 1374;
...
inline const char *to_string(CCU40_CC40_CMC_OFS instance)
{
    ...
    switch (instance)
    {
    case CCU40_CC40_CMC_OFS::value1:
        result = "value1";
        break;
    case CCU40_CC40_CMC_OFS::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, CCU40_CC40_CMC_OFS &output)
{
    ...
    {
        output = CCU40_CC40_CMC_OFS::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = CCU40_CC40_CMC_OFS::value2;
    }
