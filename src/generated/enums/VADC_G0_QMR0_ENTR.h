 ...
 *     },
 *     "value2": {
 *       "description": "The selected edge at the selected trigger input signal REQTR generates the trigger event",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t VADC_G0_QMR0_ENTR_id = 954;
