...
{
    value1 /*!< No device is attached to the port. */,
    value2 = 1 /*!< A device is attached to the port. */
};
static_assert(sizeof(USB0_HPRT_PrtConnSts) == 1);

static constexpr uint16_t USB0_HPRT_PrtConnSts_id = 3152;
...
inline const char *to_string(USB0_HPRT_PrtConnSts instance)
{
    ...
    switch (instance)
    {
    case USB0_HPRT_PrtConnSts::value1:
        result = "value1";
        break;
    case USB0_HPRT_PrtConnSts::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, USB0_HPRT_PrtConnSts &output)
{
    ...
    {
        output = USB0_HPRT_PrtConnSts::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = USB0_HPRT_PrtConnSts::value2;
    }
