 ...
 *   "enum": {
 *     "value1": {
 *       "description": "A protocol interrupt is not activated if a falling edge of WA is generated.",
 *       "value": 0
 *     },
 *     "value2": {
 *       "description": "A protocol interrupt is activated if a falling edge of WA is generated.",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
{
    value1 /*!< A protocol interrupt is not activated if a falling edge of WA is generated. */,
    value2 = 1 /*!< A protocol interrupt is activated if a falling edge of WA is generated. */
};
 ...
 */
inline bool from_string(const char *data, USIC0_CH0_PCR_IISMode_WAFEIEN &output)
{
    bool result = false;
