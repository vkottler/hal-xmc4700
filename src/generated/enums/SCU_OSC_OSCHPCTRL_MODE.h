...
{
    value1 /*!< External Crystal Mode and External Input Clock Mode. The
              oscillator Power-Saving Mode is not entered. */
        ,
    value2 = 1 /*!< OSC is disabled. The oscillator Power-Saving Mode is not
                  entered. */
        ,
    value3 = 2 /*!< External Input Clock Mode and the oscillator Power-Saving
                  Mode is entered */
        ,
    value4 =
...
static constexpr uint16_t SCU_OSC_OSCHPCTRL_MODE_id = 645;
