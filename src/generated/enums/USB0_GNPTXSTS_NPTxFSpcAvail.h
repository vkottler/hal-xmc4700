...
inline const char *to_string(USB0_GNPTXSTS_NPTxFSpcAvail instance)
{
    ...
    case USB0_GNPTXSTS_NPTxFSpcAvail::non_periodic_txfifo_full:
        ...
        break;
    case USB0_GNPTXSTS_NPTxFSpcAvail::1_word_available:
        result = "1_word_available";
        break;
    case USB0_GNPTXSTS_NPTxFSpcAvail::2_words_available:
...
inline bool from_string(const char *data, USB0_GNPTXSTS_NPTxFSpcAvail &output)
{
    ...
    {
        output = USB0_GNPTXSTS_NPTxFSpcAvail::1_word_available;
    }
    else if ((result = !strncmp(data, "2_words_available", 17)))
    {
        output = USB0_GNPTXSTS_NPTxFSpcAvail::2_words_available;
    }
