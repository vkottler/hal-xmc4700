 ...
 *   "enum": {
 *     "value1": {
 *       "description": "No Double-Bit Error detected during read access to PFLASH",
 *       "value": 0
 *     },
 *     "value2": {
 *       "description": "Double-Bit Error detected in PFLASH",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t FLASH0_FSR_PFDBER_id = 1931;
...
inline const char *to_string(FLASH0_FSR_PFDBER instance)
{
    ...
    switch (instance)
    {
    case FLASH0_FSR_PFDBER::value1:
        result = "value1";
        break;
    case FLASH0_FSR_PFDBER::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, FLASH0_FSR_PFDBER &output)
{
    ...
    {
        output = FLASH0_FSR_PFDBER::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = FLASH0_FSR_PFDBER::value2;
    }
