...
static constexpr uint16_t USIC0_CH0_TRBSCR_CTBERI_id = 3482;
...
inline const char *to_string(USIC0_CH0_TRBSCR_CTBERI instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_TRBSCR_CTBERI::value1:
        result = "value1";
        break;
    case USIC0_CH0_TRBSCR_CTBERI::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_TRBSCR_CTBERI &output)
{
    ...
    {
        output = USIC0_CH0_TRBSCR_CTBERI::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = USIC0_CH0_TRBSCR_CTBERI::value2;
    }
