...
inline const char *to_string(CCU80_CC80_SRS_E0SR instance)
{
    ...
    case CCU80_CC80_SRS_E0SR::vysr0:
        result = "vysr0";
        break;
    case CCU80_CC80_SRS_E0SR::8ysr1:
        result = "8ysr1";
        break;
    case CCU80_CC80_SRS_E0SR::8ysr2:
        result = "8ysr2";
        break;
    case CCU80_CC80_SRS_E0SR::8ysr3:
        result = "8ysr3";
        break;
    }
...
inline bool from_string(const char *data, CCU80_CC80_SRS_E0SR &output)
{
    ...
    else if ((result = !strncmp(data, "8ysr1", 5)))
    {
        output = CCU80_CC80_SRS_E0SR::8ysr1;
    }
    else if ((result = !strncmp(data, "8ysr2", 5)))
    {
        output = CCU80_CC80_SRS_E0SR::8ysr2;
    }
    else if ((result = !strncmp(data, "8ysr3", 5)))
    {
        output = CCU80_CC80_SRS_E0SR::8ysr3;
    }
