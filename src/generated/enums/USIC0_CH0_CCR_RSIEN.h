...
inline const char *to_string(USIC0_CH0_CCR_RSIEN instance)
{
    ...
    case USIC0_CH0_CCR_RSIEN::disabled:
        result = "disabled";
        break;
    case USIC0_CH0_CCR_RSIEN::enabled_case_receive_cont:
        result = "enabled_case_receive_cont";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_CCR_RSIEN &output)
{
    ...
    else if ((result = !strncmp(data, "enabled_case_receive_cont", 25)))
    {
        output = USIC0_CH0_CCR_RSIEN::enabled_case_receive_cont;
    }
