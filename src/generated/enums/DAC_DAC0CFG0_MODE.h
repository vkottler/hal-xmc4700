...
static constexpr uint16_t DAC_DAC0CFG0_MODE_id = 2142;
...
inline const char *to_string(DAC_DAC0CFG0_MODE instance)
{
    ...
    switch (instance)
    {
    case DAC_DAC0CFG0_MODE::value1:
        result = "value1";
        break;
    case DAC_DAC0CFG0_MODE::value2:
        result = "value2";
        break;
    case DAC_DAC0CFG0_MODE::value3:
        result = "value3";
        break;
    case DAC_DAC0CFG0_MODE::value4:
        result = "value4";
        break;
    case DAC_DAC0CFG0_MODE::value5:
        result = "value5";
        break;
    case DAC_DAC0CFG0_MODE::value6:
        result = "value6";
        break;
    case DAC_DAC0CFG0_MODE::value7:
        result = "value7";
        break;
    case DAC_DAC0CFG0_MODE::value8:
        result = "value8";
        break;
    }
...
inline bool from_string(const char *data, DAC_DAC0CFG0_MODE &output)
{
    ...
    {
        output = DAC_DAC0CFG0_MODE::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = DAC_DAC0CFG0_MODE::value2;
    }
    else if ((result = !strncmp(data, "value3", 6)))
    {
        output = DAC_DAC0CFG0_MODE::value3;
    }
    else if ((result = !strncmp(data, "value4", 6)))
    {
        output = DAC_DAC0CFG0_MODE::value4;
    }
    else if ((result = !strncmp(data, "value5", 6)))
    {
        output = DAC_DAC0CFG0_MODE::value5;
    }
    else if ((result = !strncmp(data, "value6", 6)))
    {
        output = DAC_DAC0CFG0_MODE::value6;
    }
    else if ((result = !strncmp(data, "value7", 6)))
    {
        output = DAC_DAC0CFG0_MODE::value7;
    }
    else if ((result = !strncmp(data, "value8", 6)))
    {
        output = DAC_DAC0CFG0_MODE::value8;
    }
