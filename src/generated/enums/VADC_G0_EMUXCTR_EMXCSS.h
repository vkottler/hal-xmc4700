 ...
 *   "enum": {
 *     "value1": {
 *       "description": "Channel number: Bitfield EMUXCH selects an arbitrary channel",
 *       "value": 0
 *     },
 *     "value2": {
 *       "description": "Channel enable: Each bit of bitfield EMUXCH selects the associated channel for EMUX control",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
enum class VADC_G0_EMUXCTR_EMXCSS : uint8_t
{
    ...
    value2 = 1 /*!< Channel enable: Each bit of bitfield EMUXCH selects the associated channel for EMUX control */
};
