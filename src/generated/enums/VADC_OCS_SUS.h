...
enum class VADC_OCS_SUS : uint8_t
{
    ...
    value3 = 2 /*!< Soft suspend mode 0: Stop conversions after the currently
                  running one is completed and its result has been stored. No
                  change for the arbiter. */
        ,
    value4 = 3 /*!< Soft suspend mode 1: Stop conversions after the currently
