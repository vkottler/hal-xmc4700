...
enum class FLASH0_FSR_PFPAGE : uint8_t
{
    ...
    page_mode_assembly_buffer_pflash_256_byte_use_cont =
...
inline const char *to_string(FLASH0_FSR_PFPAGE instance)
{
    ...
    case FLASH0_FSR_PFPAGE::not_page_mode:
        ...
        break;
    case FLASH0_FSR_PFPAGE::page_mode_assembly_buffer_pflash_256_byte_use_cont:
        result = "page_mode_assembly_buffer_pflash_256_byte_use_cont";
        break;
    }
...
inline bool from_string(const char *data, FLASH0_FSR_PFPAGE &output)
{
    ...
    if ((result = !strncmp(data, "not_page_mode", 13)))
    {
        output = FLASH0_FSR_PFPAGE::not_page_mode;
                  ...
                  data, "page_mode_assembly_buffer_pflash_256_byte_use_cont",
                  50)))
    {
        output = FLASH0_FSR_PFPAGE::
            page_mode_assembly_buffer_pflash_256_byte_use_cont;
    }
