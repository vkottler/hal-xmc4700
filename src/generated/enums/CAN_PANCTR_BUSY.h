...
{
    has_finished_command_ready_accept_new_c_cont /*!< Panel has finished
...
inline const char *to_string(CAN_PANCTR_BUSY instance)
{
    ...
    switch (instance)
    {
    case CAN_PANCTR_BUSY::has_finished_command_ready_accept_new_c_cont:
        result = "has_finished_command_ready_accept_new_c_cont";
        break;
...
inline bool from_string(const char *data, CAN_PANCTR_BUSY &output)
{
    ...
    if ((result = !strncmp(
             data, "has_finished_command_ready_accept_new_c_cont", 44)))
    {
        output = CAN_PANCTR_BUSY::has_finished_command_ready_accept_new_c_cont;
    }
