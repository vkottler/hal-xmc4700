...
inline const char *to_string(USIC0_CH0_CCR_TSIEN instance)
{
    ...
    case USIC0_CH0_CCR_TSIEN::disabled:
        result = "disabled";
        break;
    case USIC0_CH0_CCR_TSIEN::enabled_case_transmi_cont:
        result = "enabled_case_transmi_cont";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_CCR_TSIEN &output)
{
    ...
    else if ((result = !strncmp(data, "enabled_case_transmi_cont", 25)))
    {
        output = USIC0_CH0_CCR_TSIEN::enabled_case_transmi_cont;
    }
