...
{
    runs_permanently_this_setting_required_synchr_cont /*!< The arbiter runs
                                                          permanently. This
                                                          setting is required
                                                          ...
                                                          ARBCNT (see ). */
        ,
    only_runs_if_at_least_one_conversion_request__cont =
...
inline const char *to_string(VADC_G0_ARBCFG_ARBM instance)
{
    ...
    switch (instance)
    {
    case VADC_G0_ARBCFG_ARBM::
        runs_permanently_this_setting_required_synchr_cont:
        result = "runs_permanently_this_setting_required_synchr_cont";
        break;
    case VADC_G0_ARBCFG_ARBM::
        only_runs_if_at_least_one_conversion_request__cont:
        result = "only_runs_if_at_least_one_conversion_request__cont";
        break;
    }
...
inline bool from_string(const char *data, VADC_G0_ARBCFG_ARBM &output)
{
    ...
    if ((result = !strncmp(
             data, "runs_permanently_this_setting_required_synchr_cont", 50)))
    {
        output = VADC_G0_ARBCFG_ARBM::
            runs_permanently_this_setting_required_synchr_cont;
    }
    else if ((result = !strncmp(
                  data, "only_runs_if_at_least_one_conversion_request__cont",
                  50)))
    {
        output = VADC_G0_ARBCFG_ARBM::
            only_runs_if_at_least_one_conversion_request__cont;
