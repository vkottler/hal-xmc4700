 ...
 *     },
 *     "value2": {
 *       "description": "TXRQ is set in the gateway destination object after the internal transfer from the gateway source to the gateway destination object.",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t CAN_MO_MOFCR_GDFS_id = 2115;
