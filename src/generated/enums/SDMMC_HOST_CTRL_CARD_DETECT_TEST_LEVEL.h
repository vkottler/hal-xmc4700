...
static constexpr uint16_t SDMMC_HOST_CTRL_CARD_DETECT_TEST_LEVEL_id = 1458;
 ...
 */
inline bool from_string(const char *data, SDMMC_HOST_CTRL_CARD_DETECT_TEST_LEVEL &output)
{
    bool result = false;
