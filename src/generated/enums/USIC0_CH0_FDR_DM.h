...
inline const char *to_string(USIC0_CH0_FDR_DM instance)
{
    ...
    case USIC0_CH0_FDR_DM::fractional_divider_mode_selected:
        ...
        break;
    case USIC0_CH0_FDR_DM::divider_switched_off_ffd_0_:
        result = "divider_switched_off_ffd_0_";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_FDR_DM &output)
{
    ...
    else if ((result = !strncmp(data, "divider_switched_off_ffd_0_", 27)))
    {
        output = USIC0_CH0_FDR_DM::divider_switched_off_ffd_0_;
    }
