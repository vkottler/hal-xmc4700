...
enum class PORT4_IOCR0_PC3 : uint8_t
{
...
static_assert(sizeof(PORT4_IOCR0_PC3) == 1);

/**
 * Converts PORT4_IOCR0_PC3 to a C string.
 *
 * \param[in] instance Value to convert.
 * \return             A C string representation of the value.
 */
inline const char *to_string(PORT4_IOCR0_PC3 instance)
{
    const char *result = "UNKNOWN PORT4_IOCR0_PC3";

    switch (instance)
    {
    case PORT4_IOCR0_PC3::input_no_internal_pull_device_active:
        result = "input_no_internal_pull_device_active";
        break;
    case PORT4_IOCR0_PC3::input_internal_pull_down_device_active:
        result = "input_internal_pull_down_device_active";
        break;
    case PORT4_IOCR0_PC3::input_internal_pull_up_device_active:
        result = "input_internal_pull_up_device_active";
        break;
    case PORT4_IOCR0_PC3::input_no_internal_pull_device_pn_outx_input_value:
        result = "input_no_internal_pull_device_pn_outx_input_value";
        break;
    case PORT4_IOCR0_PC3::input_inverted_no_internal_pull_device_active:
        result = "input_inverted_no_internal_pull_device_active";
        break;
    case PORT4_IOCR0_PC3::input_inverted_internal_pull_down_device_active:
        result = "input_inverted_internal_pull_down_device_active";
        break;
    case PORT4_IOCR0_PC3::input_inverted_internal_pull_up_device_active:
        result = "input_inverted_internal_pull_up_device_active";
        break;
    case PORT4_IOCR0_PC3::input_inverted_no_internal_pull_device_pn_out_cont:
        result = "input_inverted_no_internal_pull_device_pn_out_cont";
        break;
    case PORT4_IOCR0_PC3::output_push_pull_general_purpose_output:
        result = "output_push_pull_general_purpose_output";
        break;
    case PORT4_IOCR0_PC3::output_push_pull_alternate_output_function_1:
        result = "output_push_pull_alternate_output_function_1";
        break;
    case PORT4_IOCR0_PC3::output_push_pull_alternate_output_function_2:
        result = "output_push_pull_alternate_output_function_2";
        break;
    case PORT4_IOCR0_PC3::output_push_pull_alternate_output_function_3:
        result = "output_push_pull_alternate_output_function_3";
        break;
    case PORT4_IOCR0_PC3::output_push_pull_alternate_output_function_4:
        result = "output_push_pull_alternate_output_function_4";
        break;
    case PORT4_IOCR0_PC3::output_open_drain_general_purpose_output:
        result = "output_open_drain_general_purpose_output";
        break;
    case PORT4_IOCR0_PC3::output_open_drain_alternate_output_function_1:
        result = "output_open_drain_alternate_output_function_1";
        break;
    case PORT4_IOCR0_PC3::output_open_drain_alternate_output_function_2:
        result = "output_open_drain_alternate_output_function_2";
        break;
    case PORT4_IOCR0_PC3::output_open_drain_alternate_output_function_3:
        result = "output_open_drain_alternate_output_function_3";
        break;
    case PORT4_IOCR0_PC3::output_open_drain_alternate_output_function_4:
...
/**
 * Converts a C string to PORT4_IOCR0_PC3.
 *
 * \param[in]  data   A C string to convert.
 * \param[out] output The enumeration element to write.
 * \return            Whether or not the output was written.
 */
inline bool from_string(const char *data, PORT4_IOCR0_PC3 &output)
{
    bool result = false;

    if ((result = !strncmp(data, "input_no_internal_pull_device_active", 36)))
    {
        output = PORT4_IOCR0_PC3::input_no_internal_pull_device_active;
    }
    else if ((result = !strncmp(data, "input_internal_pull_down_device_active",
                                38)))
    {
        output = PORT4_IOCR0_PC3::input_internal_pull_down_device_active;
    }
    else if ((result =
                  !strncmp(data, "input_internal_pull_up_device_active", 36)))
    {
        output = PORT4_IOCR0_PC3::input_internal_pull_up_device_active;
    }
    ...
    {
        output =
            PORT4_IOCR0_PC3::input_no_internal_pull_device_pn_outx_input_value;
    }
    else if ((result = !strncmp(
                  data, "input_inverted_no_internal_pull_device_active", 45)))
    {
        output =
            PORT4_IOCR0_PC3::input_inverted_no_internal_pull_device_active;
    }
    else if ((result = !strncmp(
    ...
    {
        output =
            PORT4_IOCR0_PC3::input_inverted_internal_pull_down_device_active;
    }
    else if ((result = !strncmp(
                  data, "input_inverted_internal_pull_up_device_active", 45)))
    {
        output =
            PORT4_IOCR0_PC3::input_inverted_internal_pull_up_device_active;
    }
    else if ((result = !strncmp(
                  data, "input_inverted_no_internal_pull_device_pn_out_cont",
                  50)))
    {
        output = PORT4_IOCR0_PC3::
            input_inverted_no_internal_pull_device_pn_out_cont;
    }
    else if ((result = !strncmp(
                  data, "output_push_pull_general_purpose_output", 39)))
    {
        output = PORT4_IOCR0_PC3::output_push_pull_general_purpose_output;
    }
    else if ((result = !strncmp(
                  data, "output_push_pull_alternate_output_function_1", 44)))
    {
        output = PORT4_IOCR0_PC3::output_push_pull_alternate_output_function_1;
    }
    else if ((result = !strncmp(
                  data, "output_push_pull_alternate_output_function_2", 44)))
    {
        output = PORT4_IOCR0_PC3::output_push_pull_alternate_output_function_2;
    }
    else if ((result = !strncmp(
                  data, "output_push_pull_alternate_output_function_3", 44)))
    {
        output = PORT4_IOCR0_PC3::output_push_pull_alternate_output_function_3;
    }
    else if ((result = !strncmp(
                  data, "output_push_pull_alternate_output_function_4", 44)))
    {
        output = PORT4_IOCR0_PC3::output_push_pull_alternate_output_function_4;
    }
    else if ((result = !strncmp(
                  data, "output_open_drain_general_purpose_output", 40)))
    {
        output = PORT4_IOCR0_PC3::output_open_drain_general_purpose_output;
    }
    else if ((result = !strncmp(
                  data, "output_open_drain_alternate_output_function_1", 45)))
    {
        output =
            PORT4_IOCR0_PC3::output_open_drain_alternate_output_function_1;
    }
    else if ((result = !strncmp(
                  data, "output_open_drain_alternate_output_function_2", 45)))
    {
        output =
            PORT4_IOCR0_PC3::output_open_drain_alternate_output_function_2;
    }
    else if ((result = !strncmp(
                  data, "output_open_drain_alternate_output_function_3", 45)))
    {
        output =
            PORT4_IOCR0_PC3::output_open_drain_alternate_output_function_3;
    }
    else if ((result = !strncmp(
                  data, "output_open_drain_alternate_output_function_4", 45)))
    {
        output =
            PORT4_IOCR0_PC3::output_open_drain_alternate_output_function_4;
    }
