...
inline const char *to_string(PORT4_IOCR0_PC3 instance)
{
    ...
    switch (instance)
    {
    case PORT4_IOCR0_PC3::input___no_internal_pull_device_active:
        result = "input___no_internal_pull_device_active";
        break;
    case PORT4_IOCR0_PC3::input___internal_pull_down_device_active:
        result = "input___internal_pull_down_device_active";
        break;
    case PORT4_IOCR0_PC3::input___internal_pull_up_device_active:
        result = "input___internal_pull_up_device_active";
        break;
    case PORT4_IOCR0_PC3::input___no_internal_pull_device_pn_outx_input_cont:
        result = "input___no_internal_pull_device_pn_outx_input_cont";
        break;
    case PORT4_IOCR0_PC3::input_inverted___no_internal_pull_device_active:
        result = "input_inverted___no_internal_pull_device_active";
        break;
    case PORT4_IOCR0_PC3::input_inverted___internal_pull_down_device_active:
        result = "input_inverted___internal_pull_down_device_active";
        break;
    case PORT4_IOCR0_PC3::input_inverted___internal_pull_up_device_active:
        result = "input_inverted___internal_pull_up_device_active";
        break;
    case PORT4_IOCR0_PC3::input_inverted___no_internal_pull_device_pn_o_cont:
        result = "input_inverted___no_internal_pull_device_pn_o_cont";
        break;
    case PORT4_IOCR0_PC3::output_push_pull___general_purpose_output:
        result = "output_push_pull___general_purpose_output";
        break;
    case PORT4_IOCR0_PC3::output_push_pull___alternate_output_function_1:
        result = "output_push_pull___alternate_output_function_1";
        break;
    case PORT4_IOCR0_PC3::output_push_pull___alternate_output_function_2:
        result = "output_push_pull___alternate_output_function_2";
        break;
    case PORT4_IOCR0_PC3::output_push_pull___alternate_output_function_3:
        result = "output_push_pull___alternate_output_function_3";
        break;
    case PORT4_IOCR0_PC3::output_push_pull___alternate_output_function_4:
        result = "output_push_pull___alternate_output_function_4";
        break;
    case PORT4_IOCR0_PC3::output_open_drain___general_purpose_output:
        result = "output_open_drain___general_purpose_output";
        break;
    case PORT4_IOCR0_PC3::output_open_drain___alternate_output_function_1:
        result = "output_open_drain___alternate_output_function_1";
        break;
    case PORT4_IOCR0_PC3::output_open_drain___alternate_output_function_2:
        result = "output_open_drain___alternate_output_function_2";
        break;
    case PORT4_IOCR0_PC3::output_open_drain___alternate_output_function_3:
        result = "output_open_drain___alternate_output_function_3";
        break;
    case PORT4_IOCR0_PC3::output_open_drain___alternate_output_function_4:
...
inline bool from_string(const char *data, PORT4_IOCR0_PC3 &output)
{
    ...
    {
        output = PORT4_IOCR0_PC3::input___no_internal_pull_device_active;
    }
    else if ((result = !strncmp(
                  data, "input___internal_pull_down_device_active", 40)))
    {
        output = PORT4_IOCR0_PC3::input___internal_pull_down_device_active;
    }
    else if ((result = !strncmp(data, "input___internal_pull_up_device_active",
                                38)))
    {
        output = PORT4_IOCR0_PC3::input___internal_pull_up_device_active;
    }
    else if ((result = !strncmp(
    ...
    {
        output =
            PORT4_IOCR0_PC3::input_inverted___no_internal_pull_device_active;
    }
    else if ((result = !strncmp(
    ...
    {
        output =
            PORT4_IOCR0_PC3::input_inverted___internal_pull_down_device_active;
    }
    else if ((result = !strncmp(
    ...
    {
        output =
            PORT4_IOCR0_PC3::input_inverted___internal_pull_up_device_active;
    }
    else if ((result = !strncmp(
    ...
    {
        output = PORT4_IOCR0_PC3::output_push_pull___general_purpose_output;
    }
    else if ((result = !strncmp(
                  data, "output_push_pull___alternate_output_function_1", 46)))
    {
        output =
            PORT4_IOCR0_PC3::output_push_pull___alternate_output_function_1;
    }
    else if ((result = !strncmp(
                  data, "output_push_pull___alternate_output_function_2", 46)))
    {
        output =
            PORT4_IOCR0_PC3::output_push_pull___alternate_output_function_2;
    }
    else if ((result = !strncmp(
                  data, "output_push_pull___alternate_output_function_3", 46)))
    {
        output =
            PORT4_IOCR0_PC3::output_push_pull___alternate_output_function_3;
    }
    else if ((result = !strncmp(
                  data, "output_push_pull___alternate_output_function_4", 46)))
    {
        output =
            PORT4_IOCR0_PC3::output_push_pull___alternate_output_function_4;
    }
    else if ((result = !strncmp(
                  data, "output_open_drain___general_purpose_output", 42)))
    {
        output = PORT4_IOCR0_PC3::output_open_drain___general_purpose_output;
    }
    else if ((result = !strncmp(
    ...
    {
        output =
            PORT4_IOCR0_PC3::output_open_drain___alternate_output_function_1;
    }
    else if ((result = !strncmp(
    ...
    {
        output =
            PORT4_IOCR0_PC3::output_open_drain___alternate_output_function_2;
    }
    else if ((result = !strncmp(
    ...
    {
        output =
            PORT4_IOCR0_PC3::output_open_drain___alternate_output_function_3;
    }
    else if ((result = !strncmp(
    ...
    {
        output =
            PORT4_IOCR0_PC3::output_open_drain___alternate_output_function_4;
    }
