...
{
    value1 /*!< Multi-Channel pattern Update Event interrupt forward to POSIFx.SR0 */,
    value2 = 1 /*!< Multi-Channel pattern Update Event interrupt forward to POSIFx.SR1 */
};
static_assert(sizeof(POSIF0_PFLGE_MSTSEL) == 1);

static constexpr uint16_t POSIF0_PFLGE_MSTSEL_id = 2328;
...
inline const char *to_string(POSIF0_PFLGE_MSTSEL instance)
{
    ...
    switch (instance)
    {
    case POSIF0_PFLGE_MSTSEL::value1:
        result = "value1";
        break;
    case POSIF0_PFLGE_MSTSEL::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, POSIF0_PFLGE_MSTSEL &output)
{
    ...
    {
        output = POSIF0_PFLGE_MSTSEL::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = POSIF0_PFLGE_MSTSEL::value2;
    }
