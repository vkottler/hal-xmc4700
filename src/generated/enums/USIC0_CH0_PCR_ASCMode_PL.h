...
inline const char *to_string(USIC0_CH0_PCR_ASCMode_PL instance)
{
    ...
    case USIC0_CH0_PCR_ASCMode_PL::equal_bit_length_no_shortened_0:
        ...
        break;
    case USIC0_CH0_PCR_ASCMode_PL::0_bit_2_time_quanta:
        result = "0_bit_2_time_quanta";
        break;
    case USIC0_CH0_PCR_ASCMode_PL::0_bit_3_time_quanta:
        result = "0_bit_3_time_quanta";
        break;
    case USIC0_CH0_PCR_ASCMode_PL::0_bit_8_time_quanta:
        result = "0_bit_8_time_quanta";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_PCR_ASCMode_PL &output)
{
    ...
    else if ((result = !strncmp(data, "0_bit_2_time_quanta", 19)))
    {
        output = USIC0_CH0_PCR_ASCMode_PL::0_bit_2_time_quanta;
    }
    else if ((result = !strncmp(data, "0_bit_3_time_quanta", 19)))
    {
        output = USIC0_CH0_PCR_ASCMode_PL::0_bit_3_time_quanta;
    }
    else if ((result = !strncmp(data, "0_bit_8_time_quanta", 19)))
    {
        output = USIC0_CH0_PCR_ASCMode_PL::0_bit_8_time_quanta;
    }
