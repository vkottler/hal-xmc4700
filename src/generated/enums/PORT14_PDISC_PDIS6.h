...
enum class PORT14_PDISC_PDIS6 : uint8_t
{
    enabled_digital_input_selected /*!< Pad is enabled, digital input selected.
                                    */
        ,
    disabled_adc_0_analog_input_6_selected =
        1 /*!< Pad is disabled, ADC 0 analog input 6 selected. */
};
...
inline const char *to_string(PORT14_PDISC_PDIS6 instance)
{
    ...
    switch (instance)
    {
    case PORT14_PDISC_PDIS6::enabled_digital_input_selected:
        result = "enabled_digital_input_selected";
        break;
    case PORT14_PDISC_PDIS6::disabled_adc_0_analog_input_6_selected:
        result = "disabled_adc_0_analog_input_6_selected";
        break;
    }
...
inline bool from_string(const char *data, PORT14_PDISC_PDIS6 &output)
{
    ...
    {
        output = PORT14_PDISC_PDIS6::enabled_digital_input_selected;
    }
    else if ((result = !strncmp(data, "disabled_adc_0_analog_input_6_selected",
                                38)))
    {
        output = PORT14_PDISC_PDIS6::disabled_adc_0_analog_input_6_selected;
    }
