...
static constexpr uint16_t VADC_G0_QMR0_CEV_id = 950;
...
inline const char *to_string(VADC_G0_QMR0_CEV instance)
{
    ...
    switch (instance)
    {
    case VADC_G0_QMR0_CEV::value1:
        result = "value1";
        break;
    case VADC_G0_QMR0_CEV::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, VADC_G0_QMR0_CEV &output)
{
    ...
    {
        output = VADC_G0_QMR0_CEV::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = VADC_G0_QMR0_CEV::value2;
    }
