...
static constexpr uint16_t USIC0_CH0_PSR_IICMode_SLSEL_id = 3390;
...
inline const char *to_string(USIC0_CH0_PSR_IICMode_SLSEL instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_PSR_IICMode_SLSEL::value1:
        result = "value1";
        break;
    case USIC0_CH0_PSR_IICMode_SLSEL::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_PSR_IICMode_SLSEL &output)
{
    ...
    {
        output = USIC0_CH0_PSR_IICMode_SLSEL::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = USIC0_CH0_PSR_IICMode_SLSEL::value2;
    }
