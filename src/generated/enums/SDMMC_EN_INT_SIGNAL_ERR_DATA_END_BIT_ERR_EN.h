...
static constexpr uint16_t SDMMC_EN_INT_SIGNAL_ERR_DATA_END_BIT_ERR_EN_id = 3036;
 ...
 */
inline const char *to_string(SDMMC_EN_INT_SIGNAL_ERR_DATA_END_BIT_ERR_EN instance)
{
 ...
 */
inline bool from_string(const char *data, SDMMC_EN_INT_SIGNAL_ERR_DATA_END_BIT_ERR_EN &output)
{
    bool result = false;
