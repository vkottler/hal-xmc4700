...
{
    33v_supported = 1 /*!< 3.3V supported */
};
...
inline const char *to_string(SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3_3V instance)
{
    ...
    switch (instance)
    {
    case SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3_3V::33v_supported:
        result = "33v_supported";
        break;
    }
                        ...
                        SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3_3V &output)
{
    ...
    if ((result = !strncmp(data, "33v_supported", 13)))
    {
        output = SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3_3V::33v_supported;
    }
