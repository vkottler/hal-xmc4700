...
inline const char *to_string(VADC_G0_ASMR_ENSI instance)
{
    ...
    switch (instance)
    {
    case VADC_G0_ASMR_ENSI::no_request_source_interrupt:
        result = "no_request_source_interrupt";
        break;
    case VADC_G0_ASMR_ENSI::request_source_interrupt_generated_upon_reque_cont:
...
inline bool from_string(const char *data, VADC_G0_ASMR_ENSI &output)
{
    ...
    {
        output = VADC_G0_ASMR_ENSI::no_request_source_interrupt;
    }
    else if ((result = !strncmp(
                  data, "request_source_interrupt_generated_upon_reque_cont",
                  50)))
    {
        output = VADC_G0_ASMR_ENSI::
            request_source_interrupt_generated_upon_reque_cont;
    }
