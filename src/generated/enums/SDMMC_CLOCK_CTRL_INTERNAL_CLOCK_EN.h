...
static constexpr uint16_t SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_EN_id = 2977;
...
inline const char *to_string(SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_EN instance)
{
    ...
    switch (instance)
    {
    case SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_EN::value1:
        result = "value1";
        break;
    case SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_EN::value2:
        result = "value2";
        break;
    }
 ...
 */
inline bool from_string(const char *data, SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_EN &output)
{
    bool result = false;

    if ((result = !strncmp(data, "value1", 6)))
    {
        output = SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_EN::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_EN::value2;
    }
