...
static constexpr uint16_t PORT15_PDISC_PDIS6_id = 1405;
...
inline const char *to_string(PORT15_PDISC_PDIS6 instance)
{
    ...
    switch (instance)
    {
    case PORT15_PDISC_PDIS6::value1:
        result = "value1";
        break;
    case PORT15_PDISC_PDIS6::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, PORT15_PDISC_PDIS6 &output)
{
    ...
    {
        output = PORT15_PDISC_PDIS6::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = PORT15_PDISC_PDIS6::value2;
    }
