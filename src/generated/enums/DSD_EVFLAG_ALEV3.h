...
static constexpr uint16_t DSD_EVFLAG_ALEV3_id = 2368;
...
inline const char *to_string(DSD_EVFLAG_ALEV3 instance)
{
    ...
    switch (instance)
    {
    case DSD_EVFLAG_ALEV3::value1:
        result = "value1";
        break;
    case DSD_EVFLAG_ALEV3::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, DSD_EVFLAG_ALEV3 &output)
{
    ...
    {
        output = DSD_EVFLAG_ALEV3::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = DSD_EVFLAG_ALEV3::value2;
    }
