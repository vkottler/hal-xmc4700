...
enum class CAN_MO_MOAR_PRI : uint8_t
{
    ...
    can_ident_cont =
        ...
        ,
    list_orde_cont_ = 3 /*!< Transmit acceptance filtering is based on the list
                           order (as PRI = 01B). */
};
...
inline const char *to_string(CAN_MO_MOAR_PRI instance)
{
    ...
    switch (instance)
    {
    case CAN_MO_MOAR_PRI::list_orde_cont:
        result = "list_orde_cont";
        break;
    case CAN_MO_MOAR_PRI::can_ident_cont:
        result = "can_ident_cont";
        break;
    case CAN_MO_MOAR_PRI::list_orde_cont_:
        result = "list_orde_cont_";
        break;
    }
...
inline bool from_string(const char *data, CAN_MO_MOAR_PRI &output)
{
    ...
    if ((result = !strncmp(data, "list_orde_cont", 14)))
    {
        output = CAN_MO_MOAR_PRI::list_orde_cont;
    }
    else if ((result = !strncmp(data, "can_ident_cont", 14)))
    {
        output = CAN_MO_MOAR_PRI::can_ident_cont;
    }
    else if ((result = !strncmp(data, "list_orde_cont_", 15)))
    {
        output = CAN_MO_MOAR_PRI::list_orde_cont_;
    }
