...
static constexpr uint16_t GPDMA0_CH0_CTLL_DINC_id = 1799;
...
inline const char *to_string(GPDMA0_CH0_CTLL_DINC instance)
{
    ...
    switch (instance)
    {
    case GPDMA0_CH0_CTLL_DINC::value1:
        result = "value1";
        break;
    case GPDMA0_CH0_CTLL_DINC::value2:
        result = "value2";
        break;
    case GPDMA0_CH0_CTLL_DINC::value3:
        result = "value3";
        break;
    }
...
inline bool from_string(const char *data, GPDMA0_CH0_CTLL_DINC &output)
{
    ...
    {
        output = GPDMA0_CH0_CTLL_DINC::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = GPDMA0_CH0_CTLL_DINC::value2;
    }
    else if ((result = !strncmp(data, "value3", 6)))
    {
        output = GPDMA0_CH0_CTLL_DINC::value3;
    }
