...
{
    1 /*!< Timer is loaded with the value of CR1 */,
    2 = 1 /*!< Timer is loaded with the value of CR2 */
};
...
inline const char *to_string(CCU80_CC80_TC_TLS instance)
{
    ...
    switch (instance)
    {
    case CCU80_CC80_TC_TLS::1:
        result = "1";
        break;
    case CCU80_CC80_TC_TLS::2:
        result = "2";
        break;
    }
...
inline bool from_string(const char *data, CCU80_CC80_TC_TLS &output)
{
    ...
    {
        output = CCU80_CC80_TC_TLS::1;
    }
    else if ((result = !strncmp(data, "2", 1)))
    {
        output = CCU80_CC80_TC_TLS::2;
    }
