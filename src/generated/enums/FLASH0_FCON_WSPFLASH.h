...
enum class FLASH0_FCON_WSPFLASH : uint8_t
{
    ...
    one_clock_cycle_ = 1 /*!< PFLASH access in one clock cycle */,
...
inline const char *to_string(FLASH0_FCON_WSPFLASH instance)
{
    ...
    case FLASH0_FCON_WSPFLASH::one_clock_cycle:
        ...
        break;
    case FLASH0_FCON_WSPFLASH::one_clock_cycle_:
        result = "one_clock_cycle_";
        break;
...
inline bool from_string(const char *data, FLASH0_FCON_WSPFLASH &output)
{
    ...
    else if ((result = !strncmp(data, "one_clock_cycle_", 16)))
    {
        output = FLASH0_FCON_WSPFLASH::one_clock_cycle_;
    }
