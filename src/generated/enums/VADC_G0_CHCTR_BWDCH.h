 ...
 *   "enum": {
 *     "value1": {
 *       "description": "Select VAGND",
 *       "value": 0
 *     },
 *     "value2": {
 *       "description": "Select VAREF",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t VADC_G0_CHCTR_BWDCH_id = 1107;
...
inline const char *to_string(VADC_G0_CHCTR_BWDCH instance)
{
    ...
    switch (instance)
    {
    case VADC_G0_CHCTR_BWDCH::value1:
        result = "value1";
        break;
    case VADC_G0_CHCTR_BWDCH::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, VADC_G0_CHCTR_BWDCH &output)
{
    ...
    {
        output = VADC_G0_CHCTR_BWDCH::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = VADC_G0_CHCTR_BWDCH::value2;
    }
