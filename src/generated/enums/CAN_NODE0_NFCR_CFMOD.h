 ...
 *   "enum": {
 *     "value1": {
 *       "description": "Frame Count Mode: The frame counter is incremented upon the reception and transmission of frames.",
 *       "value": 0
 *     },
 *     "value2": {
 ...
 *     },
 *     "value3": {
 *       "description": "Bit Timing Mode: The frame counter is used for analysis of the bit timing.",
 *       "value": 2
 *     },
 *     "value4": {
 *       "description": "Error Count Mode: The frame counter is used for counting when an error frame is received or an error is detected by the node.",
 *       "value": 3
 *     }
 *   },
 *   "unit_test": false,
...
{
    value1 /*!< Frame Count Mode: The frame counter is incremented upon the reception and transmission of frames. */,
    value2 = 1 /*!< Time Stamp Mode: The frame counter is used to count bit times. */,
    value3 = 2 /*!< Bit Timing Mode: The frame counter is used for analysis of the bit timing. */,
    value4 = 3 /*!< Error Count Mode: The frame counter is used for counting when an error frame is received or an error is detected by the node. */
};
