...
{
    value1 /*!< The frequency difference of fREF and fDIV is greater than
              allowed. The VCO part of the PLL can not lock on a target
              frequency. */
        ,
    value2 = 1 /*!< The frequency difference of fREF and fDIV is small enough
                  to enable a stable VCO operation */
};
