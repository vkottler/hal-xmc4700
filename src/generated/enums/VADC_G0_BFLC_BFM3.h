...
static constexpr uint16_t VADC_G0_BFLC_BFM3_id = 935;
...
inline const char *to_string(VADC_G0_BFLC_BFM3 instance)
{
    ...
    switch (instance)
    {
    case VADC_G0_BFLC_BFM3::value1:
        result = "value1";
        break;
    case VADC_G0_BFLC_BFM3::value2:
        result = "value2";
        break;
    case VADC_G0_BFLC_BFM3::value3:
        result = "value3";
        break;
    case VADC_G0_BFLC_BFM3::value4:
        result = "value4";
        break;
    }
...
inline bool from_string(const char *data, VADC_G0_BFLC_BFM3 &output)
{
    ...
    {
        output = VADC_G0_BFLC_BFM3::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = VADC_G0_BFLC_BFM3::value2;
    }
    else if ((result = !strncmp(data, "value3", 6)))
    {
        output = VADC_G0_BFLC_BFM3::value3;
    }
    else if ((result = !strncmp(data, "value4", 6)))
    {
        output = VADC_G0_BFLC_BFM3::value4;
    }
