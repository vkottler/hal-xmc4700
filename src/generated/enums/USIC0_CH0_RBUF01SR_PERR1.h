...
{
    matche_cont /*!< The received protocol-related argument PAR matches the
                   expected value. The reception of the data word sets bit
                   PSR.RIF and can generate a receive interrupt. */
        ,
    does_n_cont =
...
inline const char *to_string(USIC0_CH0_RBUF01SR_PERR1 instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_RBUF01SR_PERR1::matche_cont:
        result = "matche_cont";
        break;
    case USIC0_CH0_RBUF01SR_PERR1::does_n_cont:
        result = "does_n_cont";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_RBUF01SR_PERR1 &output)
{
    ...
    if ((result = !strncmp(data, "matche_cont", 11)))
    {
        output = USIC0_CH0_RBUF01SR_PERR1::matche_cont;
    }
    else if ((result = !strncmp(data, "does_n_cont", 11)))
    {
        output = USIC0_CH0_RBUF01SR_PERR1::does_n_cont;
    }
