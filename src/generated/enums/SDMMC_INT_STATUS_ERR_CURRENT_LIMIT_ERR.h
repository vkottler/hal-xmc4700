...
static constexpr uint16_t SDMMC_INT_STATUS_ERR_CURRENT_LIMIT_ERR_id = 1491;
...
inline const char *to_string(SDMMC_INT_STATUS_ERR_CURRENT_LIMIT_ERR instance)
{
    ...
    switch (instance)
    {
    case SDMMC_INT_STATUS_ERR_CURRENT_LIMIT_ERR::value1:
        result = "value1";
        break;
    case SDMMC_INT_STATUS_ERR_CURRENT_LIMIT_ERR::value2:
        result = "value2";
        break;
    }
 ...
 */
inline bool from_string(const char *data, SDMMC_INT_STATUS_ERR_CURRENT_LIMIT_ERR &output)
{
    bool result = false;

    if ((result = !strncmp(data, "value1", 6)))
    {
        output = SDMMC_INT_STATUS_ERR_CURRENT_LIMIT_ERR::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SDMMC_INT_STATUS_ERR_CURRENT_LIMIT_ERR::value2;
    }
