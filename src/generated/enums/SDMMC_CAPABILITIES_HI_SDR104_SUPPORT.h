...
{
    sdr104_not_supported /*!< SDR104 is not supported */
};
...
inline const char *to_string(SDMMC_CAPABILITIES_HI_SDR104_SUPPORT instance)
{
    ...
    switch (instance)
    {
    case SDMMC_CAPABILITIES_HI_SDR104_SUPPORT::sdr104_not_supported:
        result = "sdr104_not_supported";
        break;
    }
...
inline bool from_string(const char *data,
                        SDMMC_CAPABILITIES_HI_SDR104_SUPPORT &output)
{
    bool result = false;

    if ((result = !strncmp(data, "sdr104_not_supported", 20)))
    {
        output = SDMMC_CAPABILITIES_HI_SDR104_SUPPORT::sdr104_not_supported;
    }
