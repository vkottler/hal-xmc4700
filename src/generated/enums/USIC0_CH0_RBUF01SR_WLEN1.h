...
static constexpr uint16_t USIC0_CH0_RBUF01SR_WLEN1_id = 3426;
...
inline const char *to_string(USIC0_CH0_RBUF01SR_WLEN1 instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_RBUF01SR_WLEN1::value1:
        result = "value1";
        break;
    case USIC0_CH0_RBUF01SR_WLEN1::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_RBUF01SR_WLEN1 &output)
{
    ...
    {
        output = USIC0_CH0_RBUF01SR_WLEN1::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = USIC0_CH0_RBUF01SR_WLEN1::value2;
    }
