...
static constexpr uint16_t
    SDMMC_FORCE_EVENT_ACMD_ERR_STATUS_FE_ACMD_CRC_ERR_id = 1058;
...
inline const char *to_string(
    SDMMC_FORCE_EVENT_ACMD_ERR_STATUS_FE_ACMD_CRC_ERR instance)
{
    const char *result =
        "UNKNOWN SDMMC_FORCE_EVENT_ACMD_ERR_STATUS_FE_ACMD_CRC_ERR";
...
inline bool from_string(
    const char *data,
    SDMMC_FORCE_EVENT_ACMD_ERR_STATUS_FE_ACMD_CRC_ERR &output)
{
    bool result = false;
