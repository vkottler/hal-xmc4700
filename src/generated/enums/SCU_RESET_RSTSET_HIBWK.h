 ...
 *     },
 *     "value2": {
 *       "description": "Assert reset status bit",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t SCU_RESET_RSTSET_HIBWK_id = 2024;
...
inline const char *to_string(SCU_RESET_RSTSET_HIBWK instance)
{
    ...
    switch (instance)
    {
    case SCU_RESET_RSTSET_HIBWK::value1:
        result = "value1";
        break;
    case SCU_RESET_RSTSET_HIBWK::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, SCU_RESET_RSTSET_HIBWK &output)
{
    ...
    {
        output = SCU_RESET_RSTSET_HIBWK::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SCU_RESET_RSTSET_HIBWK::value2;
    }
