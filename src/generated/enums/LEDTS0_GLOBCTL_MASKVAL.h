...
enum class LEDTS0_GLOBCTL_MASKVAL : uint8_t
{
    ...
    2_lsb_bits = 1 /*!< Mask 2 LSB bits */,
    8_lsb_bits = 7 /*!< Mask 8 LSB bits */
};
...
inline const char *to_string(LEDTS0_GLOBCTL_MASKVAL instance)
{
    ...
    case LEDTS0_GLOBCTL_MASKVAL::lsb_bit:
        result = "lsb_bit";
        break;
    case LEDTS0_GLOBCTL_MASKVAL::2_lsb_bits:
        result = "2_lsb_bits";
        break;
    case LEDTS0_GLOBCTL_MASKVAL::8_lsb_bits:
        result = "8_lsb_bits";
        break;
    }
...
inline bool from_string(const char *data, LEDTS0_GLOBCTL_MASKVAL &output)
{
    ...
    else if ((result = !strncmp(data, "2_lsb_bits", 10)))
    {
        output = LEDTS0_GLOBCTL_MASKVAL::2_lsb_bits;
    }
    else if ((result = !strncmp(data, "8_lsb_bits", 10)))
    {
        output = LEDTS0_GLOBCTL_MASKVAL::8_lsb_bits;
    }
