...
enum class PORT0_PDR1_PD13 : uint8_t
{
...
static_assert(sizeof(PORT0_PDR1_PD13) == 1);

static constexpr uint16_t PORT0_PDR1_PD13_id = 1664;

/**
 * Converts PORT0_PDR1_PD13 to a C string.
 *
 * \param[in] instance Value to convert.
 * \return             A C string representation of the value.
 */
inline const char *to_string(PORT0_PDR1_PD13 instance)
{
    const char *result = "UNKNOWN PORT0_PDR1_PD13";

    switch (instance)
    {
    case PORT0_PDR1_PD13::sd_soe:
        result = "sd_soe";
        break;
    case PORT0_PDR1_PD13::sd_sle:
        result = "sd_sle";
        break;
    case PORT0_PDR1_PD13::md:
        result = "md";
        break;
    case PORT0_PDR1_PD13::wd:
        result = "wd";
        break;
    case PORT0_PDR1_PD13::sd_soe_alt:
        result = "sd_soe_alt";
        break;
    case PORT0_PDR1_PD13::sd_sle_alt:
        result = "sd_sle_alt";
        break;
    case PORT0_PDR1_PD13::md_alt:
        result = "md_alt";
        break;
    case PORT0_PDR1_PD13::wd_alt:
        result = "wd_alt";
        break;
    }
...
/**
 * Converts a C string to PORT0_PDR1_PD13.
 *
 * \param[in]  data   A C string to convert.
 * \param[out] output The enumeration element to write.
 * \return            Whether or not the output was written.
 */
inline bool from_string(const char *data, PORT0_PDR1_PD13 &output)
{
    bool result = false;

    if ((result = !strncmp(data, "sd_soe", 6)))
    {
        output = PORT0_PDR1_PD13::sd_soe;
    }
    else if ((result = !strncmp(data, "sd_sle", 6)))
    {
        output = PORT0_PDR1_PD13::sd_sle;
    }
    else if ((result = !strncmp(data, "md", 2)))
    {
        output = PORT0_PDR1_PD13::md;
    }
    else if ((result = !strncmp(data, "wd", 2)))
    {
        output = PORT0_PDR1_PD13::wd;
    }
    else if ((result = !strncmp(data, "sd_soe_alt", 10)))
    {
        output = PORT0_PDR1_PD13::sd_soe_alt;
    }
    else if ((result = !strncmp(data, "sd_sle_alt", 10)))
    {
        output = PORT0_PDR1_PD13::sd_sle_alt;
    }
    else if ((result = !strncmp(data, "md_alt", 6)))
    {
        output = PORT0_PDR1_PD13::md_alt;
    }
    else if ((result = !strncmp(data, "wd_alt", 6)))
    {
        output = PORT0_PDR1_PD13::wd_alt;
    }
