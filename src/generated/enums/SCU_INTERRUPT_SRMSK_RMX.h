...
static constexpr uint16_t SCU_INTERRUPT_SRMSK_RMX_id = 2647;
...
inline const char *to_string(SCU_INTERRUPT_SRMSK_RMX instance)
{
    ...
    switch (instance)
    {
    case SCU_INTERRUPT_SRMSK_RMX::value1:
        result = "value1";
        break;
    case SCU_INTERRUPT_SRMSK_RMX::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, SCU_INTERRUPT_SRMSK_RMX &output)
{
    ...
    {
        output = SCU_INTERRUPT_SRMSK_RMX::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SCU_INTERRUPT_SRMSK_RMX::value2;
    }
