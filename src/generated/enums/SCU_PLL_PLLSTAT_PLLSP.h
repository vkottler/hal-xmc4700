...
{
    not_usable_spikes_detected_dist_cont /*!< The OSC frequency is not usable.
                                            Spikes are detected that disturb a
                                            locked operation */
        ,
...
inline const char *to_string(SCU_PLL_PLLSTAT_PLLSP instance)
{
    ...
    switch (instance)
    {
    case SCU_PLL_PLLSTAT_PLLSP::not_usable_spikes_detected_dist_cont:
        result = "not_usable_spikes_detected_dist_cont";
        break;
...
inline bool from_string(const char *data, SCU_PLL_PLLSTAT_PLLSP &output)
{
    ...
    if ((result = !strncmp(data, "not_usable_spikes_detected_dist_cont", 36)))
    {
        output = SCU_PLL_PLLSTAT_PLLSP::not_usable_spikes_detected_dist_cont;
    }
