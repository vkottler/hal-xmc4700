...
static constexpr uint16_t GPDMA0_CH2_CFGL_DST_HS_POL_id = 898;
...
inline const char *to_string(GPDMA0_CH2_CFGL_DST_HS_POL instance)
{
    ...
    switch (instance)
    {
    case GPDMA0_CH2_CFGL_DST_HS_POL::value1:
        result = "value1";
        break;
    case GPDMA0_CH2_CFGL_DST_HS_POL::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, GPDMA0_CH2_CFGL_DST_HS_POL &output)
{
    ...
    {
        output = GPDMA0_CH2_CFGL_DST_HS_POL::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = GPDMA0_CH2_CFGL_DST_HS_POL::value2;
    }
