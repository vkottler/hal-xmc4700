...
static constexpr uint16_t CCU80_CC80_TC_TRPSE_id = 1852;
...
inline const char *to_string(CCU80_CC80_TC_TRPSE instance)
{
    ...
    switch (instance)
    {
    case CCU80_CC80_TC_TRPSE::value1:
        result = "value1";
        break;
    case CCU80_CC80_TC_TRPSE::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, CCU80_CC80_TC_TRPSE &output)
{
    ...
    {
        output = CCU80_CC80_TC_TRPSE::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = CCU80_CC80_TC_TRPSE::value2;
    }
