...
static constexpr uint16_t EBU_BUSRAP0_AHOLDC_id = 423;
...
inline const char *to_string(EBU_BUSRAP0_AHOLDC instance)
{
    ...
    switch (instance)
    {
    case EBU_BUSRAP0_AHOLDC::value1:
        result = "value1";
        break;
    case EBU_BUSRAP0_AHOLDC::value2:
        result = "value2";
        break;
    case EBU_BUSRAP0_AHOLDC::value3:
        result = "value3";
        break;
    case EBU_BUSRAP0_AHOLDC::value4:
        result = "value4";
        break;
    }
...
inline bool from_string(const char *data, EBU_BUSRAP0_AHOLDC &output)
{
    ...
    {
        output = EBU_BUSRAP0_AHOLDC::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = EBU_BUSRAP0_AHOLDC::value2;
    }
    else if ((result = !strncmp(data, "value3", 6)))
    {
        output = EBU_BUSRAP0_AHOLDC::value3;
    }
    else if ((result = !strncmp(data, "value4", 6)))
    {
        output = EBU_BUSRAP0_AHOLDC::value4;
    }
