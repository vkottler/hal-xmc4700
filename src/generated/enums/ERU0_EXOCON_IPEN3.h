...
static constexpr uint16_t ERU0_EXOCON_IPEN3_id = 585;
...
inline const char *to_string(ERU0_EXOCON_IPEN3 instance)
{
    ...
    switch (instance)
    {
    case ERU0_EXOCON_IPEN3::value1:
        result = "value1";
        break;
    case ERU0_EXOCON_IPEN3::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, ERU0_EXOCON_IPEN3 &output)
{
    ...
    {
        output = ERU0_EXOCON_IPEN3::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = ERU0_EXOCON_IPEN3::value2;
    }
