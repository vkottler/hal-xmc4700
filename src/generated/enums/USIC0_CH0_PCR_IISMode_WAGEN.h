...
{
    slave_generation_word_address_signal_disabled_cont /*!< The IIS can be used
                                                          as slave. The
                                                          generation of the
                                                          word address signal
                                                          is disabled. The
...
inline const char *to_string(USIC0_CH0_PCR_IISMode_WAGEN instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_PCR_IISMode_WAGEN::
        slave_generation_word_address_signal_disabled_cont:
        result = "slave_generation_word_address_signal_disabled_cont";
        break;
    case USIC0_CH0_PCR_IISMode_WAGEN::
        master_generation_word_address_signal_enabled_cont:
        result = "master_generation_word_address_signal_enabled_cont";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_PCR_IISMode_WAGEN &output)
{
    ...
    if ((result = !strncmp(
             data, "slave_generation_word_address_signal_disabled_cont", 50)))
    {
        output = USIC0_CH0_PCR_IISMode_WAGEN::
            slave_generation_word_address_signal_disabled_cont;
    }
    else if ((result = !strncmp(
                  data, "master_generation_word_address_signal_enabled_cont",
                  50)))
    {
        output = USIC0_CH0_PCR_IISMode_WAGEN::
            master_generation_word_address_signal_enabled_cont;
