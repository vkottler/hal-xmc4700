...
static constexpr uint16_t USIC0_CH0_DX0CR_CM_id = 3213;
...
inline const char *to_string(USIC0_CH0_DX0CR_CM instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_DX0CR_CM::value1:
        result = "value1";
        break;
    case USIC0_CH0_DX0CR_CM::value2:
        result = "value2";
        break;
    case USIC0_CH0_DX0CR_CM::value3:
        result = "value3";
        break;
    case USIC0_CH0_DX0CR_CM::value4:
        result = "value4";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_DX0CR_CM &output)
{
    ...
    {
        output = USIC0_CH0_DX0CR_CM::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = USIC0_CH0_DX0CR_CM::value2;
    }
    else if ((result = !strncmp(data, "value3", 6)))
    {
        output = USIC0_CH0_DX0CR_CM::value3;
    }
    else if ((result = !strncmp(data, "value4", 6)))
    {
        output = USIC0_CH0_DX0CR_CM::value4;
    }
