...
static constexpr uint16_t PORT15_PDISC_PDIS12_id = 1401;
...
inline const char *to_string(PORT15_PDISC_PDIS12 instance)
{
    ...
    switch (instance)
    {
    case PORT15_PDISC_PDIS12::value1:
        result = "value1";
        break;
    case PORT15_PDISC_PDIS12::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, PORT15_PDISC_PDIS12 &output)
{
    ...
    {
        output = PORT15_PDISC_PDIS12::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = PORT15_PDISC_PDIS12::value2;
    }
