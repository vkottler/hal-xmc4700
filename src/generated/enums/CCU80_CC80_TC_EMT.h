 ...
 *   "enum": {
 *     "value1": {
 *       "description": "External Modulation functionality is clearing the CC8ySTx bits.",
 *       "value": 0
 *     },
 *     "value2": {
 *       "description": "External Modulation functionality is gating the outputs.",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t CCU80_CC80_TC_EMT_id = 1849;
