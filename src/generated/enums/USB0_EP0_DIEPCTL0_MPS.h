...
static constexpr uint16_t USB0_EP0_DIEPCTL0_MPS_id = 1814;
...
inline const char *to_string(USB0_EP0_DIEPCTL0_MPS instance)
{
    ...
    switch (instance)
    {
    case USB0_EP0_DIEPCTL0_MPS::value1:
        result = "value1";
        break;
    case USB0_EP0_DIEPCTL0_MPS::value2:
        result = "value2";
        break;
    case USB0_EP0_DIEPCTL0_MPS::value3:
        result = "value3";
        break;
    case USB0_EP0_DIEPCTL0_MPS::value4:
        result = "value4";
        break;
    }
...
inline bool from_string(const char *data, USB0_EP0_DIEPCTL0_MPS &output)
{
    ...
    {
        output = USB0_EP0_DIEPCTL0_MPS::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = USB0_EP0_DIEPCTL0_MPS::value2;
    }
    else if ((result = !strncmp(data, "value3", 6)))
    {
        output = USB0_EP0_DIEPCTL0_MPS::value3;
    }
    else if ((result = !strncmp(data, "value4", 6)))
    {
        output = USB0_EP0_DIEPCTL0_MPS::value4;
    }
