...
enum class USIC0_CH0_PSR_ASCMode_TXIDLE : uint8_t
{
    ...
    been_idle_frame_transmis_cont = 1 /*!< The transmitter line has been idle
                                         and frame transmission is possible. */
};
...
inline const char *to_string(USIC0_CH0_PSR_ASCMode_TXIDLE instance)
{
    ...
    case USIC0_CH0_PSR_ASCMode_TXIDLE::not_been_idle:
        ...
        break;
    case USIC0_CH0_PSR_ASCMode_TXIDLE::been_idle_frame_transmis_cont:
        result = "been_idle_frame_transmis_cont";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_PSR_ASCMode_TXIDLE &output)
{
    ...
    else if ((result = !strncmp(data, "been_idle_frame_transmis_cont", 29)))
    {
        output = USIC0_CH0_PSR_ASCMode_TXIDLE::been_idle_frame_transmis_cont;
    }
