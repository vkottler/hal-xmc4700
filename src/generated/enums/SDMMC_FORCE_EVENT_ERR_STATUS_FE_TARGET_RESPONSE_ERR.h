...
static_assert(sizeof(SDMMC_FORCE_EVENT_ERR_STATUS_FE_TARGET_RESPONSE_ERR) ==
              1);

static constexpr uint16_t
    SDMMC_FORCE_EVENT_ERR_STATUS_FE_TARGET_RESPONSE_ERR_id = 1071;
...
inline const char *to_string(
    SDMMC_FORCE_EVENT_ERR_STATUS_FE_TARGET_RESPONSE_ERR instance)
{
    const char *result =
        "UNKNOWN SDMMC_FORCE_EVENT_ERR_STATUS_FE_TARGET_RESPONSE_ERR";
...
inline bool from_string(
    const char *data,
    SDMMC_FORCE_EVENT_ERR_STATUS_FE_TARGET_RESPONSE_ERR &output)
{
    bool result = false;
