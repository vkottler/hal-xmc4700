...
{
    mpu_rnr_not_changed_processor_updates_base_ad_cont /*!< MPU_RNR not
                                                          changed, and the
                                                          processor: - updates
                                                          ...
                                                          the REGION field */
        ,
    processor_updates_value_mpu_rnr_value_region__cont =
...
inline const char *to_string(PPB_MPU_RBAR_VALID instance)
{
    ...
    case PPB_MPU_RBAR_VALID::
        mpu_rnr_not_changed_processor_updates_base_ad_cont:
        result = "mpu_rnr_not_changed_processor_updates_base_ad_cont";
        break;
    case PPB_MPU_RBAR_VALID::
        processor_updates_value_mpu_rnr_value_region__cont:
        result = "processor_updates_value_mpu_rnr_value_region__cont";
        break;
    }
...
inline bool from_string(const char *data, PPB_MPU_RBAR_VALID &output)
{
    ...
    if ((result = !strncmp(
             data, "mpu_rnr_not_changed_processor_updates_base_ad_cont", 50)))
    {
        output = PPB_MPU_RBAR_VALID::
            mpu_rnr_not_changed_processor_updates_base_ad_cont;
    }
    else if ((result = !strncmp(
                  data, "processor_updates_value_mpu_rnr_value_region__cont",
                  50)))
    {
        output = PPB_MPU_RBAR_VALID::
            processor_updates_value_mpu_rnr_value_region__cont;
