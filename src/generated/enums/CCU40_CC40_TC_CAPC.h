...
inline const char *to_string(CCU40_CC40_TC_CAPC instance)
{
    ...
    switch (instance)
    {
    case CCU40_CC40_TC_CAPC::never_cleared_capture_event:
        result = "never_cleared_capture_event";
        break;
    case CCU40_CC40_TC_CAPC::
        cleared_capture_event_into_capture_registers__cont:
        result = "cleared_capture_event_into_capture_registers__cont";
        break;
    case CCU40_CC40_TC_CAPC::
        cleared_capture_event_into_capture_registers__cont_x:
        result = "cleared_capture_event_into_capture_registers__cont_x";
        break;
    case CCU40_CC40_TC_CAPC::always_cleared_capture_event:
...
inline bool from_string(const char *data, CCU40_CC40_TC_CAPC &output)
{
    ...
    {
        output = CCU40_CC40_TC_CAPC::never_cleared_capture_event;
    }
    else if ((result = !strncmp(
                  data, "cleared_capture_event_into_capture_registers__cont",
                  50)))
    {
        output = CCU40_CC40_TC_CAPC::
            cleared_capture_event_into_capture_registers__cont;
    }
    else if ((result = !strncmp(
                  data, "cleared_capture_event_into_capture_registers__cont_x",
                  52)))
    {
        output = CCU40_CC40_TC_CAPC::
            cleared_capture_event_into_capture_registers__cont_x;
    ...
    {
        output = CCU40_CC40_TC_CAPC::always_cleared_capture_event;
    }
