...
inline const char *to_string(CCU40_CC40_TC_CAPC instance)
{
    ...
    case CCU40_CC40_TC_CAPC::never_cleared_capture_event:
        ...
        break;
    case CCU40_CC40_TC_CAPC::cleared_capture_event_into_capture_regi_cont:
        result = "cleared_capture_event_into_capture_regi_cont";
        break;
    case CCU40_CC40_TC_CAPC::cleared_capture_event_into_capture_regi_cont_:
...
inline bool from_string(const char *data, CCU40_CC40_TC_CAPC &output)
{
    ...
    {
        output =
            CCU40_CC40_TC_CAPC::cleared_capture_event_into_capture_regi_cont;
    }
    else if ((result = !strncmp(
                  data, "cleared_capture_event_into_capture_regi_cont_", 45)))
    {
        output =
            CCU40_CC40_TC_CAPC::cleared_capture_event_into_capture_regi_cont_;
    }
