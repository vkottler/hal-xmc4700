...
static constexpr uint16_t SCU_CLK_MLINKCLKCR_CCUDIV_id = 1153;
...
inline const char *to_string(SCU_CLK_MLINKCLKCR_CCUDIV instance)
{
    ...
    switch (instance)
    {
    case SCU_CLK_MLINKCLKCR_CCUDIV::value1:
        result = "value1";
        break;
    case SCU_CLK_MLINKCLKCR_CCUDIV::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, SCU_CLK_MLINKCLKCR_CCUDIV &output)
{
    ...
    {
        output = SCU_CLK_MLINKCLKCR_CCUDIV::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SCU_CLK_MLINKCLKCR_CCUDIV::value2;
    }
