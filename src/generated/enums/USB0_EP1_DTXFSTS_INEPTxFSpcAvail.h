...
inline const char *to_string(USB0_EP1_DTXFSTS_INEPTxFSpcAvail instance)
{
    ...
    case USB0_EP1_DTXFSTS_INEPTxFSpcAvail::endpoint_txfifo_full:
        ...
        break;
    case USB0_EP1_DTXFSTS_INEPTxFSpcAvail::1_word_available:
        result = "1_word_available";
        break;
    case USB0_EP1_DTXFSTS_INEPTxFSpcAvail::2_words_available:
                        ...
                        USB0_EP1_DTXFSTS_INEPTxFSpcAvail &output)
{
    ...
    {
        output = USB0_EP1_DTXFSTS_INEPTxFSpcAvail::1_word_available;
    }
    else if ((result = !strncmp(data, "2_words_available", 17)))
    {
        output = USB0_EP1_DTXFSTS_INEPTxFSpcAvail::2_words_available;
    }
