...
static constexpr uint16_t VADC_G0_QSR0_REQGT_id = 957;
...
inline const char *to_string(VADC_G0_QSR0_REQGT instance)
{
    ...
    switch (instance)
    {
    case VADC_G0_QSR0_REQGT::value1:
        result = "value1";
        break;
    case VADC_G0_QSR0_REQGT::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, VADC_G0_QSR0_REQGT &output)
{
    ...
    {
        output = VADC_G0_QSR0_REQGT::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = VADC_G0_QSR0_REQGT::value2;
    }
