...
static constexpr uint16_t PORT15_OUT_P15_id = 1350;
...
inline const char *to_string(PORT15_OUT_P15 instance)
{
    ...
    switch (instance)
    {
    case PORT15_OUT_P15::value1:
        result = "value1";
        break;
    case PORT15_OUT_P15::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, PORT15_OUT_P15 &output)
{
    ...
    {
        output = PORT15_OUT_P15::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = PORT15_OUT_P15::value2;
    }
