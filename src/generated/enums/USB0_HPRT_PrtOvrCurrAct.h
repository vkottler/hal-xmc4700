...
{
    value1 /*!< No overcurrent condition */,
    value2 = 1 /*!< Overcurrent condition */
};
static_assert(sizeof(USB0_HPRT_PrtOvrCurrAct) == 1);

static constexpr uint16_t USB0_HPRT_PrtOvrCurrAct_id = 3150;
...
inline const char *to_string(USB0_HPRT_PrtOvrCurrAct instance)
{
    ...
    switch (instance)
    {
    case USB0_HPRT_PrtOvrCurrAct::value1:
        result = "value1";
        break;
    case USB0_HPRT_PrtOvrCurrAct::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, USB0_HPRT_PrtOvrCurrAct &output)
{
    ...
    {
        output = USB0_HPRT_PrtOvrCurrAct::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = USB0_HPRT_PrtOvrCurrAct::value2;
    }
