...
{
    functionality_doesnt_affe_cont /*!< External Modulation functionality
                                      doesn't affect any channel */
        ,
...
inline const char *to_string(CCU80_CC80_TC_EME instance)
{
    ...
    switch (instance)
    {
    case CCU80_CC80_TC_EME::functionality_doesnt_affe_cont:
        result = "functionality_doesnt_affe_cont";
        break;
...
inline bool from_string(const char *data, CCU80_CC80_TC_EME &output)
{
    ...
    if ((result = !strncmp(data, "functionality_doesnt_affe_cont", 30)))
    {
        output = CCU80_CC80_TC_EME::functionality_doesnt_affe_cont;
    }
