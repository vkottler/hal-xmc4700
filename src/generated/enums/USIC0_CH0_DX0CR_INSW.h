...
static constexpr uint16_t USIC0_CH0_DX0CR_INSW_id = 33;
...
inline const char *to_string(USIC0_CH0_DX0CR_INSW instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_DX0CR_INSW::value1:
        result = "value1";
        break;
    case USIC0_CH0_DX0CR_INSW::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_DX0CR_INSW &output)
{
    ...
    {
        output = USIC0_CH0_DX0CR_INSW::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = USIC0_CH0_DX0CR_INSW::value2;
    }
