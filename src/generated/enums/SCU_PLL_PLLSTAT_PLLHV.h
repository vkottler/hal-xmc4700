...
{
    value1 /*!< The OSC frequency is not usable. Frequency fOSC is too high. */,
    value2 = 1 /*!< The OSC frequency is usable */
};
static_assert(sizeof(SCU_PLL_PLLSTAT_PLLHV) == 1);

static constexpr uint16_t SCU_PLL_PLLSTAT_PLLHV_id = 2770;
...
inline const char *to_string(SCU_PLL_PLLSTAT_PLLHV instance)
{
    ...
    switch (instance)
    {
    case SCU_PLL_PLLSTAT_PLLHV::value1:
        result = "value1";
        break;
    case SCU_PLL_PLLSTAT_PLLHV::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, SCU_PLL_PLLSTAT_PLLHV &output)
{
    ...
    {
        output = SCU_PLL_PLLSTAT_PLLHV::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = SCU_PLL_PLLSTAT_PLLHV::value2;
    }
