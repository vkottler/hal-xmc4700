...
{
    asynchronous_ahb_bus_clock_using_separate_cont /*!< the EBU is asynchronous
                                                      to the AHB bus clock and
                                                      is using a separate clock
                                                      source */
        ,
...
inline const char *to_string(EBU_CLC_SYNCACK instance)
{
    ...
    switch (instance)
    {
    case EBU_CLC_SYNCACK::asynchronous_ahb_bus_clock_using_separate_cont:
        result = "asynchronous_ahb_bus_clock_using_separate_cont";
        break;
...
inline bool from_string(const char *data, EBU_CLC_SYNCACK &output)
{
    ...
    if ((result = !strncmp(
             data, "asynchronous_ahb_bus_clock_using_separate_cont", 46)))
    {
        output =
            EBU_CLC_SYNCACK::asynchronous_ahb_bus_clock_using_separate_cont;
    }
