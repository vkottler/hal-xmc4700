 ...
 *   "enum": {
 *     "value1": {
 *       "description": "Override is disabled and vbus valid signal from the PHY is used internally by the core.",
 *       "value": 0
 *     },
 *     "value2": {
 *       "description": "Internally vbus valid received from the PHY is overridden with GOTGCTL.VbvalidOvVal.",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
{
    value1 /*!< Override is disabled and vbus valid signal from the PHY is used internally by the core. */,
    value2 = 1 /*!< Internally vbus valid received from the PHY is overridden with GOTGCTL.VbvalidOvVal. */
};
