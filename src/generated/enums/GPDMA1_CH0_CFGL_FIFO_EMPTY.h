...
static constexpr uint16_t GPDMA1_CH0_CFGL_FIFO_EMPTY_id = 2000;
...
inline const char *to_string(GPDMA1_CH0_CFGL_FIFO_EMPTY instance)
{
    ...
    switch (instance)
    {
    case GPDMA1_CH0_CFGL_FIFO_EMPTY::value1:
        result = "value1";
        break;
    case GPDMA1_CH0_CFGL_FIFO_EMPTY::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, GPDMA1_CH0_CFGL_FIFO_EMPTY &output)
{
    ...
    {
        output = GPDMA1_CH0_CFGL_FIFO_EMPTY::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = GPDMA1_CH0_CFGL_FIFO_EMPTY::value2;
    }
