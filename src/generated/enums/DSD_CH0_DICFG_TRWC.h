...
static constexpr uint16_t DSD_CH0_DICFG_TRWC_id = 1587;
...
inline const char *to_string(DSD_CH0_DICFG_TRWC instance)
{
    ...
    switch (instance)
    {
    case DSD_CH0_DICFG_TRWC::value1:
        result = "value1";
        break;
    case DSD_CH0_DICFG_TRWC::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, DSD_CH0_DICFG_TRWC &output)
{
    ...
    {
        output = DSD_CH0_DICFG_TRWC::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = DSD_CH0_DICFG_TRWC::value2;
    }
