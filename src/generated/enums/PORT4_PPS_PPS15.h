...
static constexpr uint16_t PORT4_PPS_PPS15_id = 1730;
...
inline const char *to_string(PORT4_PPS_PPS15 instance)
{
    ...
    switch (instance)
    {
    case PORT4_PPS_PPS15::value1:
        result = "value1";
        break;
    case PORT4_PPS_PPS15::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, PORT4_PPS_PPS15 &output)
{
    ...
    {
        output = PORT4_PPS_PPS15::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = PORT4_PPS_PPS15::value2;
    }
