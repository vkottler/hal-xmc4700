 ...
 *   "enum": {
 *     "value1": {
 *       "description": "Inverted CC8yST1 signal path is connected to the CCU8x.OUTy1",
 *       "value": 0
 *     },
 *     "value2": {
 *       "description": "CC8yST1 signal path is connected to the CCU8x.OUTy1",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t CCU80_CC80_CHC_OCS2_id = 1873;
