 ...
 *   "enum": {
 *     "value1": {
 *       "description": "SDCD is selected (for normal use)",
 *       "value": 0
 *     },
 *     "value2": {
 *       "description": "The card detect test level is selected",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t SDMMC_HOST_CTRL_CARD_DET_SIGNAL_DETECT_id = 1459;
