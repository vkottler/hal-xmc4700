 ...
 *   "enum": {
 *     "value1": {
 *       "description": "Clock Multiplier not supported",
 *       "value": 0
 *     }
 *   },
 *   "unit_test": false,
...
{
    value1 /*!< Clock Multiplier not supported */
};
static_assert(sizeof(SDMMC_CAPABILITIES_HI_CLK_MULT) == 1);

static constexpr uint16_t SDMMC_CAPABILITIES_HI_CLK_MULT_id = 1553;
...
inline const char *to_string(SDMMC_CAPABILITIES_HI_CLK_MULT instance)
{
    ...
    switch (instance)
    {
    case SDMMC_CAPABILITIES_HI_CLK_MULT::value1:
        result = "value1";
        break;
    }
 ...
 */
inline bool from_string(const char *data, SDMMC_CAPABILITIES_HI_CLK_MULT &output)
{
    bool result = false;

    if ((result = !strncmp(data, "value1", 6)))
    {
        output = SDMMC_CAPABILITIES_HI_CLK_MULT::value1;
    }
