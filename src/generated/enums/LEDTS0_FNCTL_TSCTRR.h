 ...
 *     },
 *     "value2": {
 *       "description": "Enable TS-counter automatic reset to 00H on the first pad turn of a new TSIN[x]. Triggered on compare match in time slice.",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
enum class LEDTS0_FNCTL_TSCTRR : uint8_t
{
    ...
    value2 = 1 /*!< Enable TS-counter automatic reset to 00H on the first pad turn of a new TSIN[x]. Triggered on compare match in time slice. */
};
