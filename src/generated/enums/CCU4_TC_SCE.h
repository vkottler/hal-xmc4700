...
enum class CCU4_TC_SCE : uint8_t
{
...
static_assert(sizeof(CCU4_TC_SCE) == 1);

static constexpr uint16_t CCU4_TC_SCE_id = 64;

/**
 * Converts CCU4_TC_SCE to a C string.
 *
 * \param[in] instance Value to convert.
 * \return             A C string representation of the value.
 */
inline const char *to_string(CCU4_TC_SCE instance)
{
    const char *result = "UNKNOWN CCU4_TC_SCE";

    switch (instance)
    {
    case CCU4_TC_SCE::value1:
        result = "value1";
        break;
    case CCU4_TC_SCE::value2:
        result = "value2";
        break;
    }
...
/**
 * Converts a C string to CCU4_TC_SCE.
 *
 * \param[in]  data   A C string to convert.
 * \param[out] output The enumeration element to write.
 * \return            Whether or not the output was written.
 */
inline bool from_string(const char *data, CCU4_TC_SCE &output)
{
    bool result = false;

    if ((result = !strncmp(data, "value1", 6)))
    {
        output = CCU4_TC_SCE::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = CCU4_TC_SCE::value2;
    }
