...
static constexpr uint16_t USIC0_CH0_DX0CR_DSEL_id = 3219;
...
inline const char *to_string(USIC0_CH0_DX0CR_DSEL instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_DX0CR_DSEL::value1:
        result = "value1";
        break;
    case USIC0_CH0_DX0CR_DSEL::value2:
        result = "value2";
        break;
    case USIC0_CH0_DX0CR_DSEL::value3:
        result = "value3";
        break;
    case USIC0_CH0_DX0CR_DSEL::value4:
        result = "value4";
        break;
    case USIC0_CH0_DX0CR_DSEL::value5:
        result = "value5";
        break;
    case USIC0_CH0_DX0CR_DSEL::value6:
        result = "value6";
        break;
    case USIC0_CH0_DX0CR_DSEL::value7:
        result = "value7";
        break;
    case USIC0_CH0_DX0CR_DSEL::value8:
        result = "value8";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_DX0CR_DSEL &output)
{
    ...
    {
        output = USIC0_CH0_DX0CR_DSEL::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = USIC0_CH0_DX0CR_DSEL::value2;
    }
    else if ((result = !strncmp(data, "value3", 6)))
    {
        output = USIC0_CH0_DX0CR_DSEL::value3;
    }
    else if ((result = !strncmp(data, "value4", 6)))
    {
        output = USIC0_CH0_DX0CR_DSEL::value4;
    }
    else if ((result = !strncmp(data, "value5", 6)))
    {
        output = USIC0_CH0_DX0CR_DSEL::value5;
    }
    else if ((result = !strncmp(data, "value6", 6)))
    {
        output = USIC0_CH0_DX0CR_DSEL::value6;
    }
    else if ((result = !strncmp(data, "value7", 6)))
    {
        output = USIC0_CH0_DX0CR_DSEL::value7;
    }
    else if ((result = !strncmp(data, "value8", 6)))
    {
        output = USIC0_CH0_DX0CR_DSEL::value8;
    }
