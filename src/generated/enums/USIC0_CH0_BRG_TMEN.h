 ...
 *   "enum": {
 *     "value1": {
 *       "description": "Timing measurement is disabled: The trigger signals DX0T and DX1T are ignored.",
 *       "value": 0
 *     },
 *     "value2": {
...
{
    value1 /*!< Timing measurement is disabled: The trigger signals DX0T and DX1T are ignored. */,
    value2 = 1 /*!< Timing measurement is enabled: The 10-bit counter is incremented by 1 with fPPP and stops counting when reaching its maximum value. If one of the trigger signals DX0T or DX1T become active, the counter value is captured into bit field CTV, the counter is cleared and a transmit shift event is generated. */
};
