...
inline const char *to_string(USB0_HPTXSTS_PTxQSpcAvail instance)
{
    ...
    case USB0_HPTXSTS_PTxQSpcAvail::periodic_transmit_request_queue_full:
        ...
        break;
    case USB0_HPTXSTS_PTxQSpcAvail::1_location_available:
        result = "1_location_available";
        break;
    case USB0_HPTXSTS_PTxQSpcAvail::2_locations_available:
...
inline bool from_string(const char *data, USB0_HPTXSTS_PTxQSpcAvail &output)
{
    ...
    {
        output = USB0_HPTXSTS_PTxQSpcAvail::1_location_available;
    }
    else if ((result = !strncmp(data, "2_locations_available", 21)))
    {
        output = USB0_HPTXSTS_PTxQSpcAvail::2_locations_available;
    }
