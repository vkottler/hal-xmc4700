...
static constexpr uint16_t CAN_NODE0_NIPR_CFCINP_id = 852;
...
inline const char *to_string(CAN_NODE0_NIPR_CFCINP instance)
{
    ...
    switch (instance)
    {
    case CAN_NODE0_NIPR_CFCINP::value1:
        result = "value1";
        break;
    case CAN_NODE0_NIPR_CFCINP::value2:
        result = "value2";
        break;
    case CAN_NODE0_NIPR_CFCINP::value3:
        result = "value3";
        break;
    case CAN_NODE0_NIPR_CFCINP::value4:
        result = "value4";
        break;
    }
...
inline bool from_string(const char *data, CAN_NODE0_NIPR_CFCINP &output)
{
    ...
    {
        output = CAN_NODE0_NIPR_CFCINP::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = CAN_NODE0_NIPR_CFCINP::value2;
    }
    else if ((result = !strncmp(data, "value3", 6)))
    {
        output = CAN_NODE0_NIPR_CFCINP::value3;
    }
    else if ((result = !strncmp(data, "value4", 6)))
    {
        output = CAN_NODE0_NIPR_CFCINP::value4;
    }
