 ...
 *   "enum": {
 *     "value1": {
 *       "description": "EBU is using standard clocking mode. clock input selected by SYNC bitfield (default after reset).",
 *       "value": 0
 *     },
 *     "value2": {
...
static constexpr uint16_t EBU_CLC_DIV2ACK_id = 372;
