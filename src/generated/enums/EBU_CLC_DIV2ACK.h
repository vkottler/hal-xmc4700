...
{
    using_standard_clocking_mode_clock_input__cont /*!< EBU is using standard
                                                      clocking mode. clock
                                                      input selected by SYNC
                                                      bitfield (default after
                                                      reset). */
        ,
...
inline const char *to_string(EBU_CLC_DIV2ACK instance)
{
    ...
    switch (instance)
    {
    case EBU_CLC_DIV2ACK::using_standard_clocking_mode_clock_input__cont:
        result = "using_standard_clocking_mode_clock_input__cont";
        break;
...
inline bool from_string(const char *data, EBU_CLC_DIV2ACK &output)
{
    ...
    if ((result = !strncmp(
             data, "using_standard_clocking_mode_clock_input__cont", 46)))
    {
        output =
            EBU_CLC_DIV2ACK::using_standard_clocking_mode_clock_input__cont;
    }
