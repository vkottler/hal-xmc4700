 ...
 *     },
 *     "value2": {
 *       "description": "Converter is busy with a conversion",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t VADC_G0_ARBCFG_BUSY_id = 887;
...
inline const char *to_string(VADC_G0_ARBCFG_BUSY instance)
{
    ...
    switch (instance)
    {
    case VADC_G0_ARBCFG_BUSY::value1:
        result = "value1";
        break;
    case VADC_G0_ARBCFG_BUSY::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, VADC_G0_ARBCFG_BUSY &output)
{
    ...
    {
        output = VADC_G0_ARBCFG_BUSY::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = VADC_G0_ARBCFG_BUSY::value2;
    }
