...
enum class PORT0_PDR0_PD0 : uint8_t
{
...
static_assert(sizeof(PORT0_PDR0_PD0) == 1);

static constexpr uint16_t PORT0_PDR0_PD0_id = 1661;

/**
 * Converts PORT0_PDR0_PD0 to a C string.
 *
 * \param[in] instance Value to convert.
 * \return             A C string representation of the value.
 */
inline const char *to_string(PORT0_PDR0_PD0 instance)
{
    const char *result = "UNKNOWN PORT0_PDR0_PD0";

    switch (instance)
    {
    case PORT0_PDR0_PD0::sd_soe:
        result = "sd_soe";
        break;
    case PORT0_PDR0_PD0::sd_sle:
        result = "sd_sle";
        break;
    case PORT0_PDR0_PD0::md:
        result = "md";
        break;
    case PORT0_PDR0_PD0::wd:
        result = "wd";
        break;
    case PORT0_PDR0_PD0::sd_soe_alt:
        result = "sd_soe_alt";
        break;
    case PORT0_PDR0_PD0::sd_sle_alt:
        result = "sd_sle_alt";
        break;
    case PORT0_PDR0_PD0::md_alt:
        result = "md_alt";
        break;
    case PORT0_PDR0_PD0::wd_alt:
        result = "wd_alt";
        break;
    }
...
/**
 * Converts a C string to PORT0_PDR0_PD0.
 *
 * \param[in]  data   A C string to convert.
 * \param[out] output The enumeration element to write.
 * \return            Whether or not the output was written.
 */
inline bool from_string(const char *data, PORT0_PDR0_PD0 &output)
{
    bool result = false;

    if ((result = !strncmp(data, "sd_soe", 6)))
    {
        output = PORT0_PDR0_PD0::sd_soe;
    }
    else if ((result = !strncmp(data, "sd_sle", 6)))
    {
        output = PORT0_PDR0_PD0::sd_sle;
    }
    else if ((result = !strncmp(data, "md", 2)))
    {
        output = PORT0_PDR0_PD0::md;
    }
    else if ((result = !strncmp(data, "wd", 2)))
    {
        output = PORT0_PDR0_PD0::wd;
    }
    else if ((result = !strncmp(data, "sd_soe_alt", 10)))
    {
        output = PORT0_PDR0_PD0::sd_soe_alt;
    }
    else if ((result = !strncmp(data, "sd_sle_alt", 10)))
    {
        output = PORT0_PDR0_PD0::sd_sle_alt;
    }
    else if ((result = !strncmp(data, "md_alt", 6)))
    {
        output = PORT0_PDR0_PD0::md_alt;
    }
    else if ((result = !strncmp(data, "wd_alt", 6)))
    {
        output = PORT0_PDR0_PD0::wd_alt;
    }
