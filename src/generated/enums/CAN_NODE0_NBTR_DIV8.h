...
inline const char *to_string(CAN_NODE0_NBTR_DIV8 instance)
{
    ...
    case CAN_NODE0_NBTR_DIV8::brp1_clock_cycles:
        ...
        break;
    case CAN_NODE0_NBTR_DIV8::8_brp1_clock_cycles:
        result = "8_brp1_clock_cycles";
        break;
    }
...
inline bool from_string(const char *data, CAN_NODE0_NBTR_DIV8 &output)
{
    ...
    else if ((result = !strncmp(data, "8_brp1_clock_cycles", 19)))
    {
        output = CAN_NODE0_NBTR_DIV8::8_brp1_clock_cycles;
    }
