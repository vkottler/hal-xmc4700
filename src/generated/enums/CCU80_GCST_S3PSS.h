...
static constexpr uint16_t CCU80_GCST_S3PSS_id = 1732;
...
inline const char *to_string(CCU80_GCST_S3PSS instance)
{
    ...
    switch (instance)
    {
    case CCU80_GCST_S3PSS::value1:
        result = "value1";
        break;
    case CCU80_GCST_S3PSS::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, CCU80_GCST_S3PSS &output)
{
    ...
    {
        output = CCU80_GCST_S3PSS::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = CCU80_GCST_S3PSS::value2;
    }
