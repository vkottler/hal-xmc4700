...
inline const char *to_string(VADC_G0_QCTRL0_SRCRESREG instance)
{
    ...
    switch (instance)
    {
    case VADC_G0_QCTRL0_SRCRESREG::
        use_gxchctryresreg_select_group_result_register:
        result = "use_gxchctryresreg_select_group_result_register";
        break;
    case VADC_G0_QCTRL0_SRCRESREG::store_result_group_result_register_gxres1:
        result = "store_result_group_result_register_gxres1";
        break;
    case VADC_G0_QCTRL0_SRCRESREG::store_result_group_result_register_gxres15:
...
inline bool from_string(const char *data, VADC_G0_QCTRL0_SRCRESREG &output)
{
    ...
    {
        output = VADC_G0_QCTRL0_SRCRESREG::
            use_gxchctryresreg_select_group_result_register;
    }
