...
enum class CCU40_GCTRL_MSE3 : uint8_t
{
    only_be_requested_by_sw /*!< Shadow transfer can only be requested by SW */
        ,
    be_requested_via_sw_via_ccu4xmcss_input =
...
inline const char *to_string(CCU40_GCTRL_MSE3 instance)
{
    ...
    case CCU40_GCTRL_MSE3::only_be_requested_by_sw:
        ...
        break;
    case CCU40_GCTRL_MSE3::be_requested_via_sw_via_ccu4xmcss_input:
        result = "be_requested_via_sw_via_ccu4xmcss_input";
        break;
    }
...
inline bool from_string(const char *data, CCU40_GCTRL_MSE3 &output)
{
    ...
    if ((result = !strncmp(data, "only_be_requested_by_sw", 23)))
    {
        output = CCU40_GCTRL_MSE3::only_be_requested_by_sw;
                  ...
                  data, "be_requested_via_sw_via_ccu4xmcss_input", 39)))
    {
        output = CCU40_GCTRL_MSE3::be_requested_via_sw_via_ccu4xmcss_input;
    }
