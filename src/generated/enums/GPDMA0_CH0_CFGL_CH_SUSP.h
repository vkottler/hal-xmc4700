...
static constexpr uint16_t GPDMA0_CH0_CFGL_CH_SUSP_id = 1803;
...
inline const char *to_string(GPDMA0_CH0_CFGL_CH_SUSP instance)
{
    ...
    switch (instance)
    {
    case GPDMA0_CH0_CFGL_CH_SUSP::value1:
        result = "value1";
        break;
    case GPDMA0_CH0_CFGL_CH_SUSP::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, GPDMA0_CH0_CFGL_CH_SUSP &output)
{
    ...
    {
        output = GPDMA0_CH0_CFGL_CH_SUSP::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = GPDMA0_CH0_CFGL_CH_SUSP::value2;
    }
