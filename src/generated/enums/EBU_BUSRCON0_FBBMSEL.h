...
static constexpr uint16_t EBU_BUSRCON0_FBBMSEL_id = 408;
...
inline const char *to_string(EBU_BUSRCON0_FBBMSEL instance)
{
    ...
    switch (instance)
    {
    case EBU_BUSRCON0_FBBMSEL::value1:
        result = "value1";
        break;
    case EBU_BUSRCON0_FBBMSEL::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, EBU_BUSRCON0_FBBMSEL &output)
{
    ...
    {
        output = EBU_BUSRCON0_FBBMSEL::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = EBU_BUSRCON0_FBBMSEL::value2;
    }
