 ...
 *     },
 *     "value2": {
 *       "description": "The identifier of the gateway source object (after storing the received frame in the source) is copied to the gateway destination object.",
 *       "value": 1
 *     }
 *   },
 *   "unit_test": false,
...
static constexpr uint16_t CAN_MO_MOFCR_IDC_id = 2114;
