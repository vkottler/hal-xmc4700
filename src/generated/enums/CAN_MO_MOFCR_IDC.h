...
enum class CAN_MO_MOFCR_IDC : uint8_t
{
    not_copied /*!< The identifier of the gateway source object is not copied.
                */
        ,
    after_storing_received_frame_source_copied_ga_cont =
        1 /*!< The identifier of the gateway source object (after storing the
...
inline const char *to_string(CAN_MO_MOFCR_IDC instance)
{
    ...
    case CAN_MO_MOFCR_IDC::not_copied:
        result = "not_copied";
        break;
    case CAN_MO_MOFCR_IDC::after_storing_received_frame_source_copied_ga_cont:
        result = "after_storing_received_frame_source_copied_ga_cont";
        break;
    }
...
inline bool from_string(const char *data, CAN_MO_MOFCR_IDC &output)
{
    ...
    if ((result = !strncmp(data, "not_copied", 10)))
    {
        output = CAN_MO_MOFCR_IDC::not_copied;
                  ...
                  data, "after_storing_received_frame_source_copied_ga_cont",
                  50)))
    {
        output = CAN_MO_MOFCR_IDC::
            after_storing_received_frame_source_copied_ga_cont;
    }
