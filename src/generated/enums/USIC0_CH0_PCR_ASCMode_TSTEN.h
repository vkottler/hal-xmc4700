...
{
    not_modified_depending_transmitter__cont /*!< Flag PSR[9] is not modified
...
inline const char *to_string(USIC0_CH0_PCR_ASCMode_TSTEN instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_PCR_ASCMode_TSTEN::not_modified_depending_transmitter__cont:
        result = "not_modified_depending_transmitter__cont";
        break;
...
inline bool from_string(const char *data, USIC0_CH0_PCR_ASCMode_TSTEN &output)
{
    ...
    if ((result =
             !strncmp(data, "not_modified_depending_transmitter__cont", 40)))
    {
        output = USIC0_CH0_PCR_ASCMode_TSTEN::
            not_modified_depending_transmitter__cont;
    }
