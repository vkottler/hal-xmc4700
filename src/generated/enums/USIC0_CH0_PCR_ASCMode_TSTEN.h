...
{
    value1 /*!< Flag PSR[9] is not modified depending on the transmitter status. */,
    value2 = 1 /*!< Flag PSR[9] is set during the complete transmission of a frame. */
};
static_assert(sizeof(USIC0_CH0_PCR_ASCMode_TSTEN) == 1);

static constexpr uint16_t USIC0_CH0_PCR_ASCMode_TSTEN_id = 3285;
...
inline const char *to_string(USIC0_CH0_PCR_ASCMode_TSTEN instance)
{
    ...
    switch (instance)
    {
    case USIC0_CH0_PCR_ASCMode_TSTEN::value1:
        result = "value1";
        break;
    case USIC0_CH0_PCR_ASCMode_TSTEN::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, USIC0_CH0_PCR_ASCMode_TSTEN &output)
{
    ...
    {
        output = USIC0_CH0_PCR_ASCMode_TSTEN::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = USIC0_CH0_PCR_ASCMode_TSTEN::value2;
    }
