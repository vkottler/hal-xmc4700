...
static constexpr uint16_t GPDMA0_CH2_CFGL_HS_SEL_DST_id = 894;
...
inline const char *to_string(GPDMA0_CH2_CFGL_HS_SEL_DST instance)
{
    ...
    switch (instance)
    {
    case GPDMA0_CH2_CFGL_HS_SEL_DST::value1:
        result = "value1";
        break;
    case GPDMA0_CH2_CFGL_HS_SEL_DST::value2:
        result = "value2";
        break;
    }
...
inline bool from_string(const char *data, GPDMA0_CH2_CFGL_HS_SEL_DST &output)
{
    ...
    {
        output = GPDMA0_CH2_CFGL_HS_SEL_DST::value1;
    }
    else if ((result = !strncmp(data, "value2", 6)))
    {
        output = GPDMA0_CH2_CFGL_HS_SEL_DST::value2;
    }
