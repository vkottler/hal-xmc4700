 ...
 */
struct [[gnu::packed]] gpdma1_ch
{
    /* Constant attributes. */
    static constexpr uint16_t id = 1;       /*!< gpdma1_ch's identifier. */
    static constexpr std::size_t size = 72; /*!< gpdma1_ch's size in bytes. */
     ...
     */
    GPDMA1_CH0_CTLL_DINC get_CTLL_DINC()
    {
     ...
     */
    GPDMA1_CH0_CTLL_SINC get_CTLL_SINC()
    {
     ...
     */
    GPDMA1_CH0_CFGL_CH_SUSP get_CFGL_CH_SUSP()
    {
     ...
     */
    GPDMA1_CH0_CFGL_FIFO_EMPTY get_CFGL_FIFO_EMPTY()
    {
     ...
     */
    GPDMA1_CH0_CFGL_HS_SEL_DST get_CFGL_HS_SEL_DST()
    {
     ...
     */
    GPDMA1_CH0_CFGL_HS_SEL_SRC get_CFGL_HS_SEL_SRC()
    {
     ...
     */
    GPDMA1_CH0_CFGL_LOCK_CH_L get_CFGL_LOCK_CH_L()
    {
     ...
     */
    GPDMA1_CH0_CFGL_LOCK_B_L get_CFGL_LOCK_B_L()
    {
     ...
     */
    GPDMA1_CH0_CFGL_DST_HS_POL get_CFGL_DST_HS_POL()
    {
     ...
     */
    GPDMA1_CH0_CFGL_SRC_HS_POL get_CFGL_SRC_HS_POL()
    {
     ...
     */
    GPDMA1_CH0_CFGH_FCMODE get_CFGH_FCMODE()
    {
     ...
     */
    GPDMA1_CH0_CFGH_FIFO_MODE get_CFGH_FIFO_MODE()
    {
...
static_assert(sizeof(gpdma1_ch) == gpdma1_ch::size);

static volatile gpdma1_ch *const GPDMA1_CH0 = reinterpret_cast<gpdma1_ch *>(0x50018000);

static volatile gpdma1_ch *const GPDMA1_CH1 = reinterpret_cast<gpdma1_ch *>(0x50018058);

static volatile gpdma1_ch *const GPDMA1_CH2 = reinterpret_cast<gpdma1_ch *>(0x500180B0);

static volatile gpdma1_ch *const GPDMA1_CH3 = reinterpret_cast<gpdma1_ch *>(0x50018108);
