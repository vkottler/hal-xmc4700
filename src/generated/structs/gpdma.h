...
#include "../enums/GPDMA_CFGH_FCMODE.h"
#include "../enums/GPDMA_CFGH_FIFO_MODE.h"
#include "../enums/GPDMA_CFGL_CH_SUSP.h"
#include "../enums/GPDMA_CFGL_DST_HS_POL.h"
#include "../enums/GPDMA_CFGL_FIFO_EMPTY.h"
#include "../enums/GPDMA_CFGL_HS_SEL_DST.h"
#include "../enums/GPDMA_CFGL_HS_SEL_SRC.h"
#include "../enums/GPDMA_CFGL_LOCK_B_L.h"
#include "../enums/GPDMA_CFGL_LOCK_CH_L.h"
#include "../enums/GPDMA_CFGL_SRC_HS_POL.h"
#include "../enums/GPDMA_CTLL_DINC.h"
#include "../enums/GPDMA_CTLL_SINC.h"
...
struct [[gnu::packed]] gpdma
{
    ...
    static constexpr std::size_t size = 72; /*!< gpdma's size in bytes. */
     ...
     */
    GPDMA_CTLL_DINC get_CTLL_DINC()
    {
        return GPDMA_CTLL_DINC((CTLL >> 7u) & 0b11u);
    }

    /**
     * Set CTLL's DINC field.
     */
    inline void set_CTLL_DINC(GPDMA_CTLL_DINC value)
    {
        uint32_t curr = CTLL;
     ...
     */
    GPDMA_CTLL_SINC get_CTLL_SINC()
    {
        return GPDMA_CTLL_SINC((CTLL >> 9u) & 0b11u);
    }

    /**
     * Set CTLL's SINC field.
     */
    inline void set_CTLL_SINC(GPDMA_CTLL_SINC value)
    {
        uint32_t curr = CTLL;
     ...
     */
    GPDMA_CFGL_CH_SUSP get_CFGL_CH_SUSP()
    {
        return GPDMA_CFGL_CH_SUSP(CFGL & (1u << 8u));
    }
     ...
     */
    GPDMA_CFGL_FIFO_EMPTY get_CFGL_FIFO_EMPTY()
    {
        return GPDMA_CFGL_FIFO_EMPTY(CFGL & (1u << 9u));
    }

    /**
     * Get CFGL's HS_SEL_DST bit.
     */
    GPDMA_CFGL_HS_SEL_DST get_CFGL_HS_SEL_DST()
    {
        return GPDMA_CFGL_HS_SEL_DST(CFGL & (1u << 10u));
    }
     ...
     */
    GPDMA_CFGL_HS_SEL_SRC get_CFGL_HS_SEL_SRC()
    {
        return GPDMA_CFGL_HS_SEL_SRC(CFGL & (1u << 11u));
    }
     ...
     */
    GPDMA_CFGL_LOCK_CH_L get_CFGL_LOCK_CH_L()
    {
        return GPDMA_CFGL_LOCK_CH_L((CFGL >> 12u) & 0b11u);
    }

    /**
     * Set CFGL's LOCK_CH_L field.
     */
    inline void set_CFGL_LOCK_CH_L(GPDMA_CFGL_LOCK_CH_L value)
    {
        uint32_t curr = CFGL;
     ...
     */
    GPDMA_CFGL_LOCK_B_L get_CFGL_LOCK_B_L()
    {
        return GPDMA_CFGL_LOCK_B_L((CFGL >> 14u) & 0b11u);
    }

    /**
     * Set CFGL's LOCK_B_L field.
     */
    inline void set_CFGL_LOCK_B_L(GPDMA_CFGL_LOCK_B_L value)
    {
        uint32_t curr = CFGL;
     ...
     */
    GPDMA_CFGL_DST_HS_POL get_CFGL_DST_HS_POL()
    {
        return GPDMA_CFGL_DST_HS_POL(CFGL & (1u << 18u));
    }
     ...
     */
    GPDMA_CFGL_SRC_HS_POL get_CFGL_SRC_HS_POL()
    {
        return GPDMA_CFGL_SRC_HS_POL(CFGL & (1u << 19u));
    }
     ...
     */
    GPDMA_CFGH_FCMODE get_CFGH_FCMODE()
    {
        return GPDMA_CFGH_FCMODE(CFGH & (1u << 0u));
    }
     ...
     */
    GPDMA_CFGH_FIFO_MODE get_CFGH_FIFO_MODE()
    {
        return GPDMA_CFGH_FIFO_MODE(CFGH & (1u << 1u));
    }
...
static volatile gpdma *const GPDMA1_CH0 =
    reinterpret_cast<gpdma *>(0x50018000);

static volatile gpdma *const GPDMA1 = reinterpret_cast<gpdma *>(0x500182C0);

static volatile gpdma *const GPDMA0_CH2 =
    reinterpret_cast<gpdma *>(0x500140B0);

static volatile gpdma *const GPDMA0_CH0 =
    reinterpret_cast<gpdma *>(0x50014000);

static volatile gpdma *const GPDMA0 = reinterpret_cast<gpdma *>(0x500142C0);

static volatile gpdma *const GPDMA0_CH1 =
    reinterpret_cast<gpdma *>(0x50014058);

static volatile gpdma *const GPDMA0_CH3 =
    reinterpret_cast<gpdma *>(0x50014108);

static volatile gpdma *const GPDMA0_CH4 =
    reinterpret_cast<gpdma *>(0x50014160);

static volatile gpdma *const GPDMA0_CH5 =
    reinterpret_cast<gpdma *>(0x500141B8);

static volatile gpdma *const GPDMA0_CH6 =
    reinterpret_cast<gpdma *>(0x50014210);

static volatile gpdma *const GPDMA0_CH7 =
    reinterpret_cast<gpdma *>(0x50014268);

static volatile gpdma *const GPDMA1_CH1 =
    reinterpret_cast<gpdma *>(0x50018058);

static volatile gpdma *const GPDMA1_CH2 =
    reinterpret_cast<gpdma *>(0x500180B0);

static volatile gpdma *const GPDMA1_CH3 =
    reinterpret_cast<gpdma *>(0x50018108);
