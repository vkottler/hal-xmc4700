...
struct [[gnu::packed]] scu_hibernate
{
    ...
    static constexpr std::size_t size =
        32; /*!< scu_hibernate's size in bytes. */

    /* Fields. */
    const uint32_t HDSTAT =
        {};         /*!< (read-only) Hibernate Domain Status Register */
     ...
     */
    inline SCU_HIBERNATE_HDSTAT_RTCEV get_HDSTAT_ENEV() volatile
    {
        return SCU_HIBERNATE_HDSTAT_RTCEV(HDSTAT & (1u << 1u));
    }
     ...
     */
    inline SCU_HIBERNATE_HDSTAT_RTCEV get_HDSTAT_EPEV() volatile
    {
        return SCU_HIBERNATE_HDSTAT_RTCEV(HDSTAT & (1u << 0u));
    }
     ...
     * (read-only) Hibernate Domain Status Register
     */
    inline void get_HDSTAT(SCU_HIBERNATE_HDSTAT_HIBNOUT &HIBNOUT,
                           SCU_HIBERNATE_HDSTAT_ULPWDG &ULPWDG,
                           SCU_HIBERNATE_HDSTAT_RTCEV &RTCEV,
                           SCU_HIBERNATE_HDSTAT_RTCEV &ENEV,
                           SCU_HIBERNATE_HDSTAT_RTCEV &EPEV) volatile
    {
        ...
        ENEV = SCU_HIBERNATE_HDSTAT_RTCEV(curr & (1u << 1u));
        EPEV = SCU_HIBERNATE_HDSTAT_RTCEV(curr & (1u << 0u));
    }
     ...
     *
     * (write-only) Hibernate Domain Status Clear Register
     */
    inline void set_HDCLR(SCU_HIBERNATE_HDCLR_ULPWDG ULPWDG,
                          SCU_HIBERNATE_HDCLR_RTCEV RTCEV,
                          SCU_HIBERNATE_HDCLR_RTCEV ENEV,
                          SCU_HIBERNATE_HDCLR_RTCEV EPEV) volatile
    {
        uint32_t curr = HDCLR;
     ...
     *
     * (write-only) Hibernate Domain Status Set Register
     */
    inline void set_HDSET(SCU_HIBERNATE_HDSET_ULPWDG ULPWDG,
                          SCU_HIBERNATE_HDSET_RTCEV RTCEV,
                          SCU_HIBERNATE_HDSET_RTCEV ENEV,
                          SCU_HIBERNATE_HDSET_RTCEV EPEV) volatile
    {
        uint32_t curr = HDSET;
     ...
     */
    inline SCU_HIBERNATE_HDCR_HIBIO1SEL get_HDCR_HIBIO0SEL() volatile
    {
        return SCU_HIBERNATE_HDCR_HIBIO1SEL((HDCR >> 16u) & 0b1111u);
    }
     ...
     * HIB_IO_0 Pin I/O Control (default HIBOUT)
     */
    inline void set_HDCR_HIBIO0SEL(SCU_HIBERNATE_HDCR_HIBIO1SEL value) volatile
    {
        uint32_t curr = HDCR;
     ...
     * HIBIO0 Polarity Set
     */
    inline SCU_HIBERNATE_HDCR_HIBIO1POL get_HDCR_HIBIO0POL() volatile
    {
        return SCU_HIBERNATE_HDCR_HIBIO1POL(HDCR & (1u << 12u));
    }
     ...
     */
    inline SCU_HIBERNATE_HDCR_GPI0SEL get_HDCR_WKUPSEL() volatile
    {
        return SCU_HIBERNATE_HDCR_GPI0SEL(HDCR & (1u << 8u));
    }
     ...
     */
    inline SCU_HIBERNATE_HDCR_STDBYSEL get_HDCR_RCS() volatile
    {
        return SCU_HIBERNATE_HDCR_STDBYSEL(HDCR & (1u << 6u));
    }
     ...
     */
    inline SCU_HIBERNATE_HDSTAT_RTCEV get_HDCR_HIB() volatile
    {
        return SCU_HIBERNATE_HDSTAT_RTCEV(HDCR & (1u << 4u));
    }
     ...
     */
    inline SCU_HIBERNATE_HDCR_ULPWDGEN get_HDCR_RTCE() volatile
    {
        return SCU_HIBERNATE_HDCR_ULPWDGEN(HDCR & (1u << 2u));
    }
     ...
     */
    inline SCU_HIBERNATE_HDCR_ULPWDGEN get_HDCR_WKPEN() volatile
    {
        return SCU_HIBERNATE_HDCR_ULPWDGEN(HDCR & (1u << 1u));
    }
     ...
     */
    inline SCU_HIBERNATE_HDCR_ULPWDGEN get_HDCR_WKPEP() volatile
    {
        return SCU_HIBERNATE_HDCR_ULPWDGEN(HDCR & (1u << 0u));
    }
     ...
     *
     * (read-write) Hibernate Domain Control Register
     */
    inline void get_HDCR(SCU_HIBERNATE_HDCR_HIBIO1SEL &HIBIO1SEL,
                         SCU_HIBERNATE_HDCR_HIBIO1SEL &HIBIO0SEL,
                         SCU_HIBERNATE_HDCR_HIBIO1POL &HIBIO1POL,
                         SCU_HIBERNATE_HDCR_HIBIO1POL &HIBIO0POL,
                         SCU_HIBERNATE_HDCR_GPI0SEL &GPI0SEL,
                         SCU_HIBERNATE_HDCR_GPI0SEL &WKUPSEL,
                         SCU_HIBERNATE_HDCR_STDBYSEL &STDBYSEL,
                         SCU_HIBERNATE_HDCR_STDBYSEL &RCS,
                         SCU_HIBERNATE_HDSTAT_RTCEV &HIB,
                         SCU_HIBERNATE_HDCR_ULPWDGEN &ULPWDGEN,
                         SCU_HIBERNATE_HDCR_ULPWDGEN &RTCE,
                         SCU_HIBERNATE_HDCR_ULPWDGEN &WKPEN,
                         SCU_HIBERNATE_HDCR_ULPWDGEN &WKPEP) volatile
    {
        uint32_t curr = HDCR;

        HIBIO1SEL = SCU_HIBERNATE_HDCR_HIBIO1SEL((curr >> 20u) & 0b1111u);
        HIBIO0SEL = SCU_HIBERNATE_HDCR_HIBIO1SEL((curr >> 16u) & 0b1111u);
        HIBIO1POL = SCU_HIBERNATE_HDCR_HIBIO1POL(curr & (1u << 13u));
        HIBIO0POL = SCU_HIBERNATE_HDCR_HIBIO1POL(curr & (1u << 12u));
        GPI0SEL = SCU_HIBERNATE_HDCR_GPI0SEL(curr & (1u << 10u));
        WKUPSEL = SCU_HIBERNATE_HDCR_GPI0SEL(curr & (1u << 8u));
        STDBYSEL = SCU_HIBERNATE_HDCR_STDBYSEL(curr & (1u << 7u));
        RCS = SCU_HIBERNATE_HDCR_STDBYSEL(curr & (1u << 6u));
        HIB = SCU_HIBERNATE_HDSTAT_RTCEV(curr & (1u << 4u));
        ULPWDGEN = SCU_HIBERNATE_HDCR_ULPWDGEN(curr & (1u << 3u));
        RTCE = SCU_HIBERNATE_HDCR_ULPWDGEN(curr & (1u << 2u));
        WKPEN = SCU_HIBERNATE_HDCR_ULPWDGEN(curr & (1u << 1u));
        WKPEP = SCU_HIBERNATE_HDCR_ULPWDGEN(curr & (1u << 0u));
    }
     ...
     * (read-write) Hibernate Domain Control Register
     */
    inline void set_HDCR(
        SCU_HIBERNATE_HDCR_HIBIO1SEL HIBIO1SEL,
        SCU_HIBERNATE_HDCR_HIBIO1SEL HIBIO0SEL,
        SCU_HIBERNATE_HDCR_HIBIO1POL HIBIO1POL,
        SCU_HIBERNATE_HDCR_HIBIO1POL HIBIO0POL,
        SCU_HIBERNATE_HDCR_GPI0SEL GPI0SEL, SCU_HIBERNATE_HDCR_GPI0SEL WKUPSEL,
        SCU_HIBERNATE_HDCR_STDBYSEL STDBYSEL, SCU_HIBERNATE_HDCR_STDBYSEL RCS,
        SCU_HIBERNATE_HDSTAT_RTCEV HIB, SCU_HIBERNATE_HDCR_ULPWDGEN ULPWDGEN,
        SCU_HIBERNATE_HDCR_ULPWDGEN RTCE, SCU_HIBERNATE_HDCR_ULPWDGEN WKPEN,
        SCU_HIBERNATE_HDCR_ULPWDGEN WKPEP) volatile
    {
        uint32_t curr = HDCR;
     ...
     *
     * (read-write) OSC_ULP Control Register
     */
    inline void get_OSCULCTRL(SCU_HIBERNATE_OSCULCTRL_MODE &MODE,
                              SCU_HIBERNATE_OSCULCTRL_X1DEN &X1DEN) volatile
    {
        uint32_t curr = OSCULCTRL;
     ...
     * (read-write) OSC_ULP Control Register
     */
    inline void set_OSCULCTRL(SCU_HIBERNATE_OSCULCTRL_MODE MODE,
                              SCU_HIBERNATE_OSCULCTRL_X1DEN X1DEN) volatile
    {
        uint32_t curr = OSCULCTRL;
...
static volatile scu_hibernate *const SCU_HIBERNATE =
    reinterpret_cast<scu_hibernate *>(0x50004300);
