...
struct [[gnu::packed]] scu_hibernate
{
     ...
     */
    inline bool get_HDSTAT_HIBNOUT() volatile
    {
        return HDSTAT & (1u << 4u);
    }
     ...
     */
    inline bool get_HDSTAT_ULPWDG() volatile
    {
        return HDSTAT & (1u << 3u);
    }
     ...
     * RTC Event
     */
    inline bool get_HDSTAT_RTCEV() volatile
    {
        return HDSTAT & (1u << 2u);
    }
     ...
     */
    inline bool get_HDSTAT_ENEV() volatile
    {
        return HDSTAT & (1u << 1u);
    }
     ...
     */
    inline bool get_HDSTAT_EPEV() volatile
    {
        return HDSTAT & (1u << 0u);
    }
     ...
     * (read-only) Hibernate Domain Status Register
     */
    inline void get_HDSTAT(bool &HIBNOUT, bool &ULPWDG, bool &RTCEV,
                           bool &ENEV, bool &EPEV) volatile
    {
     ...
     */
    inline void set_HDCLR(bool ULPWDG, bool RTCEV, bool ENEV,
                          bool EPEV) volatile
    {
        uint32_t curr = HDCLR;
     ...
     */
    inline void set_HDSET(bool ULPWDG, bool RTCEV, bool ENEV,
                          bool EPEV) volatile
    {
        uint32_t curr = HDSET;
     ...
     * HIBIO1 Polarity Set
     */
    inline bool get_HDCR_HIBIO1POL() volatile
    {
        return HDCR & (1u << 13u);
    }
     ...
     * HIBIO0 Polarity Set
     */
    inline bool get_HDCR_HIBIO0POL() volatile
    {
        return HDCR & (1u << 12u);
    }
     ...
     */
    inline bool get_HDCR_GPI0SEL() volatile
    {
        return HDCR & (1u << 10u);
    }
     ...
     */
    inline bool get_HDCR_WKUPSEL() volatile
    {
        return HDCR & (1u << 8u);
    }
     ...
     */
    inline bool get_HDCR_STDBYSEL() volatile
    {
        return HDCR & (1u << 7u);
    }
     ...
     */
    inline bool get_HDCR_RCS() volatile
    {
        return HDCR & (1u << 6u);
    }
     ...
     */
    inline bool get_HDCR_HIB() volatile
    {
        return HDCR & (1u << 4u);
    }
     ...
     */
    inline bool get_HDCR_ULPWDGEN() volatile
    {
        return HDCR & (1u << 3u);
    }
     ...
     */
    inline bool get_HDCR_RTCE() volatile
    {
        return HDCR & (1u << 2u);
    }
     ...
     */
    inline bool get_HDCR_WKPEN() volatile
    {
        return HDCR & (1u << 1u);
    }
     ...
     */
    inline bool get_HDCR_WKPEP() volatile
    {
        return HDCR & (1u << 0u);
    }
    ...
    inline void get_HDCR(SCU_HIBERNATE_HDCR_HIBIO1SEL &HIBIO1SEL,
                         ...
                         bool &HIBIO1POL, bool &HIBIO0POL, bool &GPI0SEL,
                         bool &WKUPSEL, bool &STDBYSEL, bool &RCS, bool &HIB,
                         bool &ULPWDGEN, bool &RTCE, bool &WKPEN,
                         bool &WKPEP) volatile
    {
        uint32_t curr = HDCR;
        ...
        HIBIO1POL = curr & (1u << 13u);
        HIBIO0POL = curr & (1u << 12u);
        GPI0SEL = curr & (1u << 10u);
        WKUPSEL = curr & (1u << 8u);
        STDBYSEL = curr & (1u << 7u);
        RCS = curr & (1u << 6u);
     ...
     * (read-write) Hibernate Domain Control Register
     */
    inline void set_HDCR(SCU_HIBERNATE_HDCR_HIBIO1SEL HIBIO1SEL,
                         SCU_HIBERNATE_HDCR_HIBIO1SEL HIBIO0SEL,
                         bool HIBIO1POL, bool HIBIO0POL, bool GPI0SEL,
                         bool WKUPSEL, bool STDBYSEL, bool RCS, bool HIB,
                         bool ULPWDGEN, bool RTCE, bool WKPEN,
                         bool WKPEP) volatile
    {
        ...
        curr &= ~(0b1u << 13u);
        curr |= (HIBIO1POL & 0b1u) << 13u;
        curr &= ~(0b1u << 12u);
        curr |= (HIBIO0POL & 0b1u) << 12u;
        curr &= ~(0b1u << 10u);
        curr |= (GPI0SEL & 0b1u) << 10u;
        curr &= ~(0b1u << 8u);
        curr |= (WKUPSEL & 0b1u) << 8u;
        curr &= ~(0b1u << 7u);
        curr |= (STDBYSEL & 0b1u) << 7u;
        curr &= ~(0b1u << 6u);
        curr |= (RCS & 0b1u) << 6u;
        curr &= ~(0b1u << 4u);
        curr |= (HIB & 0b1u) << 4u;
        curr &= ~(0b1u << 3u);
        curr |= (ULPWDGEN & 0b1u) << 3u;
        curr &= ~(0b1u << 2u);
        curr |= (RTCE & 0b1u) << 2u;
        curr &= ~(0b1u << 1u);
        curr |= (WKPEN & 0b1u) << 1u;
     ...
     */
    inline bool get_OSCSICTRL_PWD() volatile
    {
        return OSCSICTRL & (1u << 0u);
    }
     ...
     */
    inline bool get_OSCULCTRL_X1DEN() volatile
    {
        return OSCULCTRL & (1u << 0u);
    }
