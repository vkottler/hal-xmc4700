...
{
    /* Constant attributes. */
    static constexpr uint16_t id = 1; /*!< scu_hibernate's identifier. */
     ...
     */
    SCU_HIBERNATE_HDSTAT_HIBNOUT get_HDSTAT_HIBNOUT()
    {
     ...
     */
    SCU_HIBERNATE_HDSTAT_ULPWDG get_HDSTAT_ULPWDG()
    {
     ...
     */
    SCU_HIBERNATE_HDSTAT_RTCEV get_HDSTAT_RTCEV()
    {
     ...
     */
    SCU_HIBERNATE_HDSTAT_ENEV get_HDSTAT_ENEV()
    {
     ...
     */
    SCU_HIBERNATE_HDSTAT_EPEV get_HDSTAT_EPEV()
    {
     ...
     */
    SCU_HIBERNATE_HDCR_HIBIO1SEL get_HDCR_HIBIO1SEL()
    {
     ...
     */
    SCU_HIBERNATE_HDCR_HIBIO0SEL get_HDCR_HIBIO0SEL()
    {
     ...
     */
    SCU_HIBERNATE_HDCR_HIBIO1POL get_HDCR_HIBIO1POL()
    {
     ...
     */
    SCU_HIBERNATE_HDCR_HIBIO0POL get_HDCR_HIBIO0POL()
    {
     ...
     */
    SCU_HIBERNATE_HDCR_GPI0SEL get_HDCR_GPI0SEL()
    {
     ...
     */
    SCU_HIBERNATE_HDCR_WKUPSEL get_HDCR_WKUPSEL()
    {
     ...
     */
    SCU_HIBERNATE_HDCR_STDBYSEL get_HDCR_STDBYSEL()
    {
     ...
     * Get HDCR's RCS bit.
     */
    SCU_HIBERNATE_HDCR_RCS get_HDCR_RCS()
    {
     ...
     * Get HDCR's HIB bit.
     */
    SCU_HIBERNATE_HDCR_HIB get_HDCR_HIB()
    {
     ...
     */
    SCU_HIBERNATE_HDCR_ULPWDGEN get_HDCR_ULPWDGEN()
    {
     ...
     * Get HDCR's RTCE bit.
     */
    SCU_HIBERNATE_HDCR_RTCE get_HDCR_RTCE()
    {
     ...
     */
    SCU_HIBERNATE_HDCR_WKPEN get_HDCR_WKPEN()
    {
     ...
     */
    SCU_HIBERNATE_HDCR_WKPEP get_HDCR_WKPEP()
    {
     ...
     */
    SCU_HIBERNATE_OSCSICTRL_PWD get_OSCSICTRL_PWD()
    {
     ...
     */
    SCU_HIBERNATE_OSCULCTRL_MODE get_OSCULCTRL_MODE()
    {
     ...
     */
    SCU_HIBERNATE_OSCULCTRL_X1DEN get_OSCULCTRL_X1DEN()
    {
