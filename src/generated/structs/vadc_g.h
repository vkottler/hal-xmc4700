 ...
 */
struct [[gnu::packed]] vadc_g
{
    /* Constant attributes. */
    static constexpr uint16_t id = 1;        /*!< vadc_g's identifier. */
    static constexpr std::size_t size = 960; /*!< vadc_g's size in bytes. */
...
static_assert(sizeof(vadc_g) == vadc_g::size);

static volatile vadc_g *const VADC_G0 = reinterpret_cast<vadc_g *>(0x40004400);

static volatile vadc_g *const VADC_G1 = reinterpret_cast<vadc_g *>(0x40004800);

static volatile vadc_g *const VADC_G2 = reinterpret_cast<vadc_g *>(0x40004C00);

static volatile vadc_g *const VADC_G3 = reinterpret_cast<vadc_g *>(0x40005000);
