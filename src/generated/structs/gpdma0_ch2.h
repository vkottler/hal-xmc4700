...
struct [[gnu::packed]] gpdma0_ch2
{
     ...
     */
    inline GPDMA0_CH2_CTLL_DINC get_CTLL_DINC() volatile
    {
     ...
     * Destination Address Increment
     */
    inline void set_CTLL_DINC(GPDMA0_CH2_CTLL_DINC value) volatile
    {
        uint32_t curr = CTLL;
     ...
     */
    inline GPDMA0_CH2_CTLL_DINC get_CTLL_SINC() volatile
    {
        return GPDMA0_CH2_CTLL_DINC((CTLL >> 9u) & 0b11u);
    }
     ...
     * Source Address Increment
     */
    inline void set_CTLL_SINC(GPDMA0_CH2_CTLL_DINC value) volatile
    {
        uint32_t curr = CTLL;
    ...
    inline void get_CTLL(bool &INT_EN, uint8_t &DST_TR_WIDTH,
                         uint8_t &SRC_TR_WIDTH, GPDMA0_CH2_CTLL_DINC &DINC,
                         GPDMA0_CH2_CTLL_DINC &SINC, uint8_t &DEST_MSIZE,
                         uint8_t &SRC_MSIZE, uint8_t &TT_FC) volatile
    {
        ...
        DINC = GPDMA0_CH2_CTLL_DINC((curr >> 7u) & 0b11u);
        SINC = GPDMA0_CH2_CTLL_DINC((curr >> 9u) & 0b11u);
     ...
     * Channel Suspend
     */
    inline GPDMA0_CH2_CFGL_CH_SUSP get_CFGL_CH_SUSP() volatile
    {
     ...
     */
    inline GPDMA0_CH2_CFGL_FIFO_EMPTY get_CFGL_FIFO_EMPTY() volatile
    {
     ...
     */
    inline GPDMA0_CH2_CFGL_HS_SEL_DST get_CFGL_HS_SEL_DST() volatile
    {
     ...
     */
    inline GPDMA0_CH2_CFGL_HS_SEL_SRC get_CFGL_HS_SEL_SRC() volatile
    {
     ...
     * Channel Lock Level
     */
    inline GPDMA0_CH2_CFGL_LOCK_CH_L get_CFGL_LOCK_CH_L() volatile
    {
     ...
     * Channel Lock Level
     */
    inline void set_CFGL_LOCK_CH_L(GPDMA0_CH2_CFGL_LOCK_CH_L value) volatile
    {
        uint32_t curr = CFGL;
     ...
     * Bus Lock Level
     */
    inline GPDMA0_CH2_CFGL_LOCK_CH_L get_CFGL_LOCK_B_L() volatile
    {
        return GPDMA0_CH2_CFGL_LOCK_CH_L((CFGL >> 14u) & 0b11u);
    }
     ...
     * Bus Lock Level
     */
    inline void set_CFGL_LOCK_B_L(GPDMA0_CH2_CFGL_LOCK_CH_L value) volatile
    {
        uint32_t curr = CFGL;
     ...
     */
    inline GPDMA0_CH2_CFGL_DST_HS_POL get_CFGL_DST_HS_POL() volatile
    {
     ...
     */
    inline GPDMA0_CH2_CFGL_DST_HS_POL get_CFGL_SRC_HS_POL() volatile
    {
        return GPDMA0_CH2_CFGL_DST_HS_POL(CFGL & (1u << 19u));
    }
     ...
     */
    inline void get_CFGL(uint8_t &CH_PRIOR, GPDMA0_CH2_CFGL_CH_SUSP &CH_SUSP,
                         GPDMA0_CH2_CFGL_FIFO_EMPTY &FIFO_EMPTY,
                         GPDMA0_CH2_CFGL_HS_SEL_DST &HS_SEL_DST,
                         GPDMA0_CH2_CFGL_HS_SEL_SRC &HS_SEL_SRC,
                         GPDMA0_CH2_CFGL_LOCK_CH_L &LOCK_CH_L,
                         GPDMA0_CH2_CFGL_LOCK_CH_L &LOCK_B_L, bool &LOCK_CH,
                         bool &LOCK_B, GPDMA0_CH2_CFGL_DST_HS_POL &DST_HS_POL,
                         GPDMA0_CH2_CFGL_DST_HS_POL &SRC_HS_POL,
                         uint16_t &MAX_ABRST) volatile
    {
        uint32_t curr = CFGL;

        CH_PRIOR = (curr >> 5u) & 0b111u;
        CH_SUSP = GPDMA0_CH2_CFGL_CH_SUSP(curr & (1u << 8u));
        FIFO_EMPTY = GPDMA0_CH2_CFGL_FIFO_EMPTY(curr & (1u << 9u));
        HS_SEL_DST = GPDMA0_CH2_CFGL_HS_SEL_DST(curr & (1u << 10u));
        HS_SEL_SRC = GPDMA0_CH2_CFGL_HS_SEL_SRC(curr & (1u << 11u));
        LOCK_CH_L = GPDMA0_CH2_CFGL_LOCK_CH_L((curr >> 12u) & 0b11u);
        LOCK_B_L = GPDMA0_CH2_CFGL_LOCK_CH_L((curr >> 14u) & 0b11u);
        LOCK_CH = curr & (1u << 16u);
        LOCK_B = curr & (1u << 17u);
        DST_HS_POL = GPDMA0_CH2_CFGL_DST_HS_POL(curr & (1u << 18u));
        SRC_HS_POL = GPDMA0_CH2_CFGL_DST_HS_POL(curr & (1u << 19u));
     ...
     * (read-write) Configuration Register Low
     */
    inline void set_CFGL(uint8_t CH_PRIOR, GPDMA0_CH2_CFGL_CH_SUSP CH_SUSP,
                         GPDMA0_CH2_CFGL_HS_SEL_DST HS_SEL_DST,
                         GPDMA0_CH2_CFGL_HS_SEL_SRC HS_SEL_SRC,
                         GPDMA0_CH2_CFGL_LOCK_CH_L LOCK_CH_L,
                         GPDMA0_CH2_CFGL_LOCK_CH_L LOCK_B_L, bool LOCK_CH,
     ...
     * Flow Control Mode
     */
    inline GPDMA0_CH2_CFGH_FCMODE get_CFGH_FCMODE() volatile
    {
     ...
     * FIFO Mode Select
     */
    inline GPDMA0_CH2_CFGH_FIFO_MODE get_CFGH_FIFO_MODE() volatile
    {
     ...
     */
    inline void get_CFGH(GPDMA0_CH2_CFGH_FCMODE &FCMODE,
                         GPDMA0_CH2_CFGH_FIFO_MODE &FIFO_MODE,
                         uint8_t &PROTCTL, uint8_t &SRC_PER,
                         uint8_t &DEST_PER) volatile
    {
        uint32_t curr = CFGH;

        FCMODE = GPDMA0_CH2_CFGH_FCMODE(curr & (1u << 0u));
        FIFO_MODE = GPDMA0_CH2_CFGH_FIFO_MODE(curr & (1u << 1u));
     ...
     * (read-write) Configuration Register High
     */
    inline void set_CFGH(GPDMA0_CH2_CFGH_FCMODE FCMODE,
                         GPDMA0_CH2_CFGH_FIFO_MODE FIFO_MODE, uint8_t PROTCTL,
...
static volatile gpdma0_ch2 *const GPDMA0_CH2 =
    reinterpret_cast<gpdma0_ch2 *>(0x500140B0);

static volatile gpdma0_ch2 *const GPDMA0_CH3 =
    reinterpret_cast<gpdma0_ch2 *>(0x50014108);

static volatile gpdma0_ch2 *const GPDMA0_CH4 =
    reinterpret_cast<gpdma0_ch2 *>(0x50014160);

static volatile gpdma0_ch2 *const GPDMA0_CH5 =
    reinterpret_cast<gpdma0_ch2 *>(0x500141B8);

static volatile gpdma0_ch2 *const GPDMA0_CH6 =
    reinterpret_cast<gpdma0_ch2 *>(0x50014210);

static volatile gpdma0_ch2 *const GPDMA0_CH7 =
    reinterpret_cast<gpdma0_ch2 *>(0x50014268);

static volatile gpdma0_ch2 *const GPDMA1_CH0 =
    reinterpret_cast<gpdma0_ch2 *>(0x50018000);
