...
struct [[gnu::packed]] gpdma0_ch2
{
     ...
     */
    inline GPDMA0_CH2_CTLL_SINC get_CTLL_SINC() volatile
    {
     ...
     */
    inline void set_CTLL_SINC(GPDMA0_CH2_CTLL_SINC value) volatile
    {
        uint32_t curr = CTLL;
     ...
     */
    inline void get_CTLL(bool &INT_EN, uint8_t &DST_TR_WIDTH, uint8_t &SRC_TR_WIDTH, GPDMA0_CH2_CTLL_DINC &DINC, GPDMA0_CH2_CTLL_SINC &SINC, uint8_t &DEST_MSIZE, uint8_t &SRC_MSIZE, uint8_t &TT_FC) volatile
    {
        uint32_t curr = CTLL;
     ...
     */
    inline void set_CTLL(bool INT_EN, uint8_t DST_TR_WIDTH, uint8_t SRC_TR_WIDTH, GPDMA0_CH2_CTLL_DINC DINC, GPDMA0_CH2_CTLL_SINC SINC, uint8_t DEST_MSIZE, uint8_t SRC_MSIZE, uint8_t TT_FC) volatile
    {
        uint32_t curr = CTLL;
     ...
     */
    inline GPDMA0_CH2_CFGL_LOCK_B_L get_CFGL_LOCK_B_L() volatile
    {
     ...
     */
    inline void set_CFGL_LOCK_B_L(GPDMA0_CH2_CFGL_LOCK_B_L value) volatile
    {
        uint32_t curr = CFGL;
     ...
     */
    inline GPDMA0_CH2_CFGL_SRC_HS_POL get_CFGL_SRC_HS_POL() volatile
    {
     ...
     */
    inline void get_CFGH(GPDMA0_CH2_CFGH_FCMODE &FCMODE, GPDMA0_CH2_CFGH_FIFO_MODE &FIFO_MODE, uint8_t &PROTCTL, uint8_t &SRC_PER, uint8_t &DEST_PER) volatile
    {
        uint32_t curr = CFGH;
     ...
     */
    inline void set_CFGH(GPDMA0_CH2_CFGH_FCMODE FCMODE, GPDMA0_CH2_CFGH_FIFO_MODE FIFO_MODE, uint8_t PROTCTL, uint8_t SRC_PER, uint8_t DEST_PER) volatile
    {
        uint32_t curr = CFGH;
