...
struct [[gnu::packed]] gpdma0_ch2
{
     ...
     */
    inline GPDMA0_CH2_CTLL_DINC get_CTLL_DINC()
    {
     ...
     */
    inline GPDMA0_CH2_CTLL_SINC get_CTLL_SINC()
    {
     ...
     */
    inline void get_CTLL(bool &INT_EN, uint8_t &DST_TR_WIDTH, uint8_t &SRC_TR_WIDTH, GPDMA0_CH2_CTLL_DINC &DINC, GPDMA0_CH2_CTLL_SINC &SINC, uint8_t &DEST_MSIZE, uint8_t &SRC_MSIZE, uint8_t &TT_FC)
    {
        uint32_t curr = CTLL;
        ...
        SINC = GPDMA0_CH2_CTLL_SINC((curr >> 9u) & 0b11u);
     ...
     */
    inline void set_CTLL(bool INT_EN, uint8_t DST_TR_WIDTH, uint8_t SRC_TR_WIDTH, GPDMA0_CH2_CTLL_DINC DINC, GPDMA0_CH2_CTLL_SINC SINC, uint8_t DEST_MSIZE, uint8_t SRC_MSIZE, uint8_t TT_FC)
    {
        uint32_t curr = CTLL;
     ...
     */
    inline GPDMA0_CH2_CFGL_CH_SUSP get_CFGL_CH_SUSP()
    {
     ...
     */
    inline GPDMA0_CH2_CFGL_FIFO_EMPTY get_CFGL_FIFO_EMPTY()
    {
     ...
     */
    inline GPDMA0_CH2_CFGL_HS_SEL_DST get_CFGL_HS_SEL_DST()
    {
     ...
     */
    inline GPDMA0_CH2_CFGL_HS_SEL_SRC get_CFGL_HS_SEL_SRC()
    {
     ...
     */
    inline GPDMA0_CH2_CFGL_LOCK_CH_L get_CFGL_LOCK_CH_L()
    {
     ...
     */
    inline GPDMA0_CH2_CFGL_LOCK_B_L get_CFGL_LOCK_B_L()
    {
     ...
     */
    inline GPDMA0_CH2_CFGL_DST_HS_POL get_CFGL_DST_HS_POL()
    {
     ...
     */
    inline GPDMA0_CH2_CFGL_SRC_HS_POL get_CFGL_SRC_HS_POL()
    {
     ...
     */
    inline void get_CFGL(uint8_t &CH_PRIOR, GPDMA0_CH2_CFGL_CH_SUSP &CH_SUSP, GPDMA0_CH2_CFGL_FIFO_EMPTY &FIFO_EMPTY, GPDMA0_CH2_CFGL_HS_SEL_DST &HS_SEL_DST, GPDMA0_CH2_CFGL_HS_SEL_SRC &HS_SEL_SRC, GPDMA0_CH2_CFGL_LOCK_CH_L &LOCK_CH_L, GPDMA0_CH2_CFGL_LOCK_B_L &LOCK_B_L, bool &LOCK_CH, bool &LOCK_B, GPDMA0_CH2_CFGL_DST_HS_POL &DST_HS_POL, GPDMA0_CH2_CFGL_SRC_HS_POL &SRC_HS_POL, uint16_t &MAX_ABRST)
    {
        uint32_t curr = CFGL;
        ...
        LOCK_B_L = GPDMA0_CH2_CFGL_LOCK_B_L((curr >> 14u) & 0b11u);
        LOCK_CH = curr & (1u << 16u);
        LOCK_B = curr & (1u << 17u);
        DST_HS_POL = GPDMA0_CH2_CFGL_DST_HS_POL(curr & (1u << 18u));
        SRC_HS_POL = GPDMA0_CH2_CFGL_SRC_HS_POL(curr & (1u << 19u));
     ...
     */
    inline void set_CFGL(uint8_t CH_PRIOR, GPDMA0_CH2_CFGL_CH_SUSP CH_SUSP, GPDMA0_CH2_CFGL_HS_SEL_DST HS_SEL_DST, GPDMA0_CH2_CFGL_HS_SEL_SRC HS_SEL_SRC, GPDMA0_CH2_CFGL_LOCK_CH_L LOCK_CH_L, GPDMA0_CH2_CFGL_LOCK_B_L LOCK_B_L, bool LOCK_CH, bool LOCK_B, GPDMA0_CH2_CFGL_DST_HS_POL DST_HS_POL, GPDMA0_CH2_CFGL_SRC_HS_POL SRC_HS_POL, uint16_t MAX_ABRST)
    {
        uint32_t curr = CFGL;
     ...
     */
    inline GPDMA0_CH2_CFGH_FCMODE get_CFGH_FCMODE()
    {
     ...
     */
    inline GPDMA0_CH2_CFGH_FIFO_MODE get_CFGH_FIFO_MODE()
    {
     ...
     */
    inline void get_CFGH(GPDMA0_CH2_CFGH_FCMODE &FCMODE, GPDMA0_CH2_CFGH_FIFO_MODE &FIFO_MODE, uint8_t &PROTCTL, uint8_t &SRC_PER, uint8_t &DEST_PER)
    {
        uint32_t curr = CFGH;
     ...
     */
    inline void set_CFGH(GPDMA0_CH2_CFGH_FCMODE FCMODE, GPDMA0_CH2_CFGH_FIFO_MODE FIFO_MODE, uint8_t PROTCTL, uint8_t SRC_PER, uint8_t DEST_PER)
    {
        uint32_t curr = CFGH;
