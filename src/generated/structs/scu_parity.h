...
struct [[gnu::packed]] scu_parity
{
     ...
     */
    inline bool get_PEEN_PEENSD1() volatile
    {
        return PEEN & (1u << 20u);
    }
     ...
     */
    inline bool get_PEEN_PEENSD0() volatile
    {
        return PEEN & (1u << 19u);
    }
     ...
     */
    inline bool get_PEEN_PEENETH0RX() volatile
    {
        return PEEN & (1u << 18u);
    }
     ...
     */
    inline bool get_PEEN_PEENETH0TX() volatile
    {
        return PEEN & (1u << 17u);
    }
     ...
     */
    inline bool get_PEEN_PEENUSB() volatile
    {
        return PEEN & (1u << 16u);
    }
     ...
     */
    inline bool get_PEEN_PEENPPRF() volatile
    {
        return PEEN & (1u << 13u);
    }
     ...
     */
    inline bool get_PEEN_PEENMC() volatile
    {
        return PEEN & (1u << 12u);
    }
     ...
     */
    inline bool get_PEEN_PEENU2() volatile
    {
        return PEEN & (1u << 10u);
    }
     ...
     */
    inline bool get_PEEN_PEENU1() volatile
    {
        return PEEN & (1u << 9u);
    }
     ...
     */
    inline bool get_PEEN_PEENU0() volatile
    {
        return PEEN & (1u << 8u);
    }
     ...
     */
    inline bool get_PEEN_PEENDS2() volatile
    {
        return PEEN & (1u << 2u);
    }
     ...
     */
    inline bool get_PEEN_PEENDS1() volatile
    {
        return PEEN & (1u << 1u);
    }
     ...
     */
    inline bool get_PEEN_PEENPS() volatile
    {
        return PEEN & (1u << 0u);
    }
     ...
     */
    inline void get_PEEN(bool &PEENSD1, bool &PEENSD0, bool &PEENETH0RX,
                         bool &PEENETH0TX, bool &PEENUSB, bool &PEENPPRF,
                         bool &PEENMC, bool &PEENU2, bool &PEENU1,
                         bool &PEENU0, bool &PEENDS2, bool &PEENDS1,
                         bool &PEENPS) volatile
    {
        uint32_t curr = PEEN;

        PEENSD1 = curr & (1u << 20u);
        PEENSD0 = curr & (1u << 19u);
        PEENETH0RX = curr & (1u << 18u);
        PEENETH0TX = curr & (1u << 17u);
        PEENUSB = curr & (1u << 16u);
        PEENPPRF = curr & (1u << 13u);
        PEENMC = curr & (1u << 12u);
        PEENU2 = curr & (1u << 10u);
        PEENU1 = curr & (1u << 9u);
        PEENU0 = curr & (1u << 8u);
     ...
     * (read-write) Parity Error Enable Register
     */
    inline void set_PEEN(bool PEENSD1, bool PEENSD0, bool PEENETH0RX,
                         bool PEENETH0TX, bool PEENUSB, bool PEENPPRF,
                         bool PEENMC, bool PEENU2, bool PEENU1, bool PEENU0,
                         bool PEENDS2, bool PEENDS1, bool PEENPS) volatile
    {
        uint32_t curr = PEEN;

        curr &= ~(0b1u << 20u);
        curr |= (PEENSD1 & 0b1u) << 20u;
        curr &= ~(0b1u << 19u);
        curr |= (PEENSD0 & 0b1u) << 19u;
        curr &= ~(0b1u << 18u);
        curr |= (PEENETH0RX & 0b1u) << 18u;
        curr &= ~(0b1u << 17u);
        curr |= (PEENETH0TX & 0b1u) << 17u;
        curr &= ~(0b1u << 16u);
        curr |= (PEENUSB & 0b1u) << 16u;
        curr &= ~(0b1u << 13u);
        curr |= (PEENPPRF & 0b1u) << 13u;
        curr &= ~(0b1u << 12u);
        curr |= (PEENMC & 0b1u) << 12u;
        curr &= ~(0b1u << 10u);
        curr |= (PEENU2 & 0b1u) << 10u;
        curr &= ~(0b1u << 9u);
        curr |= (PEENU1 & 0b1u) << 9u;
        curr &= ~(0b1u << 8u);
        curr |= (PEENU0 & 0b1u) << 8u;
        curr &= ~(0b1u << 2u);
        curr |= (PEENDS2 & 0b1u) << 2u;
        curr &= ~(0b1u << 1u);
        curr |= (PEENDS1 & 0b1u) << 1u;
        curr &= ~(0b1u << 0u);
        curr |= (PEENPS & 0b1u) << 0u;
     ...
     */
    inline bool get_MCHKCON_SELSD1() volatile
    {
        return MCHKCON & (1u << 20u);
    }
     ...
     */
    inline bool get_MCHKCON_SELSD0() volatile
    {
        return MCHKCON & (1u << 19u);
    }
     ...
     */
    inline bool get_MCHKCON_SELETH0RX() volatile
    {
        return MCHKCON & (1u << 18u);
    }
     ...
     */
    inline bool get_MCHKCON_SELETH0TX() volatile
    {
        return MCHKCON & (1u << 17u);
    }
     ...
     */
    inline bool get_MCHKCON_SELUSB() volatile
    {
        return MCHKCON & (1u << 16u);
    }
     ...
     */
    inline bool get_MCHKCON_PPRFDRA() volatile
    {
        return MCHKCON & (1u << 13u);
    }
     ...
     */
    inline bool get_MCHKCON_MCANDRA() volatile
    {
        return MCHKCON & (1u << 12u);
    }
     ...
     */
    inline bool get_MCHKCON_USIC2DRA() volatile
    {
        return MCHKCON & (1u << 10u);
    }
     ...
     */
    inline bool get_MCHKCON_USIC1DRA() volatile
    {
        return MCHKCON & (1u << 9u);
    }
     ...
     */
    inline bool get_MCHKCON_USIC0DRA() volatile
    {
        return MCHKCON & (1u << 8u);
    }
     ...
     */
    inline bool get_MCHKCON_SELDS2() volatile
    {
        return MCHKCON & (1u << 2u);
    }
     ...
     */
    inline bool get_MCHKCON_SELDS1() volatile
    {
        return MCHKCON & (1u << 1u);
    }
     ...
     */
    inline bool get_MCHKCON_SELPS() volatile
    {
        return MCHKCON & (1u << 0u);
    }
     ...
     */
    inline void get_MCHKCON(bool &SELSD1, bool &SELSD0, bool &SELETH0RX,
                            bool &SELETH0TX, bool &SELUSB, bool &PPRFDRA,
                            bool &MCANDRA, bool &USIC2DRA, bool &USIC1DRA,
                            bool &USIC0DRA, bool &SELDS2, bool &SELDS1,
                            bool &SELPS) volatile
    {
        ...
        SELSD1 = curr & (1u << 20u);
        SELSD0 = curr & (1u << 19u);
        SELETH0RX = curr & (1u << 18u);
        SELETH0TX = curr & (1u << 17u);
        SELUSB = curr & (1u << 16u);
        PPRFDRA = curr & (1u << 13u);
        MCANDRA = curr & (1u << 12u);
        USIC2DRA = curr & (1u << 10u);
        USIC1DRA = curr & (1u << 9u);
        USIC0DRA = curr & (1u << 8u);
        SELDS2 = curr & (1u << 2u);
        SELDS1 = curr & (1u << 1u);
     ...
     * (read-write) Memory Checking Control Register
     */
    inline void set_MCHKCON(bool SELSD1, bool SELSD0, bool SELETH0RX,
                            bool SELETH0TX, bool SELUSB, bool PPRFDRA,
                            bool MCANDRA, bool USIC2DRA, bool USIC1DRA,
                            bool USIC0DRA, bool SELDS2, bool SELDS1,
                            bool SELPS) volatile
    {
        ...
        curr &= ~(0b1u << 20u);
        curr |= (SELSD1 & 0b1u) << 20u;
        curr &= ~(0b1u << 19u);
        curr |= (SELSD0 & 0b1u) << 19u;
        curr &= ~(0b1u << 18u);
        curr |= (SELETH0RX & 0b1u) << 18u;
        curr &= ~(0b1u << 17u);
        curr |= (SELETH0TX & 0b1u) << 17u;
        curr &= ~(0b1u << 16u);
        curr |= (SELUSB & 0b1u) << 16u;
        curr &= ~(0b1u << 13u);
        curr |= (PPRFDRA & 0b1u) << 13u;
        curr &= ~(0b1u << 12u);
        curr |= (MCANDRA & 0b1u) << 12u;
        curr &= ~(0b1u << 10u);
        curr |= (USIC2DRA & 0b1u) << 10u;
        curr &= ~(0b1u << 9u);
        curr |= (USIC1DRA & 0b1u) << 9u;
        curr &= ~(0b1u << 8u);
        curr |= (USIC0DRA & 0b1u) << 8u;
        curr &= ~(0b1u << 2u);
        curr |= (SELDS2 & 0b1u) << 2u;
        curr &= ~(0b1u << 1u);
        curr |= (SELDS1 & 0b1u) << 1u;
     ...
     */
    inline bool get_PETE_PETESD1() volatile
    {
        return PETE & (1u << 20u);
    }
     ...
     */
    inline bool get_PETE_PETESD0() volatile
    {
        return PETE & (1u << 19u);
    }
     ...
     */
    inline bool get_PETE_PETEETH0RX() volatile
    {
        return PETE & (1u << 18u);
    }
     ...
     */
    inline bool get_PETE_PETEETH0TX() volatile
    {
        return PETE & (1u << 17u);
    }
     ...
     */
    inline bool get_PETE_PETEUSB() volatile
    {
        return PETE & (1u << 16u);
    }
     ...
     */
    inline bool get_PETE_PETEPPRF() volatile
    {
        return PETE & (1u << 13u);
    }
     ...
     */
    inline bool get_PETE_PETEMC() volatile
    {
        return PETE & (1u << 12u);
    }
     ...
     */
    inline bool get_PETE_PETEU2() volatile
    {
        return PETE & (1u << 10u);
    }
     ...
     */
    inline bool get_PETE_PETEU1() volatile
    {
        return PETE & (1u << 9u);
    }
     ...
     */
    inline bool get_PETE_PETEU0() volatile
    {
        return PETE & (1u << 8u);
    }
     ...
     */
    inline bool get_PETE_PETEDS2() volatile
    {
        return PETE & (1u << 2u);
    }
     ...
     */
    inline bool get_PETE_PETEDS1() volatile
    {
        return PETE & (1u << 1u);
    }
     ...
     */
    inline bool get_PETE_PETEPS() volatile
    {
        return PETE & (1u << 0u);
    }
     ...
     */
    inline void get_PETE(bool &PETESD1, bool &PETESD0, bool &PETEETH0RX,
                         bool &PETEETH0TX, bool &PETEUSB, bool &PETEPPRF,
                         bool &PETEMC, bool &PETEU2, bool &PETEU1,
                         bool &PETEU0, bool &PETEDS2, bool &PETEDS1,
                         bool &PETEPS) volatile
    {
        uint32_t curr = PETE;

        PETESD1 = curr & (1u << 20u);
        PETESD0 = curr & (1u << 19u);
        PETEETH0RX = curr & (1u << 18u);
        PETEETH0TX = curr & (1u << 17u);
        PETEUSB = curr & (1u << 16u);
        PETEPPRF = curr & (1u << 13u);
        PETEMC = curr & (1u << 12u);
        PETEU2 = curr & (1u << 10u);
        PETEU1 = curr & (1u << 9u);
        PETEU0 = curr & (1u << 8u);
     ...
     * (read-write) Parity Error Trap Enable Register
     */
    inline void set_PETE(bool PETESD1, bool PETESD0, bool PETEETH0RX,
                         bool PETEETH0TX, bool PETEUSB, bool PETEPPRF,
                         bool PETEMC, bool PETEU2, bool PETEU1, bool PETEU0,
                         bool PETEDS2, bool PETEDS1, bool PETEPS) volatile
    {
        uint32_t curr = PETE;

        curr &= ~(0b1u << 20u);
        curr |= (PETESD1 & 0b1u) << 20u;
        curr &= ~(0b1u << 19u);
        curr |= (PETESD0 & 0b1u) << 19u;
        curr &= ~(0b1u << 18u);
        curr |= (PETEETH0RX & 0b1u) << 18u;
        curr &= ~(0b1u << 17u);
        curr |= (PETEETH0TX & 0b1u) << 17u;
        curr &= ~(0b1u << 16u);
        curr |= (PETEUSB & 0b1u) << 16u;
        curr &= ~(0b1u << 13u);
        curr |= (PETEPPRF & 0b1u) << 13u;
        curr &= ~(0b1u << 12u);
        curr |= (PETEMC & 0b1u) << 12u;
        curr &= ~(0b1u << 10u);
        curr |= (PETEU2 & 0b1u) << 10u;
        curr &= ~(0b1u << 9u);
        curr |= (PETEU1 & 0b1u) << 9u;
        curr &= ~(0b1u << 8u);
        curr |= (PETEU0 & 0b1u) << 8u;
        curr &= ~(0b1u << 2u);
        curr |= (PETEDS2 & 0b1u) << 2u;
        curr &= ~(0b1u << 1u);
        curr |= (PETEDS1 & 0b1u) << 1u;
        curr &= ~(0b1u << 0u);
        curr |= (PETEPS & 0b1u) << 0u;
     ...
     */
    inline bool get_PERSTEN_RSEN() volatile
    {
        return PERSTEN & (1u << 0u);
    }
     ...
     */
    inline bool get_PEFLAG_PESD1() volatile
    {
        return PEFLAG & (1u << 20u);
    }
     ...
     */
    inline bool get_PEFLAG_PESD0() volatile
    {
        return PEFLAG & (1u << 19u);
    }
     ...
     */
    inline bool get_PEFLAG_PEETH0RX() volatile
    {
        return PEFLAG & (1u << 18u);
    }
     ...
     */
    inline bool get_PEFLAG_PEETH0TX() volatile
    {
        return PEFLAG & (1u << 17u);
    }
     ...
     */
    inline bool get_PEFLAG_PEUSB() volatile
    {
        return PEFLAG & (1u << 16u);
    }
     ...
     */
    inline bool get_PEFLAG_PEFPPRF() volatile
    {
        return PEFLAG & (1u << 13u);
    }
     ...
     */
    inline bool get_PEFLAG_PEFMC() volatile
    {
        return PEFLAG & (1u << 12u);
    }
     ...
     */
    inline bool get_PEFLAG_PEFU2() volatile
    {
        return PEFLAG & (1u << 10u);
    }
     ...
     */
    inline bool get_PEFLAG_PEFU1() volatile
    {
        return PEFLAG & (1u << 9u);
    }
     ...
     */
    inline bool get_PEFLAG_PEFU0() volatile
    {
        return PEFLAG & (1u << 8u);
    }
     ...
     */
    inline bool get_PEFLAG_PEFDS2() volatile
    {
        return PEFLAG & (1u << 2u);
    }
     ...
     */
    inline bool get_PEFLAG_PEFDS1() volatile
    {
        return PEFLAG & (1u << 1u);
    }
     ...
     */
    inline bool get_PEFLAG_PEFPS() volatile
    {
        return PEFLAG & (1u << 0u);
    }
     ...
     */
    inline void get_PEFLAG(bool &PESD1, bool &PESD0, bool &PEETH0RX,
                           bool &PEETH0TX, bool &PEUSB, bool &PEFPPRF,
                           bool &PEFMC, bool &PEFU2, bool &PEFU1, bool &PEFU0,
                           bool &PEFDS2, bool &PEFDS1, bool &PEFPS) volatile
    {
        uint32_t curr = PEFLAG;

        PESD1 = curr & (1u << 20u);
        PESD0 = curr & (1u << 19u);
        PEETH0RX = curr & (1u << 18u);
        PEETH0TX = curr & (1u << 17u);
        PEUSB = curr & (1u << 16u);
        PEFPPRF = curr & (1u << 13u);
        PEFMC = curr & (1u << 12u);
        PEFU2 = curr & (1u << 10u);
     ...
     * (read-write) Parity Error Flag Register
     */
    inline void set_PEFLAG(bool PESD1, bool PESD0, bool PEETH0RX,
                           bool PEETH0TX, bool PEUSB, bool PEFPPRF, bool PEFMC,
                           bool PEFU2, bool PEFU1, bool PEFU0, bool PEFDS2,
                           bool PEFDS1, bool PEFPS) volatile
    {
        uint32_t curr = PEFLAG;
        ...
        curr |= (PESD0 & 0b1u) << 19u;
        curr &= ~(0b1u << 18u);
        curr |= (PEETH0RX & 0b1u) << 18u;
        curr &= ~(0b1u << 17u);
        curr |= (PEETH0TX & 0b1u) << 17u;
        curr &= ~(0b1u << 16u);
        curr |= (PEUSB & 0b1u) << 16u;
        curr &= ~(0b1u << 13u);
        curr |= (PEFPPRF & 0b1u) << 13u;
        curr &= ~(0b1u << 12u);
        curr |= (PEFMC & 0b1u) << 12u;
        curr &= ~(0b1u << 10u);
        curr |= (PEFU2 & 0b1u) << 10u;
     ...
     *
     * (read-write) Parity Memory Test Pattern Register
     */
     ...
     */
    inline bool get_PMTSR_MTSD1() volatile
    {
        return PMTSR & (1u << 20u);
    }
     ...
     */
    inline bool get_PMTSR_MTSD0() volatile
    {
        return PMTSR & (1u << 19u);
    }
     ...
     */
    inline bool get_PMTSR_MTETH0RX() volatile
    {
        return PMTSR & (1u << 18u);
    }
     ...
     */
    inline bool get_PMTSR_MTETH0TX() volatile
    {
        return PMTSR & (1u << 17u);
    }
     ...
     */
    inline bool get_PMTSR_MTUSB() volatile
    {
        return PMTSR & (1u << 16u);
    }
     ...
     */
    inline bool get_PMTSR_MTEPPRF() volatile
    {
        return PMTSR & (1u << 13u);
    }
     ...
     */
    inline bool get_PMTSR_MTEMC() volatile
    {
        return PMTSR & (1u << 12u);
    }
     ...
     */
    inline bool get_PMTSR_MTEU2() volatile
    {
        return PMTSR & (1u << 10u);
    }
     ...
     */
    inline bool get_PMTSR_MTEU1() volatile
    {
        return PMTSR & (1u << 9u);
    }
     ...
     */
    inline bool get_PMTSR_MTEU0() volatile
    {
        return PMTSR & (1u << 8u);
    }
     ...
     */
    inline bool get_PMTSR_MTENDS2() volatile
    {
        return PMTSR & (1u << 2u);
    }
     ...
     */
    inline bool get_PMTSR_MTENDS1() volatile
    {
        return PMTSR & (1u << 1u);
    }
     ...
     */
    inline bool get_PMTSR_MTENPS() volatile
    {
        return PMTSR & (1u << 0u);
    }
     ...
     */
    inline void get_PMTSR(bool &MTSD1, bool &MTSD0, bool &MTETH0RX,
                          bool &MTETH0TX, bool &MTUSB, bool &MTEPPRF,
                          bool &MTEMC, bool &MTEU2, bool &MTEU1, bool &MTEU0,
                          bool &MTENDS2, bool &MTENDS1, bool &MTENPS) volatile
    {
        uint32_t curr = PMTSR;

        MTSD1 = curr & (1u << 20u);
        MTSD0 = curr & (1u << 19u);
        MTETH0RX = curr & (1u << 18u);
        MTETH0TX = curr & (1u << 17u);
        MTUSB = curr & (1u << 16u);
        MTEPPRF = curr & (1u << 13u);
        MTEMC = curr & (1u << 12u);
        MTEU2 = curr & (1u << 10u);
     ...
     * (read-write) Parity Memory Test Select Register
     */
    inline void set_PMTSR(bool MTSD1, bool MTSD0, bool MTETH0RX, bool MTETH0TX,
                          bool MTUSB, bool MTEPPRF, bool MTEMC, bool MTEU2,
                          bool MTEU1, bool MTEU0, bool MTENDS2, bool MTENDS1,
                          bool MTENPS) volatile
    {
        uint32_t curr = PMTSR;
        ...
        curr |= (MTSD0 & 0b1u) << 19u;
        curr &= ~(0b1u << 18u);
        curr |= (MTETH0RX & 0b1u) << 18u;
        curr &= ~(0b1u << 17u);
        curr |= (MTETH0TX & 0b1u) << 17u;
        curr &= ~(0b1u << 16u);
        curr |= (MTUSB & 0b1u) << 16u;
        curr &= ~(0b1u << 13u);
        curr |= (MTEPPRF & 0b1u) << 13u;
        curr &= ~(0b1u << 12u);
        curr |= (MTEMC & 0b1u) << 12u;
        curr &= ~(0b1u << 10u);
        curr |= (MTEU2 & 0b1u) << 10u;
        ...
        curr |= (MTEU0 & 0b1u) << 8u;
        curr &= ~(0b1u << 2u);
        curr |= (MTENDS2 & 0b1u) << 2u;
        curr &= ~(0b1u << 1u);
        curr |= (MTENDS1 & 0b1u) << 1u;
        curr &= ~(0b1u << 0u);
        curr |= (MTENPS & 0b1u) << 0u;
