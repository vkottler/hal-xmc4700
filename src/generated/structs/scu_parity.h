...
struct [[gnu::packed]] scu_parity
{
     ...
     */
    inline SCU_PARITY_PEEN_PEENSD0 get_PEEN_PEENSD0() volatile
    {
     ...
     */
    inline SCU_PARITY_PEEN_PEENETH0RX get_PEEN_PEENETH0RX() volatile
    {
     ...
     */
    inline SCU_PARITY_PEEN_PEENETH0TX get_PEEN_PEENETH0TX() volatile
    {
     ...
     */
    inline SCU_PARITY_PEEN_PEENUSB get_PEEN_PEENUSB() volatile
    {
     ...
     */
    inline SCU_PARITY_PEEN_PEENPPRF get_PEEN_PEENPPRF() volatile
    {
     ...
     */
    inline SCU_PARITY_PEEN_PEENMC get_PEEN_PEENMC() volatile
    {
     ...
     */
    inline SCU_PARITY_PEEN_PEENU2 get_PEEN_PEENU2() volatile
    {
     ...
     */
    inline SCU_PARITY_PEEN_PEENU1 get_PEEN_PEENU1() volatile
    {
     ...
     */
    inline SCU_PARITY_PEEN_PEENU0 get_PEEN_PEENU0() volatile
    {
     ...
     */
    inline SCU_PARITY_PEEN_PEENDS2 get_PEEN_PEENDS2() volatile
    {
     ...
     */
    inline SCU_PARITY_PEEN_PEENDS1 get_PEEN_PEENDS1() volatile
    {
     ...
     */
    inline SCU_PARITY_PEEN_PEENPS get_PEEN_PEENPS() volatile
    {
     ...
     */
    inline void get_PEEN(SCU_PARITY_PEEN_PEENSD1 &PEENSD1, SCU_PARITY_PEEN_PEENSD0 &PEENSD0, SCU_PARITY_PEEN_PEENETH0RX &PEENETH0RX, SCU_PARITY_PEEN_PEENETH0TX &PEENETH0TX, SCU_PARITY_PEEN_PEENUSB &PEENUSB, SCU_PARITY_PEEN_PEENPPRF &PEENPPRF, SCU_PARITY_PEEN_PEENMC &PEENMC, SCU_PARITY_PEEN_PEENU2 &PEENU2, SCU_PARITY_PEEN_PEENU1 &PEENU1, SCU_PARITY_PEEN_PEENU0 &PEENU0, SCU_PARITY_PEEN_PEENDS2 &PEENDS2, SCU_PARITY_PEEN_PEENDS1 &PEENDS1, SCU_PARITY_PEEN_PEENPS &PEENPS) volatile
    {
        uint32_t curr = PEEN;

        PEENSD1 = SCU_PARITY_PEEN_PEENSD1(curr & (1u << 20u));
        PEENSD0 = SCU_PARITY_PEEN_PEENSD0(curr & (1u << 19u));
        PEENETH0RX = SCU_PARITY_PEEN_PEENETH0RX(curr & (1u << 18u));
        PEENETH0TX = SCU_PARITY_PEEN_PEENETH0TX(curr & (1u << 17u));
        PEENUSB = SCU_PARITY_PEEN_PEENUSB(curr & (1u << 16u));
        PEENPPRF = SCU_PARITY_PEEN_PEENPPRF(curr & (1u << 13u));
        PEENMC = SCU_PARITY_PEEN_PEENMC(curr & (1u << 12u));
        PEENU2 = SCU_PARITY_PEEN_PEENU2(curr & (1u << 10u));
        PEENU1 = SCU_PARITY_PEEN_PEENU1(curr & (1u << 9u));
        PEENU0 = SCU_PARITY_PEEN_PEENU0(curr & (1u << 8u));
        PEENDS2 = SCU_PARITY_PEEN_PEENDS2(curr & (1u << 2u));
        PEENDS1 = SCU_PARITY_PEEN_PEENDS1(curr & (1u << 1u));
        PEENPS = SCU_PARITY_PEEN_PEENPS(curr & (1u << 0u));
    }

    /**
     * Set all of PEEN's bit fields.
     */
    inline void set_PEEN(SCU_PARITY_PEEN_PEENSD1 PEENSD1, SCU_PARITY_PEEN_PEENSD0 PEENSD0, SCU_PARITY_PEEN_PEENETH0RX PEENETH0RX, SCU_PARITY_PEEN_PEENETH0TX PEENETH0TX, SCU_PARITY_PEEN_PEENUSB PEENUSB, SCU_PARITY_PEEN_PEENPPRF PEENPPRF, SCU_PARITY_PEEN_PEENMC PEENMC, SCU_PARITY_PEEN_PEENU2 PEENU2, SCU_PARITY_PEEN_PEENU1 PEENU1, SCU_PARITY_PEEN_PEENU0 PEENU0, SCU_PARITY_PEEN_PEENDS2 PEENDS2, SCU_PARITY_PEEN_PEENDS1 PEENDS1, SCU_PARITY_PEEN_PEENPS PEENPS) volatile
    {
        uint32_t curr = PEEN;
     ...
     */
    inline SCU_PARITY_MCHKCON_SELSD0 get_MCHKCON_SELSD0() volatile
    {
     ...
     */
    inline SCU_PARITY_MCHKCON_SELETH0RX get_MCHKCON_SELETH0RX() volatile
    {
     ...
     */
    inline SCU_PARITY_MCHKCON_SELETH0TX get_MCHKCON_SELETH0TX() volatile
    {
     ...
     */
    inline SCU_PARITY_MCHKCON_SELUSB get_MCHKCON_SELUSB() volatile
    {
     ...
     */
    inline SCU_PARITY_MCHKCON_PPRFDRA get_MCHKCON_PPRFDRA() volatile
    {
     ...
     */
    inline SCU_PARITY_MCHKCON_MCANDRA get_MCHKCON_MCANDRA() volatile
    {
     ...
     */
    inline SCU_PARITY_MCHKCON_USIC2DRA get_MCHKCON_USIC2DRA() volatile
    {
     ...
     */
    inline SCU_PARITY_MCHKCON_USIC1DRA get_MCHKCON_USIC1DRA() volatile
    {
     ...
     */
    inline SCU_PARITY_MCHKCON_USIC0DRA get_MCHKCON_USIC0DRA() volatile
    {
     ...
     */
    inline SCU_PARITY_MCHKCON_SELDS2 get_MCHKCON_SELDS2() volatile
    {
     ...
     */
    inline SCU_PARITY_MCHKCON_SELDS1 get_MCHKCON_SELDS1() volatile
    {
     ...
     */
    inline SCU_PARITY_MCHKCON_SELPS get_MCHKCON_SELPS() volatile
    {
     ...
     */
    inline void get_MCHKCON(SCU_PARITY_MCHKCON_SELSD1 &SELSD1, SCU_PARITY_MCHKCON_SELSD0 &SELSD0, SCU_PARITY_MCHKCON_SELETH0RX &SELETH0RX, SCU_PARITY_MCHKCON_SELETH0TX &SELETH0TX, SCU_PARITY_MCHKCON_SELUSB &SELUSB, SCU_PARITY_MCHKCON_PPRFDRA &PPRFDRA, SCU_PARITY_MCHKCON_MCANDRA &MCANDRA, SCU_PARITY_MCHKCON_USIC2DRA &USIC2DRA, SCU_PARITY_MCHKCON_USIC1DRA &USIC1DRA, SCU_PARITY_MCHKCON_USIC0DRA &USIC0DRA, SCU_PARITY_MCHKCON_SELDS2 &SELDS2, SCU_PARITY_MCHKCON_SELDS1 &SELDS1, SCU_PARITY_MCHKCON_SELPS &SELPS) volatile
    {
        uint32_t curr = MCHKCON;

        SELSD1 = SCU_PARITY_MCHKCON_SELSD1(curr & (1u << 20u));
        SELSD0 = SCU_PARITY_MCHKCON_SELSD0(curr & (1u << 19u));
        SELETH0RX = SCU_PARITY_MCHKCON_SELETH0RX(curr & (1u << 18u));
        SELETH0TX = SCU_PARITY_MCHKCON_SELETH0TX(curr & (1u << 17u));
        SELUSB = SCU_PARITY_MCHKCON_SELUSB(curr & (1u << 16u));
        PPRFDRA = SCU_PARITY_MCHKCON_PPRFDRA(curr & (1u << 13u));
        MCANDRA = SCU_PARITY_MCHKCON_MCANDRA(curr & (1u << 12u));
        USIC2DRA = SCU_PARITY_MCHKCON_USIC2DRA(curr & (1u << 10u));
        USIC1DRA = SCU_PARITY_MCHKCON_USIC1DRA(curr & (1u << 9u));
        USIC0DRA = SCU_PARITY_MCHKCON_USIC0DRA(curr & (1u << 8u));
        SELDS2 = SCU_PARITY_MCHKCON_SELDS2(curr & (1u << 2u));
        SELDS1 = SCU_PARITY_MCHKCON_SELDS1(curr & (1u << 1u));
        SELPS = SCU_PARITY_MCHKCON_SELPS(curr & (1u << 0u));
    }

    /**
     * Set all of MCHKCON's bit fields.
     */
    inline void set_MCHKCON(SCU_PARITY_MCHKCON_SELSD1 SELSD1, SCU_PARITY_MCHKCON_SELSD0 SELSD0, SCU_PARITY_MCHKCON_SELETH0RX SELETH0RX, SCU_PARITY_MCHKCON_SELETH0TX SELETH0TX, SCU_PARITY_MCHKCON_SELUSB SELUSB, SCU_PARITY_MCHKCON_PPRFDRA PPRFDRA, SCU_PARITY_MCHKCON_MCANDRA MCANDRA, SCU_PARITY_MCHKCON_USIC2DRA USIC2DRA, SCU_PARITY_MCHKCON_USIC1DRA USIC1DRA, SCU_PARITY_MCHKCON_USIC0DRA USIC0DRA, SCU_PARITY_MCHKCON_SELDS2 SELDS2, SCU_PARITY_MCHKCON_SELDS1 SELDS1, SCU_PARITY_MCHKCON_SELPS SELPS) volatile
    {
        uint32_t curr = MCHKCON;
     ...
     */
    inline SCU_PARITY_PETE_PETESD1 get_PETE_PETESD1() volatile
    {
     ...
     */
    inline SCU_PARITY_PETE_PETESD0 get_PETE_PETESD0() volatile
    {
     ...
     */
    inline SCU_PARITY_PETE_PETEETH0RX get_PETE_PETEETH0RX() volatile
    {
     ...
     */
    inline SCU_PARITY_PETE_PETEETH0TX get_PETE_PETEETH0TX() volatile
    {
     ...
     */
    inline SCU_PARITY_PETE_PETEUSB get_PETE_PETEUSB() volatile
    {
     ...
     */
    inline SCU_PARITY_PETE_PETEPPRF get_PETE_PETEPPRF() volatile
    {
     ...
     */
    inline SCU_PARITY_PETE_PETEMC get_PETE_PETEMC() volatile
    {
     ...
     */
    inline SCU_PARITY_PETE_PETEU2 get_PETE_PETEU2() volatile
    {
     ...
     */
    inline SCU_PARITY_PETE_PETEU1 get_PETE_PETEU1() volatile
    {
     ...
     */
    inline SCU_PARITY_PETE_PETEU0 get_PETE_PETEU0() volatile
    {
     ...
     */
    inline SCU_PARITY_PETE_PETEDS2 get_PETE_PETEDS2() volatile
    {
     ...
     */
    inline SCU_PARITY_PETE_PETEDS1 get_PETE_PETEDS1() volatile
    {
     ...
     */
    inline SCU_PARITY_PETE_PETEPS get_PETE_PETEPS() volatile
    {
     ...
     */
    inline void get_PETE(SCU_PARITY_PETE_PETESD1 &PETESD1, SCU_PARITY_PETE_PETESD0 &PETESD0, SCU_PARITY_PETE_PETEETH0RX &PETEETH0RX, SCU_PARITY_PETE_PETEETH0TX &PETEETH0TX, SCU_PARITY_PETE_PETEUSB &PETEUSB, SCU_PARITY_PETE_PETEPPRF &PETEPPRF, SCU_PARITY_PETE_PETEMC &PETEMC, SCU_PARITY_PETE_PETEU2 &PETEU2, SCU_PARITY_PETE_PETEU1 &PETEU1, SCU_PARITY_PETE_PETEU0 &PETEU0, SCU_PARITY_PETE_PETEDS2 &PETEDS2, SCU_PARITY_PETE_PETEDS1 &PETEDS1, SCU_PARITY_PETE_PETEPS &PETEPS) volatile
    {
        uint32_t curr = PETE;

        PETESD1 = SCU_PARITY_PETE_PETESD1(curr & (1u << 20u));
        PETESD0 = SCU_PARITY_PETE_PETESD0(curr & (1u << 19u));
        PETEETH0RX = SCU_PARITY_PETE_PETEETH0RX(curr & (1u << 18u));
        PETEETH0TX = SCU_PARITY_PETE_PETEETH0TX(curr & (1u << 17u));
        PETEUSB = SCU_PARITY_PETE_PETEUSB(curr & (1u << 16u));
        PETEPPRF = SCU_PARITY_PETE_PETEPPRF(curr & (1u << 13u));
        PETEMC = SCU_PARITY_PETE_PETEMC(curr & (1u << 12u));
        PETEU2 = SCU_PARITY_PETE_PETEU2(curr & (1u << 10u));
        PETEU1 = SCU_PARITY_PETE_PETEU1(curr & (1u << 9u));
        PETEU0 = SCU_PARITY_PETE_PETEU0(curr & (1u << 8u));
        PETEDS2 = SCU_PARITY_PETE_PETEDS2(curr & (1u << 2u));
        PETEDS1 = SCU_PARITY_PETE_PETEDS1(curr & (1u << 1u));
        PETEPS = SCU_PARITY_PETE_PETEPS(curr & (1u << 0u));
    }

    /**
     * Set all of PETE's bit fields.
     */
    inline void set_PETE(SCU_PARITY_PETE_PETESD1 PETESD1, SCU_PARITY_PETE_PETESD0 PETESD0, SCU_PARITY_PETE_PETEETH0RX PETEETH0RX, SCU_PARITY_PETE_PETEETH0TX PETEETH0TX, SCU_PARITY_PETE_PETEUSB PETEUSB, SCU_PARITY_PETE_PETEPPRF PETEPPRF, SCU_PARITY_PETE_PETEMC PETEMC, SCU_PARITY_PETE_PETEU2 PETEU2, SCU_PARITY_PETE_PETEU1 PETEU1, SCU_PARITY_PETE_PETEU0 PETEU0, SCU_PARITY_PETE_PETEDS2 PETEDS2, SCU_PARITY_PETE_PETEDS1 PETEDS1, SCU_PARITY_PETE_PETEPS PETEPS) volatile
    {
        uint32_t curr = PETE;
     ...
     */
    inline SCU_PARITY_PERSTEN_RSEN get_PERSTEN_RSEN() volatile
    {
     ...
     */
    inline SCU_PARITY_PEFLAG_PESD0 get_PEFLAG_PESD0() volatile
    {
     ...
     */
    inline SCU_PARITY_PEFLAG_PEETH0RX get_PEFLAG_PEETH0RX() volatile
    {
     ...
     */
    inline SCU_PARITY_PEFLAG_PEETH0TX get_PEFLAG_PEETH0TX() volatile
    {
     ...
     */
    inline SCU_PARITY_PEFLAG_PEUSB get_PEFLAG_PEUSB() volatile
    {
     ...
     */
    inline SCU_PARITY_PEFLAG_PEFPPRF get_PEFLAG_PEFPPRF() volatile
    {
     ...
     */
    inline SCU_PARITY_PEFLAG_PEFMC get_PEFLAG_PEFMC() volatile
    {
     ...
     */
    inline SCU_PARITY_PEFLAG_PEFU2 get_PEFLAG_PEFU2() volatile
    {
     ...
     */
    inline SCU_PARITY_PEFLAG_PEFU1 get_PEFLAG_PEFU1() volatile
    {
     ...
     */
    inline SCU_PARITY_PEFLAG_PEFU0 get_PEFLAG_PEFU0() volatile
    {
     ...
     */
    inline SCU_PARITY_PEFLAG_PEFDS2 get_PEFLAG_PEFDS2() volatile
    {
     ...
     */
    inline SCU_PARITY_PEFLAG_PEFDS1 get_PEFLAG_PEFDS1() volatile
    {
     ...
     */
    inline SCU_PARITY_PEFLAG_PEFPS get_PEFLAG_PEFPS() volatile
    {
     ...
     */
    inline void get_PEFLAG(SCU_PARITY_PEFLAG_PESD1 &PESD1, SCU_PARITY_PEFLAG_PESD0 &PESD0, SCU_PARITY_PEFLAG_PEETH0RX &PEETH0RX, SCU_PARITY_PEFLAG_PEETH0TX &PEETH0TX, SCU_PARITY_PEFLAG_PEUSB &PEUSB, SCU_PARITY_PEFLAG_PEFPPRF &PEFPPRF, SCU_PARITY_PEFLAG_PEFMC &PEFMC, SCU_PARITY_PEFLAG_PEFU2 &PEFU2, SCU_PARITY_PEFLAG_PEFU1 &PEFU1, SCU_PARITY_PEFLAG_PEFU0 &PEFU0, SCU_PARITY_PEFLAG_PEFDS2 &PEFDS2, SCU_PARITY_PEFLAG_PEFDS1 &PEFDS1, SCU_PARITY_PEFLAG_PEFPS &PEFPS) volatile
    {
        uint32_t curr = PEFLAG;

        PESD1 = SCU_PARITY_PEFLAG_PESD1(curr & (1u << 20u));
        PESD0 = SCU_PARITY_PEFLAG_PESD0(curr & (1u << 19u));
        PEETH0RX = SCU_PARITY_PEFLAG_PEETH0RX(curr & (1u << 18u));
        PEETH0TX = SCU_PARITY_PEFLAG_PEETH0TX(curr & (1u << 17u));
        PEUSB = SCU_PARITY_PEFLAG_PEUSB(curr & (1u << 16u));
        PEFPPRF = SCU_PARITY_PEFLAG_PEFPPRF(curr & (1u << 13u));
        PEFMC = SCU_PARITY_PEFLAG_PEFMC(curr & (1u << 12u));
        PEFU2 = SCU_PARITY_PEFLAG_PEFU2(curr & (1u << 10u));
        PEFU1 = SCU_PARITY_PEFLAG_PEFU1(curr & (1u << 9u));
        PEFU0 = SCU_PARITY_PEFLAG_PEFU0(curr & (1u << 8u));
        PEFDS2 = SCU_PARITY_PEFLAG_PEFDS2(curr & (1u << 2u));
        PEFDS1 = SCU_PARITY_PEFLAG_PEFDS1(curr & (1u << 1u));
        PEFPS = SCU_PARITY_PEFLAG_PEFPS(curr & (1u << 0u));
    }

    /**
     * Set all of PEFLAG's bit fields.
     */
    inline void set_PEFLAG(SCU_PARITY_PEFLAG_PESD1 PESD1, SCU_PARITY_PEFLAG_PESD0 PESD0, SCU_PARITY_PEFLAG_PEETH0RX PEETH0RX, SCU_PARITY_PEFLAG_PEETH0TX PEETH0TX, SCU_PARITY_PEFLAG_PEUSB PEUSB, SCU_PARITY_PEFLAG_PEFPPRF PEFPPRF, SCU_PARITY_PEFLAG_PEFMC PEFMC, SCU_PARITY_PEFLAG_PEFU2 PEFU2, SCU_PARITY_PEFLAG_PEFU1 PEFU1, SCU_PARITY_PEFLAG_PEFU0 PEFU0, SCU_PARITY_PEFLAG_PEFDS2 PEFDS2, SCU_PARITY_PEFLAG_PEFDS1 PEFDS1, SCU_PARITY_PEFLAG_PEFPS PEFPS) volatile
    {
        uint32_t curr = PEFLAG;
     ...
     */
    inline SCU_PARITY_PMTSR_MTSD0 get_PMTSR_MTSD0() volatile
    {
     ...
     */
    inline SCU_PARITY_PMTSR_MTETH0RX get_PMTSR_MTETH0RX() volatile
    {
     ...
     */
    inline SCU_PARITY_PMTSR_MTETH0TX get_PMTSR_MTETH0TX() volatile
    {
     ...
     */
    inline SCU_PARITY_PMTSR_MTUSB get_PMTSR_MTUSB() volatile
    {
     ...
     */
    inline SCU_PARITY_PMTSR_MTEPPRF get_PMTSR_MTEPPRF() volatile
    {
     ...
     */
    inline SCU_PARITY_PMTSR_MTEMC get_PMTSR_MTEMC() volatile
    {
     ...
     */
    inline SCU_PARITY_PMTSR_MTEU2 get_PMTSR_MTEU2() volatile
    {
     ...
     */
    inline SCU_PARITY_PMTSR_MTEU1 get_PMTSR_MTEU1() volatile
    {
     ...
     */
    inline SCU_PARITY_PMTSR_MTEU0 get_PMTSR_MTEU0() volatile
    {
     ...
     */
    inline SCU_PARITY_PMTSR_MTENDS2 get_PMTSR_MTENDS2() volatile
    {
     ...
     */
    inline SCU_PARITY_PMTSR_MTENDS1 get_PMTSR_MTENDS1() volatile
    {
     ...
     */
    inline SCU_PARITY_PMTSR_MTENPS get_PMTSR_MTENPS() volatile
    {
     ...
     */
    inline void get_PMTSR(SCU_PARITY_PMTSR_MTSD1 &MTSD1, SCU_PARITY_PMTSR_MTSD0 &MTSD0, SCU_PARITY_PMTSR_MTETH0RX &MTETH0RX, SCU_PARITY_PMTSR_MTETH0TX &MTETH0TX, SCU_PARITY_PMTSR_MTUSB &MTUSB, SCU_PARITY_PMTSR_MTEPPRF &MTEPPRF, SCU_PARITY_PMTSR_MTEMC &MTEMC, SCU_PARITY_PMTSR_MTEU2 &MTEU2, SCU_PARITY_PMTSR_MTEU1 &MTEU1, SCU_PARITY_PMTSR_MTEU0 &MTEU0, SCU_PARITY_PMTSR_MTENDS2 &MTENDS2, SCU_PARITY_PMTSR_MTENDS1 &MTENDS1, SCU_PARITY_PMTSR_MTENPS &MTENPS) volatile
    {
        uint32_t curr = PMTSR;

        MTSD1 = SCU_PARITY_PMTSR_MTSD1(curr & (1u << 20u));
        MTSD0 = SCU_PARITY_PMTSR_MTSD0(curr & (1u << 19u));
        MTETH0RX = SCU_PARITY_PMTSR_MTETH0RX(curr & (1u << 18u));
        MTETH0TX = SCU_PARITY_PMTSR_MTETH0TX(curr & (1u << 17u));
        MTUSB = SCU_PARITY_PMTSR_MTUSB(curr & (1u << 16u));
        MTEPPRF = SCU_PARITY_PMTSR_MTEPPRF(curr & (1u << 13u));
        MTEMC = SCU_PARITY_PMTSR_MTEMC(curr & (1u << 12u));
        MTEU2 = SCU_PARITY_PMTSR_MTEU2(curr & (1u << 10u));
        MTEU1 = SCU_PARITY_PMTSR_MTEU1(curr & (1u << 9u));
        MTEU0 = SCU_PARITY_PMTSR_MTEU0(curr & (1u << 8u));
        MTENDS2 = SCU_PARITY_PMTSR_MTENDS2(curr & (1u << 2u));
        MTENDS1 = SCU_PARITY_PMTSR_MTENDS1(curr & (1u << 1u));
        MTENPS = SCU_PARITY_PMTSR_MTENPS(curr & (1u << 0u));
    }

    /**
     * Set all of PMTSR's bit fields.
     */
    inline void set_PMTSR(SCU_PARITY_PMTSR_MTSD1 MTSD1, SCU_PARITY_PMTSR_MTSD0 MTSD0, SCU_PARITY_PMTSR_MTETH0RX MTETH0RX, SCU_PARITY_PMTSR_MTETH0TX MTETH0TX, SCU_PARITY_PMTSR_MTUSB MTUSB, SCU_PARITY_PMTSR_MTEPPRF MTEPPRF, SCU_PARITY_PMTSR_MTEMC MTEMC, SCU_PARITY_PMTSR_MTEU2 MTEU2, SCU_PARITY_PMTSR_MTEU1 MTEU1, SCU_PARITY_PMTSR_MTEU0 MTEU0, SCU_PARITY_PMTSR_MTENDS2 MTENDS2, SCU_PARITY_PMTSR_MTENDS1 MTENDS1, SCU_PARITY_PMTSR_MTENPS MTENPS) volatile
    {
        uint32_t curr = PMTSR;
...
static volatile scu_parity *const SCU_PARITY = reinterpret_cast<scu_parity *>(0x5000413C);
