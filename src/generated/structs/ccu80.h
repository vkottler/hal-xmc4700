...
struct [[gnu::packed]] ccu80
{
     ...
     */
    inline CCU80_GCTRL_MSDE get_GCTRL_MSDE()
    {
     ...
     */
    inline CCU80_GCTRL_MSE3 get_GCTRL_MSE3()
    {
     ...
     */
    inline CCU80_GCTRL_MSE2 get_GCTRL_MSE2()
    {
     ...
     */
    inline CCU80_GCTRL_MSE1 get_GCTRL_MSE1()
    {
     ...
     */
    inline CCU80_GCTRL_MSE0 get_GCTRL_MSE0()
    {
     ...
     */
    inline CCU80_GCTRL_SUSCFG get_GCTRL_SUSCFG()
    {
     ...
     */
    inline CCU80_GCTRL_PCIS get_GCTRL_PCIS()
    {
     ...
     */
    inline CCU80_GCTRL_PRBC get_GCTRL_PRBC()
    {
     ...
     */
    inline void get_GCTRL(CCU80_GCTRL_MSDE &MSDE, CCU80_GCTRL_MSE3 &MSE3, CCU80_GCTRL_MSE2 &MSE2, CCU80_GCTRL_MSE1 &MSE1, CCU80_GCTRL_MSE0 &MSE0, CCU80_GCTRL_SUSCFG &SUSCFG, CCU80_GCTRL_PCIS &PCIS, CCU80_GCTRL_PRBC &PRBC)
    {
        uint32_t curr = GCTRL;

        MSDE = CCU80_GCTRL_MSDE((curr >> 14u) & 0b11u);
        MSE3 = CCU80_GCTRL_MSE3(curr & (1u << 13u));
        MSE2 = CCU80_GCTRL_MSE2(curr & (1u << 12u));
        MSE1 = CCU80_GCTRL_MSE1(curr & (1u << 11u));
        MSE0 = CCU80_GCTRL_MSE0(curr & (1u << 10u));
     ...
     */
    inline void set_GCTRL(CCU80_GCTRL_MSDE MSDE, CCU80_GCTRL_MSE3 MSE3, CCU80_GCTRL_MSE2 MSE2, CCU80_GCTRL_MSE1 MSE1, CCU80_GCTRL_MSE0 MSE0, CCU80_GCTRL_SUSCFG SUSCFG, CCU80_GCTRL_PCIS PCIS, CCU80_GCTRL_PRBC PRBC)
    {
        uint32_t curr = GCTRL;
     ...
     */
    inline CCU80_GSTAT_PCRB get_GSTAT_PCRB()
    {
     ...
     * Get GSTAT's PRB bit.
     */
    inline CCU80_GSTAT_PRB get_GSTAT_PRB()
    {
     ...
     * Get GSTAT's S3I bit.
     */
    inline CCU80_GSTAT_S3I get_GSTAT_S3I()
    {
     ...
     * Get GSTAT's S2I bit.
     */
    inline CCU80_GSTAT_S2I get_GSTAT_S2I()
    {
     ...
     * Get GSTAT's S1I bit.
     */
    inline CCU80_GSTAT_S1I get_GSTAT_S1I()
    {
     ...
     * Get GSTAT's S0I bit.
     */
    inline CCU80_GSTAT_S0I get_GSTAT_S0I()
    {
     ...
     */
    inline void get_GSTAT(CCU80_GSTAT_PCRB &PCRB, CCU80_GSTAT_PRB &PRB, CCU80_GSTAT_S3I &S3I, CCU80_GSTAT_S2I &S2I, CCU80_GSTAT_S1I &S1I, CCU80_GSTAT_S0I &S0I)
    {
        uint32_t curr = GSTAT;

        PCRB = CCU80_GSTAT_PCRB(curr & (1u << 10u));
        PRB = CCU80_GSTAT_PRB(curr & (1u << 8u));
        S3I = CCU80_GSTAT_S3I(curr & (1u << 3u));
        S2I = CCU80_GSTAT_S2I(curr & (1u << 2u));
        S1I = CCU80_GSTAT_S1I(curr & (1u << 1u));
        S0I = CCU80_GSTAT_S0I(curr & (1u << 0u));
    }
     ...
     */
    inline void set_GIDLS(bool CPCH, bool PSIC, bool CPRB, bool SS3I, bool SS2I, bool SS1I, bool SS0I)
    {
        uint32_t curr = GIDLS;
     ...
     */
    inline void set_GIDLC(bool SPCH, bool SPRB, bool CS3I, bool CS2I, bool CS1I, bool CS0I)
    {
        uint32_t curr = GIDLC;
     ...
     */
    inline void set_GCSS(bool S3ST2S, bool S2ST2S, bool S1ST2S, bool S0ST2S, bool S3ST1S, bool S2ST1S, bool S1ST1S, bool S0ST1S, bool S3PSE, bool S3DSE, bool S3SE, bool S2PSE, bool S2DSE, bool S2SE, bool S1PSE, bool S1DSE, bool S1SE, bool S0PSE, bool S0DSE, bool S0SE)
    {
        uint32_t curr = GCSS;
     ...
     */
    inline void set_GCSC(bool S3ST2C, bool S2ST2C, bool S1ST2C, bool S0ST2C, bool S3ST1C, bool S2ST1C, bool S1ST1C, bool S0ST1C, bool S3PSC, bool S3DSC, bool S3SC, bool S2PSC, bool S2DSC, bool S2SC, bool S1PSC, bool S1DSC, bool S1SC, bool S0PSC, bool S0DSC, bool S0SC)
    {
        uint32_t curr = GCSC;
     ...
     */
    inline CCU80_GCST_S3PSS get_GCST_S3PSS()
    {
     ...
     */
    inline CCU80_GCST_S3DSS get_GCST_S3DSS()
    {
     ...
     * Get GCST's S3SS bit.
     */
    inline CCU80_GCST_S3SS get_GCST_S3SS()
    {
     ...
     */
    inline CCU80_GCST_S2PSS get_GCST_S2PSS()
    {
     ...
     */
    inline CCU80_GCST_S2DSS get_GCST_S2DSS()
    {
     ...
     * Get GCST's S2SS bit.
     */
    inline CCU80_GCST_S2SS get_GCST_S2SS()
    {
     ...
     */
    inline CCU80_GCST_S1PSS get_GCST_S1PSS()
    {
     ...
     */
    inline CCU80_GCST_S1DSS get_GCST_S1DSS()
    {
     ...
     * Get GCST's S1SS bit.
     */
    inline CCU80_GCST_S1SS get_GCST_S1SS()
    {
     ...
     */
    inline CCU80_GCST_S0PSS get_GCST_S0PSS()
    {
     ...
     */
    inline CCU80_GCST_S0DSS get_GCST_S0DSS()
    {
     ...
     * Get GCST's S0SS bit.
     */
    inline CCU80_GCST_S0SS get_GCST_S0SS()
    {
     ...
     */
    inline void get_GCST(bool &CC83ST2, bool &CC82ST2, bool &CC81ST2, bool &CC80ST2, bool &CC83ST1, bool &CC82ST1, bool &CC81ST1, bool &CC80ST1, CCU80_GCST_S3PSS &S3PSS, CCU80_GCST_S3DSS &S3DSS, CCU80_GCST_S3SS &S3SS, CCU80_GCST_S2PSS &S2PSS, CCU80_GCST_S2DSS &S2DSS, CCU80_GCST_S2SS &S2SS, CCU80_GCST_S1PSS &S1PSS, CCU80_GCST_S1DSS &S1DSS, CCU80_GCST_S1SS &S1SS, CCU80_GCST_S0PSS &S0PSS, CCU80_GCST_S0DSS &S0DSS, CCU80_GCST_S0SS &S0SS)
    {
        uint32_t curr = GCST;
        ...
        S3DSS = CCU80_GCST_S3DSS(curr & (1u << 13u));
        S3SS = CCU80_GCST_S3SS(curr & (1u << 12u));
        S2PSS = CCU80_GCST_S2PSS(curr & (1u << 10u));
        S2DSS = CCU80_GCST_S2DSS(curr & (1u << 9u));
        S2SS = CCU80_GCST_S2SS(curr & (1u << 8u));
        S1PSS = CCU80_GCST_S1PSS(curr & (1u << 6u));
        S1DSS = CCU80_GCST_S1DSS(curr & (1u << 5u));
        S1SS = CCU80_GCST_S1SS(curr & (1u << 4u));
        S0PSS = CCU80_GCST_S0PSS(curr & (1u << 2u));
        S0DSS = CCU80_GCST_S0DSS(curr & (1u << 1u));
        S0SS = CCU80_GCST_S0SS(curr & (1u << 0u));
    }

    /**
     * Get GPCHK's PCSEL3 field.
     */
    inline uint8_t get_GPCHK_PCSEL3()
    {
     ...
     */
    inline uint8_t get_GPCHK_PCSEL2()
    {
     ...
     */
    inline uint8_t get_GPCHK_PCSEL1()
    {
     ...
     */
    inline uint8_t get_GPCHK_PCSEL0()
    {
     ...
     */
    inline CCU80_GPCHK_PCTS get_GPCHK_PCTS()
    {
     ...
     */
    inline CCU80_GPCHK_PCDS get_GPCHK_PCDS()
    {
     ...
     */
    inline CCU80_GPCHK_PISEL get_GPCHK_PISEL()
    {
     ...
     */
    inline CCU80_GPCHK_PACS get_GPCHK_PACS()
    {
     ...
     */
    inline void get_GPCHK(uint8_t &PCSEL3, uint8_t &PCSEL2, uint8_t &PCSEL1, uint8_t &PCSEL0, bool &PCST, CCU80_GPCHK_PCTS &PCTS, CCU80_GPCHK_PCDS &PCDS, CCU80_GPCHK_PISEL &PISEL, CCU80_GPCHK_PACS &PACS, bool &PASE)
    {
        uint32_t curr = GPCHK;
     ...
     */
    inline void set_GPCHK(uint8_t PCSEL3, uint8_t PCSEL2, uint8_t PCSEL1, uint8_t PCSEL0, CCU80_GPCHK_PCTS PCTS, CCU80_GPCHK_PCDS PCDS, CCU80_GPCHK_PISEL PISEL, CCU80_GPCHK_PACS PACS, bool PASE)
    {
        uint32_t curr = GPCHK;
