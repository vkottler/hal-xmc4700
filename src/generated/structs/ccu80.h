...
struct [[gnu::packed]] ccu80
{
     ...
     */
    inline bool get_GCTRL_MSE3() volatile
    {
        return GCTRL & (1u << 13u);
    }
     ...
     */
    inline bool get_GCTRL_MSE2() volatile
    {
        return GCTRL & (1u << 12u);
    }
     ...
     */
    inline bool get_GCTRL_MSE1() volatile
    {
        return GCTRL & (1u << 11u);
    }
     ...
     */
    inline bool get_GCTRL_MSE0() volatile
    {
        return GCTRL & (1u << 10u);
    }
     ...
     */
    inline void get_GCTRL(CCU80_GCTRL_MSDE &MSDE, bool &MSE3, bool &MSE2,
                          bool &MSE1, bool &MSE0, CCU80_GCTRL_SUSCFG &SUSCFG,
     ...
     * (read-write) Global Control Register
     */
    inline void set_GCTRL(CCU80_GCTRL_MSDE MSDE, bool MSE3, bool MSE2,
                          bool MSE1, bool MSE0, CCU80_GCTRL_SUSCFG SUSCFG,
                          CCU80_GCTRL_PCIS PCIS,
                          CCU80_GCTRL_PRBC PRBC) volatile
    {
     ...
     */
    inline bool get_GSTAT_PCRB() volatile
    {
        return GSTAT & (1u << 10u);
    }
     ...
     * Prescaler Run Bit
     */
    inline bool get_GSTAT_PRB() volatile
    {
        return GSTAT & (1u << 8u);
    }
     ...
     * CC83 IDLE status
     */
    inline bool get_GSTAT_S3I() volatile
    {
        return GSTAT & (1u << 3u);
    }
     ...
     * CC82 IDLE status
     */
    inline bool get_GSTAT_S2I() volatile
    {
        return GSTAT & (1u << 2u);
    }
     ...
     * CC81 IDLE status
     */
    inline bool get_GSTAT_S1I() volatile
    {
        return GSTAT & (1u << 1u);
    }
     ...
     * CC80 IDLE status
     */
    inline bool get_GSTAT_S0I() volatile
    {
        return GSTAT & (1u << 0u);
    }
     ...
     *
     * (read-only) Global Status Register
     */
    inline void get_GSTAT(bool &PCRB, bool &PRB, bool &S3I, bool &S2I,
                          bool &S1I, bool &S0I) volatile
    {
        uint32_t curr = GSTAT;
     ...
     */
    inline bool get_GCST_S3PSS() volatile
    {
        return GCST & (1u << 14u);
    }
     ...
     */
    inline bool get_GCST_S3DSS() volatile
    {
        return GCST & (1u << 13u);
    }
     ...
     */
    inline bool get_GCST_S3SS() volatile
    {
        return GCST & (1u << 12u);
    }
     ...
     */
    inline bool get_GCST_S2PSS() volatile
    {
        return GCST & (1u << 10u);
    }
     ...
     */
    inline bool get_GCST_S2DSS() volatile
    {
        return GCST & (1u << 9u);
    }
     ...
     */
    inline bool get_GCST_S2SS() volatile
    {
        return GCST & (1u << 8u);
    }
     ...
     */
    inline bool get_GCST_S1PSS() volatile
    {
        return GCST & (1u << 6u);
    }
     ...
     */
    inline bool get_GCST_S1DSS() volatile
    {
        return GCST & (1u << 5u);
    }
     ...
     */
    inline bool get_GCST_S1SS() volatile
    {
        return GCST & (1u << 4u);
    }
     ...
     */
    inline bool get_GCST_S0PSS() volatile
    {
        return GCST & (1u << 2u);
    }
     ...
     */
    inline bool get_GCST_S0DSS() volatile
    {
        return GCST & (1u << 1u);
    }
     ...
     */
    inline bool get_GCST_S0SS() volatile
    {
        return GCST & (1u << 0u);
    }
     ...
     *
     * (read-only) Global Channel status
     */
    inline void get_GCST(bool &CC83ST2, bool &CC82ST2, bool &CC81ST2,
                         bool &CC80ST2, bool &CC83ST1, bool &CC82ST1,
                         bool &CC81ST1, bool &CC80ST1, bool &S3PSS,
                         bool &S3DSS, bool &S3SS, bool &S2PSS, bool &S2DSS,
                         bool &S2SS, bool &S1PSS, bool &S1DSS, bool &S1SS,
                         bool &S0PSS, bool &S0DSS, bool &S0SS) volatile
    {
        uint32_t curr = GCST;
     ...
     */
    inline bool get_GPCHK_PCTS() volatile
    {
        return GPCHK & (1u << 7u);
    }
     ...
     *
     * (read-write) Parity Checker Configuration
     */
    inline void get_GPCHK(uint8_t &PCSEL3, uint8_t &PCSEL2, uint8_t &PCSEL1,
                          uint8_t &PCSEL0, bool &PCST, bool &PCTS,
    ...
    inline void set_GPCHK(uint8_t PCSEL3, uint8_t PCSEL2, uint8_t PCSEL1,
                          uint8_t PCSEL0, bool PCTS, CCU80_GPCHK_PCDS PCDS,
                          CCU80_GPCHK_PISEL PISEL, CCU80_GPCHK_PACS PACS,
                          bool PASE) volatile
    {
        uint32_t curr = GPCHK;
     ...
     *
     * (read-only) Module Identification
     */
