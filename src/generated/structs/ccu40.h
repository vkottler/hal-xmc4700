...
struct [[gnu::packed]] ccu40
{
     ...
     */
    inline CCU40_GCTRL_MSDE get_GCTRL_MSDE()
    {
     ...
     */
    inline CCU40_GCTRL_MSE3 get_GCTRL_MSE3()
    {
     ...
     */
    inline CCU40_GCTRL_MSE2 get_GCTRL_MSE2()
    {
     ...
     */
    inline CCU40_GCTRL_MSE1 get_GCTRL_MSE1()
    {
     ...
     */
    inline CCU40_GCTRL_MSE0 get_GCTRL_MSE0()
    {
     ...
     */
    inline CCU40_GCTRL_SUSCFG get_GCTRL_SUSCFG()
    {
     ...
     */
    inline CCU40_GCTRL_PCIS get_GCTRL_PCIS()
    {
     ...
     */
    inline CCU40_GCTRL_PRBC get_GCTRL_PRBC()
    {
     ...
     */
    inline void get_GCTRL(CCU40_GCTRL_MSDE &MSDE, CCU40_GCTRL_MSE3 &MSE3, CCU40_GCTRL_MSE2 &MSE2, CCU40_GCTRL_MSE1 &MSE1, CCU40_GCTRL_MSE0 &MSE0, CCU40_GCTRL_SUSCFG &SUSCFG, CCU40_GCTRL_PCIS &PCIS, CCU40_GCTRL_PRBC &PRBC)
    {
        uint32_t curr = GCTRL;

        MSDE = CCU40_GCTRL_MSDE((curr >> 14u) & 0b11u);
        MSE3 = CCU40_GCTRL_MSE3(curr & (1u << 13u));
        MSE2 = CCU40_GCTRL_MSE2(curr & (1u << 12u));
        MSE1 = CCU40_GCTRL_MSE1(curr & (1u << 11u));
        MSE0 = CCU40_GCTRL_MSE0(curr & (1u << 10u));
     ...
     */
    inline void set_GCTRL(CCU40_GCTRL_MSDE MSDE, CCU40_GCTRL_MSE3 MSE3, CCU40_GCTRL_MSE2 MSE2, CCU40_GCTRL_MSE1 MSE1, CCU40_GCTRL_MSE0 MSE0, CCU40_GCTRL_SUSCFG SUSCFG, CCU40_GCTRL_PCIS PCIS, CCU40_GCTRL_PRBC PRBC)
    {
        uint32_t curr = GCTRL;
     ...
     * Get GSTAT's PRB bit.
     */
    inline CCU40_GSTAT_PRB get_GSTAT_PRB()
    {
     ...
     * Get GSTAT's S3I bit.
     */
    inline CCU40_GSTAT_S3I get_GSTAT_S3I()
    {
     ...
     * Get GSTAT's S2I bit.
     */
    inline CCU40_GSTAT_S2I get_GSTAT_S2I()
    {
     ...
     * Get GSTAT's S1I bit.
     */
    inline CCU40_GSTAT_S1I get_GSTAT_S1I()
    {
     ...
     * Get GSTAT's S0I bit.
     */
    inline CCU40_GSTAT_S0I get_GSTAT_S0I()
    {
     ...
     */
    inline void get_GSTAT(CCU40_GSTAT_PRB &PRB, CCU40_GSTAT_S3I &S3I, CCU40_GSTAT_S2I &S2I, CCU40_GSTAT_S1I &S1I, CCU40_GSTAT_S0I &S0I)
    {
        uint32_t curr = GSTAT;

        PRB = CCU40_GSTAT_PRB(curr & (1u << 8u));
        S3I = CCU40_GSTAT_S3I(curr & (1u << 3u));
        S2I = CCU40_GSTAT_S2I(curr & (1u << 2u));
        S1I = CCU40_GSTAT_S1I(curr & (1u << 1u));
        S0I = CCU40_GSTAT_S0I(curr & (1u << 0u));
    }
     ...
     */
    inline void set_GIDLS(bool PSIC, bool CPRB, bool SS3I, bool SS2I, bool SS1I, bool SS0I)
    {
        uint32_t curr = GIDLS;
     ...
     */
    inline void set_GIDLC(bool SPRB, bool CS3I, bool CS2I, bool CS1I, bool CS0I)
    {
        uint32_t curr = GIDLC;
     ...
     */
    inline void set_GCSS(bool S3STS, bool S2STS, bool S1STS, bool S0STS, bool S3PSE, bool S3DSE, bool S3SE, bool S2PSE, bool S2DSE, bool S2SE, bool S1PSE, bool S1DSE, bool S1SE, bool S0PSE, bool S0DSE, bool S0SE)
    {
        uint32_t curr = GCSS;
     ...
     */
    inline void set_GCSC(bool S3STC, bool S2STC, bool S1STC, bool S0STC, bool S3PSC, bool S3DSC, bool S3SC, bool S2PSC, bool S2DSC, bool S2SC, bool S1PSC, bool S1DSC, bool S1SC, bool S0PSC, bool S0DSC, bool S0SC)
    {
        uint32_t curr = GCSC;
     ...
     */
    inline CCU40_GCST_S3PSS get_GCST_S3PSS()
    {
     ...
     */
    inline CCU40_GCST_S3DSS get_GCST_S3DSS()
    {
     ...
     * Get GCST's S3SS bit.
     */
    inline CCU40_GCST_S3SS get_GCST_S3SS()
    {
     ...
     */
    inline CCU40_GCST_S2PSS get_GCST_S2PSS()
    {
     ...
     */
    inline CCU40_GCST_S2DSS get_GCST_S2DSS()
    {
     ...
     * Get GCST's S2SS bit.
     */
    inline CCU40_GCST_S2SS get_GCST_S2SS()
    {
     ...
     */
    inline CCU40_GCST_S1PSS get_GCST_S1PSS()
    {
     ...
     */
    inline CCU40_GCST_S1DSS get_GCST_S1DSS()
    {
     ...
     * Get GCST's S1SS bit.
     */
    inline CCU40_GCST_S1SS get_GCST_S1SS()
    {
     ...
     */
    inline CCU40_GCST_S0PSS get_GCST_S0PSS()
    {
     ...
     */
    inline CCU40_GCST_S0DSS get_GCST_S0DSS()
    {
     ...
     * Get GCST's S0SS bit.
     */
    inline CCU40_GCST_S0SS get_GCST_S0SS()
    {
     ...
     */
    inline void get_GCST(bool &CC43ST, bool &CC42ST, bool &CC41ST, bool &CC40ST, CCU40_GCST_S3PSS &S3PSS, CCU40_GCST_S3DSS &S3DSS, CCU40_GCST_S3SS &S3SS, CCU40_GCST_S2PSS &S2PSS, CCU40_GCST_S2DSS &S2DSS, CCU40_GCST_S2SS &S2SS, CCU40_GCST_S1PSS &S1PSS, CCU40_GCST_S1DSS &S1DSS, CCU40_GCST_S1SS &S1SS, CCU40_GCST_S0PSS &S0PSS, CCU40_GCST_S0DSS &S0DSS, CCU40_GCST_S0SS &S0SS)
    {
        uint32_t curr = GCST;
        ...
        S3DSS = CCU40_GCST_S3DSS(curr & (1u << 13u));
        S3SS = CCU40_GCST_S3SS(curr & (1u << 12u));
        S2PSS = CCU40_GCST_S2PSS(curr & (1u << 10u));
        S2DSS = CCU40_GCST_S2DSS(curr & (1u << 9u));
        S2SS = CCU40_GCST_S2SS(curr & (1u << 8u));
        S1PSS = CCU40_GCST_S1PSS(curr & (1u << 6u));
        S1DSS = CCU40_GCST_S1DSS(curr & (1u << 5u));
        S1SS = CCU40_GCST_S1SS(curr & (1u << 4u));
        S0PSS = CCU40_GCST_S0PSS(curr & (1u << 2u));
        S0DSS = CCU40_GCST_S0DSS(curr & (1u << 1u));
        S0SS = CCU40_GCST_S0SS(curr & (1u << 0u));
    }
