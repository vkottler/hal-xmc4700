...
struct [[gnu::packed]] dsd_ch0
{
     ...
     */
    inline void set_MODCFG(bool DWC, DSD_CH0_MODCFG_DIVM DIVM) volatile
    {
        uint32_t curr = MODCFG;
     ...
     * (read-write) Demodulator Input Configuration Register
     */
    inline void set_DICFG(bool SCWC, DSD_CH0_DICFG_STROBE STROBE,
                          DSD_CH0_DICFG_CSRC CSRC, bool TRWC, uint8_t TRSEL,
                          DSD_CH0_DICFG_TSTRMODE TSTRMODE,
                          DSD_CH0_DICFG_ITRMODE ITRMODE, bool DSWC,
                          DSD_CH0_DICFG_DSRC DSRC) volatile
    {
        uint32_t curr = DICFG;
     ...
     * CIC Filter Enable
     */
    inline bool get_FCFGC_CFEN() volatile
    {
        return FCFGC & (1u << 10u);
    }
    ...
    inline void get_FCFGC(uint8_t &CFMDCNT, uint8_t &CFMSV,
                          DSD_CH0_FCFGC_SRGM &SRGM, bool &CFEN,
     ...
     * (read-write) Filter Configuration Register, Main CIC Filter
     */
    inline void set_FCFGC(uint8_t CFMSV, DSD_CH0_FCFGC_SRGM SRGM, bool CFEN,
                          DSD_CH0_FCFGC_CFMC CFMC, uint8_t CFMDF) volatile
    {
        uint32_t curr = FCFGC;
     ...
     * Event Gating
     */
    inline bool get_FCFGA_EGT() volatile
    {
        return FCFGA & (1u << 14u);
    }
     ...
     */
    inline void get_FCFGA(uint8_t &CFADCNT, bool &EGT,
     ...
     * (read-write) Filter Configuration Register, Auxiliary Filter
     */
    inline void set_FCFGA(bool EGT, DSD_CH0_FCFGA_ESEL ESEL,
     ...
     */
    inline bool get_IWCTR_IWS() volatile
    {
        return IWCTR & (1u << 23u);
    }
     ...
     * Integration Enable
     */
    inline bool get_IWCTR_INTEN() volatile
    {
        return IWCTR & (1u << 7u);
    }
     ...
     */
    inline void get_IWCTR(uint8_t &NVALINT, bool &IWS, uint8_t &NVALDIS,
                          uint8_t &REPVAL, uint8_t &REPCNT, bool &INTEN,
     ...
     * (read-write) Integration Window Control Register
     */
    inline void set_IWCTR(uint8_t NVALINT, bool IWS, uint8_t NVALDIS,
                          uint8_t REPVAL) volatile
    {
        uint32_t curr = IWCTR;
     ...
     * Sign Signal Delayed
     */
    inline bool get_RECTCFG_SGND() volatile
    {
        return RECTCFG & (1u << 31u);
    }
     ...
     */
    inline bool get_RECTCFG_SGNCS() volatile
    {
        return RECTCFG & (1u << 30u);
    }
     ...
     * Valid Flag
     */
    inline bool get_RECTCFG_SDVAL() volatile
    {
        return RECTCFG & (1u << 15u);
    }
     ...
     */
    inline bool get_RECTCFG_RFEN() volatile
    {
        return RECTCFG & (1u << 0u);
    }
     ...
     */
    inline void get_RECTCFG(bool &SGND, bool &SGNCS, bool &SDVAL,
                            DSD_CH0_RECTCFG_SSRC &SSRC, bool &RFEN) volatile
    {
        uint32_t curr = RECTCFG;
     ...
     * (read-write) Rectification Configuration Register
     */
    inline void set_RECTCFG(DSD_CH0_RECTCFG_SSRC SSRC, bool RFEN) volatile
    {
        uint32_t curr = RECTCFG;
