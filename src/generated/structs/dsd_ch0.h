...
struct [[gnu::packed]] dsd_ch0
{
     ...
     */
    inline DSD_CH0_MODCFG_DIVM get_MODCFG_DIVM()
    {
     ...
     */
    inline void set_MODCFG(DSD_CH0_MODCFG_DWC DWC, DSD_CH0_MODCFG_DIVM DIVM)
    {
        uint32_t curr = MODCFG;
     ...
     */
    inline DSD_CH0_DICFG_STROBE get_DICFG_STROBE()
    {
     ...
     */
    inline DSD_CH0_DICFG_CSRC get_DICFG_CSRC()
    {
     ...
     */
    inline uint8_t get_DICFG_TRSEL()
    {
     ...
     */
    inline DSD_CH0_DICFG_TSTRMODE get_DICFG_TSTRMODE()
    {
     ...
     */
    inline DSD_CH0_DICFG_ITRMODE get_DICFG_ITRMODE()
    {
     ...
     */
    inline DSD_CH0_DICFG_DSRC get_DICFG_DSRC()
    {
     ...
     */
    inline void get_DICFG(DSD_CH0_DICFG_STROBE &STROBE, DSD_CH0_DICFG_CSRC &CSRC, uint8_t &TRSEL, DSD_CH0_DICFG_TSTRMODE &TSTRMODE, DSD_CH0_DICFG_ITRMODE &ITRMODE, DSD_CH0_DICFG_DSRC &DSRC)
    {
        uint32_t curr = DICFG;
     ...
     */
    inline void set_DICFG(DSD_CH0_DICFG_SCWC SCWC, DSD_CH0_DICFG_STROBE STROBE, DSD_CH0_DICFG_CSRC CSRC, DSD_CH0_DICFG_TRWC TRWC, uint8_t TRSEL, DSD_CH0_DICFG_TSTRMODE TSTRMODE, DSD_CH0_DICFG_ITRMODE ITRMODE, DSD_CH0_DICFG_DSWC DSWC, DSD_CH0_DICFG_DSRC DSRC)
    {
        uint32_t curr = DICFG;
     ...
     */
    inline uint8_t get_FCFGC_CFMDCNT()
    {
     ...
     */
    inline uint8_t get_FCFGC_CFMSV()
    {
     ...
     */
    inline DSD_CH0_FCFGC_SRGM get_FCFGC_SRGM()
    {
     ...
     */
    inline DSD_CH0_FCFGC_CFEN get_FCFGC_CFEN()
    {
     ...
     */
    inline DSD_CH0_FCFGC_CFMC get_FCFGC_CFMC()
    {
     ...
     */
    inline uint8_t get_FCFGC_CFMDF()
    {
     ...
     */
    inline void get_FCFGC(uint8_t &CFMDCNT, uint8_t &CFMSV, DSD_CH0_FCFGC_SRGM &SRGM, DSD_CH0_FCFGC_CFEN &CFEN, DSD_CH0_FCFGC_CFMC &CFMC, uint8_t &CFMDF)
    {
        uint32_t curr = FCFGC;
     ...
     */
    inline void set_FCFGC(uint8_t CFMSV, DSD_CH0_FCFGC_SRGM SRGM, DSD_CH0_FCFGC_CFEN CFEN, DSD_CH0_FCFGC_CFMC CFMC, uint8_t CFMDF)
    {
        uint32_t curr = FCFGC;
     ...
     */
    inline uint8_t get_FCFGA_CFADCNT()
    {
     ...
     * Get FCFGA's EGT bit.
     */
    inline DSD_CH0_FCFGA_EGT get_FCFGA_EGT()
    {
     ...
     */
    inline DSD_CH0_FCFGA_ESEL get_FCFGA_ESEL()
    {
     ...
     */
    inline DSD_CH0_FCFGA_SRGA get_FCFGA_SRGA()
    {
     ...
     */
    inline DSD_CH0_FCFGA_CFAC get_FCFGA_CFAC()
    {
     ...
     */
    inline uint8_t get_FCFGA_CFADF()
    {
     ...
     */
    inline void get_FCFGA(uint8_t &CFADCNT, DSD_CH0_FCFGA_EGT &EGT, DSD_CH0_FCFGA_ESEL &ESEL, DSD_CH0_FCFGA_SRGA &SRGA, DSD_CH0_FCFGA_CFAC &CFAC, uint8_t &CFADF)
    {
        uint32_t curr = FCFGA;
     ...
     */
    inline void set_FCFGA(DSD_CH0_FCFGA_EGT EGT, DSD_CH0_FCFGA_ESEL ESEL, DSD_CH0_FCFGA_SRGA SRGA, DSD_CH0_FCFGA_CFAC CFAC, uint8_t CFADF)
    {
        uint32_t curr = FCFGA;
     ...
     */
    inline uint8_t get_IWCTR_NVALINT()
    {
     ...
     * Get IWCTR's IWS bit.
     */
    inline DSD_CH0_IWCTR_IWS get_IWCTR_IWS()
    {
     ...
     */
    inline uint8_t get_IWCTR_NVALDIS()
    {
     ...
     */
    inline uint8_t get_IWCTR_REPVAL()
    {
     ...
     */
    inline uint8_t get_IWCTR_REPCNT()
    {
     ...
     */
    inline DSD_CH0_IWCTR_INTEN get_IWCTR_INTEN()
    {
     ...
     */
    inline uint8_t get_IWCTR_NVALCNT()
    {
     ...
     */
    inline void get_IWCTR(uint8_t &NVALINT, DSD_CH0_IWCTR_IWS &IWS, uint8_t &NVALDIS, uint8_t &REPVAL, uint8_t &REPCNT, DSD_CH0_IWCTR_INTEN &INTEN, uint8_t &NVALCNT)
    {
        uint32_t curr = IWCTR;
     ...
     */
    inline void set_IWCTR(uint8_t NVALINT, DSD_CH0_IWCTR_IWS IWS, uint8_t NVALDIS, uint8_t REPVAL)
    {
        uint32_t curr = IWCTR;
     ...
     */
    inline uint16_t get_BOUNDSEL_BOUNDARYU()
    {
     ...
     */
    inline uint16_t get_BOUNDSEL_BOUNDARYL()
    {
     ...
     */
    inline void get_BOUNDSEL(uint16_t &BOUNDARYU, uint16_t &BOUNDARYL)
    {
        uint32_t curr = BOUNDSEL;
     ...
     */
    inline void set_BOUNDSEL(uint16_t BOUNDARYU, uint16_t BOUNDARYL)
    {
        uint32_t curr = BOUNDSEL;
     ...
     */
    inline uint16_t get_RESM_RESULT()
    {
     ...
     */
    inline uint16_t get_OFFM_OFFSET()
    {
     ...
     */
    inline uint16_t get_RESA_RESULT()
    {
     ...
     */
    inline uint8_t get_TSTMP_NVALCNT()
    {
     ...
     */
    inline uint8_t get_TSTMP_CFMDCNT()
    {
     ...
     */
    inline uint16_t get_TSTMP_RESULT()
    {
     ...
     */
    inline void get_TSTMP(uint8_t &NVALCNT, uint8_t &CFMDCNT, uint16_t &RESULT)
    {
        uint32_t curr = TSTMP;
     ...
     */
    inline uint8_t get_CGSYNC_SDNEG()
    {
     ...
     */
    inline uint8_t get_CGSYNC_SDPOS()
    {
     ...
     */
    inline uint8_t get_CGSYNC_SDCAP()
    {
     ...
     */
    inline uint8_t get_CGSYNC_SDCOUNT()
    {
     ...
     */
    inline void get_CGSYNC(uint8_t &SDNEG, uint8_t &SDPOS, uint8_t &SDCAP, uint8_t &SDCOUNT)
    {
        uint32_t curr = CGSYNC;
     ...
     */
    inline void set_CGSYNC(uint8_t SDNEG, uint8_t SDPOS)
    {
        uint32_t curr = CGSYNC;
     ...
     */
    inline DSD_CH0_RECTCFG_SGND get_RECTCFG_SGND()
    {
     ...
     */
    inline DSD_CH0_RECTCFG_SGNCS get_RECTCFG_SGNCS()
    {
     ...
     */
    inline DSD_CH0_RECTCFG_SDVAL get_RECTCFG_SDVAL()
    {
     ...
     */
    inline DSD_CH0_RECTCFG_SSRC get_RECTCFG_SSRC()
    {
     ...
     */
    inline DSD_CH0_RECTCFG_RFEN get_RECTCFG_RFEN()
    {
     ...
     */
    inline void get_RECTCFG(DSD_CH0_RECTCFG_SGND &SGND, DSD_CH0_RECTCFG_SGNCS &SGNCS, DSD_CH0_RECTCFG_SDVAL &SDVAL, DSD_CH0_RECTCFG_SSRC &SSRC, DSD_CH0_RECTCFG_RFEN &RFEN)
    {
        uint32_t curr = RECTCFG;
     ...
     */
    inline void set_RECTCFG(DSD_CH0_RECTCFG_SSRC SSRC, DSD_CH0_RECTCFG_RFEN RFEN)
    {
        uint32_t curr = RECTCFG;
