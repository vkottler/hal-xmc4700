...
struct [[gnu::packed]] dac
{
     ...
     */
    inline void get_ID(uint16_t &MODN, uint8_t &MODT, uint8_t &MODR)
    {
        uint32_t curr = ID;
     ...
     */
    inline DAC_DAC0CFG0_RUN get_DAC0CFG0_RUN()
    {
     ...
     */
    inline DAC_DAC0CFG0_SREN get_DAC0CFG0_SREN()
    {
     ...
     */
    inline DAC_DAC0CFG0_SIGNEN get_DAC0CFG0_SIGNEN()
    {
     ...
     */
    inline DAC_DAC0CFG0_NEGATE get_DAC0CFG0_NEGATE()
    {
     ...
     */
    inline DAC_DAC0CFG0_FIFOFUL get_DAC0CFG0_FIFOFUL()
    {
     ...
     */
    inline DAC_DAC0CFG0_FIFOEMP get_DAC0CFG0_FIFOEMP()
    {
     ...
     */
    inline uint8_t get_DAC0CFG0_FIFOIND()
    {
     ...
     */
    inline DAC_DAC0CFG0_SIGN get_DAC0CFG0_SIGN()
    {
     ...
     */
    inline DAC_DAC0CFG0_MODE get_DAC0CFG0_MODE()
    {
     ...
     */
    inline uint32_t get_DAC0CFG0_FREQ()
    {
     ...
     */
    inline void get_DAC0CFG0(DAC_DAC0CFG0_RUN &RUN, DAC_DAC0CFG0_SREN &SREN, DAC_DAC0CFG0_SIGNEN &SIGNEN, DAC_DAC0CFG0_NEGATE &NEGATE, DAC_DAC0CFG0_FIFOFUL &FIFOFUL, DAC_DAC0CFG0_FIFOEMP &FIFOEMP, uint8_t &FIFOIND, DAC_DAC0CFG0_SIGN &SIGN, DAC_DAC0CFG0_MODE &MODE, uint32_t &FREQ)
    {
        uint32_t curr = DAC0CFG0;

        RUN = DAC_DAC0CFG0_RUN(curr & (1u << 31u));
        SREN = DAC_DAC0CFG0_SREN(curr & (1u << 30u));
        SIGNEN = DAC_DAC0CFG0_SIGNEN(curr & (1u << 29u));
     ...
     */
    inline void set_DAC0CFG0(DAC_DAC0CFG0_SREN SREN, DAC_DAC0CFG0_SIGNEN SIGNEN, DAC_DAC0CFG0_NEGATE NEGATE, DAC_DAC0CFG0_SIGN SIGN, DAC_DAC0CFG0_MODE MODE, uint32_t FREQ)
    {
        uint32_t curr = DAC0CFG0;
     ...
     */
    inline uint8_t get_DAC0CFG1_REFCFGL()
    {
     ...
     */
    inline DAC_DAC0CFG1_ANAEN get_DAC0CFG1_ANAEN()
    {
     ...
     */
    inline uint8_t get_DAC0CFG1_ANACFG()
    {
     ...
     */
    inline DAC_DAC0CFG1_TRIGMOD get_DAC0CFG1_TRIGMOD()
    {
     ...
     */
    inline bool get_DAC0CFG1_SWTRIG()
    {
     ...
     */
    inline DAC_DAC0CFG1_DATMOD get_DAC0CFG1_DATMOD()
    {
     ...
     */
    inline uint8_t get_DAC0CFG1_TRIGSEL()
    {
     ...
     */
    inline uint8_t get_DAC0CFG1_OFFS()
    {
     ...
     */
    inline DAC_DAC0CFG1_MULDIV get_DAC0CFG1_MULDIV()
    {
     ...
     */
    inline DAC_DAC0CFG1_SCALE get_DAC0CFG1_SCALE()
    {
     ...
     */
    inline void get_DAC0CFG1(uint8_t &REFCFGL, DAC_DAC0CFG1_ANAEN &ANAEN, uint8_t &ANACFG, DAC_DAC0CFG1_TRIGMOD &TRIGMOD, bool &SWTRIG, DAC_DAC0CFG1_DATMOD &DATMOD, uint8_t &TRIGSEL, uint8_t &OFFS, DAC_DAC0CFG1_MULDIV &MULDIV, DAC_DAC0CFG1_SCALE &SCALE)
    {
        uint32_t curr = DAC0CFG1;
     ...
     */
    inline void set_DAC0CFG1(uint8_t REFCFGL, DAC_DAC0CFG1_ANAEN ANAEN, uint8_t ANACFG, DAC_DAC0CFG1_TRIGMOD TRIGMOD, bool SWTRIG, DAC_DAC0CFG1_DATMOD DATMOD, uint8_t TRIGSEL, uint8_t OFFS, DAC_DAC0CFG1_MULDIV MULDIV, DAC_DAC0CFG1_SCALE SCALE)
    {
        uint32_t curr = DAC0CFG1;
     ...
     */
    inline DAC_DAC1CFG0_RUN get_DAC1CFG0_RUN()
    {
     ...
     */
    inline DAC_DAC1CFG0_SREN get_DAC1CFG0_SREN()
    {
     ...
     */
    inline DAC_DAC1CFG0_SIGNEN get_DAC1CFG0_SIGNEN()
    {
     ...
     */
    inline DAC_DAC1CFG0_NEGATE get_DAC1CFG0_NEGATE()
    {
     ...
     */
    inline DAC_DAC1CFG0_FIFOFUL get_DAC1CFG0_FIFOFUL()
    {
     ...
     */
    inline DAC_DAC1CFG0_FIFOEMP get_DAC1CFG0_FIFOEMP()
    {
     ...
     */
    inline uint8_t get_DAC1CFG0_FIFOIND()
    {
     ...
     */
    inline DAC_DAC1CFG0_SIGN get_DAC1CFG0_SIGN()
    {
     ...
     */
    inline DAC_DAC1CFG0_MODE get_DAC1CFG0_MODE()
    {
     ...
     */
    inline uint32_t get_DAC1CFG0_FREQ()
    {
     ...
     */
    inline void get_DAC1CFG0(DAC_DAC1CFG0_RUN &RUN, DAC_DAC1CFG0_SREN &SREN, DAC_DAC1CFG0_SIGNEN &SIGNEN, DAC_DAC1CFG0_NEGATE &NEGATE, DAC_DAC1CFG0_FIFOFUL &FIFOFUL, DAC_DAC1CFG0_FIFOEMP &FIFOEMP, uint8_t &FIFOIND, DAC_DAC1CFG0_SIGN &SIGN, DAC_DAC1CFG0_MODE &MODE, uint32_t &FREQ)
    {
        uint32_t curr = DAC1CFG0;

        RUN = DAC_DAC1CFG0_RUN(curr & (1u << 31u));
        SREN = DAC_DAC1CFG0_SREN(curr & (1u << 30u));
        SIGNEN = DAC_DAC1CFG0_SIGNEN(curr & (1u << 29u));
        NEGATE = DAC_DAC1CFG0_NEGATE(curr & (1u << 28u));
        FIFOFUL = DAC_DAC1CFG0_FIFOFUL(curr & (1u << 27u));
        FIFOEMP = DAC_DAC1CFG0_FIFOEMP(curr & (1u << 26u));
        FIFOIND = (curr >> 24u) & 0b11u;
        SIGN = DAC_DAC1CFG0_SIGN(curr & (1u << 23u));
        MODE = DAC_DAC1CFG0_MODE((curr >> 20u) & 0b111u);
        FREQ = (curr >> 0u) & 0b11111111111111111111u;
    }
     ...
     */
    inline void set_DAC1CFG0(DAC_DAC1CFG0_SREN SREN, DAC_DAC1CFG0_SIGNEN SIGNEN, DAC_DAC1CFG0_NEGATE NEGATE, DAC_DAC1CFG0_SIGN SIGN, DAC_DAC1CFG0_MODE MODE, uint32_t FREQ)
    {
        uint32_t curr = DAC1CFG0;
     ...
     */
    inline uint8_t get_DAC1CFG1_REFCFGH()
    {
     ...
     */
    inline DAC_DAC1CFG1_ANAEN get_DAC1CFG1_ANAEN()
    {
     ...
     */
    inline uint8_t get_DAC1CFG1_ANACFG()
    {
     ...
     */
    inline DAC_DAC1CFG1_TRIGMOD get_DAC1CFG1_TRIGMOD()
    {
     ...
     */
    inline bool get_DAC1CFG1_SWTRIG()
    {
     ...
     */
    inline uint8_t get_DAC1CFG1_TRIGSEL()
    {
     ...
     */
    inline uint8_t get_DAC1CFG1_OFFS()
    {
     ...
     */
    inline DAC_DAC1CFG1_MULDIV get_DAC1CFG1_MULDIV()
    {
     ...
     */
    inline DAC_DAC1CFG1_SCALE get_DAC1CFG1_SCALE()
    {
     ...
     */
    inline void get_DAC1CFG1(uint8_t &REFCFGH, DAC_DAC1CFG1_ANAEN &ANAEN, uint8_t &ANACFG, DAC_DAC1CFG1_TRIGMOD &TRIGMOD, bool &SWTRIG, uint8_t &TRIGSEL, uint8_t &OFFS, DAC_DAC1CFG1_MULDIV &MULDIV, DAC_DAC1CFG1_SCALE &SCALE)
    {
        uint32_t curr = DAC1CFG1;
        ...
        ANACFG = (curr >> 19u) & 0b11111u;
        TRIGMOD = DAC_DAC1CFG1_TRIGMOD((curr >> 17u) & 0b11u);
        SWTRIG = curr & (1u << 16u);
        TRIGSEL = (curr >> 12u) & 0b111u;
        OFFS = (curr >> 4u) & 0b11111111u;
        MULDIV = DAC_DAC1CFG1_MULDIV(curr & (1u << 3u));
        SCALE = DAC_DAC1CFG1_SCALE((curr >> 0u) & 0b111u);
    }

    /**
     * Set all of DAC1CFG1's bit fields.
     */
    inline void set_DAC1CFG1(uint8_t REFCFGH, DAC_DAC1CFG1_ANAEN ANAEN, uint8_t ANACFG, DAC_DAC1CFG1_TRIGMOD TRIGMOD, bool SWTRIG, uint8_t TRIGSEL, uint8_t OFFS, DAC_DAC1CFG1_MULDIV MULDIV, DAC_DAC1CFG1_SCALE SCALE)
    {
        uint32_t curr = DAC1CFG1;
     ...
     */
    inline uint16_t get_DAC0DATA_DATA0()
    {
     ...
     */
    inline uint16_t get_DAC1DATA_DATA1()
    {
     ...
     */
    inline uint16_t get_DAC01DATA_DATA1()
    {
     ...
     */
    inline uint16_t get_DAC01DATA_DATA0()
    {
     ...
     */
    inline void get_DAC01DATA(uint16_t &DATA1, uint16_t &DATA0)
    {
        uint32_t curr = DAC01DATA;
     ...
     */
    inline void set_DAC01DATA(uint16_t DATA1, uint16_t DATA0)
    {
        uint32_t curr = DAC01DATA;
     ...
     */
    inline uint8_t get_DAC0PATL_PAT5()
    {
     ...
     */
    inline uint8_t get_DAC0PATL_PAT4()
    {
     ...
     */
    inline uint8_t get_DAC0PATL_PAT3()
    {
     ...
     */
    inline uint8_t get_DAC0PATL_PAT2()
    {
     ...
     */
    inline uint8_t get_DAC0PATL_PAT1()
    {
     ...
     */
    inline uint8_t get_DAC0PATL_PAT0()
    {
     ...
     */
    inline void get_DAC0PATL(uint8_t &PAT5, uint8_t &PAT4, uint8_t &PAT3, uint8_t &PAT2, uint8_t &PAT1, uint8_t &PAT0)
    {
        uint32_t curr = DAC0PATL;
     ...
     */
    inline void set_DAC0PATL(uint8_t PAT5, uint8_t PAT4, uint8_t PAT3, uint8_t PAT2, uint8_t PAT1, uint8_t PAT0)
    {
        uint32_t curr = DAC0PATL;
     ...
     */
    inline uint8_t get_DAC0PATH_PAT8()
    {
     ...
     */
    inline uint8_t get_DAC0PATH_PAT7()
    {
     ...
     */
    inline uint8_t get_DAC0PATH_PAT6()
    {
     ...
     */
    inline void get_DAC0PATH(uint8_t &PAT8, uint8_t &PAT7, uint8_t &PAT6)
    {
        uint32_t curr = DAC0PATH;
     ...
     */
    inline void set_DAC0PATH(uint8_t PAT8, uint8_t PAT7, uint8_t PAT6)
    {
        uint32_t curr = DAC0PATH;
     ...
     */
    inline uint8_t get_DAC1PATL_PAT5()
    {
     ...
     */
    inline uint8_t get_DAC1PATL_PAT4()
    {
     ...
     */
    inline uint8_t get_DAC1PATL_PAT3()
    {
     ...
     */
    inline uint8_t get_DAC1PATL_PAT2()
    {
     ...
     */
    inline uint8_t get_DAC1PATL_PAT1()
    {
     ...
     */
    inline uint8_t get_DAC1PATL_PAT0()
    {
     ...
     */
    inline void get_DAC1PATL(uint8_t &PAT5, uint8_t &PAT4, uint8_t &PAT3, uint8_t &PAT2, uint8_t &PAT1, uint8_t &PAT0)
    {
        uint32_t curr = DAC1PATL;
     ...
     */
    inline void set_DAC1PATL(uint8_t PAT5, uint8_t PAT4, uint8_t PAT3, uint8_t PAT2, uint8_t PAT1, uint8_t PAT0)
    {
        uint32_t curr = DAC1PATL;
     ...
     */
    inline uint8_t get_DAC1PATH_PAT8()
    {
     ...
     */
    inline uint8_t get_DAC1PATH_PAT7()
    {
     ...
     */
    inline uint8_t get_DAC1PATH_PAT6()
    {
     ...
     */
    inline void get_DAC1PATH(uint8_t &PAT8, uint8_t &PAT7, uint8_t &PAT6)
    {
        uint32_t curr = DAC1PATH;
     ...
     */
    inline void set_DAC1PATH(uint8_t PAT8, uint8_t PAT7, uint8_t PAT6)
    {
        uint32_t curr = DAC1PATH;
