...
struct [[gnu::packed]] dsd
{
     ...
     * Get CLC's EDIS bit.
     */
    inline DSD_CLC_EDIS get_CLC_EDIS()
    {
     ...
     * Get CLC's DISS bit.
     */
    inline DSD_CLC_DISS get_CLC_DISS()
    {
     ...
     * Get CLC's DISR bit.
     */
    inline DSD_CLC_DISR get_CLC_DISR()
    {
     ...
     */
    inline void get_CLC(DSD_CLC_EDIS &EDIS, DSD_CLC_DISS &DISS, DSD_CLC_DISR &DISR)
    {
        uint32_t curr = CLC;
     ...
     */
    inline void set_CLC(DSD_CLC_EDIS EDIS, DSD_CLC_DISR DISR)
    {
        uint32_t curr = CLC;
     ...
     */
    inline DSD_OCS_SUSSTA get_OCS_SUSSTA()
    {
     ...
     * Get OCS's SUS field.
     */
    inline DSD_OCS_SUS get_OCS_SUS()
    {
     ...
     */
    inline void get_OCS(DSD_OCS_SUSSTA &SUSSTA, DSD_OCS_SUS &SUS)
    {
        uint32_t curr = OCS;
     ...
     */
    inline void set_OCS(bool SUS_P, DSD_OCS_SUS SUS)
    {
        uint32_t curr = OCS;
     ...
     */
    inline DSD_GLOBCFG_MCSEL get_GLOBCFG_MCSEL()
    {
     ...
     */
    inline DSD_GLOBRC_CH3RUN get_GLOBRC_CH3RUN()
    {
     ...
     */
    inline DSD_GLOBRC_CH2RUN get_GLOBRC_CH2RUN()
    {
     ...
     */
    inline DSD_GLOBRC_CH1RUN get_GLOBRC_CH1RUN()
    {
     ...
     */
    inline DSD_GLOBRC_CH0RUN get_GLOBRC_CH0RUN()
    {
     ...
     */
    inline void get_GLOBRC(DSD_GLOBRC_CH3RUN &CH3RUN, DSD_GLOBRC_CH2RUN &CH2RUN, DSD_GLOBRC_CH1RUN &CH1RUN, DSD_GLOBRC_CH0RUN &CH0RUN)
    {
        uint32_t curr = GLOBRC;

        CH3RUN = DSD_GLOBRC_CH3RUN(curr & (1u << 3u));
        CH2RUN = DSD_GLOBRC_CH2RUN(curr & (1u << 2u));
        CH1RUN = DSD_GLOBRC_CH1RUN(curr & (1u << 1u));
        CH0RUN = DSD_GLOBRC_CH0RUN(curr & (1u << 0u));
    }

    /**
     * Set all of GLOBRC's bit fields.
     */
    inline void set_GLOBRC(DSD_GLOBRC_CH3RUN CH3RUN, DSD_GLOBRC_CH2RUN CH2RUN, DSD_GLOBRC_CH1RUN CH1RUN, DSD_GLOBRC_CH0RUN CH0RUN)
    {
        uint32_t curr = GLOBRC;
     ...
     */
    inline DSD_CGCFG_SGNCG get_CGCFG_SGNCG()
    {
     ...
     */
    inline DSD_CGCFG_STEPD get_CGCFG_STEPD()
    {
     ...
     */
    inline DSD_CGCFG_STEPS get_CGCFG_STEPS()
    {
     ...
     */
    inline uint8_t get_CGCFG_STEPCOUNT()
    {
     ...
     */
    inline uint8_t get_CGCFG_BITCOUNT()
    {
     ...
     * Get CGCFG's RUN bit.
     */
    inline DSD_CGCFG_RUN get_CGCFG_RUN()
    {
     ...
     */
    inline DSD_CGCFG_DIVCG get_CGCFG_DIVCG()
    {
     ...
     */
    inline DSD_CGCFG_SIGPOL get_CGCFG_SIGPOL()
    {
     ...
     */
    inline DSD_CGCFG_BREV get_CGCFG_BREV()
    {
     ...
     */
    inline DSD_CGCFG_CGMOD get_CGCFG_CGMOD()
    {
     ...
     */
    inline void get_CGCFG(DSD_CGCFG_SGNCG &SGNCG, DSD_CGCFG_STEPD &STEPD, DSD_CGCFG_STEPS &STEPS, uint8_t &STEPCOUNT, uint8_t &BITCOUNT, DSD_CGCFG_RUN &RUN, DSD_CGCFG_DIVCG &DIVCG, DSD_CGCFG_SIGPOL &SIGPOL, DSD_CGCFG_BREV &BREV, DSD_CGCFG_CGMOD &CGMOD)
    {
        uint32_t curr = CGCFG;
     ...
     */
    inline void set_CGCFG(DSD_CGCFG_DIVCG DIVCG, DSD_CGCFG_SIGPOL SIGPOL, DSD_CGCFG_BREV BREV, DSD_CGCFG_CGMOD CGMOD)
    {
        uint32_t curr = CGCFG;
     ...
     */
    inline DSD_EVFLAG_ALEV3 get_EVFLAG_ALEV3()
    {
     ...
     */
    inline DSD_EVFLAG_ALEV2 get_EVFLAG_ALEV2()
    {
     ...
     */
    inline DSD_EVFLAG_ALEV1 get_EVFLAG_ALEV1()
    {
     ...
     */
    inline DSD_EVFLAG_ALEV0 get_EVFLAG_ALEV0()
    {
     ...
     */
    inline DSD_EVFLAG_RESEV3 get_EVFLAG_RESEV3()
    {
     ...
     */
    inline DSD_EVFLAG_RESEV2 get_EVFLAG_RESEV2()
    {
     ...
     */
    inline DSD_EVFLAG_RESEV1 get_EVFLAG_RESEV1()
    {
     ...
     */
    inline DSD_EVFLAG_RESEV0 get_EVFLAG_RESEV0()
    {
     ...
     */
    inline void get_EVFLAG(DSD_EVFLAG_ALEV3 &ALEV3, DSD_EVFLAG_ALEV2 &ALEV2, DSD_EVFLAG_ALEV1 &ALEV1, DSD_EVFLAG_ALEV0 &ALEV0, DSD_EVFLAG_RESEV3 &RESEV3, DSD_EVFLAG_RESEV2 &RESEV2, DSD_EVFLAG_RESEV1 &RESEV1, DSD_EVFLAG_RESEV0 &RESEV0)
    {
        uint32_t curr = EVFLAG;

        ALEV3 = DSD_EVFLAG_ALEV3(curr & (1u << 19u));
        ALEV2 = DSD_EVFLAG_ALEV2(curr & (1u << 18u));
        ALEV1 = DSD_EVFLAG_ALEV1(curr & (1u << 17u));
        ALEV0 = DSD_EVFLAG_ALEV0(curr & (1u << 16u));
        RESEV3 = DSD_EVFLAG_RESEV3(curr & (1u << 3u));
        RESEV2 = DSD_EVFLAG_RESEV2(curr & (1u << 2u));
        RESEV1 = DSD_EVFLAG_RESEV1(curr & (1u << 1u));
        RESEV0 = DSD_EVFLAG_RESEV0(curr & (1u << 0u));
    }

    /**
     * Set all of EVFLAG's bit fields.
     */
    inline void set_EVFLAG(DSD_EVFLAG_ALEV3 ALEV3, DSD_EVFLAG_ALEV2 ALEV2, DSD_EVFLAG_ALEV1 ALEV1, DSD_EVFLAG_ALEV0 ALEV0, DSD_EVFLAG_RESEV3 RESEV3, DSD_EVFLAG_RESEV2 RESEV2, DSD_EVFLAG_RESEV1 RESEV1, DSD_EVFLAG_RESEV0 RESEV0)
    {
        uint32_t curr = EVFLAG;
     ...
     */
    inline void set_EVFLAGCLR(DSD_EVFLAGCLR_ALEC3 ALEC3, DSD_EVFLAGCLR_ALEC2 ALEC2, DSD_EVFLAGCLR_ALEC1 ALEC1, DSD_EVFLAGCLR_ALEC0 ALEC0, DSD_EVFLAGCLR_RESEC3 RESEC3, DSD_EVFLAGCLR_RESEC2 RESEC2, DSD_EVFLAGCLR_RESEC1 RESEC1, DSD_EVFLAGCLR_RESEC0 RESEC0)
    {
