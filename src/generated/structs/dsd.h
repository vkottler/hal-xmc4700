...
#include "../enums/DSD_DICFG_CSRC.h"
#include "../enums/DSD_DICFG_DSRC.h"
#include "../enums/DSD_DICFG_DSWC.h"
#include "../enums/DSD_DICFG_ITRMODE.h"
#include "../enums/DSD_DICFG_SCWC.h"
#include "../enums/DSD_DICFG_STROBE.h"
#include "../enums/DSD_DICFG_TRWC.h"
#include "../enums/DSD_DICFG_TSTRMODE.h"
#include "../enums/DSD_FCFGA_CFAC.h"
#include "../enums/DSD_FCFGA_EGT.h"
#include "../enums/DSD_FCFGA_ESEL.h"
#include "../enums/DSD_FCFGA_SRGA.h"
#include "../enums/DSD_FCFGC_CFEN.h"
#include "../enums/DSD_FCFGC_CFMC.h"
#include "../enums/DSD_FCFGC_SRGM.h"
#include "../enums/DSD_IWCTR_INTEN.h"
#include "../enums/DSD_IWCTR_IWS.h"
#include "../enums/DSD_MODCFG_DIVM.h"
#include "../enums/DSD_MODCFG_DWC.h"
#include "../enums/DSD_RECTCFG_RFEN.h"
#include "../enums/DSD_RECTCFG_SDVAL.h"
#include "../enums/DSD_RECTCFG_SGNCS.h"
#include "../enums/DSD_RECTCFG_SGND.h"
#include "../enums/DSD_RECTCFG_SSRC.h"
...
struct [[gnu::packed]] dsd
{
    ...
    static constexpr std::size_t size = 172; /*!< dsd's size in bytes. */
     ...
     */
    DSD_MODCFG_DIVM get_MODCFG_DIVM()
    {
        return DSD_MODCFG_DIVM((MODCFG >> 16u) & 0b1111u);
    }

    /**
     * Set MODCFG's DIVM field.
     */
    inline void set_MODCFG_DIVM(DSD_MODCFG_DIVM value)
    {
     ...
     */
    DSD_DICFG_STROBE get_DICFG_STROBE()
    {
        return DSD_DICFG_STROBE((DICFG >> 20u) & 0b1111u);
    }

    /**
     * Set DICFG's STROBE field.
     */
    inline void set_DICFG_STROBE(DSD_DICFG_STROBE value)
    {
        uint32_t curr = DICFG;
     ...
     */
    DSD_DICFG_CSRC get_DICFG_CSRC()
    {
        return DSD_DICFG_CSRC((DICFG >> 16u) & 0b1111u);
    }

    /**
     * Set DICFG's CSRC field.
     */
    inline void set_DICFG_CSRC(DSD_DICFG_CSRC value)
    {
        uint32_t curr = DICFG;
     ...
     */
    DSD_DICFG_TSTRMODE get_DICFG_TSTRMODE()
    {
        return DSD_DICFG_TSTRMODE((DICFG >> 10u) & 0b11u);
    }

    /**
     * Set DICFG's TSTRMODE field.
     */
    inline void set_DICFG_TSTRMODE(DSD_DICFG_TSTRMODE value)
    {
        uint32_t curr = DICFG;
     ...
     */
    DSD_DICFG_ITRMODE get_DICFG_ITRMODE()
    {
        return DSD_DICFG_ITRMODE((DICFG >> 8u) & 0b11u);
    }

    /**
     * Set DICFG's ITRMODE field.
     */
    inline void set_DICFG_ITRMODE(DSD_DICFG_ITRMODE value)
    {
        uint32_t curr = DICFG;
     ...
     */
    DSD_DICFG_DSRC get_DICFG_DSRC()
    {
        return DSD_DICFG_DSRC((DICFG >> 0u) & 0b1111u);
    }

    /**
     * Set DICFG's DSRC field.
     */
    inline void set_DICFG_DSRC(DSD_DICFG_DSRC value)
    {
        uint32_t curr = DICFG;
     ...
     */
    DSD_FCFGC_SRGM get_FCFGC_SRGM()
    {
        return DSD_FCFGC_SRGM((FCFGC >> 14u) & 0b11u);
    }

    /**
     * Set FCFGC's SRGM field.
     */
    inline void set_FCFGC_SRGM(DSD_FCFGC_SRGM value)
    {
        uint32_t curr = FCFGC;
     ...
     */
    DSD_FCFGC_CFEN get_FCFGC_CFEN()
    {
        return DSD_FCFGC_CFEN(FCFGC & (1u << 10u));
    }
     ...
     */
    DSD_FCFGC_CFMC get_FCFGC_CFMC()
    {
        return DSD_FCFGC_CFMC((FCFGC >> 8u) & 0b11u);
    }

    /**
     * Set FCFGC's CFMC field.
     */
    inline void set_FCFGC_CFMC(DSD_FCFGC_CFMC value)
    {
        uint32_t curr = FCFGC;
     ...
     * Get FCFGA's EGT bit.
     */
    DSD_FCFGA_EGT get_FCFGA_EGT()
    {
        return DSD_FCFGA_EGT(FCFGA & (1u << 14u));
    }
     ...
     */
    DSD_FCFGA_ESEL get_FCFGA_ESEL()
    {
        return DSD_FCFGA_ESEL((FCFGA >> 12u) & 0b11u);
    }

    /**
     * Set FCFGA's ESEL field.
     */
    inline void set_FCFGA_ESEL(DSD_FCFGA_ESEL value)
    {
        uint32_t curr = FCFGA;
     ...
     */
    DSD_FCFGA_SRGA get_FCFGA_SRGA()
    {
        return DSD_FCFGA_SRGA((FCFGA >> 10u) & 0b11u);
    }

    /**
     * Set FCFGA's SRGA field.
     */
    inline void set_FCFGA_SRGA(DSD_FCFGA_SRGA value)
    {
        uint32_t curr = FCFGA;
     ...
     */
    DSD_FCFGA_CFAC get_FCFGA_CFAC()
    {
        return DSD_FCFGA_CFAC((FCFGA >> 8u) & 0b11u);
    }

    /**
     * Set FCFGA's CFAC field.
     */
    inline void set_FCFGA_CFAC(DSD_FCFGA_CFAC value)
    {
        uint32_t curr = FCFGA;
     ...
     * Get IWCTR's IWS bit.
     */
    DSD_IWCTR_IWS get_IWCTR_IWS()
    {
        return DSD_IWCTR_IWS(IWCTR & (1u << 23u));
    }
     ...
     */
    DSD_IWCTR_INTEN get_IWCTR_INTEN()
    {
        return DSD_IWCTR_INTEN(IWCTR & (1u << 7u));
    }
     ...
     */
    DSD_RECTCFG_SGND get_RECTCFG_SGND()
    {
        return DSD_RECTCFG_SGND(RECTCFG & (1u << 31u));
    }

    /**
     * Get RECTCFG's SGNCS bit.
     */
    DSD_RECTCFG_SGNCS get_RECTCFG_SGNCS()
    {
        return DSD_RECTCFG_SGNCS(RECTCFG & (1u << 30u));
    }

    /**
     * Get RECTCFG's SDVAL bit.
     */
    DSD_RECTCFG_SDVAL get_RECTCFG_SDVAL()
    {
        return DSD_RECTCFG_SDVAL(RECTCFG & (1u << 15u));
    }

    /**
     * Get RECTCFG's SSRC field.
     */
    DSD_RECTCFG_SSRC get_RECTCFG_SSRC()
    {
        return DSD_RECTCFG_SSRC((RECTCFG >> 4u) & 0b11u);
    }

    /**
     * Set RECTCFG's SSRC field.
     */
    inline void set_RECTCFG_SSRC(DSD_RECTCFG_SSRC value)
    {
     ...
     */
    DSD_RECTCFG_RFEN get_RECTCFG_RFEN()
    {
        return DSD_RECTCFG_RFEN(RECTCFG & (1u << 0u));
    }
...
static volatile dsd *const DSD_CH0 = reinterpret_cast<dsd *>(0x40008100);

static volatile dsd *const DSD = reinterpret_cast<dsd *>(0x40008000);

static volatile dsd *const DSD_CH1 = reinterpret_cast<dsd *>(0x40008200);

static volatile dsd *const DSD_CH2 = reinterpret_cast<dsd *>(0x40008300);

static volatile dsd *const DSD_CH3 = reinterpret_cast<dsd *>(0x40008400);
