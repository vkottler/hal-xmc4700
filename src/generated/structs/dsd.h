...
struct [[gnu::packed]] dsd
{
     ...
     */
    inline void get_CLC(DSD_CLC_EDIS &EDIS, DSD_CLC_DISS &DISS, DSD_CLC_DISR &DISR) volatile
    {
        uint32_t curr = CLC;
     ...
     */
    inline DSD_GLOBRC_CH2RUN get_GLOBRC_CH2RUN() volatile
    {
     ...
     */
    inline DSD_GLOBRC_CH1RUN get_GLOBRC_CH1RUN() volatile
    {
     ...
     */
    inline DSD_GLOBRC_CH0RUN get_GLOBRC_CH0RUN() volatile
    {
     ...
     */
    inline void get_GLOBRC(DSD_GLOBRC_CH3RUN &CH3RUN, DSD_GLOBRC_CH2RUN &CH2RUN, DSD_GLOBRC_CH1RUN &CH1RUN, DSD_GLOBRC_CH0RUN &CH0RUN) volatile
    {
     ...
     */
    inline void set_GLOBRC(DSD_GLOBRC_CH3RUN CH3RUN, DSD_GLOBRC_CH2RUN CH2RUN, DSD_GLOBRC_CH1RUN CH1RUN, DSD_GLOBRC_CH0RUN CH0RUN) volatile
    {
        uint32_t curr = GLOBRC;
     ...
     */
    inline void get_CGCFG(DSD_CGCFG_SGNCG &SGNCG, DSD_CGCFG_STEPD &STEPD, DSD_CGCFG_STEPS &STEPS, uint8_t &STEPCOUNT, uint8_t &BITCOUNT, DSD_CGCFG_RUN &RUN, DSD_CGCFG_DIVCG &DIVCG, DSD_CGCFG_SIGPOL &SIGPOL, DSD_CGCFG_BREV &BREV, DSD_CGCFG_CGMOD &CGMOD) volatile
    {
        uint32_t curr = CGCFG;
     ...
     */
    inline void set_CGCFG(DSD_CGCFG_DIVCG DIVCG, DSD_CGCFG_SIGPOL SIGPOL, DSD_CGCFG_BREV BREV, DSD_CGCFG_CGMOD CGMOD) volatile
    {
        uint32_t curr = CGCFG;
     ...
     */
    inline DSD_EVFLAG_ALEV2 get_EVFLAG_ALEV2() volatile
    {
     ...
     */
    inline DSD_EVFLAG_ALEV1 get_EVFLAG_ALEV1() volatile
    {
     ...
     */
    inline DSD_EVFLAG_ALEV0 get_EVFLAG_ALEV0() volatile
    {
     ...
     */
    inline DSD_EVFLAG_RESEV2 get_EVFLAG_RESEV2() volatile
    {
     ...
     */
    inline DSD_EVFLAG_RESEV1 get_EVFLAG_RESEV1() volatile
    {
     ...
     */
    inline DSD_EVFLAG_RESEV0 get_EVFLAG_RESEV0() volatile
    {
     ...
     */
    inline void get_EVFLAG(DSD_EVFLAG_ALEV3 &ALEV3, DSD_EVFLAG_ALEV2 &ALEV2, DSD_EVFLAG_ALEV1 &ALEV1, DSD_EVFLAG_ALEV0 &ALEV0, DSD_EVFLAG_RESEV3 &RESEV3, DSD_EVFLAG_RESEV2 &RESEV2, DSD_EVFLAG_RESEV1 &RESEV1, DSD_EVFLAG_RESEV0 &RESEV0) volatile
    {
     ...
     */
    inline void set_EVFLAG(DSD_EVFLAG_ALEV3 ALEV3, DSD_EVFLAG_ALEV2 ALEV2, DSD_EVFLAG_ALEV1 ALEV1, DSD_EVFLAG_ALEV0 ALEV0, DSD_EVFLAG_RESEV3 RESEV3, DSD_EVFLAG_RESEV2 RESEV2, DSD_EVFLAG_RESEV1 RESEV1, DSD_EVFLAG_RESEV0 RESEV0) volatile
    {
        uint32_t curr = EVFLAG;
     ...
     */
    inline void set_EVFLAGCLR(DSD_EVFLAGCLR_ALEC3 ALEC3, DSD_EVFLAGCLR_ALEC2 ALEC2, DSD_EVFLAGCLR_ALEC1 ALEC1, DSD_EVFLAGCLR_ALEC0 ALEC0, DSD_EVFLAGCLR_RESEC3 RESEC3, DSD_EVFLAGCLR_RESEC2 RESEC2, DSD_EVFLAGCLR_RESEC1 RESEC1, DSD_EVFLAGCLR_RESEC0 RESEC0) volatile
    {
