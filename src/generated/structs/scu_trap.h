...
struct [[gnu::packed]] scu_trap
{
     ...
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPSTAT_BWERR0T() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPSTAT & (1u << 7u));
    }

    /**
     * Get TRAPSTAT's ULPWDGT bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPSTAT_ULPWDGT() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPSTAT & (1u << 6u));
    }

    /**
     * Get TRAPSTAT's BRWNT bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPSTAT_BRWNT() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPSTAT & (1u << 5u));
    }

    /**
     * Get TRAPSTAT's PET bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPSTAT_PET() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPSTAT & (1u << 4u));
    }

    /**
     * Get TRAPSTAT's UVCOLCKT bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPSTAT_UVCOLCKT() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPSTAT & (1u << 3u));
    }

    /**
     * Get TRAPSTAT's SVCOLCKT bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPSTAT_SVCOLCKT() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPSTAT & (1u << 2u));
    }

    /**
     * Get TRAPSTAT's SOSCWDGT bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPSTAT_SOSCWDGT() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPSTAT & (1u << 0u));
    }

    /**
     * Get all of TRAPSTAT's bit fields.
     */
    inline void get_TRAPSTAT(SCU_TRAP_TRAPSTAT_BWERR1T &BWERR1T,
                             SCU_TRAP_TRAPSTAT_BWERR1T &BWERR0T,
                             SCU_TRAP_TRAPSTAT_BWERR1T &ULPWDGT,
                             SCU_TRAP_TRAPSTAT_BWERR1T &BRWNT,
                             SCU_TRAP_TRAPSTAT_BWERR1T &PET,
                             SCU_TRAP_TRAPSTAT_BWERR1T &UVCOLCKT,
                             SCU_TRAP_TRAPSTAT_BWERR1T &SVCOLCKT,
                             SCU_TRAP_TRAPSTAT_BWERR1T &SOSCWDGT) volatile
    {
        uint32_t curr = TRAPSTAT;

        BWERR1T = SCU_TRAP_TRAPSTAT_BWERR1T(curr & (1u << 8u));
        BWERR0T = SCU_TRAP_TRAPSTAT_BWERR1T(curr & (1u << 7u));
        ULPWDGT = SCU_TRAP_TRAPSTAT_BWERR1T(curr & (1u << 6u));
        BRWNT = SCU_TRAP_TRAPSTAT_BWERR1T(curr & (1u << 5u));
        PET = SCU_TRAP_TRAPSTAT_BWERR1T(curr & (1u << 4u));
        UVCOLCKT = SCU_TRAP_TRAPSTAT_BWERR1T(curr & (1u << 3u));
        SVCOLCKT = SCU_TRAP_TRAPSTAT_BWERR1T(curr & (1u << 2u));
        SOSCWDGT = SCU_TRAP_TRAPSTAT_BWERR1T(curr & (1u << 0u));
    }

    /**
     * Get TRAPRAW's BWERR1T bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPRAW_BWERR1T() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPRAW & (1u << 8u));
    }

    /**
     * Get TRAPRAW's BWERR0T bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPRAW_BWERR0T() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPRAW & (1u << 7u));
    }

    /**
     * Get TRAPRAW's ULPWDGT bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPRAW_ULPWDGT() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPRAW & (1u << 6u));
    }

    /**
     * Get TRAPRAW's BRWNT bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPRAW_BRWNT() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPRAW & (1u << 5u));
    }

    /**
     * Get TRAPRAW's PET bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPRAW_PET() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPRAW & (1u << 4u));
    }

    /**
     * Get TRAPRAW's UVCOLCKT bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPRAW_UVCOLCKT() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPRAW & (1u << 3u));
    }

    /**
     * Get TRAPRAW's SVCOLCKT bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPRAW_SVCOLCKT() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPRAW & (1u << 2u));
    }

    /**
     * Get TRAPRAW's SOSCWDGT bit.
     */
    inline SCU_TRAP_TRAPSTAT_BWERR1T get_TRAPRAW_SOSCWDGT() volatile
    {
        return SCU_TRAP_TRAPSTAT_BWERR1T(TRAPRAW & (1u << 0u));
    }

    /**
     * Get all of TRAPRAW's bit fields.
     */
    inline void get_TRAPRAW(SCU_TRAP_TRAPSTAT_BWERR1T &BWERR1T,
                            SCU_TRAP_TRAPSTAT_BWERR1T &BWERR0T,
                            SCU_TRAP_TRAPSTAT_BWERR1T &ULPWDGT,
                            SCU_TRAP_TRAPSTAT_BWERR1T &BRWNT,
                            SCU_TRAP_TRAPSTAT_BWERR1T &PET,
     ...
     */
    inline SCU_TRAP_TRAPDIS_BWERR1T get_TRAPDIS_BWERR0T() volatile
    {
        return SCU_TRAP_TRAPDIS_BWERR1T(TRAPDIS & (1u << 7u));
    }
     ...
     */
    inline SCU_TRAP_TRAPDIS_BWERR1T get_TRAPDIS_ULPWDGT() volatile
    {
        return SCU_TRAP_TRAPDIS_BWERR1T(TRAPDIS & (1u << 6u));
    }
     ...
     */
    inline SCU_TRAP_TRAPDIS_BWERR1T get_TRAPDIS_BRWNT() volatile
    {
        return SCU_TRAP_TRAPDIS_BWERR1T(TRAPDIS & (1u << 5u));
    }
     ...
     */
    inline SCU_TRAP_TRAPDIS_BWERR1T get_TRAPDIS_PET() volatile
    {
        return SCU_TRAP_TRAPDIS_BWERR1T(TRAPDIS & (1u << 4u));
    }
     ...
     */
    inline SCU_TRAP_TRAPDIS_BWERR1T get_TRAPDIS_UVCOLCKT() volatile
    {
        return SCU_TRAP_TRAPDIS_BWERR1T(TRAPDIS & (1u << 3u));
    }
     ...
     */
    inline SCU_TRAP_TRAPDIS_BWERR1T get_TRAPDIS_SVCOLCKT() volatile
    {
        return SCU_TRAP_TRAPDIS_BWERR1T(TRAPDIS & (1u << 2u));
    }
     ...
     */
    inline SCU_TRAP_TRAPDIS_BWERR1T get_TRAPDIS_SOSCWDGT() volatile
    {
        return SCU_TRAP_TRAPDIS_BWERR1T(TRAPDIS & (1u << 0u));
    }
     ...
     */
    inline void get_TRAPDIS(SCU_TRAP_TRAPDIS_BWERR1T &BWERR1T,
                            SCU_TRAP_TRAPDIS_BWERR1T &BWERR0T,
                            SCU_TRAP_TRAPDIS_BWERR1T &ULPWDGT,
                            SCU_TRAP_TRAPDIS_BWERR1T &BRWNT,
                            SCU_TRAP_TRAPDIS_BWERR1T &PET,
                            SCU_TRAP_TRAPDIS_BWERR1T &UVCOLCKT,
                            SCU_TRAP_TRAPDIS_BWERR1T &SVCOLCKT,
                            SCU_TRAP_TRAPDIS_BWERR1T &SOSCWDGT) volatile
    {
        uint32_t curr = TRAPDIS;

        BWERR1T = SCU_TRAP_TRAPDIS_BWERR1T(curr & (1u << 8u));
        BWERR0T = SCU_TRAP_TRAPDIS_BWERR1T(curr & (1u << 7u));
        ULPWDGT = SCU_TRAP_TRAPDIS_BWERR1T(curr & (1u << 6u));
        BRWNT = SCU_TRAP_TRAPDIS_BWERR1T(curr & (1u << 5u));
        PET = SCU_TRAP_TRAPDIS_BWERR1T(curr & (1u << 4u));
        UVCOLCKT = SCU_TRAP_TRAPDIS_BWERR1T(curr & (1u << 3u));
        SVCOLCKT = SCU_TRAP_TRAPDIS_BWERR1T(curr & (1u << 2u));
        SOSCWDGT = SCU_TRAP_TRAPDIS_BWERR1T(curr & (1u << 0u));
    }
     ...
     */
    inline void set_TRAPDIS(SCU_TRAP_TRAPDIS_BWERR1T BWERR1T,
                            SCU_TRAP_TRAPDIS_BWERR1T BWERR0T,
                            SCU_TRAP_TRAPDIS_BWERR1T ULPWDGT,
                            SCU_TRAP_TRAPDIS_BWERR1T BRWNT,
                            SCU_TRAP_TRAPDIS_BWERR1T PET,
     ...
     */
    inline void set_TRAPCLR(SCU_TRAP_TRAPCLR_BWERR1T BWERR1T,
                            SCU_TRAP_TRAPCLR_BWERR1T BWERR0T,
                            SCU_TRAP_TRAPCLR_BWERR1T ULPWDGT,
                            SCU_TRAP_TRAPCLR_BWERR1T BRWNT,
                            SCU_TRAP_TRAPCLR_BWERR1T PET,
                            SCU_TRAP_TRAPCLR_BWERR1T UVCOLCKT,
                            SCU_TRAP_TRAPCLR_BWERR1T SVCOLCKT,
                            SCU_TRAP_TRAPCLR_BWERR1T SOSCWDGT) volatile
    {
     ...
     */
    inline void set_TRAPSET(SCU_TRAP_TRAPSET_BWERR1T BWERR1T,
                            SCU_TRAP_TRAPSET_BWERR1T BWERR0T,
                            SCU_TRAP_TRAPSET_BWERR1T ULPWDT,
                            SCU_TRAP_TRAPSET_BWERR1T BRWNT,
                            SCU_TRAP_TRAPSET_BWERR1T PET,
                            SCU_TRAP_TRAPSET_BWERR1T UVCOLCKT,
                            SCU_TRAP_TRAPSET_BWERR1T SVCOLCKT,
                            SCU_TRAP_TRAPSET_BWERR1T SOSCWDGT) volatile
    {
