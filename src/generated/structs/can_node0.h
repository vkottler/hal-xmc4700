...
struct [[gnu::packed]] can_node0
{
     ...
     */
    inline bool get_NCR_CCE() volatile
    {
        return NCR & (1u << 6u);
    }
     ...
     */
    inline bool get_NCR_ALIE() volatile
    {
        return NCR & (1u << 3u);
    }
     ...
     */
    inline bool get_NCR_LECIE() volatile
    {
        return NCR & (1u << 2u);
    }
     ...
     */
    inline bool get_NCR_TRIE() volatile
    {
        return NCR & (1u << 1u);
    }
     ...
     * Node Initialization
     */
    inline bool get_NCR_INIT() volatile
    {
        return NCR & (1u << 0u);
    }
     ...
     */
    inline void get_NCR(bool &CALM, bool &CCE, bool &TXDIS, bool &CANDIS,
                        bool &ALIE, bool &LECIE, bool &TRIE,
                        bool &INIT) volatile
    {
        uint32_t curr = NCR;
     ...
     * (read-write) Node Control Register
     */
    inline void set_NCR(bool CALM, bool CCE, bool TXDIS, bool CANDIS,
                        bool ALIE, bool LECIE, bool TRIE, bool INIT) volatile
    {
        uint32_t curr = NCR;
     ...
     * List Object Error
     */
    inline bool get_NSR_LOE() volatile
    {
        return NSR & (1u << 9u);
    }
     ...
     * List Length Error
     */
    inline bool get_NSR_LLE() volatile
    {
        return NSR & (1u << 8u);
    }
     ...
     * Bus-off Status
     */
    inline bool get_NSR_BOFF() volatile
    {
        return NSR & (1u << 7u);
    }
     ...
     */
    inline bool get_NSR_EWRN() volatile
    {
        return NSR & (1u << 6u);
    }
     ...
     */
    inline bool get_NSR_RXOK() volatile
    {
        return NSR & (1u << 4u);
    }
     ...
     */
    inline bool get_NSR_TXOK() volatile
    {
        return NSR & (1u << 3u);
    }
     ...
     */
    inline void get_NSR(bool &LOE, bool &LLE, bool &BOFF, bool &EWRN,
                        bool &ALERT, bool &RXOK, bool &TXOK,
                        uint8_t &LEC) volatile
    {
        uint32_t curr = NSR;
     ...
     * (read-write) Node Status Register
     */
    inline void set_NSR(bool LOE, bool LLE, bool ALERT, bool RXOK, bool TXOK,
                        uint8_t LEC) volatile
    {
        uint32_t curr = NSR;
     ...
     * Loop-Back Mode
     */
    inline bool get_NPCR_LBM() volatile
    {
        return NPCR & (1u << 8u);
    }
     ...
     */
    inline void get_NPCR(bool &LBM, uint8_t &RXSEL) volatile
    {
        uint32_t curr = NPCR;
     ...
     * (read-write) Node Port Control Register
     */
    inline void set_NPCR(bool LBM, uint8_t RXSEL) volatile
    {
        uint32_t curr = NPCR;
     ...
     */
    inline bool get_NBTR_DIV8() volatile
    {
        return NBTR & (1u << 15u);
    }
     ...
     */
    inline void get_NBTR(bool &DIV8, uint8_t &TSEG2, uint8_t &TSEG1,
                         uint8_t &SJW, uint8_t &BRP) volatile
    {
        uint32_t curr = NBTR;
     ...
     * (read-write) Node Bit Timing Register
     */
    inline void set_NBTR(bool DIV8, uint8_t TSEG2, uint8_t TSEG1, uint8_t SJW,
                         uint8_t BRP) volatile
    {
        uint32_t curr = NBTR;
     ...
     */
    inline bool get_NECNT_LEINC() volatile
    {
        return NECNT & (1u << 25u);
    }
     ...
     */
    inline bool get_NECNT_LETD() volatile
    {
        return NECNT & (1u << 24u);
    }
     ...
     */
    inline void get_NECNT(bool &LEINC, bool &LETD, uint8_t &EWRNLVL,
     ...
     */
    inline bool get_NFCR_CFCOV() volatile
    {
        return NFCR & (1u << 23u);
    }
     ...
     */
    inline bool get_NFCR_CFCIE() volatile
    {
        return NFCR & (1u << 22u);
    }
     ...
     */
    inline void get_NFCR(bool &CFCOV, bool &CFCIE, CAN_NODE0_NFCR_CFMOD &CFMOD,
                         uint8_t &CFSEL, uint16_t &CFC) volatile
    {
        uint32_t curr = NFCR;
     ...
     * (read-write) Node Frame Counter Register
     */
    inline void set_NFCR(bool CFCOV, bool CFCIE, CAN_NODE0_NFCR_CFMOD CFMOD,
                         uint8_t CFSEL, uint16_t CFC) volatile
    {
        uint32_t curr = NFCR;
