...
struct [[gnu::packed]] can_node0
{
     ...
     * Get NCR's CCE bit.
     */
    inline CAN_NODE0_NCR_CCE get_NCR_CCE()
    {
     ...
     * Get NCR's ALIE bit.
     */
    inline CAN_NODE0_NCR_ALIE get_NCR_ALIE()
    {
     ...
     * Get NCR's LECIE bit.
     */
    inline CAN_NODE0_NCR_LECIE get_NCR_LECIE()
    {
     ...
     * Get NCR's TRIE bit.
     */
    inline CAN_NODE0_NCR_TRIE get_NCR_TRIE()
    {
     ...
     * Get NCR's INIT bit.
     */
    inline CAN_NODE0_NCR_INIT get_NCR_INIT()
    {
     ...
     */
    inline void get_NCR(bool &CALM, CAN_NODE0_NCR_CCE &CCE, bool &TXDIS, bool &CANDIS, CAN_NODE0_NCR_ALIE &ALIE, CAN_NODE0_NCR_LECIE &LECIE, CAN_NODE0_NCR_TRIE &TRIE, CAN_NODE0_NCR_INIT &INIT)
    {
        uint32_t curr = NCR;
     ...
     */
    inline void set_NCR(bool CALM, CAN_NODE0_NCR_CCE CCE, bool TXDIS, bool CANDIS, CAN_NODE0_NCR_ALIE ALIE, CAN_NODE0_NCR_LECIE LECIE, CAN_NODE0_NCR_TRIE TRIE, CAN_NODE0_NCR_INIT INIT)
    {
        uint32_t curr = NCR;
     ...
     * Get NSR's LOE bit.
     */
    inline CAN_NODE0_NSR_LOE get_NSR_LOE()
    {
     ...
     * Get NSR's LLE bit.
     */
    inline CAN_NODE0_NSR_LLE get_NSR_LLE()
    {
     ...
     * Get NSR's BOFF bit.
     */
    inline CAN_NODE0_NSR_BOFF get_NSR_BOFF()
    {
     ...
     * Get NSR's EWRN bit.
     */
    inline CAN_NODE0_NSR_EWRN get_NSR_EWRN()
    {
     ...
     * Get NSR's RXOK bit.
     */
    inline CAN_NODE0_NSR_RXOK get_NSR_RXOK()
    {
     ...
     * Get NSR's TXOK bit.
     */
    inline CAN_NODE0_NSR_TXOK get_NSR_TXOK()
    {
     ...
     */
    inline void get_NSR(CAN_NODE0_NSR_LOE &LOE, CAN_NODE0_NSR_LLE &LLE, CAN_NODE0_NSR_BOFF &BOFF, CAN_NODE0_NSR_EWRN &EWRN, bool &ALERT, CAN_NODE0_NSR_RXOK &RXOK, CAN_NODE0_NSR_TXOK &TXOK, uint8_t &LEC)
    {
        uint32_t curr = NSR;
     ...
     */
    inline void set_NSR(CAN_NODE0_NSR_LOE LOE, CAN_NODE0_NSR_LLE LLE, bool ALERT, CAN_NODE0_NSR_RXOK RXOK, CAN_NODE0_NSR_TXOK TXOK, uint8_t LEC)
    {
        uint32_t curr = NSR;
     ...
     */
    inline CAN_NODE0_NIPR_CFCINP get_NIPR_CFCINP()
    {
     ...
     */
    inline CAN_NODE0_NIPR_TRINP get_NIPR_TRINP()
    {
     ...
     */
    inline CAN_NODE0_NIPR_LECINP get_NIPR_LECINP()
    {
     ...
     */
    inline CAN_NODE0_NIPR_ALINP get_NIPR_ALINP()
    {
     ...
     */
    inline void get_NIPR(CAN_NODE0_NIPR_CFCINP &CFCINP, CAN_NODE0_NIPR_TRINP &TRINP, CAN_NODE0_NIPR_LECINP &LECINP, CAN_NODE0_NIPR_ALINP &ALINP)
    {
        uint32_t curr = NIPR;
     ...
     */
    inline void set_NIPR(CAN_NODE0_NIPR_CFCINP CFCINP, CAN_NODE0_NIPR_TRINP TRINP, CAN_NODE0_NIPR_LECINP LECINP, CAN_NODE0_NIPR_ALINP ALINP)
    {
        uint32_t curr = NIPR;
     ...
     * Get NPCR's LBM bit.
     */
    inline CAN_NODE0_NPCR_LBM get_NPCR_LBM()
    {
     ...
     */
    inline void get_NPCR(CAN_NODE0_NPCR_LBM &LBM, uint8_t &RXSEL)
    {
        uint32_t curr = NPCR;
     ...
     */
    inline void set_NPCR(CAN_NODE0_NPCR_LBM LBM, uint8_t RXSEL)
    {
        uint32_t curr = NPCR;
     ...
     * Get NBTR's DIV8 bit.
     */
    inline CAN_NODE0_NBTR_DIV8 get_NBTR_DIV8()
    {
     ...
     */
    inline void get_NBTR(CAN_NODE0_NBTR_DIV8 &DIV8, uint8_t &TSEG2, uint8_t &TSEG1, uint8_t &SJW, uint8_t &BRP)
    {
        uint32_t curr = NBTR;
     ...
     */
    inline void set_NBTR(CAN_NODE0_NBTR_DIV8 DIV8, uint8_t TSEG2, uint8_t TSEG1, uint8_t SJW, uint8_t BRP)
    {
        uint32_t curr = NBTR;
     ...
     */
    inline CAN_NODE0_NECNT_LEINC get_NECNT_LEINC()
    {
     ...
     */
    inline CAN_NODE0_NECNT_LETD get_NECNT_LETD()
    {
     ...
     */
    inline uint8_t get_NECNT_EWRNLVL()
    {
     ...
     */
    inline void get_NECNT(CAN_NODE0_NECNT_LEINC &LEINC, CAN_NODE0_NECNT_LETD &LETD, uint8_t &EWRNLVL, uint8_t &TEC, uint8_t &REC)
    {
        uint32_t curr = NECNT;
     ...
     */
    inline void set_NECNT(uint8_t EWRNLVL, uint8_t TEC, uint8_t REC)
    {
        uint32_t curr = NECNT;
     ...
     */
    inline CAN_NODE0_NFCR_CFCOV get_NFCR_CFCOV()
    {
     ...
     */
    inline CAN_NODE0_NFCR_CFCIE get_NFCR_CFCIE()
    {
     ...
     */
    inline CAN_NODE0_NFCR_CFMOD get_NFCR_CFMOD()
    {
     ...
     */
    inline void get_NFCR(CAN_NODE0_NFCR_CFCOV &CFCOV, CAN_NODE0_NFCR_CFCIE &CFCIE, CAN_NODE0_NFCR_CFMOD &CFMOD, uint8_t &CFSEL, uint16_t &CFC)
    {
        uint32_t curr = NFCR;
     ...
     */
    inline void set_NFCR(CAN_NODE0_NFCR_CFCOV CFCOV, CAN_NODE0_NFCR_CFCIE CFCIE, CAN_NODE0_NFCR_CFMOD CFMOD, uint8_t CFSEL, uint16_t CFC)
    {
        uint32_t curr = NFCR;
