...
struct [[gnu::packed]] sdmmc
{
    ...
    const uint32_t PRESENT_STATE = {};                               /*!< (read-only) Present State Register */
    ...
    uint16_t INT_STATUS_NORM;                                        /*!< (read-write) Normal Interrupt Status Register */
    uint16_t INT_STATUS_ERR;                                         /*!< (read-write) Error Interrupt Status Register */
    uint16_t EN_INT_STATUS_NORM;                                     /*!< (read-write) Normal Interrupt Status Enable Register */
    uint16_t EN_INT_STATUS_ERR;                                      /*!< (read-write) Error Interrupt Status Enable Register */
    uint16_t EN_INT_SIGNAL_NORM;                                     /*!< (read-write) Normal Interrupt Signal Enable Register */
    uint16_t EN_INT_SIGNAL_ERR;                                      /*!< (read-write) Error Interrupt Signal Enable Register */
    const uint16_t ACMD_ERR_STATUS = {};                             /*!< (read-only) Auto CMD Error Status Register */
    ...
    const uint32_t CAPABILITIES_HI = {};                             /*!< (read-only) Capabilities Register High */
    const uint32_t MAX_CURRENT_CAP = {};                             /*!< (read-only) Maximum Current Capabilities Register */
    const uint32_t reserved_padding2 = {};
    uint16_t FORCE_EVENT_ACMD_ERR_STATUS;                            /*!< (write-only) Force Event Register for Auto CMD Error Status */
    uint16_t FORCE_EVENT_ERR_STATUS;                                 /*!< (write-only) Force Event Register for Error Interrupt Status */
    ...
    const uint16_t SLOT_INT_STATUS = {};                             /*!< (read-only) Slot Interrupt Status Register */
     ...
     */
    inline void get_BLOCK_SIZE(uint16_t &TX_BLOCK_SIZE, bool &TX_BLOCK_SIZE_12) volatile
    {
        uint16_t curr = BLOCK_SIZE;
     ...
     */
    inline void set_BLOCK_SIZE(uint16_t TX_BLOCK_SIZE, bool TX_BLOCK_SIZE_12) volatile
    {
        uint16_t curr = BLOCK_SIZE;
     ...
     */
    inline SDMMC_TRANSFER_MODE_BLOCK_COUNT_EN get_TRANSFER_MODE_BLOCK_COUNT_EN() volatile
    {
     ...
     */
    inline void set_TRANSFER_MODE_ACMD_EN(SDMMC_TRANSFER_MODE_ACMD_EN value) volatile
    {
     ...
     */
    inline SDMMC_TRANSFER_MODE_TX_DIR_SELECT get_TRANSFER_MODE_TX_DIR_SELECT() volatile
    {
     ...
     */
    inline SDMMC_TRANSFER_MODE_MULTI_BLOCK_SELECT get_TRANSFER_MODE_MULTI_BLOCK_SELECT() volatile
    {
        return SDMMC_TRANSFER_MODE_MULTI_BLOCK_SELECT(TRANSFER_MODE & (1u << 5u));
    }
     ...
     */
    inline SDMMC_TRANSFER_MODE_CMD_COMP_ATA get_TRANSFER_MODE_CMD_COMP_ATA() volatile
    {
     ...
     */
    inline void get_TRANSFER_MODE(SDMMC_TRANSFER_MODE_BLOCK_COUNT_EN &BLOCK_COUNT_EN, SDMMC_TRANSFER_MODE_ACMD_EN &ACMD_EN, SDMMC_TRANSFER_MODE_TX_DIR_SELECT &TX_DIR_SELECT, SDMMC_TRANSFER_MODE_MULTI_BLOCK_SELECT &MULTI_BLOCK_SELECT, SDMMC_TRANSFER_MODE_CMD_COMP_ATA &CMD_COMP_ATA) volatile
    {
        uint16_t curr = TRANSFER_MODE;
        ...
        MULTI_BLOCK_SELECT = SDMMC_TRANSFER_MODE_MULTI_BLOCK_SELECT(curr & (1u << 5u));
     ...
     */
    inline void set_TRANSFER_MODE(SDMMC_TRANSFER_MODE_BLOCK_COUNT_EN BLOCK_COUNT_EN, SDMMC_TRANSFER_MODE_ACMD_EN ACMD_EN, SDMMC_TRANSFER_MODE_TX_DIR_SELECT TX_DIR_SELECT, SDMMC_TRANSFER_MODE_MULTI_BLOCK_SELECT MULTI_BLOCK_SELECT, SDMMC_TRANSFER_MODE_CMD_COMP_ATA CMD_COMP_ATA) volatile
    {
        uint16_t curr = TRANSFER_MODE;
     ...
     */
    inline SDMMC_COMMAND_RESP_TYPE_SELECT get_COMMAND_RESP_TYPE_SELECT() volatile
    {
     ...
     */
    inline void set_COMMAND_RESP_TYPE_SELECT(SDMMC_COMMAND_RESP_TYPE_SELECT value) volatile
    {
     ...
     */
    inline SDMMC_COMMAND_CMD_CRC_CHECK_EN get_COMMAND_CMD_CRC_CHECK_EN() volatile
    {
     ...
     */
    inline SDMMC_COMMAND_CMD_IND_CHECK_EN get_COMMAND_CMD_IND_CHECK_EN() volatile
    {
     ...
     */
    inline SDMMC_COMMAND_DATA_PRESENT_SELECT get_COMMAND_DATA_PRESENT_SELECT() volatile
    {
     ...
     */
    inline void get_COMMAND(SDMMC_COMMAND_RESP_TYPE_SELECT &RESP_TYPE_SELECT, SDMMC_COMMAND_CMD_CRC_CHECK_EN &CMD_CRC_CHECK_EN, SDMMC_COMMAND_CMD_IND_CHECK_EN &CMD_IND_CHECK_EN, SDMMC_COMMAND_DATA_PRESENT_SELECT &DATA_PRESENT_SELECT, SDMMC_COMMAND_CMD_TYPE &CMD_TYPE, uint8_t &CMD_IND) volatile
    {
        uint16_t curr = COMMAND;

        RESP_TYPE_SELECT = SDMMC_COMMAND_RESP_TYPE_SELECT((curr >> 0u) & 0b11u);
        CMD_CRC_CHECK_EN = SDMMC_COMMAND_CMD_CRC_CHECK_EN(curr & (1u << 3u));
        CMD_IND_CHECK_EN = SDMMC_COMMAND_CMD_IND_CHECK_EN(curr & (1u << 4u));
        DATA_PRESENT_SELECT = SDMMC_COMMAND_DATA_PRESENT_SELECT(curr & (1u << 5u));
     ...
     */
    inline void set_COMMAND(SDMMC_COMMAND_RESP_TYPE_SELECT RESP_TYPE_SELECT, SDMMC_COMMAND_CMD_CRC_CHECK_EN CMD_CRC_CHECK_EN, SDMMC_COMMAND_CMD_IND_CHECK_EN CMD_IND_CHECK_EN, SDMMC_COMMAND_DATA_PRESENT_SELECT DATA_PRESENT_SELECT, SDMMC_COMMAND_CMD_TYPE CMD_TYPE, uint8_t CMD_IND) volatile
    {
        uint16_t curr = COMMAND;
     ...
     */
    inline void get_RESPONSE0(uint16_t &RESPONSE0, uint16_t &RESPONSE1) volatile
    {
     ...
     */
    inline void get_RESPONSE2(uint16_t &RESPONSE2, uint16_t &RESPONSE3) volatile
    {
     ...
     */
    inline void get_RESPONSE4(uint16_t &RESPONSE4, uint16_t &RESPONSE5) volatile
    {
     ...
     */
    inline void get_RESPONSE6(uint16_t &RESPONSE6, uint16_t &RESPONSE7) volatile
    {
     ...
     */
    inline SDMMC_PRESENT_STATE_COMMAND_INHIBIT_DAT get_PRESENT_STATE_COMMAND_INHIBIT_DAT() volatile
    {
        return SDMMC_PRESENT_STATE_COMMAND_INHIBIT_DAT(PRESENT_STATE & (1u << 1u));
    }

    /**
     * Get PRESENT_STATE's DAT_LINE_ACTIVE bit.
     */
    inline SDMMC_PRESENT_STATE_DAT_LINE_ACTIVE get_PRESENT_STATE_DAT_LINE_ACTIVE() volatile
    {
     ...
     */
    inline SDMMC_PRESENT_STATE_WRITE_TRANSFER_ACTIVE get_PRESENT_STATE_WRITE_TRANSFER_ACTIVE() volatile
    {
        return SDMMC_PRESENT_STATE_WRITE_TRANSFER_ACTIVE(PRESENT_STATE & (1u << 8u));
    }

    /**
     * Get PRESENT_STATE's READ_TRANSFER_ACTIVE bit.
     */
    inline SDMMC_PRESENT_STATE_READ_TRANSFER_ACTIVE get_PRESENT_STATE_READ_TRANSFER_ACTIVE() volatile
    {
        return SDMMC_PRESENT_STATE_READ_TRANSFER_ACTIVE(PRESENT_STATE & (1u << 9u));
    }

    /**
     * Get PRESENT_STATE's BUFFER_WRITE_ENABLE bit.
     */
    inline SDMMC_PRESENT_STATE_BUFFER_WRITE_ENABLE get_PRESENT_STATE_BUFFER_WRITE_ENABLE() volatile
    {
        return SDMMC_PRESENT_STATE_BUFFER_WRITE_ENABLE(PRESENT_STATE & (1u << 10u));
    }

    /**
     * Get PRESENT_STATE's BUFFER_READ_ENABLE bit.
     */
    inline SDMMC_PRESENT_STATE_BUFFER_READ_ENABLE get_PRESENT_STATE_BUFFER_READ_ENABLE() volatile
    {
        return SDMMC_PRESENT_STATE_BUFFER_READ_ENABLE(PRESENT_STATE & (1u << 11u));
    }

    /**
     * Get PRESENT_STATE's CARD_INSERTED bit.
     */
    inline SDMMC_PRESENT_STATE_CARD_INSERTED get_PRESENT_STATE_CARD_INSERTED() volatile
    {
     ...
     */
    inline SDMMC_PRESENT_STATE_CARD_STATE_STABLE get_PRESENT_STATE_CARD_STATE_STABLE() volatile
    {
        return SDMMC_PRESENT_STATE_CARD_STATE_STABLE(PRESENT_STATE & (1u << 17u));
    }

    /**
     * Get PRESENT_STATE's CARD_DETECT_PIN_LEVEL bit.
     */
    inline SDMMC_PRESENT_STATE_CARD_DETECT_PIN_LEVEL get_PRESENT_STATE_CARD_DETECT_PIN_LEVEL() volatile
    {
        return SDMMC_PRESENT_STATE_CARD_DETECT_PIN_LEVEL(PRESENT_STATE & (1u << 18u));
    }

    /**
     * Get PRESENT_STATE's WRITE_PROTECT_PIN_LEVEL bit.
     */
    inline SDMMC_PRESENT_STATE_WRITE_PROTECT_PIN_LEVEL get_PRESENT_STATE_WRITE_PROTECT_PIN_LEVEL() volatile
    {
        return SDMMC_PRESENT_STATE_WRITE_PROTECT_PIN_LEVEL(PRESENT_STATE & (1u << 19u));
    }
     ...
     */
    inline void get_PRESENT_STATE(bool &COMMAND_INHIBIT_CMD, SDMMC_PRESENT_STATE_COMMAND_INHIBIT_DAT &COMMAND_INHIBIT_DAT, SDMMC_PRESENT_STATE_DAT_LINE_ACTIVE &DAT_LINE_ACTIVE, SDMMC_PRESENT_STATE_WRITE_TRANSFER_ACTIVE &WRITE_TRANSFER_ACTIVE, SDMMC_PRESENT_STATE_READ_TRANSFER_ACTIVE &READ_TRANSFER_ACTIVE, SDMMC_PRESENT_STATE_BUFFER_WRITE_ENABLE &BUFFER_WRITE_ENABLE, SDMMC_PRESENT_STATE_BUFFER_READ_ENABLE &BUFFER_READ_ENABLE, SDMMC_PRESENT_STATE_CARD_INSERTED &CARD_INSERTED, SDMMC_PRESENT_STATE_CARD_STATE_STABLE &CARD_STATE_STABLE, SDMMC_PRESENT_STATE_CARD_DETECT_PIN_LEVEL &CARD_DETECT_PIN_LEVEL, SDMMC_PRESENT_STATE_WRITE_PROTECT_PIN_LEVEL &WRITE_PROTECT_PIN_LEVEL, uint8_t &DAT_3_0_PIN_LEVEL, bool &CMD_LINE_LEVEL, uint8_t &DAT_7_4_PIN_LEVEL) volatile
    {
        uint32_t curr = PRESENT_STATE;

        COMMAND_INHIBIT_CMD = curr & (1u << 0u);
        COMMAND_INHIBIT_DAT = SDMMC_PRESENT_STATE_COMMAND_INHIBIT_DAT(curr & (1u << 1u));
        DAT_LINE_ACTIVE = SDMMC_PRESENT_STATE_DAT_LINE_ACTIVE(curr & (1u << 2u));
        WRITE_TRANSFER_ACTIVE = SDMMC_PRESENT_STATE_WRITE_TRANSFER_ACTIVE(curr & (1u << 8u));
        READ_TRANSFER_ACTIVE = SDMMC_PRESENT_STATE_READ_TRANSFER_ACTIVE(curr & (1u << 9u));
        BUFFER_WRITE_ENABLE = SDMMC_PRESENT_STATE_BUFFER_WRITE_ENABLE(curr & (1u << 10u));
        BUFFER_READ_ENABLE = SDMMC_PRESENT_STATE_BUFFER_READ_ENABLE(curr & (1u << 11u));
        CARD_INSERTED = SDMMC_PRESENT_STATE_CARD_INSERTED(curr & (1u << 16u));
        CARD_STATE_STABLE = SDMMC_PRESENT_STATE_CARD_STATE_STABLE(curr & (1u << 17u));
        CARD_DETECT_PIN_LEVEL = SDMMC_PRESENT_STATE_CARD_DETECT_PIN_LEVEL(curr & (1u << 18u));
        WRITE_PROTECT_PIN_LEVEL = SDMMC_PRESENT_STATE_WRITE_PROTECT_PIN_LEVEL(curr & (1u << 19u));
     ...
     */
    inline SDMMC_HOST_CTRL_CARD_DETECT_TEST_LEVEL get_HOST_CTRL_CARD_DETECT_TEST_LEVEL() volatile
    {
     ...
     */
    inline SDMMC_HOST_CTRL_CARD_DET_SIGNAL_DETECT get_HOST_CTRL_CARD_DET_SIGNAL_DETECT() volatile
    {
     ...
     */
    inline void get_HOST_CTRL(SDMMC_HOST_CTRL_LED_CTRL &LED_CTRL, SDMMC_HOST_CTRL_DATA_TX_WIDTH &DATA_TX_WIDTH, SDMMC_HOST_CTRL_HIGH_SPEED_EN &HIGH_SPEED_EN, SDMMC_HOST_CTRL_SD_8BIT_MODE &SD_8BIT_MODE, SDMMC_HOST_CTRL_CARD_DETECT_TEST_LEVEL &CARD_DETECT_TEST_LEVEL, SDMMC_HOST_CTRL_CARD_DET_SIGNAL_DETECT &CARD_DET_SIGNAL_DETECT) volatile
    {
        ...
        CARD_DETECT_TEST_LEVEL = SDMMC_HOST_CTRL_CARD_DETECT_TEST_LEVEL(curr & (1u << 6u));
        CARD_DET_SIGNAL_DETECT = SDMMC_HOST_CTRL_CARD_DET_SIGNAL_DETECT(curr & (1u << 7u));
    }

    /**
     * Set all of HOST_CTRL's bit fields.
     */
    inline void set_HOST_CTRL(SDMMC_HOST_CTRL_LED_CTRL LED_CTRL, SDMMC_HOST_CTRL_DATA_TX_WIDTH DATA_TX_WIDTH, SDMMC_HOST_CTRL_HIGH_SPEED_EN HIGH_SPEED_EN, SDMMC_HOST_CTRL_SD_8BIT_MODE SD_8BIT_MODE, SDMMC_HOST_CTRL_CARD_DETECT_TEST_LEVEL CARD_DETECT_TEST_LEVEL, SDMMC_HOST_CTRL_CARD_DET_SIGNAL_DETECT CARD_DET_SIGNAL_DETECT) volatile
    {
        uint8_t curr = HOST_CTRL;
     ...
     */
    inline SDMMC_POWER_CTRL_SD_BUS_VOLTAGE_SEL get_POWER_CTRL_SD_BUS_VOLTAGE_SEL() volatile
    {
        return SDMMC_POWER_CTRL_SD_BUS_VOLTAGE_SEL((POWER_CTRL >> 1u) & 0b111u);
    }

    /**
     * Set POWER_CTRL's SD_BUS_VOLTAGE_SEL field.
     */
    inline void set_POWER_CTRL_SD_BUS_VOLTAGE_SEL(SDMMC_POWER_CTRL_SD_BUS_VOLTAGE_SEL value) volatile
    {
     ...
     */
    inline void get_POWER_CTRL(SDMMC_POWER_CTRL_SD_BUS_POWER &SD_BUS_POWER, SDMMC_POWER_CTRL_SD_BUS_VOLTAGE_SEL &SD_BUS_VOLTAGE_SEL, bool &HARDWARE_RESET) volatile
    {
        uint8_t curr = POWER_CTRL;

        SD_BUS_POWER = SDMMC_POWER_CTRL_SD_BUS_POWER(curr & (1u << 0u));
        SD_BUS_VOLTAGE_SEL = SDMMC_POWER_CTRL_SD_BUS_VOLTAGE_SEL((curr >> 1u) & 0b111u);
     ...
     */
    inline void set_POWER_CTRL(SDMMC_POWER_CTRL_SD_BUS_POWER SD_BUS_POWER, SDMMC_POWER_CTRL_SD_BUS_VOLTAGE_SEL SD_BUS_VOLTAGE_SEL, bool HARDWARE_RESET) volatile
    {
        uint8_t curr = POWER_CTRL;
     ...
     */
    inline SDMMC_BLOCK_GAP_CTRL_STOP_AT_BLOCK_GAP get_BLOCK_GAP_CTRL_STOP_AT_BLOCK_GAP() volatile
    {
        return SDMMC_BLOCK_GAP_CTRL_STOP_AT_BLOCK_GAP(BLOCK_GAP_CTRL & (1u << 0u));
    }
     ...
     */
    inline SDMMC_BLOCK_GAP_CTRL_CONTINUE_REQ get_BLOCK_GAP_CTRL_CONTINUE_REQ() volatile
    {
     ...
     */
    inline SDMMC_BLOCK_GAP_CTRL_READ_WAIT_CTRL get_BLOCK_GAP_CTRL_READ_WAIT_CTRL() volatile
    {
        return SDMMC_BLOCK_GAP_CTRL_READ_WAIT_CTRL(BLOCK_GAP_CTRL & (1u << 2u));
    }
     ...
     */
    inline void get_BLOCK_GAP_CTRL(SDMMC_BLOCK_GAP_CTRL_STOP_AT_BLOCK_GAP &STOP_AT_BLOCK_GAP, SDMMC_BLOCK_GAP_CTRL_CONTINUE_REQ &CONTINUE_REQ, SDMMC_BLOCK_GAP_CTRL_READ_WAIT_CTRL &READ_WAIT_CTRL, bool &INT_AT_BLOCK_GAP) volatile
    {
        uint8_t curr = BLOCK_GAP_CTRL;

        STOP_AT_BLOCK_GAP = SDMMC_BLOCK_GAP_CTRL_STOP_AT_BLOCK_GAP(curr & (1u << 0u));
        CONTINUE_REQ = SDMMC_BLOCK_GAP_CTRL_CONTINUE_REQ(curr & (1u << 1u));
        READ_WAIT_CTRL = SDMMC_BLOCK_GAP_CTRL_READ_WAIT_CTRL(curr & (1u << 2u));
     ...
     */
    inline void set_BLOCK_GAP_CTRL(SDMMC_BLOCK_GAP_CTRL_STOP_AT_BLOCK_GAP STOP_AT_BLOCK_GAP, SDMMC_BLOCK_GAP_CTRL_CONTINUE_REQ CONTINUE_REQ, SDMMC_BLOCK_GAP_CTRL_READ_WAIT_CTRL READ_WAIT_CTRL, bool INT_AT_BLOCK_GAP) volatile
    {
        uint8_t curr = BLOCK_GAP_CTRL;
     ...
     */
    inline SDMMC_WAKEUP_CTRL_WAKEUP_EVENT_EN_INT get_WAKEUP_CTRL_WAKEUP_EVENT_EN_INT() volatile
    {
     ...
     */
    inline SDMMC_WAKEUP_CTRL_WAKEUP_EVENT_EN_INS get_WAKEUP_CTRL_WAKEUP_EVENT_EN_INS() volatile
    {
     ...
     */
    inline SDMMC_WAKEUP_CTRL_WAKEUP_EVENT_EN_REM get_WAKEUP_CTRL_WAKEUP_EVENT_EN_REM() volatile
    {
     ...
     */
    inline void get_WAKEUP_CTRL(SDMMC_WAKEUP_CTRL_WAKEUP_EVENT_EN_INT &WAKEUP_EVENT_EN_INT, SDMMC_WAKEUP_CTRL_WAKEUP_EVENT_EN_INS &WAKEUP_EVENT_EN_INS, SDMMC_WAKEUP_CTRL_WAKEUP_EVENT_EN_REM &WAKEUP_EVENT_EN_REM) volatile
    {
        uint8_t curr = WAKEUP_CTRL;

        WAKEUP_EVENT_EN_INT = SDMMC_WAKEUP_CTRL_WAKEUP_EVENT_EN_INT(curr & (1u << 0u));
        WAKEUP_EVENT_EN_INS = SDMMC_WAKEUP_CTRL_WAKEUP_EVENT_EN_INS(curr & (1u << 1u));
        WAKEUP_EVENT_EN_REM = SDMMC_WAKEUP_CTRL_WAKEUP_EVENT_EN_REM(curr & (1u << 2u));
    }

    /**
     * Set all of WAKEUP_CTRL's bit fields.
     */
    inline void set_WAKEUP_CTRL(SDMMC_WAKEUP_CTRL_WAKEUP_EVENT_EN_INT WAKEUP_EVENT_EN_INT, SDMMC_WAKEUP_CTRL_WAKEUP_EVENT_EN_INS WAKEUP_EVENT_EN_INS, SDMMC_WAKEUP_CTRL_WAKEUP_EVENT_EN_REM WAKEUP_EVENT_EN_REM) volatile
    {
        uint8_t curr = WAKEUP_CTRL;
     ...
     */
    inline SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_EN get_CLOCK_CTRL_INTERNAL_CLOCK_EN() volatile
    {
     ...
     */
    inline SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_STABLE get_CLOCK_CTRL_INTERNAL_CLOCK_STABLE() volatile
    {
     ...
     */
    inline SDMMC_CLOCK_CTRL_SDCLOCK_EN get_CLOCK_CTRL_SDCLOCK_EN() volatile
    {
     ...
     */
    inline SDMMC_CLOCK_CTRL_SDCLK_FREQ_SEL get_CLOCK_CTRL_SDCLK_FREQ_SEL() volatile
    {
        return SDMMC_CLOCK_CTRL_SDCLK_FREQ_SEL((CLOCK_CTRL >> 8u) & 0b11111111u);
    }

    /**
     * Set CLOCK_CTRL's SDCLK_FREQ_SEL field.
     */
    inline void set_CLOCK_CTRL_SDCLK_FREQ_SEL(SDMMC_CLOCK_CTRL_SDCLK_FREQ_SEL value) volatile
    {
     ...
     */
    inline void get_CLOCK_CTRL(SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_EN &INTERNAL_CLOCK_EN, SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_STABLE &INTERNAL_CLOCK_STABLE, SDMMC_CLOCK_CTRL_SDCLOCK_EN &SDCLOCK_EN, SDMMC_CLOCK_CTRL_SDCLK_FREQ_SEL &SDCLK_FREQ_SEL) volatile
    {
        uint16_t curr = CLOCK_CTRL;

        INTERNAL_CLOCK_EN = SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_EN(curr & (1u << 0u));
        INTERNAL_CLOCK_STABLE = SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_STABLE(curr & (1u << 1u));
        SDCLOCK_EN = SDMMC_CLOCK_CTRL_SDCLOCK_EN(curr & (1u << 2u));
        SDCLK_FREQ_SEL = SDMMC_CLOCK_CTRL_SDCLK_FREQ_SEL((curr >> 8u) & 0b11111111u);
    }

    /**
     * Set all of CLOCK_CTRL's bit fields.
     */
    inline void set_CLOCK_CTRL(SDMMC_CLOCK_CTRL_INTERNAL_CLOCK_EN INTERNAL_CLOCK_EN, SDMMC_CLOCK_CTRL_SDCLOCK_EN SDCLOCK_EN, SDMMC_CLOCK_CTRL_SDCLK_FREQ_SEL SDCLK_FREQ_SEL) volatile
    {
        uint16_t curr = CLOCK_CTRL;
     ...
     */
    inline SDMMC_TIMEOUT_CTRL_DAT_TIMEOUT_CNT_VAL get_TIMEOUT_CTRL_DAT_TIMEOUT_CNT_VAL() volatile
    {
        return SDMMC_TIMEOUT_CTRL_DAT_TIMEOUT_CNT_VAL((TIMEOUT_CTRL >> 0u) & 0b1111u);
    }

    /**
     * Set TIMEOUT_CTRL's DAT_TIMEOUT_CNT_VAL field.
     */
    inline void set_TIMEOUT_CTRL_DAT_TIMEOUT_CNT_VAL(SDMMC_TIMEOUT_CTRL_DAT_TIMEOUT_CNT_VAL value) volatile
    {
     ...
     */
    inline SDMMC_SW_RESET_SW_RST_CMD_LINE get_SW_RESET_SW_RST_CMD_LINE() volatile
    {
     ...
     */
    inline SDMMC_SW_RESET_SW_RST_DAT_LINE get_SW_RESET_SW_RST_DAT_LINE() volatile
    {
     ...
     */
    inline void get_SW_RESET(bool &SW_RST_ALL, SDMMC_SW_RESET_SW_RST_CMD_LINE &SW_RST_CMD_LINE, SDMMC_SW_RESET_SW_RST_DAT_LINE &SW_RST_DAT_LINE) volatile
    {
        uint8_t curr = SW_RESET;

        SW_RST_ALL = curr & (1u << 0u);
        SW_RST_CMD_LINE = SDMMC_SW_RESET_SW_RST_CMD_LINE(curr & (1u << 1u));
        SW_RST_DAT_LINE = SDMMC_SW_RESET_SW_RST_DAT_LINE(curr & (1u << 2u));
    }

    /**
     * Set all of SW_RESET's bit fields.
     */
    inline void set_SW_RESET(bool SW_RST_ALL, SDMMC_SW_RESET_SW_RST_CMD_LINE SW_RST_CMD_LINE, SDMMC_SW_RESET_SW_RST_DAT_LINE SW_RST_DAT_LINE) volatile
    {
        uint8_t curr = SW_RESET;
     ...
     */
    inline SDMMC_INT_STATUS_NORM_CMD_COMPLETE get_INT_STATUS_NORM_CMD_COMPLETE() volatile
    {
        return SDMMC_INT_STATUS_NORM_CMD_COMPLETE(INT_STATUS_NORM & (1u << 0u));
    }
     ...
     */
    inline SDMMC_INT_STATUS_NORM_TX_COMPLETE get_INT_STATUS_NORM_TX_COMPLETE() volatile
    {
     ...
     */
    inline SDMMC_INT_STATUS_NORM_BLOCK_GAP_EVENT get_INT_STATUS_NORM_BLOCK_GAP_EVENT() volatile
    {
        return SDMMC_INT_STATUS_NORM_BLOCK_GAP_EVENT(INT_STATUS_NORM & (1u << 2u));
    }
     ...
     */
    inline SDMMC_INT_STATUS_NORM_BUFF_WRITE_READY get_INT_STATUS_NORM_BUFF_WRITE_READY() volatile
    {
        return SDMMC_INT_STATUS_NORM_BUFF_WRITE_READY(INT_STATUS_NORM & (1u << 4u));
    }
     ...
     */
    inline SDMMC_INT_STATUS_NORM_BUFF_READ_READY get_INT_STATUS_NORM_BUFF_READ_READY() volatile
    {
        return SDMMC_INT_STATUS_NORM_BUFF_READ_READY(INT_STATUS_NORM & (1u << 5u));
    }
     ...
     */
    inline SDMMC_INT_STATUS_NORM_CARD_INS get_INT_STATUS_NORM_CARD_INS() volatile
    {
     ...
     */
    inline SDMMC_INT_STATUS_NORM_CARD_REMOVAL get_INT_STATUS_NORM_CARD_REMOVAL() volatile
    {
        return SDMMC_INT_STATUS_NORM_CARD_REMOVAL(INT_STATUS_NORM & (1u << 7u));
    }
     ...
     */
    inline SDMMC_INT_STATUS_NORM_CARD_INT get_INT_STATUS_NORM_CARD_INT() volatile
    {
     ...
     */
    inline void get_INT_STATUS_NORM(SDMMC_INT_STATUS_NORM_CMD_COMPLETE &CMD_COMPLETE, SDMMC_INT_STATUS_NORM_TX_COMPLETE &TX_COMPLETE, SDMMC_INT_STATUS_NORM_BLOCK_GAP_EVENT &BLOCK_GAP_EVENT, SDMMC_INT_STATUS_NORM_BUFF_WRITE_READY &BUFF_WRITE_READY, SDMMC_INT_STATUS_NORM_BUFF_READ_READY &BUFF_READ_READY, SDMMC_INT_STATUS_NORM_CARD_INS &CARD_INS, SDMMC_INT_STATUS_NORM_CARD_REMOVAL &CARD_REMOVAL, SDMMC_INT_STATUS_NORM_CARD_INT &CARD_INT, SDMMC_INT_STATUS_NORM_ERR_INT &ERR_INT) volatile
    {
        ...
        BLOCK_GAP_EVENT = SDMMC_INT_STATUS_NORM_BLOCK_GAP_EVENT(curr & (1u << 2u));
        BUFF_WRITE_READY = SDMMC_INT_STATUS_NORM_BUFF_WRITE_READY(curr & (1u << 4u));
        BUFF_READ_READY = SDMMC_INT_STATUS_NORM_BUFF_READ_READY(curr & (1u << 5u));
     ...
     */
    inline void set_INT_STATUS_NORM(SDMMC_INT_STATUS_NORM_CMD_COMPLETE CMD_COMPLETE, SDMMC_INT_STATUS_NORM_TX_COMPLETE TX_COMPLETE, SDMMC_INT_STATUS_NORM_BLOCK_GAP_EVENT BLOCK_GAP_EVENT, SDMMC_INT_STATUS_NORM_BUFF_WRITE_READY BUFF_WRITE_READY, SDMMC_INT_STATUS_NORM_BUFF_READ_READY BUFF_READ_READY, SDMMC_INT_STATUS_NORM_CARD_INS CARD_INS, SDMMC_INT_STATUS_NORM_CARD_REMOVAL CARD_REMOVAL) volatile
    {
        uint16_t curr = INT_STATUS_NORM;
     ...
     */
    inline SDMMC_INT_STATUS_ERR_CMD_TIMEOUT_ERR get_INT_STATUS_ERR_CMD_TIMEOUT_ERR() volatile
    {
        return SDMMC_INT_STATUS_ERR_CMD_TIMEOUT_ERR(INT_STATUS_ERR & (1u << 0u));
    }
     ...
     */
    inline SDMMC_INT_STATUS_ERR_CMD_CRC_ERR get_INT_STATUS_ERR_CMD_CRC_ERR() volatile
    {
     ...
     */
    inline SDMMC_INT_STATUS_ERR_CMD_END_BIT_ERR get_INT_STATUS_ERR_CMD_END_BIT_ERR() volatile
    {
        return SDMMC_INT_STATUS_ERR_CMD_END_BIT_ERR(INT_STATUS_ERR & (1u << 2u));
    }
     ...
     */
    inline SDMMC_INT_STATUS_ERR_CMD_IND_ERR get_INT_STATUS_ERR_CMD_IND_ERR() volatile
    {
     ...
     */
    inline SDMMC_INT_STATUS_ERR_DATA_TIMEOUT_ERR get_INT_STATUS_ERR_DATA_TIMEOUT_ERR() volatile
    {
        return SDMMC_INT_STATUS_ERR_DATA_TIMEOUT_ERR(INT_STATUS_ERR & (1u << 4u));
    }
     ...
     */
    inline SDMMC_INT_STATUS_ERR_DATA_CRC_ERR get_INT_STATUS_ERR_DATA_CRC_ERR() volatile
    {
     ...
     */
    inline SDMMC_INT_STATUS_ERR_DATA_END_BIT_ERR get_INT_STATUS_ERR_DATA_END_BIT_ERR() volatile
    {
        return SDMMC_INT_STATUS_ERR_DATA_END_BIT_ERR(INT_STATUS_ERR & (1u << 6u));
    }
     ...
     */
    inline SDMMC_INT_STATUS_ERR_CURRENT_LIMIT_ERR get_INT_STATUS_ERR_CURRENT_LIMIT_ERR() volatile
    {
        return SDMMC_INT_STATUS_ERR_CURRENT_LIMIT_ERR(INT_STATUS_ERR & (1u << 7u));
    }
     ...
     */
    inline SDMMC_INT_STATUS_ERR_ACMD_ERR get_INT_STATUS_ERR_ACMD_ERR() volatile
    {
     ...
     */
    inline SDMMC_INT_STATUS_ERR_CEATA_ERR get_INT_STATUS_ERR_CEATA_ERR() volatile
    {
     ...
     */
    inline void get_INT_STATUS_ERR(SDMMC_INT_STATUS_ERR_CMD_TIMEOUT_ERR &CMD_TIMEOUT_ERR, SDMMC_INT_STATUS_ERR_CMD_CRC_ERR &CMD_CRC_ERR, SDMMC_INT_STATUS_ERR_CMD_END_BIT_ERR &CMD_END_BIT_ERR, SDMMC_INT_STATUS_ERR_CMD_IND_ERR &CMD_IND_ERR, SDMMC_INT_STATUS_ERR_DATA_TIMEOUT_ERR &DATA_TIMEOUT_ERR, SDMMC_INT_STATUS_ERR_DATA_CRC_ERR &DATA_CRC_ERR, SDMMC_INT_STATUS_ERR_DATA_END_BIT_ERR &DATA_END_BIT_ERR, SDMMC_INT_STATUS_ERR_CURRENT_LIMIT_ERR &CURRENT_LIMIT_ERR, SDMMC_INT_STATUS_ERR_ACMD_ERR &ACMD_ERR, SDMMC_INT_STATUS_ERR_CEATA_ERR &CEATA_ERR) volatile
    {
        uint16_t curr = INT_STATUS_ERR;

        CMD_TIMEOUT_ERR = SDMMC_INT_STATUS_ERR_CMD_TIMEOUT_ERR(curr & (1u << 0u));
        CMD_CRC_ERR = SDMMC_INT_STATUS_ERR_CMD_CRC_ERR(curr & (1u << 1u));
        CMD_END_BIT_ERR = SDMMC_INT_STATUS_ERR_CMD_END_BIT_ERR(curr & (1u << 2u));
        CMD_IND_ERR = SDMMC_INT_STATUS_ERR_CMD_IND_ERR(curr & (1u << 3u));
        DATA_TIMEOUT_ERR = SDMMC_INT_STATUS_ERR_DATA_TIMEOUT_ERR(curr & (1u << 4u));
        DATA_CRC_ERR = SDMMC_INT_STATUS_ERR_DATA_CRC_ERR(curr & (1u << 5u));
        DATA_END_BIT_ERR = SDMMC_INT_STATUS_ERR_DATA_END_BIT_ERR(curr & (1u << 6u));
        CURRENT_LIMIT_ERR = SDMMC_INT_STATUS_ERR_CURRENT_LIMIT_ERR(curr & (1u << 7u));
        ACMD_ERR = SDMMC_INT_STATUS_ERR_ACMD_ERR(curr & (1u << 8u));
        CEATA_ERR = SDMMC_INT_STATUS_ERR_CEATA_ERR(curr & (1u << 13u));
    }

    /**
     * Set all of INT_STATUS_ERR's bit fields.
     */
    inline void set_INT_STATUS_ERR(SDMMC_INT_STATUS_ERR_CMD_TIMEOUT_ERR CMD_TIMEOUT_ERR, SDMMC_INT_STATUS_ERR_CMD_CRC_ERR CMD_CRC_ERR, SDMMC_INT_STATUS_ERR_CMD_END_BIT_ERR CMD_END_BIT_ERR, SDMMC_INT_STATUS_ERR_CMD_IND_ERR CMD_IND_ERR, SDMMC_INT_STATUS_ERR_DATA_TIMEOUT_ERR DATA_TIMEOUT_ERR, SDMMC_INT_STATUS_ERR_DATA_CRC_ERR DATA_CRC_ERR, SDMMC_INT_STATUS_ERR_DATA_END_BIT_ERR DATA_END_BIT_ERR, SDMMC_INT_STATUS_ERR_CURRENT_LIMIT_ERR CURRENT_LIMIT_ERR, SDMMC_INT_STATUS_ERR_ACMD_ERR ACMD_ERR, SDMMC_INT_STATUS_ERR_CEATA_ERR CEATA_ERR) volatile
    {
        uint16_t curr = INT_STATUS_ERR;
     ...
     */
    inline SDMMC_EN_INT_STATUS_NORM_CMD_COMPLETE_EN get_EN_INT_STATUS_NORM_CMD_COMPLETE_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_NORM_CMD_COMPLETE_EN(EN_INT_STATUS_NORM & (1u << 0u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_NORM_TX_COMPLETE_EN get_EN_INT_STATUS_NORM_TX_COMPLETE_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_NORM_TX_COMPLETE_EN(EN_INT_STATUS_NORM & (1u << 1u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_NORM_BLOCK_GAP_EVENT_EN get_EN_INT_STATUS_NORM_BLOCK_GAP_EVENT_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_NORM_BLOCK_GAP_EVENT_EN(EN_INT_STATUS_NORM & (1u << 2u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_NORM_BUFF_WRITE_READY_EN get_EN_INT_STATUS_NORM_BUFF_WRITE_READY_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_NORM_BUFF_WRITE_READY_EN(EN_INT_STATUS_NORM & (1u << 4u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_NORM_BUFF_READ_READY_EN get_EN_INT_STATUS_NORM_BUFF_READ_READY_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_NORM_BUFF_READ_READY_EN(EN_INT_STATUS_NORM & (1u << 5u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_NORM_CARD_INS_EN get_EN_INT_STATUS_NORM_CARD_INS_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_NORM_CARD_INS_EN(EN_INT_STATUS_NORM & (1u << 6u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_NORM_CARD_REMOVAL_EN get_EN_INT_STATUS_NORM_CARD_REMOVAL_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_NORM_CARD_REMOVAL_EN(EN_INT_STATUS_NORM & (1u << 7u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_NORM_CARD_INT_EN get_EN_INT_STATUS_NORM_CARD_INT_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_NORM_CARD_INT_EN(EN_INT_STATUS_NORM & (1u << 8u));
    }
     ...
     */
    inline void get_EN_INT_STATUS_NORM(SDMMC_EN_INT_STATUS_NORM_CMD_COMPLETE_EN &CMD_COMPLETE_EN, SDMMC_EN_INT_STATUS_NORM_TX_COMPLETE_EN &TX_COMPLETE_EN, SDMMC_EN_INT_STATUS_NORM_BLOCK_GAP_EVENT_EN &BLOCK_GAP_EVENT_EN, SDMMC_EN_INT_STATUS_NORM_BUFF_WRITE_READY_EN &BUFF_WRITE_READY_EN, SDMMC_EN_INT_STATUS_NORM_BUFF_READ_READY_EN &BUFF_READ_READY_EN, SDMMC_EN_INT_STATUS_NORM_CARD_INS_EN &CARD_INS_EN, SDMMC_EN_INT_STATUS_NORM_CARD_REMOVAL_EN &CARD_REMOVAL_EN, SDMMC_EN_INT_STATUS_NORM_CARD_INT_EN &CARD_INT_EN, bool &FIXED_TO_0) volatile
    {
        uint16_t curr = EN_INT_STATUS_NORM;

        CMD_COMPLETE_EN = SDMMC_EN_INT_STATUS_NORM_CMD_COMPLETE_EN(curr & (1u << 0u));
        TX_COMPLETE_EN = SDMMC_EN_INT_STATUS_NORM_TX_COMPLETE_EN(curr & (1u << 1u));
        BLOCK_GAP_EVENT_EN = SDMMC_EN_INT_STATUS_NORM_BLOCK_GAP_EVENT_EN(curr & (1u << 2u));
        BUFF_WRITE_READY_EN = SDMMC_EN_INT_STATUS_NORM_BUFF_WRITE_READY_EN(curr & (1u << 4u));
        BUFF_READ_READY_EN = SDMMC_EN_INT_STATUS_NORM_BUFF_READ_READY_EN(curr & (1u << 5u));
        CARD_INS_EN = SDMMC_EN_INT_STATUS_NORM_CARD_INS_EN(curr & (1u << 6u));
        CARD_REMOVAL_EN = SDMMC_EN_INT_STATUS_NORM_CARD_REMOVAL_EN(curr & (1u << 7u));
        CARD_INT_EN = SDMMC_EN_INT_STATUS_NORM_CARD_INT_EN(curr & (1u << 8u));
     ...
     */
    inline void set_EN_INT_STATUS_NORM(SDMMC_EN_INT_STATUS_NORM_CMD_COMPLETE_EN CMD_COMPLETE_EN, SDMMC_EN_INT_STATUS_NORM_TX_COMPLETE_EN TX_COMPLETE_EN, SDMMC_EN_INT_STATUS_NORM_BLOCK_GAP_EVENT_EN BLOCK_GAP_EVENT_EN, SDMMC_EN_INT_STATUS_NORM_BUFF_WRITE_READY_EN BUFF_WRITE_READY_EN, SDMMC_EN_INT_STATUS_NORM_BUFF_READ_READY_EN BUFF_READ_READY_EN, SDMMC_EN_INT_STATUS_NORM_CARD_INS_EN CARD_INS_EN, SDMMC_EN_INT_STATUS_NORM_CARD_REMOVAL_EN CARD_REMOVAL_EN, SDMMC_EN_INT_STATUS_NORM_CARD_INT_EN CARD_INT_EN) volatile
    {
        uint16_t curr = EN_INT_STATUS_NORM;
     ...
     */
    inline SDMMC_EN_INT_STATUS_ERR_CMD_TIMEOUT_ERR_EN get_EN_INT_STATUS_ERR_CMD_TIMEOUT_ERR_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_ERR_CMD_TIMEOUT_ERR_EN(EN_INT_STATUS_ERR & (1u << 0u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_ERR_CMD_CRC_ERR_EN get_EN_INT_STATUS_ERR_CMD_CRC_ERR_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_ERR_CMD_CRC_ERR_EN(EN_INT_STATUS_ERR & (1u << 1u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_ERR_CMD_END_BIT_ERR_EN get_EN_INT_STATUS_ERR_CMD_END_BIT_ERR_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_ERR_CMD_END_BIT_ERR_EN(EN_INT_STATUS_ERR & (1u << 2u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_ERR_CMD_IND_ERR_EN get_EN_INT_STATUS_ERR_CMD_IND_ERR_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_ERR_CMD_IND_ERR_EN(EN_INT_STATUS_ERR & (1u << 3u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_ERR_DATA_TIMEOUT_ERR_EN get_EN_INT_STATUS_ERR_DATA_TIMEOUT_ERR_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_ERR_DATA_TIMEOUT_ERR_EN(EN_INT_STATUS_ERR & (1u << 4u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_ERR_DATA_CRC_ERR_EN get_EN_INT_STATUS_ERR_DATA_CRC_ERR_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_ERR_DATA_CRC_ERR_EN(EN_INT_STATUS_ERR & (1u << 5u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_ERR_DATA_END_BIT_ERR_EN get_EN_INT_STATUS_ERR_DATA_END_BIT_ERR_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_ERR_DATA_END_BIT_ERR_EN(EN_INT_STATUS_ERR & (1u << 6u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_ERR_CURRENT_LIMIT_ERR_EN get_EN_INT_STATUS_ERR_CURRENT_LIMIT_ERR_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_ERR_CURRENT_LIMIT_ERR_EN(EN_INT_STATUS_ERR & (1u << 7u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_ERR_ACMD_ERR_EN get_EN_INT_STATUS_ERR_ACMD_ERR_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_ERR_ACMD_ERR_EN(EN_INT_STATUS_ERR & (1u << 8u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_ERR_TARGET_RESP_ERR_EN get_EN_INT_STATUS_ERR_TARGET_RESP_ERR_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_ERR_TARGET_RESP_ERR_EN(EN_INT_STATUS_ERR & (1u << 12u));
    }
     ...
     */
    inline SDMMC_EN_INT_STATUS_ERR_CEATA_ERR_EN get_EN_INT_STATUS_ERR_CEATA_ERR_EN() volatile
    {
        return SDMMC_EN_INT_STATUS_ERR_CEATA_ERR_EN(EN_INT_STATUS_ERR & (1u << 13u));
    }
     ...
     */
    inline void get_EN_INT_STATUS_ERR(SDMMC_EN_INT_STATUS_ERR_CMD_TIMEOUT_ERR_EN &CMD_TIMEOUT_ERR_EN, SDMMC_EN_INT_STATUS_ERR_CMD_CRC_ERR_EN &CMD_CRC_ERR_EN, SDMMC_EN_INT_STATUS_ERR_CMD_END_BIT_ERR_EN &CMD_END_BIT_ERR_EN, SDMMC_EN_INT_STATUS_ERR_CMD_IND_ERR_EN &CMD_IND_ERR_EN, SDMMC_EN_INT_STATUS_ERR_DATA_TIMEOUT_ERR_EN &DATA_TIMEOUT_ERR_EN, SDMMC_EN_INT_STATUS_ERR_DATA_CRC_ERR_EN &DATA_CRC_ERR_EN, SDMMC_EN_INT_STATUS_ERR_DATA_END_BIT_ERR_EN &DATA_END_BIT_ERR_EN, SDMMC_EN_INT_STATUS_ERR_CURRENT_LIMIT_ERR_EN &CURRENT_LIMIT_ERR_EN, SDMMC_EN_INT_STATUS_ERR_ACMD_ERR_EN &ACMD_ERR_EN, SDMMC_EN_INT_STATUS_ERR_TARGET_RESP_ERR_EN &TARGET_RESP_ERR_EN, SDMMC_EN_INT_STATUS_ERR_CEATA_ERR_EN &CEATA_ERR_EN) volatile
    {
        uint16_t curr = EN_INT_STATUS_ERR;

        CMD_TIMEOUT_ERR_EN = SDMMC_EN_INT_STATUS_ERR_CMD_TIMEOUT_ERR_EN(curr & (1u << 0u));
        CMD_CRC_ERR_EN = SDMMC_EN_INT_STATUS_ERR_CMD_CRC_ERR_EN(curr & (1u << 1u));
        CMD_END_BIT_ERR_EN = SDMMC_EN_INT_STATUS_ERR_CMD_END_BIT_ERR_EN(curr & (1u << 2u));
        CMD_IND_ERR_EN = SDMMC_EN_INT_STATUS_ERR_CMD_IND_ERR_EN(curr & (1u << 3u));
        DATA_TIMEOUT_ERR_EN = SDMMC_EN_INT_STATUS_ERR_DATA_TIMEOUT_ERR_EN(curr & (1u << 4u));
        DATA_CRC_ERR_EN = SDMMC_EN_INT_STATUS_ERR_DATA_CRC_ERR_EN(curr & (1u << 5u));
        DATA_END_BIT_ERR_EN = SDMMC_EN_INT_STATUS_ERR_DATA_END_BIT_ERR_EN(curr & (1u << 6u));
        CURRENT_LIMIT_ERR_EN = SDMMC_EN_INT_STATUS_ERR_CURRENT_LIMIT_ERR_EN(curr & (1u << 7u));
        ACMD_ERR_EN = SDMMC_EN_INT_STATUS_ERR_ACMD_ERR_EN(curr & (1u << 8u));
        TARGET_RESP_ERR_EN = SDMMC_EN_INT_STATUS_ERR_TARGET_RESP_ERR_EN(curr & (1u << 12u));
        CEATA_ERR_EN = SDMMC_EN_INT_STATUS_ERR_CEATA_ERR_EN(curr & (1u << 13u));
    }

    /**
     * Set all of EN_INT_STATUS_ERR's bit fields.
     */
    inline void set_EN_INT_STATUS_ERR(SDMMC_EN_INT_STATUS_ERR_CMD_TIMEOUT_ERR_EN CMD_TIMEOUT_ERR_EN, SDMMC_EN_INT_STATUS_ERR_CMD_CRC_ERR_EN CMD_CRC_ERR_EN, SDMMC_EN_INT_STATUS_ERR_CMD_END_BIT_ERR_EN CMD_END_BIT_ERR_EN, SDMMC_EN_INT_STATUS_ERR_CMD_IND_ERR_EN CMD_IND_ERR_EN, SDMMC_EN_INT_STATUS_ERR_DATA_TIMEOUT_ERR_EN DATA_TIMEOUT_ERR_EN, SDMMC_EN_INT_STATUS_ERR_DATA_CRC_ERR_EN DATA_CRC_ERR_EN, SDMMC_EN_INT_STATUS_ERR_DATA_END_BIT_ERR_EN DATA_END_BIT_ERR_EN, SDMMC_EN_INT_STATUS_ERR_CURRENT_LIMIT_ERR_EN CURRENT_LIMIT_ERR_EN, SDMMC_EN_INT_STATUS_ERR_ACMD_ERR_EN ACMD_ERR_EN, SDMMC_EN_INT_STATUS_ERR_TARGET_RESP_ERR_EN TARGET_RESP_ERR_EN, SDMMC_EN_INT_STATUS_ERR_CEATA_ERR_EN CEATA_ERR_EN) volatile
    {
        uint16_t curr = EN_INT_STATUS_ERR;
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_NORM_CMD_COMPLETE_EN get_EN_INT_SIGNAL_NORM_CMD_COMPLETE_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_NORM_CMD_COMPLETE_EN(EN_INT_SIGNAL_NORM & (1u << 0u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_NORM_TX_COMPLETE_EN get_EN_INT_SIGNAL_NORM_TX_COMPLETE_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_NORM_TX_COMPLETE_EN(EN_INT_SIGNAL_NORM & (1u << 1u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_NORM_BLOCK_GAP_EVENT_EN get_EN_INT_SIGNAL_NORM_BLOCK_GAP_EVENT_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_NORM_BLOCK_GAP_EVENT_EN(EN_INT_SIGNAL_NORM & (1u << 2u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_NORM_BUFF_WRITE_READY_EN get_EN_INT_SIGNAL_NORM_BUFF_WRITE_READY_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_NORM_BUFF_WRITE_READY_EN(EN_INT_SIGNAL_NORM & (1u << 4u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_NORM_BUFF_READ_READY_EN get_EN_INT_SIGNAL_NORM_BUFF_READ_READY_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_NORM_BUFF_READ_READY_EN(EN_INT_SIGNAL_NORM & (1u << 5u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_NORM_CARD_INS_EN get_EN_INT_SIGNAL_NORM_CARD_INS_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_NORM_CARD_INS_EN(EN_INT_SIGNAL_NORM & (1u << 6u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_NORM_CARD_REMOVAL_EN get_EN_INT_SIGNAL_NORM_CARD_REMOVAL_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_NORM_CARD_REMOVAL_EN(EN_INT_SIGNAL_NORM & (1u << 7u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_NORM_CARD_INT_EN get_EN_INT_SIGNAL_NORM_CARD_INT_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_NORM_CARD_INT_EN(EN_INT_SIGNAL_NORM & (1u << 8u));
    }
     ...
     */
    inline void get_EN_INT_SIGNAL_NORM(SDMMC_EN_INT_SIGNAL_NORM_CMD_COMPLETE_EN &CMD_COMPLETE_EN, SDMMC_EN_INT_SIGNAL_NORM_TX_COMPLETE_EN &TX_COMPLETE_EN, SDMMC_EN_INT_SIGNAL_NORM_BLOCK_GAP_EVENT_EN &BLOCK_GAP_EVENT_EN, SDMMC_EN_INT_SIGNAL_NORM_BUFF_WRITE_READY_EN &BUFF_WRITE_READY_EN, SDMMC_EN_INT_SIGNAL_NORM_BUFF_READ_READY_EN &BUFF_READ_READY_EN, SDMMC_EN_INT_SIGNAL_NORM_CARD_INS_EN &CARD_INS_EN, SDMMC_EN_INT_SIGNAL_NORM_CARD_REMOVAL_EN &CARD_REMOVAL_EN, SDMMC_EN_INT_SIGNAL_NORM_CARD_INT_EN &CARD_INT_EN, bool &FIXED_TO_0) volatile
    {
        uint16_t curr = EN_INT_SIGNAL_NORM;

        CMD_COMPLETE_EN = SDMMC_EN_INT_SIGNAL_NORM_CMD_COMPLETE_EN(curr & (1u << 0u));
        TX_COMPLETE_EN = SDMMC_EN_INT_SIGNAL_NORM_TX_COMPLETE_EN(curr & (1u << 1u));
        BLOCK_GAP_EVENT_EN = SDMMC_EN_INT_SIGNAL_NORM_BLOCK_GAP_EVENT_EN(curr & (1u << 2u));
        BUFF_WRITE_READY_EN = SDMMC_EN_INT_SIGNAL_NORM_BUFF_WRITE_READY_EN(curr & (1u << 4u));
        BUFF_READ_READY_EN = SDMMC_EN_INT_SIGNAL_NORM_BUFF_READ_READY_EN(curr & (1u << 5u));
        CARD_INS_EN = SDMMC_EN_INT_SIGNAL_NORM_CARD_INS_EN(curr & (1u << 6u));
        CARD_REMOVAL_EN = SDMMC_EN_INT_SIGNAL_NORM_CARD_REMOVAL_EN(curr & (1u << 7u));
        CARD_INT_EN = SDMMC_EN_INT_SIGNAL_NORM_CARD_INT_EN(curr & (1u << 8u));
        FIXED_TO_0 = curr & (1u << 15u);
    }
     ...
     */
    inline void set_EN_INT_SIGNAL_NORM(SDMMC_EN_INT_SIGNAL_NORM_CMD_COMPLETE_EN CMD_COMPLETE_EN, SDMMC_EN_INT_SIGNAL_NORM_TX_COMPLETE_EN TX_COMPLETE_EN, SDMMC_EN_INT_SIGNAL_NORM_BLOCK_GAP_EVENT_EN BLOCK_GAP_EVENT_EN, SDMMC_EN_INT_SIGNAL_NORM_BUFF_WRITE_READY_EN BUFF_WRITE_READY_EN, SDMMC_EN_INT_SIGNAL_NORM_BUFF_READ_READY_EN BUFF_READ_READY_EN, SDMMC_EN_INT_SIGNAL_NORM_CARD_INS_EN CARD_INS_EN, SDMMC_EN_INT_SIGNAL_NORM_CARD_REMOVAL_EN CARD_REMOVAL_EN, SDMMC_EN_INT_SIGNAL_NORM_CARD_INT_EN CARD_INT_EN) volatile
    {
        uint16_t curr = EN_INT_SIGNAL_NORM;
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_ERR_CMD_TIMEOUT_ERR_EN get_EN_INT_SIGNAL_ERR_CMD_TIMEOUT_ERR_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_ERR_CMD_TIMEOUT_ERR_EN(EN_INT_SIGNAL_ERR & (1u << 0u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_ERR_CMD_CRC_ERR_EN get_EN_INT_SIGNAL_ERR_CMD_CRC_ERR_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_ERR_CMD_CRC_ERR_EN(EN_INT_SIGNAL_ERR & (1u << 1u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_ERR_CMD_END_BIT_ERR_EN get_EN_INT_SIGNAL_ERR_CMD_END_BIT_ERR_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_ERR_CMD_END_BIT_ERR_EN(EN_INT_SIGNAL_ERR & (1u << 2u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_ERR_CMD_IND_ERR_EN get_EN_INT_SIGNAL_ERR_CMD_IND_ERR_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_ERR_CMD_IND_ERR_EN(EN_INT_SIGNAL_ERR & (1u << 3u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_ERR_DATA_TIMEOUT_ERR_EN get_EN_INT_SIGNAL_ERR_DATA_TIMEOUT_ERR_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_ERR_DATA_TIMEOUT_ERR_EN(EN_INT_SIGNAL_ERR & (1u << 4u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_ERR_DATA_CRC_ERR_EN get_EN_INT_SIGNAL_ERR_DATA_CRC_ERR_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_ERR_DATA_CRC_ERR_EN(EN_INT_SIGNAL_ERR & (1u << 5u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_ERR_DATA_END_BIT_ERR_EN get_EN_INT_SIGNAL_ERR_DATA_END_BIT_ERR_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_ERR_DATA_END_BIT_ERR_EN(EN_INT_SIGNAL_ERR & (1u << 6u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_ERR_CURRENT_LIMIT_ERR_EN get_EN_INT_SIGNAL_ERR_CURRENT_LIMIT_ERR_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_ERR_CURRENT_LIMIT_ERR_EN(EN_INT_SIGNAL_ERR & (1u << 7u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_ERR_ACMD_ERR_EN get_EN_INT_SIGNAL_ERR_ACMD_ERR_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_ERR_ACMD_ERR_EN(EN_INT_SIGNAL_ERR & (1u << 8u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_ERR_TARGET_RESP_ERR_EN get_EN_INT_SIGNAL_ERR_TARGET_RESP_ERR_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_ERR_TARGET_RESP_ERR_EN(EN_INT_SIGNAL_ERR & (1u << 12u));
    }
     ...
     */
    inline SDMMC_EN_INT_SIGNAL_ERR_CEATA_ERR_EN get_EN_INT_SIGNAL_ERR_CEATA_ERR_EN() volatile
    {
        return SDMMC_EN_INT_SIGNAL_ERR_CEATA_ERR_EN(EN_INT_SIGNAL_ERR & (1u << 13u));
    }
     ...
     */
    inline void get_EN_INT_SIGNAL_ERR(SDMMC_EN_INT_SIGNAL_ERR_CMD_TIMEOUT_ERR_EN &CMD_TIMEOUT_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_CMD_CRC_ERR_EN &CMD_CRC_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_CMD_END_BIT_ERR_EN &CMD_END_BIT_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_CMD_IND_ERR_EN &CMD_IND_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_DATA_TIMEOUT_ERR_EN &DATA_TIMEOUT_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_DATA_CRC_ERR_EN &DATA_CRC_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_DATA_END_BIT_ERR_EN &DATA_END_BIT_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_CURRENT_LIMIT_ERR_EN &CURRENT_LIMIT_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_ACMD_ERR_EN &ACMD_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_TARGET_RESP_ERR_EN &TARGET_RESP_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_CEATA_ERR_EN &CEATA_ERR_EN) volatile
    {
        uint16_t curr = EN_INT_SIGNAL_ERR;

        CMD_TIMEOUT_ERR_EN = SDMMC_EN_INT_SIGNAL_ERR_CMD_TIMEOUT_ERR_EN(curr & (1u << 0u));
        CMD_CRC_ERR_EN = SDMMC_EN_INT_SIGNAL_ERR_CMD_CRC_ERR_EN(curr & (1u << 1u));
        CMD_END_BIT_ERR_EN = SDMMC_EN_INT_SIGNAL_ERR_CMD_END_BIT_ERR_EN(curr & (1u << 2u));
        CMD_IND_ERR_EN = SDMMC_EN_INT_SIGNAL_ERR_CMD_IND_ERR_EN(curr & (1u << 3u));
        DATA_TIMEOUT_ERR_EN = SDMMC_EN_INT_SIGNAL_ERR_DATA_TIMEOUT_ERR_EN(curr & (1u << 4u));
        DATA_CRC_ERR_EN = SDMMC_EN_INT_SIGNAL_ERR_DATA_CRC_ERR_EN(curr & (1u << 5u));
        DATA_END_BIT_ERR_EN = SDMMC_EN_INT_SIGNAL_ERR_DATA_END_BIT_ERR_EN(curr & (1u << 6u));
        CURRENT_LIMIT_ERR_EN = SDMMC_EN_INT_SIGNAL_ERR_CURRENT_LIMIT_ERR_EN(curr & (1u << 7u));
        ACMD_ERR_EN = SDMMC_EN_INT_SIGNAL_ERR_ACMD_ERR_EN(curr & (1u << 8u));
        TARGET_RESP_ERR_EN = SDMMC_EN_INT_SIGNAL_ERR_TARGET_RESP_ERR_EN(curr & (1u << 12u));
        CEATA_ERR_EN = SDMMC_EN_INT_SIGNAL_ERR_CEATA_ERR_EN(curr & (1u << 13u));
    }

    /**
     * Set all of EN_INT_SIGNAL_ERR's bit fields.
     */
    inline void set_EN_INT_SIGNAL_ERR(SDMMC_EN_INT_SIGNAL_ERR_CMD_TIMEOUT_ERR_EN CMD_TIMEOUT_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_CMD_CRC_ERR_EN CMD_CRC_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_CMD_END_BIT_ERR_EN CMD_END_BIT_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_CMD_IND_ERR_EN CMD_IND_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_DATA_TIMEOUT_ERR_EN DATA_TIMEOUT_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_DATA_CRC_ERR_EN DATA_CRC_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_DATA_END_BIT_ERR_EN DATA_END_BIT_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_CURRENT_LIMIT_ERR_EN CURRENT_LIMIT_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_ACMD_ERR_EN ACMD_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_TARGET_RESP_ERR_EN TARGET_RESP_ERR_EN, SDMMC_EN_INT_SIGNAL_ERR_CEATA_ERR_EN CEATA_ERR_EN) volatile
    {
        uint16_t curr = EN_INT_SIGNAL_ERR;
     ...
     */
    inline SDMMC_ACMD_ERR_STATUS_ACMD12_NOT_EXEC_ERR get_ACMD_ERR_STATUS_ACMD12_NOT_EXEC_ERR() volatile
    {
        return SDMMC_ACMD_ERR_STATUS_ACMD12_NOT_EXEC_ERR(ACMD_ERR_STATUS & (1u << 0u));
    }

    /**
     * Get ACMD_ERR_STATUS's ACMD_TIMEOUT_ERR bit.
     */
    inline SDMMC_ACMD_ERR_STATUS_ACMD_TIMEOUT_ERR get_ACMD_ERR_STATUS_ACMD_TIMEOUT_ERR() volatile
    {
        return SDMMC_ACMD_ERR_STATUS_ACMD_TIMEOUT_ERR(ACMD_ERR_STATUS & (1u << 1u));
    }

    /**
     * Get ACMD_ERR_STATUS's ACMD_CRC_ERR bit.
     */
    inline SDMMC_ACMD_ERR_STATUS_ACMD_CRC_ERR get_ACMD_ERR_STATUS_ACMD_CRC_ERR() volatile
    {
        return SDMMC_ACMD_ERR_STATUS_ACMD_CRC_ERR(ACMD_ERR_STATUS & (1u << 2u));
    }

    /**
     * Get ACMD_ERR_STATUS's ACMD_END_BIT_ERR bit.
     */
    inline SDMMC_ACMD_ERR_STATUS_ACMD_END_BIT_ERR get_ACMD_ERR_STATUS_ACMD_END_BIT_ERR() volatile
    {
        return SDMMC_ACMD_ERR_STATUS_ACMD_END_BIT_ERR(ACMD_ERR_STATUS & (1u << 3u));
    }

    /**
     * Get ACMD_ERR_STATUS's ACMD_IND_ERR bit.
     */
    inline SDMMC_ACMD_ERR_STATUS_ACMD_IND_ERR get_ACMD_ERR_STATUS_ACMD_IND_ERR() volatile
    {
        return SDMMC_ACMD_ERR_STATUS_ACMD_IND_ERR(ACMD_ERR_STATUS & (1u << 4u));
    }

    /**
     * Get ACMD_ERR_STATUS's CMD_NOT_ISSUED_BY_ACMD12_ERR bit.
     */
    inline SDMMC_ACMD_ERR_STATUS_CMD_NOT_ISSUED_BY_ACMD12_ERR get_ACMD_ERR_STATUS_CMD_NOT_ISSUED_BY_ACMD12_ERR() volatile
    {
        return SDMMC_ACMD_ERR_STATUS_CMD_NOT_ISSUED_BY_ACMD12_ERR(ACMD_ERR_STATUS & (1u << 7u));
    }

    /**
     * Get all of ACMD_ERR_STATUS's bit fields.
     */
    inline void get_ACMD_ERR_STATUS(SDMMC_ACMD_ERR_STATUS_ACMD12_NOT_EXEC_ERR &ACMD12_NOT_EXEC_ERR, SDMMC_ACMD_ERR_STATUS_ACMD_TIMEOUT_ERR &ACMD_TIMEOUT_ERR, SDMMC_ACMD_ERR_STATUS_ACMD_CRC_ERR &ACMD_CRC_ERR, SDMMC_ACMD_ERR_STATUS_ACMD_END_BIT_ERR &ACMD_END_BIT_ERR, SDMMC_ACMD_ERR_STATUS_ACMD_IND_ERR &ACMD_IND_ERR, SDMMC_ACMD_ERR_STATUS_CMD_NOT_ISSUED_BY_ACMD12_ERR &CMD_NOT_ISSUED_BY_ACMD12_ERR) volatile
    {
        uint16_t curr = ACMD_ERR_STATUS;

        ACMD12_NOT_EXEC_ERR = SDMMC_ACMD_ERR_STATUS_ACMD12_NOT_EXEC_ERR(curr & (1u << 0u));
        ACMD_TIMEOUT_ERR = SDMMC_ACMD_ERR_STATUS_ACMD_TIMEOUT_ERR(curr & (1u << 1u));
        ACMD_CRC_ERR = SDMMC_ACMD_ERR_STATUS_ACMD_CRC_ERR(curr & (1u << 2u));
        ACMD_END_BIT_ERR = SDMMC_ACMD_ERR_STATUS_ACMD_END_BIT_ERR(curr & (1u << 3u));
        ACMD_IND_ERR = SDMMC_ACMD_ERR_STATUS_ACMD_IND_ERR(curr & (1u << 4u));
        CMD_NOT_ISSUED_BY_ACMD12_ERR = SDMMC_ACMD_ERR_STATUS_CMD_NOT_ISSUED_BY_ACMD12_ERR(curr & (1u << 7u));
    }
     ...
     */
    inline SDMMC_CAPABILITIES_ASYNC_INT_SUPPORT get_CAPABILITIES_ASYNC_INT_SUPPORT() volatile
    {
        return SDMMC_CAPABILITIES_ASYNC_INT_SUPPORT(CAPABILITIES & (1u << 29u));
    }

    /**
     * Get CAPABILITIES's SYSBUS_64_SUPPORT bit.
     */
    inline SDMMC_CAPABILITIES_SYSBUS_64_SUPPORT get_CAPABILITIES_SYSBUS_64_SUPPORT() volatile
    {
        return SDMMC_CAPABILITIES_SYSBUS_64_SUPPORT(CAPABILITIES & (1u << 28u));
    }

    /**
     * Get CAPABILITIES's VOLTAGE_SUPPORT_1_8V bit.
     */
    inline SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_1_8V get_CAPABILITIES_VOLTAGE_SUPPORT_1_8V() volatile
    {
        return SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_1_8V(CAPABILITIES & (1u << 26u));
    }

    /**
     * Get CAPABILITIES's VOLTAGE_SUPPORT_3V bit.
     */
    inline SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3V get_CAPABILITIES_VOLTAGE_SUPPORT_3V() volatile
    {
        return SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3V(CAPABILITIES & (1u << 25u));
    }

    /**
     * Get CAPABILITIES's VOLTAGE_SUPPORT_3_3V bit.
     */
    inline SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3_3V get_CAPABILITIES_VOLTAGE_SUPPORT_3_3V() volatile
    {
        return SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3_3V(CAPABILITIES & (1u << 24u));
    }

    /**
     * Get CAPABILITIES's SUSPEND_RESUME_SUPPORT bit.
     */
    inline SDMMC_CAPABILITIES_SUSPEND_RESUME_SUPPORT get_CAPABILITIES_SUSPEND_RESUME_SUPPORT() volatile
    {
        return SDMMC_CAPABILITIES_SUSPEND_RESUME_SUPPORT(CAPABILITIES & (1u << 23u));
    }

    /**
     * Get CAPABILITIES's SDMA_SUPPORT bit.
     */
    inline SDMMC_CAPABILITIES_SDMA_SUPPORT get_CAPABILITIES_SDMA_SUPPORT() volatile
    {
     ...
     */
    inline SDMMC_CAPABILITIES_HIGH_SPEED_SUPPORT get_CAPABILITIES_HIGH_SPEED_SUPPORT() volatile
    {
        return SDMMC_CAPABILITIES_HIGH_SPEED_SUPPORT(CAPABILITIES & (1u << 21u));
    }

    /**
     * Get CAPABILITIES's ADMA2_SUPPORT bit.
     */
    inline SDMMC_CAPABILITIES_ADMA2_SUPPORT get_CAPABILITIES_ADMA2_SUPPORT() volatile
    {
     ...
     */
    inline SDMMC_CAPABILITIES_EXT_MEDIA_BUS_SUPPORT get_CAPABILITIES_EXT_MEDIA_BUS_SUPPORT() volatile
    {
        return SDMMC_CAPABILITIES_EXT_MEDIA_BUS_SUPPORT(CAPABILITIES & (1u << 18u));
    }

    /**
     * Get CAPABILITIES's MAX_BLOCK_LENGTH field.
     */
    inline SDMMC_CAPABILITIES_MAX_BLOCK_LENGTH get_CAPABILITIES_MAX_BLOCK_LENGTH() volatile
    {
        return SDMMC_CAPABILITIES_MAX_BLOCK_LENGTH((CAPABILITIES >> 16u) & 0b11u);
    }

    /**
     * Get CAPABILITIES's BASE_SD_CLOCK_FREQ field.
     */
    inline SDMMC_CAPABILITIES_BASE_SD_CLOCK_FREQ get_CAPABILITIES_BASE_SD_CLOCK_FREQ() volatile
    {
        return SDMMC_CAPABILITIES_BASE_SD_CLOCK_FREQ((CAPABILITIES >> 8u) & 0b11111111u);
    }

    /**
     * Get CAPABILITIES's TIMEOUT_CLOCK_UNIT bit.
     */
    inline SDMMC_CAPABILITIES_TIMEOUT_CLOCK_UNIT get_CAPABILITIES_TIMEOUT_CLOCK_UNIT() volatile
    {
        return SDMMC_CAPABILITIES_TIMEOUT_CLOCK_UNIT(CAPABILITIES & (1u << 7u));
    }

    /**
     * Get CAPABILITIES's TIMEOUT_CLOCK_FREQ field.
     */
    inline SDMMC_CAPABILITIES_TIMEOUT_CLOCK_FREQ get_CAPABILITIES_TIMEOUT_CLOCK_FREQ() volatile
    {
        return SDMMC_CAPABILITIES_TIMEOUT_CLOCK_FREQ((CAPABILITIES >> 0u) & 0b111111u);
    }

    /**
     * Get all of CAPABILITIES's bit fields.
     */
    inline void get_CAPABILITIES(SDMMC_CAPABILITIES_SLOT_TYPE &SLOT_TYPE, SDMMC_CAPABILITIES_ASYNC_INT_SUPPORT &ASYNC_INT_SUPPORT, SDMMC_CAPABILITIES_SYSBUS_64_SUPPORT &SYSBUS_64_SUPPORT, SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_1_8V &VOLTAGE_SUPPORT_1_8V, SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3V &VOLTAGE_SUPPORT_3V, SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3_3V &VOLTAGE_SUPPORT_3_3V, SDMMC_CAPABILITIES_SUSPEND_RESUME_SUPPORT &SUSPEND_RESUME_SUPPORT, SDMMC_CAPABILITIES_SDMA_SUPPORT &SDMA_SUPPORT, SDMMC_CAPABILITIES_HIGH_SPEED_SUPPORT &HIGH_SPEED_SUPPORT, SDMMC_CAPABILITIES_ADMA2_SUPPORT &ADMA2_SUPPORT, SDMMC_CAPABILITIES_EXT_MEDIA_BUS_SUPPORT &EXT_MEDIA_BUS_SUPPORT, SDMMC_CAPABILITIES_MAX_BLOCK_LENGTH &MAX_BLOCK_LENGTH, SDMMC_CAPABILITIES_BASE_SD_CLOCK_FREQ &BASE_SD_CLOCK_FREQ, SDMMC_CAPABILITIES_TIMEOUT_CLOCK_UNIT &TIMEOUT_CLOCK_UNIT, SDMMC_CAPABILITIES_TIMEOUT_CLOCK_FREQ &TIMEOUT_CLOCK_FREQ) volatile
    {
        uint32_t curr = CAPABILITIES;

        SLOT_TYPE = SDMMC_CAPABILITIES_SLOT_TYPE((curr >> 30u) & 0b11u);
        ASYNC_INT_SUPPORT = SDMMC_CAPABILITIES_ASYNC_INT_SUPPORT(curr & (1u << 29u));
        SYSBUS_64_SUPPORT = SDMMC_CAPABILITIES_SYSBUS_64_SUPPORT(curr & (1u << 28u));
        VOLTAGE_SUPPORT_1_8V = SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_1_8V(curr & (1u << 26u));
        VOLTAGE_SUPPORT_3V = SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3V(curr & (1u << 25u));
        VOLTAGE_SUPPORT_3_3V = SDMMC_CAPABILITIES_VOLTAGE_SUPPORT_3_3V(curr & (1u << 24u));
        SUSPEND_RESUME_SUPPORT = SDMMC_CAPABILITIES_SUSPEND_RESUME_SUPPORT(curr & (1u << 23u));
        SDMA_SUPPORT = SDMMC_CAPABILITIES_SDMA_SUPPORT(curr & (1u << 22u));
        HIGH_SPEED_SUPPORT = SDMMC_CAPABILITIES_HIGH_SPEED_SUPPORT(curr & (1u << 21u));
        ADMA2_SUPPORT = SDMMC_CAPABILITIES_ADMA2_SUPPORT(curr & (1u << 19u));
        EXT_MEDIA_BUS_SUPPORT = SDMMC_CAPABILITIES_EXT_MEDIA_BUS_SUPPORT(curr & (1u << 18u));
        MAX_BLOCK_LENGTH = SDMMC_CAPABILITIES_MAX_BLOCK_LENGTH((curr >> 16u) & 0b11u);
        BASE_SD_CLOCK_FREQ = SDMMC_CAPABILITIES_BASE_SD_CLOCK_FREQ((curr >> 8u) & 0b11111111u);
        TIMEOUT_CLOCK_UNIT = SDMMC_CAPABILITIES_TIMEOUT_CLOCK_UNIT(curr & (1u << 7u));
        TIMEOUT_CLOCK_FREQ = SDMMC_CAPABILITIES_TIMEOUT_CLOCK_FREQ((curr >> 0u) & 0b111111u);
    }

    /**
     * Get CAPABILITIES_HI's CLK_MULT field.
     */
    inline SDMMC_CAPABILITIES_HI_CLK_MULT get_CAPABILITIES_HI_CLK_MULT() volatile
    {
        return SDMMC_CAPABILITIES_HI_CLK_MULT((CAPABILITIES_HI >> 16u) & 0b11111111u);
    }

    /**
     * Get CAPABILITIES_HI's RE_TUNING_MODES field.
     */
    inline SDMMC_CAPABILITIES_HI_RE_TUNING_MODES get_CAPABILITIES_HI_RE_TUNING_MODES() volatile
    {
        return SDMMC_CAPABILITIES_HI_RE_TUNING_MODES((CAPABILITIES_HI >> 14u) & 0b11u);
    }

    /**
     * Get CAPABILITIES_HI's USE_TUNING_SDR50 bit.
     */
    inline SDMMC_CAPABILITIES_HI_USE_TUNING_SDR50 get_CAPABILITIES_HI_USE_TUNING_SDR50() volatile
    {
        return SDMMC_CAPABILITIES_HI_USE_TUNING_SDR50(CAPABILITIES_HI & (1u << 13u));
    }

    /**
     * Get CAPABILITIES_HI's TIM_CNT_RETUNE field.
     */
    inline SDMMC_CAPABILITIES_HI_TIM_CNT_RETUNE get_CAPABILITIES_HI_TIM_CNT_RETUNE() volatile
    {
        return SDMMC_CAPABILITIES_HI_TIM_CNT_RETUNE((CAPABILITIES_HI >> 8u) & 0b1111u);
    }

    /**
     * Get CAPABILITIES_HI's DRV_D_SUPPORT bit.
     */
    inline SDMMC_CAPABILITIES_HI_DRV_D_SUPPORT get_CAPABILITIES_HI_DRV_D_SUPPORT() volatile
    {
        return SDMMC_CAPABILITIES_HI_DRV_D_SUPPORT(CAPABILITIES_HI & (1u << 6u));
    }

    /**
     * Get CAPABILITIES_HI's DRV_C_SUPPORT bit.
     */
    inline SDMMC_CAPABILITIES_HI_DRV_C_SUPPORT get_CAPABILITIES_HI_DRV_C_SUPPORT() volatile
    {
        return SDMMC_CAPABILITIES_HI_DRV_C_SUPPORT(CAPABILITIES_HI & (1u << 5u));
    }

    /**
     * Get CAPABILITIES_HI's DRV_A_SUPPORT bit.
     */
    inline SDMMC_CAPABILITIES_HI_DRV_A_SUPPORT get_CAPABILITIES_HI_DRV_A_SUPPORT() volatile
    {
        return SDMMC_CAPABILITIES_HI_DRV_A_SUPPORT(CAPABILITIES_HI & (1u << 4u));
    }

    /**
     * Get CAPABILITIES_HI's DDR50_SUPPORT bit.
     */
    inline SDMMC_CAPABILITIES_HI_DDR50_SUPPORT get_CAPABILITIES_HI_DDR50_SUPPORT() volatile
    {
        return SDMMC_CAPABILITIES_HI_DDR50_SUPPORT(CAPABILITIES_HI & (1u << 2u));
    }

    /**
     * Get CAPABILITIES_HI's SDR104_SUPPORT bit.
     */
    inline SDMMC_CAPABILITIES_HI_SDR104_SUPPORT get_CAPABILITIES_HI_SDR104_SUPPORT() volatile
    {
        return SDMMC_CAPABILITIES_HI_SDR104_SUPPORT(CAPABILITIES_HI & (1u << 1u));
    }

    /**
     * Get CAPABILITIES_HI's SDR50_SUPPORT bit.
     */
    inline SDMMC_CAPABILITIES_HI_SDR50_SUPPORT get_CAPABILITIES_HI_SDR50_SUPPORT() volatile
    {
        return SDMMC_CAPABILITIES_HI_SDR50_SUPPORT(CAPABILITIES_HI & (1u << 0u));
    }

    /**
     * Get all of CAPABILITIES_HI's bit fields.
     */
    inline void get_CAPABILITIES_HI(SDMMC_CAPABILITIES_HI_CLK_MULT &CLK_MULT, SDMMC_CAPABILITIES_HI_RE_TUNING_MODES &RE_TUNING_MODES, SDMMC_CAPABILITIES_HI_USE_TUNING_SDR50 &USE_TUNING_SDR50, SDMMC_CAPABILITIES_HI_TIM_CNT_RETUNE &TIM_CNT_RETUNE, SDMMC_CAPABILITIES_HI_DRV_D_SUPPORT &DRV_D_SUPPORT, SDMMC_CAPABILITIES_HI_DRV_C_SUPPORT &DRV_C_SUPPORT, SDMMC_CAPABILITIES_HI_DRV_A_SUPPORT &DRV_A_SUPPORT, SDMMC_CAPABILITIES_HI_DDR50_SUPPORT &DDR50_SUPPORT, SDMMC_CAPABILITIES_HI_SDR104_SUPPORT &SDR104_SUPPORT, SDMMC_CAPABILITIES_HI_SDR50_SUPPORT &SDR50_SUPPORT) volatile
    {
        uint32_t curr = CAPABILITIES_HI;

        CLK_MULT = SDMMC_CAPABILITIES_HI_CLK_MULT((curr >> 16u) & 0b11111111u);
        RE_TUNING_MODES = SDMMC_CAPABILITIES_HI_RE_TUNING_MODES((curr >> 14u) & 0b11u);
        USE_TUNING_SDR50 = SDMMC_CAPABILITIES_HI_USE_TUNING_SDR50(curr & (1u << 13u));
        TIM_CNT_RETUNE = SDMMC_CAPABILITIES_HI_TIM_CNT_RETUNE((curr >> 8u) & 0b1111u);
        ...
        SDR104_SUPPORT = SDMMC_CAPABILITIES_HI_SDR104_SUPPORT(curr & (1u << 1u));
     ...
     */
    inline void clear_FORCE_EVENT_ACMD_ERR_STATUS_FE_ACMD_TIMEOUT_ERR() volatile
    {
        FORCE_EVENT_ACMD_ERR_STATUS &= ~(1u << 1u);
    }
     ...
     */
    inline void toggle_FORCE_EVENT_ACMD_ERR_STATUS_FE_ACMD_TIMEOUT_ERR() volatile
    {
        FORCE_EVENT_ACMD_ERR_STATUS ^= 1u << 1u;
    }
     ...
     */
    inline void clear_FORCE_EVENT_ACMD_ERR_STATUS_FE_ACMD_END_BIT_ERR() volatile
    {
        FORCE_EVENT_ACMD_ERR_STATUS &= ~(1u << 3u);
    }
     ...
     */
    inline void toggle_FORCE_EVENT_ACMD_ERR_STATUS_FE_ACMD_END_BIT_ERR() volatile
    {
        FORCE_EVENT_ACMD_ERR_STATUS ^= 1u << 3u;
    }
     ...
     */
    inline void set_FORCE_EVENT_ACMD_ERR_STATUS_FE_CMD_NOT_ISSUED_ACMD12_ERR() volatile
    {
     ...
     */
    inline void clear_FORCE_EVENT_ACMD_ERR_STATUS_FE_CMD_NOT_ISSUED_ACMD12_ERR() volatile
    {
        FORCE_EVENT_ACMD_ERR_STATUS &= ~(1u << 7u);
    }
     ...
     */
    inline void toggle_FORCE_EVENT_ACMD_ERR_STATUS_FE_CMD_NOT_ISSUED_ACMD12_ERR() volatile
    {
        FORCE_EVENT_ACMD_ERR_STATUS ^= 1u << 7u;
    }
     ...
     */
    inline void set_FORCE_EVENT_ACMD_ERR_STATUS(SDMMC_FORCE_EVENT_ACMD_ERR_STATUS_FE_ACMD_NOT_EXEC FE_ACMD_NOT_EXEC, SDMMC_FORCE_EVENT_ACMD_ERR_STATUS_FE_ACMD_TIMEOUT_ERR FE_ACMD_TIMEOUT_ERR, SDMMC_FORCE_EVENT_ACMD_ERR_STATUS_FE_ACMD_CRC_ERR FE_ACMD_CRC_ERR, SDMMC_FORCE_EVENT_ACMD_ERR_STATUS_FE_ACMD_END_BIT_ERR FE_ACMD_END_BIT_ERR, SDMMC_FORCE_EVENT_ACMD_ERR_STATUS_FE_ACMD_IND_ERR FE_ACMD_IND_ERR, SDMMC_FORCE_EVENT_ACMD_ERR_STATUS_FE_CMD_NOT_ISSUED_ACMD12_ERR FE_CMD_NOT_ISSUED_ACMD12_ERR) volatile
    {
        ...
        curr &= ~(0b1u << 7u);
        curr |= (std::to_underlying(FE_CMD_NOT_ISSUED_ACMD12_ERR) & 0b1u) << 7u;
     ...
     */
    inline void set_FORCE_EVENT_ERR_STATUS(SDMMC_FORCE_EVENT_ERR_STATUS_FE_CMD_TIMEOUT_ERR FE_CMD_TIMEOUT_ERR, SDMMC_FORCE_EVENT_ERR_STATUS_FE_CMD_CRC_ERR FE_CMD_CRC_ERR, SDMMC_FORCE_EVENT_ERR_STATUS_FE_CMD_END_BIT_ERR FE_CMD_END_BIT_ERR, SDMMC_FORCE_EVENT_ERR_STATUS_FE_CMD_IND_ERR FE_CMD_IND_ERR, SDMMC_FORCE_EVENT_ERR_STATUS_FE_DATA_TIMEOUT_ERR FE_DATA_TIMEOUT_ERR, SDMMC_FORCE_EVENT_ERR_STATUS_FE_DATA_CRC_ERR FE_DATA_CRC_ERR, SDMMC_FORCE_EVENT_ERR_STATUS_FE_DATA_END_BIT_ERR FE_DATA_END_BIT_ERR, SDMMC_FORCE_EVENT_ERR_STATUS_FE_CURRENT_LIMIT_ERR FE_CURRENT_LIMIT_ERR, SDMMC_FORCE_EVENT_ERR_STATUS_FE_ACMD12_ERR FE_ACMD12_ERR, SDMMC_FORCE_EVENT_ERR_STATUS_FE_TARGET_RESPONSE_ERR FE_TARGET_RESPONSE_ERR, SDMMC_FORCE_EVENT_ERR_STATUS_FE_CEATA_ERR FE_CEATA_ERR) volatile
    {
     ...
     */
    inline SDMMC_SLOT_INT_STATUS_SLOT_INT_STATUS get_SLOT_INT_STATUS_SLOT_INT_STATUS() volatile
    {
        return SDMMC_SLOT_INT_STATUS_SLOT_INT_STATUS((SLOT_INT_STATUS >> 0u) & 0b11111111u);
    }
};
