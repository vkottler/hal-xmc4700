...
struct [[gnu::packed]] scu_reset
{
     ...
     */
    inline SCU_RESET_RSTSTAT_LCKEN get_RSTSTAT_LCKEN() volatile
    {
     ...
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_RSTSTAT_HIBRS() volatile
    {
     ...
     */
    inline SCU_RESET_RSTSTAT_HIBWK get_RSTSTAT_HIBWK() volatile
    {
     ...
     */
    inline void get_RSTSTAT(SCU_RESET_RSTSTAT_LCKEN &LCKEN,
                            SCU_RESET_RSTSTAT_HIBRS &HIBRS,
                            SCU_RESET_RSTSTAT_HIBWK &HIBWK,
     ...
     */
    inline void set_RSTSET(SCU_RESET_RSTSET_LCKEN LCKEN,
                           SCU_RESET_RSTSET_HIBRS HIBRS,
                           SCU_RESET_RSTSET_HIBWK HIBWK) volatile
    {
     ...
     */
    inline void set_RSTCLR(SCU_RESET_RSTCLR_LCKEN LCKEN,
                           SCU_RESET_RSTCLR_HIBRS HIBRS,
                           SCU_RESET_RSTCLR_HIBWK HIBWK,
                           SCU_RESET_RSTCLR_RSCLR RSCLR) volatile
    {
     ...
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT0_ERU1RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT0 & (1u << 16u));
    }

    /**
     * Get PRSTAT0's USIC0RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT0_USIC0RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT0 & (1u << 11u));
    }

    /**
     * Get PRSTAT0's POSIF1RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT0_POSIF1RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT0 & (1u << 10u));
    }

    /**
     * Get PRSTAT0's POSIF0RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT0_POSIF0RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT0 & (1u << 9u));
    }

    /**
     * Get PRSTAT0's CCU81RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT0_CCU81RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT0 & (1u << 8u));
    }

    /**
     * Get PRSTAT0's CCU80RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT0_CCU80RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT0 & (1u << 7u));
    }

    /**
     * Get PRSTAT0's CCU42RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT0_CCU42RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT0 & (1u << 4u));
    }

    /**
     * Get PRSTAT0's CCU41RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT0_CCU41RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT0 & (1u << 3u));
    }

    /**
     * Get PRSTAT0's CCU40RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT0_CCU40RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT0 & (1u << 2u));
    }

    /**
     * Get PRSTAT0's DSDRS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT0_DSDRS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT0 & (1u << 1u));
    }

    /**
     * Get PRSTAT0's VADCRS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT0_VADCRS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT0 & (1u << 0u));
    }

    /**
     * Get all of PRSTAT0's bit fields.
     */
    inline void get_PRSTAT0(
        SCU_RESET_RSTSTAT_HIBRS &ERU1RS, SCU_RESET_RSTSTAT_HIBRS &USIC0RS,
        SCU_RESET_RSTSTAT_HIBRS &POSIF1RS, SCU_RESET_RSTSTAT_HIBRS &POSIF0RS,
        SCU_RESET_RSTSTAT_HIBRS &CCU81RS, SCU_RESET_RSTSTAT_HIBRS &CCU80RS,
        SCU_RESET_RSTSTAT_HIBRS &CCU42RS, SCU_RESET_RSTSTAT_HIBRS &CCU41RS,
        SCU_RESET_RSTSTAT_HIBRS &CCU40RS, SCU_RESET_RSTSTAT_HIBRS &DSDRS,
        SCU_RESET_RSTSTAT_HIBRS &VADCRS) volatile
    {
        uint32_t curr = PRSTAT0;

        ERU1RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 16u));
        USIC0RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 11u));
        POSIF1RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 10u));
        POSIF0RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 9u));
        CCU81RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 8u));
        CCU80RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 7u));
        CCU42RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 4u));
        CCU41RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 3u));
        CCU40RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 2u));
        DSDRS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 1u));
        VADCRS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 0u));
    }
     ...
     */
    inline void set_PRSET0(
        SCU_RESET_RSTSET_HIBRS ERU1RS, SCU_RESET_RSTSET_HIBRS USIC0RS,
        SCU_RESET_RSTSET_HIBRS POSIF1RS, SCU_RESET_RSTSET_HIBRS POSIF0RS,
        SCU_RESET_RSTSET_HIBRS CCU81RS, SCU_RESET_RSTSET_HIBRS CCU80RS,
        SCU_RESET_RSTSET_HIBRS CCU42RS, SCU_RESET_RSTSET_HIBRS CCU41RS,
        SCU_RESET_RSTSET_HIBRS CCU40RS, SCU_RESET_RSTSET_HIBRS DSDRS,
        SCU_RESET_RSTSET_HIBRS VADCRS) volatile
    {
     ...
     */
    inline void set_PRCLR0(
        SCU_RESET_RSTCLR_HIBRS ERU1RS, SCU_RESET_RSTCLR_HIBRS USIC0RS,
        SCU_RESET_RSTCLR_HIBRS POSIF1RS, SCU_RESET_RSTCLR_HIBRS POSIF0RS,
        SCU_RESET_RSTCLR_HIBRS CCU81RS, SCU_RESET_RSTCLR_HIBRS CCU80RS,
        SCU_RESET_RSTCLR_HIBRS CCU42RS, SCU_RESET_RSTCLR_HIBRS CCU41RS,
        SCU_RESET_RSTCLR_HIBRS CCU40RS, SCU_RESET_RSTCLR_HIBRS DSDRS,
        SCU_RESET_RSTCLR_HIBRS VADCRS) volatile
    {
     ...
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT1_PPORTSRS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT1 & (1u << 9u));
    }

    /**
     * Get PRSTAT1's USIC2RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT1_USIC2RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT1 & (1u << 8u));
    }

    /**
     * Get PRSTAT1's USIC1RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT1_USIC1RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT1 & (1u << 7u));
    }

    /**
     * Get PRSTAT1's MMCIRS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT1_MMCIRS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT1 & (1u << 6u));
    }

    /**
     * Get PRSTAT1's DACRS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT1_DACRS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT1 & (1u << 5u));
    }

    /**
     * Get PRSTAT1's MCAN0RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT1_MCAN0RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT1 & (1u << 4u));
    }

    /**
     * Get PRSTAT1's LEDTSCU0RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT1_LEDTSCU0RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT1 & (1u << 3u));
    }

    /**
     * Get PRSTAT1's CCU43RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT1_CCU43RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT1 & (1u << 0u));
    }

    /**
     * Get all of PRSTAT1's bit fields.
     */
    inline void get_PRSTAT1(SCU_RESET_RSTSTAT_HIBRS &PPORTSRS,
                            SCU_RESET_RSTSTAT_HIBRS &USIC2RS,
                            SCU_RESET_RSTSTAT_HIBRS &USIC1RS,
                            SCU_RESET_RSTSTAT_HIBRS &MMCIRS,
                            SCU_RESET_RSTSTAT_HIBRS &DACRS,
                            SCU_RESET_RSTSTAT_HIBRS &MCAN0RS,
                            SCU_RESET_RSTSTAT_HIBRS &LEDTSCU0RS,
                            SCU_RESET_RSTSTAT_HIBRS &CCU43RS) volatile
    {
        uint32_t curr = PRSTAT1;

        PPORTSRS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 9u));
        USIC2RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 8u));
        USIC1RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 7u));
        MMCIRS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 6u));
        DACRS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 5u));
        MCAN0RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 4u));
        LEDTSCU0RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 3u));
        CCU43RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 0u));
    }
     ...
     */
    inline void set_PRSET1(SCU_RESET_RSTSET_HIBRS PPORTSRS,
                           SCU_RESET_RSTSET_HIBRS USIC2RS,
                           SCU_RESET_RSTSET_HIBRS USIC1RS,
                           SCU_RESET_RSTSET_HIBRS MMCIRS,
                           SCU_RESET_RSTSET_HIBRS DACRS,
                           SCU_RESET_RSTSET_HIBRS MCAN0RS,
                           SCU_RESET_RSTSET_HIBRS LEDTSCU0RS,
                           SCU_RESET_RSTSET_HIBRS CCU43RS) volatile
    {
     ...
     */
    inline void set_PRCLR1(SCU_RESET_RSTCLR_HIBRS PPORTSRS,
                           SCU_RESET_RSTCLR_HIBRS USIC2RS,
                           SCU_RESET_RSTCLR_HIBRS USIC1RS,
                           SCU_RESET_RSTCLR_HIBRS MMCIRS,
                           SCU_RESET_RSTCLR_HIBRS DACRS,
                           SCU_RESET_RSTCLR_HIBRS MCAN0RS,
                           SCU_RESET_RSTCLR_HIBRS LEDTSCU0RS,
                           SCU_RESET_RSTCLR_HIBRS CCU43RS) volatile
    {
     ...
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT2_USBRS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT2 & (1u << 7u));
    }

    /**
     * Get PRSTAT2's FCERS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT2_FCERS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT2 & (1u << 6u));
    }

    /**
     * Get PRSTAT2's DMA1RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT2_DMA1RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT2 & (1u << 5u));
    }

    /**
     * Get PRSTAT2's DMA0RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT2_DMA0RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT2 & (1u << 4u));
    }

    /**
     * Get PRSTAT2's ETH0RS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT2_ETH0RS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT2 & (1u << 2u));
    }

    /**
     * Get PRSTAT2's WDTRS bit.
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT2_WDTRS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT2 & (1u << 1u));
    }

    /**
     * Get all of PRSTAT2's bit fields.
     */
    inline void get_PRSTAT2(SCU_RESET_RSTSTAT_HIBRS &USBRS,
                            SCU_RESET_RSTSTAT_HIBRS &FCERS,
                            SCU_RESET_RSTSTAT_HIBRS &DMA1RS,
                            SCU_RESET_RSTSTAT_HIBRS &DMA0RS,
                            SCU_RESET_RSTSTAT_HIBRS &ETH0RS,
                            SCU_RESET_RSTSTAT_HIBRS &WDTRS) volatile
    {
        uint32_t curr = PRSTAT2;

        USBRS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 7u));
        FCERS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 6u));
        DMA1RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 5u));
        DMA0RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 4u));
        ETH0RS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 2u));
        WDTRS = SCU_RESET_RSTSTAT_HIBRS(curr & (1u << 1u));
    }
     ...
     */
    inline void set_PRSET2(SCU_RESET_RSTSET_HIBRS USBRS,
                           SCU_RESET_RSTSET_HIBRS FCERS,
                           SCU_RESET_RSTSET_HIBRS DMA1RS,
                           SCU_RESET_RSTSET_HIBRS DMA0RS,
                           SCU_RESET_RSTSET_HIBRS ETH0RS,
                           SCU_RESET_RSTSET_HIBRS WDTRS) volatile
    {
     ...
     */
    inline void set_PRCLR2(SCU_RESET_RSTCLR_HIBRS USBRS,
                           SCU_RESET_RSTCLR_HIBRS FCERS,
                           SCU_RESET_RSTCLR_HIBRS DMA1RS,
                           SCU_RESET_RSTCLR_HIBRS DMA0RS,
                           SCU_RESET_RSTCLR_HIBRS ETH0RS,
                           SCU_RESET_RSTCLR_HIBRS WDTRS) volatile
    {
     ...
     */
    inline SCU_RESET_RSTSTAT_HIBRS get_PRSTAT3_EBURS() volatile
    {
        return SCU_RESET_RSTSTAT_HIBRS(PRSTAT3 & (1u << 2u));
    }
