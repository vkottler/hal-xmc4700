...
struct [[gnu::packed]] gpdma0_ch0
{
     ...
     */
    inline bool get_CTLL_SRC_GATHER_EN() volatile
    {
        return CTLL & (1u << 17u);
    }
     ...
     */
    inline bool get_CTLL_DST_SCATTER_EN() volatile
    {
        return CTLL & (1u << 18u);
    }
    ...
    inline void get_CTLL(bool &INT_EN, uint8_t &DST_TR_WIDTH,
                         ...
                         uint8_t &SRC_MSIZE, bool &SRC_GATHER_EN,
                         bool &DST_SCATTER_EN, uint8_t &TT_FC,
                         bool &LLP_DST_EN, bool &LLP_SRC_EN) volatile
    {
        uint32_t curr = CTLL;
        ...
        SRC_GATHER_EN = curr & (1u << 17u);
        DST_SCATTER_EN = curr & (1u << 18u);
    ...
    inline void set_CTLL(bool INT_EN, uint8_t DST_TR_WIDTH,
                         ...
                         GPDMA0_CH0_CTLL_DINC SINC, uint8_t DEST_MSIZE,
                         uint8_t SRC_MSIZE, bool SRC_GATHER_EN,
                         bool DST_SCATTER_EN, uint8_t TT_FC, bool LLP_DST_EN,
                         bool LLP_SRC_EN) volatile
    {
        ...
        curr &= ~(0b1u << 17u);
        curr |= (SRC_GATHER_EN & 0b1u) << 17u;
        curr &= ~(0b1u << 18u);
        curr |= (DST_SCATTER_EN & 0b1u) << 18u;
        curr &= ~(0b111u << 20u);
    ...
    inline void set_CFGL(uint8_t CH_PRIOR, bool CH_SUSP, bool HS_SEL_DST,
                         bool HS_SEL_SRC, GPDMA0_CH0_CFGL_LOCK_CH_L LOCK_CH_L,
                         GPDMA0_CH0_CFGL_LOCK_CH_L LOCK_B_L, bool LOCK_CH,
                         bool LOCK_B, bool DST_HS_POL, bool SRC_HS_POL,
                         uint16_t MAX_ABRST, bool RELOAD_SRC,
                         bool RELOAD_DST) volatile
