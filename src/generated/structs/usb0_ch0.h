...
struct [[gnu::packed]] usb0_ch0
{
     ...
     * Channel Enable
     */
    inline bool get_HCCHAR_ChEna() volatile
    {
        return HCCHAR & (1u << 31u);
    }
     ...
     * Odd Frame
     */
    inline bool get_HCCHAR_OddFrm() volatile
    {
        return HCCHAR & (1u << 29u);
    }
     ...
     * Endpoint Direction
     */
    inline bool get_HCCHAR_EPDir() volatile
    {
        return HCCHAR & (1u << 15u);
    }
     ...
     *
     * (read-write) Host Channel Characteristics Register
     */
    inline void get_HCCHAR(bool &ChEna, bool &ChDis, bool &OddFrm,
                           uint8_t &DevAddr, USB0_CH0_HCCHAR_MC_EC &MC_EC,
                           USB0_CH0_HCCHAR_EPType &EPType, bool &EPDir,
                           uint8_t &EPNum, uint16_t &MPS) volatile
    {
        uint32_t curr = HCCHAR;
     ...
     * (read-write) Host Channel Characteristics Register
     */
    inline void set_HCCHAR(bool ChEna, bool ChDis, bool OddFrm,
                           uint8_t DevAddr, USB0_CH0_HCCHAR_MC_EC MC_EC,
                           USB0_CH0_HCCHAR_EPType EPType, bool EPDir,
                           uint8_t EPNum, uint16_t MPS) volatile
    {
     ...
     *
     * (read-write) Host Channel Interrupt Register
     */
     ...
     *
     * (read-write) Host Channel Interrupt Mask Register
     */
     ...
     *
     * (read-write) Host Channel Transfer Size Register [BUFFERMODE]
     */
     ...
     *
     * Number of Transfer Descriptors: 0=1 descriptor, 63=64 descriptors, 1=2
     * descriptors, 3=4 descriptors, 7=8 descriptors, 15=16 descriptors, 31=32
     * descriptors, 63=64 descriptors,
     */
     ...
     *
     * (read-write) Host Channel DMA Address Register [BUFFERMODE]
     */
