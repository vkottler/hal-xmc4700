...
struct [[gnu::packed]] usb0_ch0
{
     ...
     */
    inline void get_HCCHAR(USB0_CH0_HCCHAR_ChEna &ChEna, bool &ChDis, USB0_CH0_HCCHAR_OddFrm &OddFrm, uint8_t &DevAddr, USB0_CH0_HCCHAR_MC_EC &MC_EC, USB0_CH0_HCCHAR_EPType &EPType, USB0_CH0_HCCHAR_EPDir &EPDir, uint8_t &EPNum, uint16_t &MPS) volatile
    {
        uint32_t curr = HCCHAR;
     ...
     */
    inline void set_HCCHAR(USB0_CH0_HCCHAR_ChEna ChEna, bool ChDis, USB0_CH0_HCCHAR_OddFrm OddFrm, uint8_t DevAddr, USB0_CH0_HCCHAR_MC_EC MC_EC, USB0_CH0_HCCHAR_EPType EPType, USB0_CH0_HCCHAR_EPDir EPDir, uint8_t EPNum, uint16_t MPS) volatile
    {
        uint32_t curr = HCCHAR;
     ...
     */
    inline void get_HCINT(bool &DESC_LST_ROLLIntr, bool &XCS_XACT_ERR, bool &BNAIntr, bool &DataTglErr, bool &FrmOvrun, bool &BblErr, bool &XactErr, bool &NYET, bool &ACK, bool &NAK, bool &STALL, bool &AHBErr, bool &ChHltd, bool &XferCompl) volatile
    {
        uint32_t curr = HCINT;
     ...
     */
    inline void set_HCINT(bool DESC_LST_ROLLIntr, bool XCS_XACT_ERR, bool BNAIntr, bool DataTglErr, bool FrmOvrun, bool BblErr, bool XactErr, bool NYET, bool ACK, bool NAK, bool STALL, bool AHBErr, bool ChHltd, bool XferCompl) volatile
    {
        uint32_t curr = HCINT;
     ...
     */
    inline void get_HCINTMSK(bool &DESC_LST_ROLLIntrMsk, bool &BNAIntrMsk, bool &DataTglErrMsk, bool &FrmOvrunMsk, bool &BblErrMsk, bool &XactErrMsk, bool &NyetMsk, bool &AckMsk, bool &NakMsk, bool &StallMsk, bool &AHBErrMsk, bool &ChHltdMsk, bool &XferComplMsk) volatile
    {
     ...
     */
    inline void set_HCINTMSK(bool DESC_LST_ROLLIntrMsk, bool BNAIntrMsk, bool DataTglErrMsk, bool FrmOvrunMsk, bool BblErrMsk, bool XactErrMsk, bool NyetMsk, bool AckMsk, bool NakMsk, bool StallMsk, bool AHBErrMsk, bool ChHltdMsk, bool XferComplMsk) volatile
    {
        uint32_t curr = HCINTMSK;
     ...
     */
    inline void set_HCTSIZ_BUFFERMODE_Pid(USB0_CH0_HCTSIZ_BUFFERMODE_Pid value) volatile
    {
     ...
     */
    inline void get_HCTSIZ_BUFFERMODE(USB0_CH0_HCTSIZ_BUFFERMODE_Pid &Pid, uint16_t &PktCnt, uint32_t &XferSize) volatile
    {
        uint32_t curr = HCTSIZ_BUFFERMODE;
     ...
     */
    inline void set_HCTSIZ_BUFFERMODE(USB0_CH0_HCTSIZ_BUFFERMODE_Pid Pid, uint16_t PktCnt, uint32_t XferSize) volatile
    {
        uint32_t curr = HCTSIZ_BUFFERMODE;
     ...
     * Set HCTSIZ_BUFFERMODE's Pid field.
     */
    inline void set_HCTSIZ_SCATGATHER_Pid(USB0_CH0_HCTSIZ_SCATGATHER_Pid value) volatile
    {
     ...
     */
    inline void get_HCTSIZ_SCATGATHER(USB0_CH0_HCTSIZ_SCATGATHER_Pid &Pid, uint8_t &NTD, uint8_t &SCHED_INFO) volatile
    {
        uint32_t curr = HCTSIZ_SCATGATHER;
     ...
     */
    inline void set_HCTSIZ_SCATGATHER(USB0_CH0_HCTSIZ_SCATGATHER_Pid Pid, uint8_t NTD, uint8_t SCHED_INFO) volatile
    {
        uint32_t curr = HCTSIZ_SCATGATHER;
     ...
     */
    inline void set_HCDMA_SCATGATHER_CTD(USB0_CH0_HCDMA_SCATGATHER_CTD value) volatile
    {
        uint32_t curr = HCDMA_SCATGATHER;
     ...
     */
    inline void get_HCDMA_SCATGATHER(uint32_t &DMAAddr, USB0_CH0_HCDMA_SCATGATHER_CTD &CTD) volatile
    {
        uint32_t curr = HCDMA_SCATGATHER;
     ...
     */
    inline void set_HCDMA_SCATGATHER(uint32_t DMAAddr, USB0_CH0_HCDMA_SCATGATHER_CTD CTD) volatile
    {
        uint32_t curr = HCDMA_SCATGATHER;
