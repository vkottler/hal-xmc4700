...
struct [[gnu::packed]] usb0_ch0
{
    ...
    union
    {
        uint32_t HCTSIZ_BUFFERMODE; /* (read-write) Host Channel Transfer Size Register [BUFFERMODE] */
        uint32_t HCTSIZ_SCATGATHER; /* (read-write) Host Channel Transfer Size Register [SCATGATHER] */
    };
    union
    {
        uint32_t HCDMA_BUFFERMODE; /* (read-write) Host Channel DMA Address Register [BUFFERMODE] */
        uint32_t HCDMA_SCATGATHER; /* (read-write) Host Channel DMA Address Register [SCATGATHER] */
    };
    ...
    uint32_t HCINTMSK;                     /*!< (read-write) Host Channel Interrupt Mask Register */
    const uint32_t reserved_padding1 = {};
    const uint32_t HCDMAB = {};            /*!< (read-only) Host Channel DMA Buffer Address Register */
     ...
     */
    inline USB0_CH0_HCCHAR_ChEna get_HCCHAR_ChEna()
    {
     ...
     */
    inline USB0_CH0_HCCHAR_OddFrm get_HCCHAR_OddFrm()
    {
     ...
     */
    inline uint8_t get_HCCHAR_DevAddr()
    {
     ...
     */
    inline USB0_CH0_HCCHAR_MC_EC get_HCCHAR_MC_EC()
    {
     ...
     */
    inline USB0_CH0_HCCHAR_EPType get_HCCHAR_EPType()
    {
     ...
     */
    inline USB0_CH0_HCCHAR_EPDir get_HCCHAR_EPDir()
    {
     ...
     */
    inline uint8_t get_HCCHAR_EPNum()
    {
     ...
     */
    inline uint16_t get_HCCHAR_MPS()
    {
     ...
     */
    inline void get_HCCHAR(USB0_CH0_HCCHAR_ChEna &ChEna, bool &ChDis, USB0_CH0_HCCHAR_OddFrm &OddFrm, uint8_t &DevAddr, USB0_CH0_HCCHAR_MC_EC &MC_EC, USB0_CH0_HCCHAR_EPType &EPType, USB0_CH0_HCCHAR_EPDir &EPDir, uint8_t &EPNum, uint16_t &MPS)
    {
        uint32_t curr = HCCHAR;
     ...
     */
    inline void set_HCCHAR(USB0_CH0_HCCHAR_ChEna ChEna, bool ChDis, USB0_CH0_HCCHAR_OddFrm OddFrm, uint8_t DevAddr, USB0_CH0_HCCHAR_MC_EC MC_EC, USB0_CH0_HCCHAR_EPType EPType, USB0_CH0_HCCHAR_EPDir EPDir, uint8_t EPNum, uint16_t MPS)
    {
        uint32_t curr = HCCHAR;
     ...
     */
    inline bool get_HCINT_DESC_LST_ROLLIntr()
    {
        return HCINT & (1u << 13u);
    }
     ...
     */
    inline bool get_HCINT_XCS_XACT_ERR()
    {
        return HCINT & (1u << 12u);
    }
     ...
     */
    inline bool get_HCINT_DataTglErr()
    {
        return HCINT & (1u << 10u);
    }
     ...
     */
    inline bool get_HCINT_FrmOvrun()
    {
        return HCINT & (1u << 9u);
    }
     ...
     */
    inline bool get_HCINT_XferCompl()
    {
        return HCINT & (1u << 0u);
    }
     ...
     */
    inline void get_HCINT(bool &DESC_LST_ROLLIntr, bool &XCS_XACT_ERR, bool &BNAIntr, bool &DataTglErr, bool &FrmOvrun, bool &BblErr, bool &XactErr, bool &NYET, bool &ACK, bool &NAK, bool &STALL, bool &AHBErr, bool &ChHltd, bool &XferCompl)
    {
        uint32_t curr = HCINT;
     ...
     */
    inline void set_HCINT(bool DESC_LST_ROLLIntr, bool XCS_XACT_ERR, bool BNAIntr, bool DataTglErr, bool FrmOvrun, bool BblErr, bool XactErr, bool NYET, bool ACK, bool NAK, bool STALL, bool AHBErr, bool ChHltd, bool XferCompl)
    {
        uint32_t curr = HCINT;
     ...
     */
    inline bool get_HCINTMSK_DESC_LST_ROLLIntrMsk()
    {
     ...
     */
    inline bool get_HCINTMSK_BNAIntrMsk()
    {
     ...
     */
    inline bool get_HCINTMSK_DataTglErrMsk()
    {
     ...
     */
    inline bool get_HCINTMSK_FrmOvrunMsk()
    {
     ...
     */
    inline bool get_HCINTMSK_BblErrMsk()
    {
     ...
     */
    inline bool get_HCINTMSK_XactErrMsk()
    {
     ...
     */
    inline bool get_HCINTMSK_NyetMsk()
    {
     ...
     */
    inline bool get_HCINTMSK_AckMsk()
    {
     ...
     */
    inline bool get_HCINTMSK_NakMsk()
    {
     ...
     */
    inline bool get_HCINTMSK_StallMsk()
    {
     ...
     */
    inline bool get_HCINTMSK_AHBErrMsk()
    {
     ...
     */
    inline bool get_HCINTMSK_ChHltdMsk()
    {
     ...
     */
    inline bool get_HCINTMSK_XferComplMsk()
    {
     ...
     */
    inline void get_HCINTMSK(bool &DESC_LST_ROLLIntrMsk, bool &BNAIntrMsk, bool &DataTglErrMsk, bool &FrmOvrunMsk, bool &BblErrMsk, bool &XactErrMsk, bool &NyetMsk, bool &AckMsk, bool &NakMsk, bool &StallMsk, bool &AHBErrMsk, bool &ChHltdMsk, bool &XferComplMsk)
    {
     ...
     */
    inline void set_HCINTMSK(bool DESC_LST_ROLLIntrMsk, bool BNAIntrMsk, bool DataTglErrMsk, bool FrmOvrunMsk, bool BblErrMsk, bool XactErrMsk, bool NyetMsk, bool AckMsk, bool NakMsk, bool StallMsk, bool AHBErrMsk, bool ChHltdMsk, bool XferComplMsk)
    {
        uint32_t curr = HCINTMSK;
     ...
     */
    inline USB0_CH0_HCTSIZ_BUFFERMODE_Pid get_HCTSIZ_BUFFERMODE_Pid()
    {
        return USB0_CH0_HCTSIZ_BUFFERMODE_Pid((HCTSIZ_BUFFERMODE >> 29u) & 0b11u);
    }
     ...
     */
    inline uint16_t get_HCTSIZ_BUFFERMODE_PktCnt()
    {
     ...
     */
    inline uint32_t get_HCTSIZ_BUFFERMODE_XferSize()
    {
     ...
     */
    inline void get_HCTSIZ_BUFFERMODE(USB0_CH0_HCTSIZ_BUFFERMODE_Pid &Pid, uint16_t &PktCnt, uint32_t &XferSize)
    {
        uint32_t curr = HCTSIZ_BUFFERMODE;
     ...
     */
    inline void set_HCTSIZ_BUFFERMODE(USB0_CH0_HCTSIZ_BUFFERMODE_Pid Pid, uint16_t PktCnt, uint32_t XferSize)
    {
        uint32_t curr = HCTSIZ_BUFFERMODE;
     ...
     * Get HCTSIZ_BUFFERMODE's Pid field.
     */
    inline USB0_CH0_HCTSIZ_SCATGATHER_Pid get_HCTSIZ_SCATGATHER_Pid()
    {
        return USB0_CH0_HCTSIZ_SCATGATHER_Pid((HCTSIZ_SCATGATHER >> 29u) & 0b11u);
    }
     ...
     */
    inline uint8_t get_HCTSIZ_SCATGATHER_NTD()
    {
     ...
     */
    inline uint8_t get_HCTSIZ_SCATGATHER_SCHED_INFO()
    {
     ...
     */
    inline void get_HCTSIZ_SCATGATHER(USB0_CH0_HCTSIZ_SCATGATHER_Pid &Pid, uint8_t &NTD, uint8_t &SCHED_INFO)
    {
        uint32_t curr = HCTSIZ_SCATGATHER;
     ...
     */
    inline void set_HCTSIZ_SCATGATHER(USB0_CH0_HCTSIZ_SCATGATHER_Pid Pid, uint8_t NTD, uint8_t SCHED_INFO)
    {
        uint32_t curr = HCTSIZ_SCATGATHER;
     ...
     */
    inline uint32_t get_HCDMA_BUFFERMODE_DMAAddr()
    {
     ...
     * Get HCDMA_BUFFERMODE's DMAAddr field.
     */
    inline uint32_t get_HCDMA_SCATGATHER_DMAAddr()
    {
     ...
     */
    inline USB0_CH0_HCDMA_SCATGATHER_CTD get_HCDMA_SCATGATHER_CTD()
    {
        return USB0_CH0_HCDMA_SCATGATHER_CTD((HCDMA_SCATGATHER >> 3u) & 0b111111u);
    }
     ...
     */
    inline void get_HCDMA_SCATGATHER(uint32_t &DMAAddr, USB0_CH0_HCDMA_SCATGATHER_CTD &CTD)
    {
        uint32_t curr = HCDMA_SCATGATHER;
     ...
     */
    inline void set_HCDMA_SCATGATHER(uint32_t DMAAddr, USB0_CH0_HCDMA_SCATGATHER_CTD CTD)
    {
        uint32_t curr = HCDMA_SCATGATHER;
     ...
     */
    inline uint32_t get_HCDMAB_Buffer_Address()
    {
...
static volatile usb0_ch0 *const USB0_CH0 = reinterpret_cast<usb0_ch0 *>(0x50040500);

static volatile usb0_ch0 *const USB0_CH1 = reinterpret_cast<usb0_ch0 *>(0x50040520);

static volatile usb0_ch0 *const USB0_CH2 = reinterpret_cast<usb0_ch0 *>(0x50040540);

static volatile usb0_ch0 *const USB0_CH3 = reinterpret_cast<usb0_ch0 *>(0x50040560);

static volatile usb0_ch0 *const USB0_CH4 = reinterpret_cast<usb0_ch0 *>(0x50040580);

static volatile usb0_ch0 *const USB0_CH5 = reinterpret_cast<usb0_ch0 *>(0x500405A0);

static volatile usb0_ch0 *const USB0_CH6 = reinterpret_cast<usb0_ch0 *>(0x500405C0);

static volatile usb0_ch0 *const USB0_CH7 = reinterpret_cast<usb0_ch0 *>(0x500405E0);

static volatile usb0_ch0 *const USB0_CH8 = reinterpret_cast<usb0_ch0 *>(0x50040600);

static volatile usb0_ch0 *const USB0_CH9 = reinterpret_cast<usb0_ch0 *>(0x50040620);

static volatile usb0_ch0 *const USB0_CH10 = reinterpret_cast<usb0_ch0 *>(0x50040640);

static volatile usb0_ch0 *const USB0_CH11 = reinterpret_cast<usb0_ch0 *>(0x50040660);

static volatile usb0_ch0 *const USB0_CH12 = reinterpret_cast<usb0_ch0 *>(0x50040680);

static volatile usb0_ch0 *const USB0_CH13 = reinterpret_cast<usb0_ch0 *>(0x500406A0);
