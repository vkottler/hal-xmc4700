...
struct [[gnu::packed]] ebu
{
     ...
     */
    inline EBU_CLC_EBUDIV get_CLC_EBUDIV() volatile
    {
     ...
     */
    inline void set_CLC_EBUDIV(EBU_CLC_EBUDIV value) volatile
    {
        uint32_t curr = CLC;
     ...
     */
    inline void get_CLC(EBU_CLC_EBUDIVACK &EBUDIVACK, EBU_CLC_DIV2ACK &DIV2ACK, EBU_CLC_SYNCACK &SYNCACK, EBU_CLC_EBUDIV &EBUDIV, EBU_CLC_DIV2 &DIV2, EBU_CLC_SYNC &SYNC, EBU_CLC_DISS &DISS, EBU_CLC_DISR &DISR) volatile
    {
        uint32_t curr = CLC;
     ...
     */
    inline void set_CLC(EBU_CLC_EBUDIV EBUDIV, EBU_CLC_DIV2 DIV2, EBU_CLC_SYNC SYNC, EBU_CLC_DISR DISR) volatile
    {
        uint32_t curr = CLC;
     ...
     */
    inline void get_MODCON(EBU_MODCON_ALE &ALE, bool &ACCSINHACK, bool &ACCSINH, uint8_t &GLOBALCS, uint8_t &LOCKTIMEOUT, EBU_MODCON_TIMEOUTC &TIMEOUTC, EBU_MODCON_ARBMODE &ARBMODE, EBU_MODCON_ARBSYNC &ARBSYNC, EBU_MODCON_EXTLOCK &EXTLOCK, EBU_MODCON_SDTRI &SDTRI, bool &LCKABRT, bool &STS) volatile
    {
        uint32_t curr = MODCON;
     ...
     */
    inline void set_MODCON(EBU_MODCON_ALE ALE, bool ACCSINH, uint8_t GLOBALCS, uint8_t LOCKTIMEOUT, EBU_MODCON_TIMEOUTC TIMEOUTC, EBU_MODCON_ARBMODE ARBMODE, EBU_MODCON_ARBSYNC ARBSYNC, EBU_MODCON_EXTLOCK EXTLOCK, EBU_MODCON_SDTRI SDTRI) volatile
    {
        uint32_t curr = MODCON;
     ...
     */
    inline void get_USERCON(EBU_USERCON_ADVIO &ADVIO, EBU_USERCON_ADDIO &ADDIO, bool &DIP) volatile
    {
        uint32_t curr = USERCON;
     ...
     */
    inline void set_USERCON(EBU_USERCON_ADVIO ADVIO, EBU_USERCON_ADDIO ADDIO, bool DIP) volatile
    {
        uint32_t curr = USERCON;
     ...
     */
    inline EBU_ADDRSEL0_REGENAB get_ADDRSEL0_REGENAB() volatile
    {
     ...
     */
    inline void get_ADDRSEL0(EBU_ADDRSEL0_WPROT &WPROT, EBU_ADDRSEL0_ALTENAB &ALTENAB, EBU_ADDRSEL0_REGENAB &REGENAB) volatile
    {
     ...
     */
    inline void set_ADDRSEL0(EBU_ADDRSEL0_WPROT WPROT, EBU_ADDRSEL0_ALTENAB ALTENAB, EBU_ADDRSEL0_REGENAB REGENAB) volatile
    {
        uint32_t curr = ADDRSEL0;
     ...
     */
    inline EBU_ADDRSEL1_WPROT get_ADDRSEL1_WPROT() volatile
    {
     ...
     */
    inline EBU_ADDRSEL1_ALTENAB get_ADDRSEL1_ALTENAB() volatile
    {
     ...
     */
    inline EBU_ADDRSEL1_REGENAB get_ADDRSEL1_REGENAB() volatile
    {
     ...
     */
    inline void get_ADDRSEL1(EBU_ADDRSEL1_WPROT &WPROT, EBU_ADDRSEL1_ALTENAB &ALTENAB, EBU_ADDRSEL1_REGENAB &REGENAB) volatile
    {
     ...
     */
    inline void set_ADDRSEL1(EBU_ADDRSEL1_WPROT WPROT, EBU_ADDRSEL1_ALTENAB ALTENAB, EBU_ADDRSEL1_REGENAB REGENAB) volatile
    {
        uint32_t curr = ADDRSEL1;
     ...
     */
    inline EBU_ADDRSEL2_WPROT get_ADDRSEL2_WPROT() volatile
    {
     ...
     */
    inline EBU_ADDRSEL2_ALTENAB get_ADDRSEL2_ALTENAB() volatile
    {
     ...
     */
    inline EBU_ADDRSEL2_REGENAB get_ADDRSEL2_REGENAB() volatile
    {
     ...
     */
    inline void get_ADDRSEL2(EBU_ADDRSEL2_WPROT &WPROT, EBU_ADDRSEL2_ALTENAB &ALTENAB, EBU_ADDRSEL2_REGENAB &REGENAB) volatile
    {
     ...
     */
    inline void set_ADDRSEL2(EBU_ADDRSEL2_WPROT WPROT, EBU_ADDRSEL2_ALTENAB ALTENAB, EBU_ADDRSEL2_REGENAB REGENAB) volatile
    {
        uint32_t curr = ADDRSEL2;
     ...
     */
    inline EBU_ADDRSEL3_WPROT get_ADDRSEL3_WPROT() volatile
    {
     ...
     */
    inline EBU_ADDRSEL3_ALTENAB get_ADDRSEL3_ALTENAB() volatile
    {
     ...
     */
    inline EBU_ADDRSEL3_REGENAB get_ADDRSEL3_REGENAB() volatile
    {
     ...
     */
    inline void get_ADDRSEL3(EBU_ADDRSEL3_WPROT &WPROT, EBU_ADDRSEL3_ALTENAB &ALTENAB, EBU_ADDRSEL3_REGENAB &REGENAB) volatile
    {
     ...
     */
    inline void set_ADDRSEL3(EBU_ADDRSEL3_WPROT WPROT, EBU_ADDRSEL3_ALTENAB ALTENAB, EBU_ADDRSEL3_REGENAB REGENAB) volatile
    {
        uint32_t curr = ADDRSEL3;
     ...
     */
    inline EBU_BUSRCON0_ECSE get_BUSRCON0_ECSE() volatile
    {
     ...
     */
    inline EBU_BUSRAP0_CMDDELAY get_BUSRAP0_CMDDELAY() volatile
    {
     ...
     */
    inline void set_BUSRAP0_CMDDELAY(EBU_BUSRAP0_CMDDELAY value) volatile
    {
        uint32_t curr = BUSRAP0;
     ...
     */
    inline void get_BUSRAP0(EBU_BUSRAP0_ADDRC &ADDRC, EBU_BUSRAP0_AHOLDC &AHOLDC, EBU_BUSRAP0_CMDDELAY &CMDDELAY, EBU_BUSRAP0_EXTDATA &EXTDATA, EBU_BUSRAP0_EXTCLOCK &EXTCLOCK, uint8_t &DATAC, EBU_BUSRAP0_WAITRDC &WAITRDC, EBU_BUSRAP0_RDRECOVC &RDRECOVC, EBU_BUSRAP0_RDDTACS &RDDTACS) volatile
    {
        uint32_t curr = BUSRAP0;
     ...
     */
    inline void set_BUSRAP0(EBU_BUSRAP0_ADDRC ADDRC, EBU_BUSRAP0_AHOLDC AHOLDC, EBU_BUSRAP0_CMDDELAY CMDDELAY, EBU_BUSRAP0_EXTDATA EXTDATA, EBU_BUSRAP0_EXTCLOCK EXTCLOCK, uint8_t DATAC, EBU_BUSRAP0_WAITRDC WAITRDC, EBU_BUSRAP0_RDRECOVC RDRECOVC, EBU_BUSRAP0_RDDTACS RDDTACS) volatile
    {
        uint32_t curr = BUSRAP0;
     ...
     */
    inline EBU_BUSWCON0_AAP get_BUSWCON0_AAP() volatile
    {
     ...
     */
    inline EBU_BUSWCON0_BCGEN get_BUSWCON0_BCGEN() volatile
    {
     ...
     */
    inline void set_BUSWCON0_BCGEN(EBU_BUSWCON0_BCGEN value) volatile
    {
        uint32_t curr = BUSWCON0;
     ...
     */
    inline EBU_BUSWCON0_WAITINV get_BUSWCON0_WAITINV() volatile
    {
     ...
     */
    inline EBU_BUSWCON0_EBSE get_BUSWCON0_EBSE() volatile
    {
     ...
     */
    inline EBU_BUSWCON0_ECSE get_BUSWCON0_ECSE() volatile
    {
     ...
     */
    inline EBU_BUSWCON0_FBBMSEL get_BUSWCON0_FBBMSEL() volatile
    {
     ...
     */
    inline EBU_BUSWCON0_FETBLEN get_BUSWCON0_FETBLEN() volatile
    {
     ...
     */
    inline void set_BUSWCON0_FETBLEN(EBU_BUSWCON0_FETBLEN value) volatile
    {
        uint32_t curr = BUSWCON0;
     ...
     */
    inline void get_BUSWCON0(uint8_t &AGEN, EBU_BUSWCON0_LOCKCS &LOCKCS, EBU_BUSWCON0_AAP &AAP, uint8_t &WAIT, uint8_t &PORTW, EBU_BUSWCON0_BCGEN &BCGEN, EBU_BUSWCON0_WAITINV &WAITINV, EBU_BUSWCON0_EBSE &EBSE, EBU_BUSWCON0_ECSE &ECSE, bool &NAA, EBU_BUSWCON0_FBBMSEL &FBBMSEL, EBU_BUSWCON0_FETBLEN &FETBLEN) volatile
    {
        uint32_t curr = BUSWCON0;
     ...
     */
    inline void set_BUSWCON0(uint8_t AGEN, EBU_BUSWCON0_LOCKCS LOCKCS, EBU_BUSWCON0_AAP AAP, uint8_t WAIT, EBU_BUSWCON0_BCGEN BCGEN, EBU_BUSWCON0_WAITINV WAITINV, EBU_BUSWCON0_EBSE EBSE, EBU_BUSWCON0_ECSE ECSE, EBU_BUSWCON0_FBBMSEL FBBMSEL, EBU_BUSWCON0_FETBLEN FETBLEN) volatile
    {
        uint32_t curr = BUSWCON0;
     ...
     */
    inline EBU_BUSWAP0_ADDRC get_BUSWAP0_ADDRC() volatile
    {
     ...
     */
    inline void set_BUSWAP0_ADDRC(EBU_BUSWAP0_ADDRC value) volatile
    {
     ...
     */
    inline EBU_BUSWAP0_AHOLDC get_BUSWAP0_AHOLDC() volatile
    {
     ...
     */
    inline void set_BUSWAP0_AHOLDC(EBU_BUSWAP0_AHOLDC value) volatile
    {
        uint32_t curr = BUSWAP0;
     ...
     */
    inline EBU_BUSWAP0_CMDDELAY get_BUSWAP0_CMDDELAY() volatile
    {
     ...
     */
    inline void set_BUSWAP0_CMDDELAY(EBU_BUSWAP0_CMDDELAY value) volatile
    {
        uint32_t curr = BUSWAP0;
     ...
     */
    inline EBU_BUSWAP0_EXTDATA get_BUSWAP0_EXTDATA() volatile
    {
     ...
     */
    inline void set_BUSWAP0_EXTDATA(EBU_BUSWAP0_EXTDATA value) volatile
    {
        uint32_t curr = BUSWAP0;
     ...
     */
    inline EBU_BUSWAP0_EXTCLOCK get_BUSWAP0_EXTCLOCK() volatile
    {
     ...
     */
    inline void set_BUSWAP0_EXTCLOCK(EBU_BUSWAP0_EXTCLOCK value) volatile
    {
        uint32_t curr = BUSWAP0;
     ...
     */
    inline EBU_BUSWAP0_DATAC get_BUSWAP0_DATAC() volatile
    {
     ...
     */
    inline void set_BUSWAP0_DATAC(EBU_BUSWAP0_DATAC value) volatile
    {
        uint32_t curr = BUSWAP0;
     ...
     */
    inline EBU_BUSWAP0_WAITWRC get_BUSWAP0_WAITWRC() volatile
    {
     ...
     */
    inline void set_BUSWAP0_WAITWRC(EBU_BUSWAP0_WAITWRC value) volatile
    {
        uint32_t curr = BUSWAP0;
     ...
     */
    inline EBU_BUSWAP0_WRRECOVC get_BUSWAP0_WRRECOVC() volatile
    {
     ...
     */
    inline void set_BUSWAP0_WRRECOVC(EBU_BUSWAP0_WRRECOVC value) volatile
    {
        uint32_t curr = BUSWAP0;
     ...
     */
    inline EBU_BUSWAP0_WRDTACS get_BUSWAP0_WRDTACS() volatile
    {
     ...
     */
    inline void set_BUSWAP0_WRDTACS(EBU_BUSWAP0_WRDTACS value) volatile
    {
        uint32_t curr = BUSWAP0;
     ...
     */
    inline void get_BUSWAP0(EBU_BUSWAP0_ADDRC &ADDRC, EBU_BUSWAP0_AHOLDC &AHOLDC, EBU_BUSWAP0_CMDDELAY &CMDDELAY, EBU_BUSWAP0_EXTDATA &EXTDATA, EBU_BUSWAP0_EXTCLOCK &EXTCLOCK, EBU_BUSWAP0_DATAC &DATAC, EBU_BUSWAP0_WAITWRC &WAITWRC, EBU_BUSWAP0_WRRECOVC &WRRECOVC, EBU_BUSWAP0_WRDTACS &WRDTACS) volatile
    {
        uint32_t curr = BUSWAP0;
     ...
     */
    inline void set_BUSWAP0(EBU_BUSWAP0_ADDRC ADDRC, EBU_BUSWAP0_AHOLDC AHOLDC, EBU_BUSWAP0_CMDDELAY CMDDELAY, EBU_BUSWAP0_EXTDATA EXTDATA, EBU_BUSWAP0_EXTCLOCK EXTCLOCK, EBU_BUSWAP0_DATAC DATAC, EBU_BUSWAP0_WAITWRC WAITWRC, EBU_BUSWAP0_WRRECOVC WRRECOVC, EBU_BUSWAP0_WRDTACS WRDTACS) volatile
    {
        uint32_t curr = BUSWAP0;
     ...
     */
    inline EBU_BUSRCON1_AAP get_BUSRCON1_AAP() volatile
    {
     ...
     */
    inline EBU_BUSRCON1_BCGEN get_BUSRCON1_BCGEN() volatile
    {
     ...
     */
    inline void set_BUSRCON1_BCGEN(EBU_BUSRCON1_BCGEN value) volatile
    {
        uint32_t curr = BUSRCON1;
     ...
     */
    inline EBU_BUSRCON1_WAITINV get_BUSRCON1_WAITINV() volatile
    {
     ...
     */
    inline EBU_BUSRCON1_DBA get_BUSRCON1_DBA() volatile
    {
     ...
     */
    inline EBU_BUSRCON1_EBSE get_BUSRCON1_EBSE() volatile
    {
     ...
     */
    inline EBU_BUSRCON1_ECSE get_BUSRCON1_ECSE() volatile
    {
     ...
     */
    inline EBU_BUSRCON1_BFCMSEL get_BUSRCON1_BFCMSEL() volatile
    {
     ...
     */
    inline EBU_BUSRCON1_FDBKEN get_BUSRCON1_FDBKEN() volatile
    {
     ...
     */
    inline EBU_BUSRCON1_BFSSS get_BUSRCON1_BFSSS() volatile
    {
     ...
     */
    inline EBU_BUSRCON1_FBBMSEL get_BUSRCON1_FBBMSEL() volatile
    {
     ...
     */
    inline EBU_BUSRCON1_FETBLEN get_BUSRCON1_FETBLEN() volatile
    {
     ...
     */
    inline void set_BUSRCON1_FETBLEN(EBU_BUSRCON1_FETBLEN value) volatile
    {
        uint32_t curr = BUSRCON1;
     ...
     */
    inline EBU_BUSRAP1_ADDRC get_BUSRAP1_ADDRC() volatile
    {
     ...
     */
    inline void set_BUSRAP1_ADDRC(EBU_BUSRAP1_ADDRC value) volatile
    {
     ...
     */
    inline EBU_BUSRAP1_AHOLDC get_BUSRAP1_AHOLDC() volatile
    {
     ...
     */
    inline void set_BUSRAP1_AHOLDC(EBU_BUSRAP1_AHOLDC value) volatile
    {
        uint32_t curr = BUSRAP1;
     ...
     */
    inline EBU_BUSRAP1_CMDDELAY get_BUSRAP1_CMDDELAY() volatile
    {
     ...
     */
    inline void set_BUSRAP1_CMDDELAY(EBU_BUSRAP1_CMDDELAY value) volatile
    {
        uint32_t curr = BUSRAP1;
     ...
     */
    inline EBU_BUSRAP1_EXTDATA get_BUSRAP1_EXTDATA() volatile
    {
     ...
     */
    inline void set_BUSRAP1_EXTDATA(EBU_BUSRAP1_EXTDATA value) volatile
    {
        uint32_t curr = BUSRAP1;
     ...
     */
    inline EBU_BUSRAP1_EXTCLOCK get_BUSRAP1_EXTCLOCK() volatile
    {
     ...
     */
    inline void set_BUSRAP1_EXTCLOCK(EBU_BUSRAP1_EXTCLOCK value) volatile
    {
        uint32_t curr = BUSRAP1;
     ...
     */
    inline EBU_BUSRAP1_WAITRDC get_BUSRAP1_WAITRDC() volatile
    {
     ...
     */
    inline void set_BUSRAP1_WAITRDC(EBU_BUSRAP1_WAITRDC value) volatile
    {
        uint32_t curr = BUSRAP1;
     ...
     */
    inline EBU_BUSRAP1_RDRECOVC get_BUSRAP1_RDRECOVC() volatile
    {
     ...
     */
    inline void set_BUSRAP1_RDRECOVC(EBU_BUSRAP1_RDRECOVC value) volatile
    {
        uint32_t curr = BUSRAP1;
     ...
     */
    inline EBU_BUSRAP1_RDDTACS get_BUSRAP1_RDDTACS() volatile
    {
     ...
     */
    inline void set_BUSRAP1_RDDTACS(EBU_BUSRAP1_RDDTACS value) volatile
    {
        uint32_t curr = BUSRAP1;
     ...
     */
    inline void get_BUSRAP1(EBU_BUSRAP1_ADDRC &ADDRC, EBU_BUSRAP1_AHOLDC &AHOLDC, EBU_BUSRAP1_CMDDELAY &CMDDELAY, EBU_BUSRAP1_EXTDATA &EXTDATA, EBU_BUSRAP1_EXTCLOCK &EXTCLOCK, uint8_t &DATAC, EBU_BUSRAP1_WAITRDC &WAITRDC, EBU_BUSRAP1_RDRECOVC &RDRECOVC, EBU_BUSRAP1_RDDTACS &RDDTACS) volatile
    {
        uint32_t curr = BUSRAP1;
     ...
     */
    inline void set_BUSRAP1(EBU_BUSRAP1_ADDRC ADDRC, EBU_BUSRAP1_AHOLDC AHOLDC, EBU_BUSRAP1_CMDDELAY CMDDELAY, EBU_BUSRAP1_EXTDATA EXTDATA, EBU_BUSRAP1_EXTCLOCK EXTCLOCK, uint8_t DATAC, EBU_BUSRAP1_WAITRDC WAITRDC, EBU_BUSRAP1_RDRECOVC RDRECOVC, EBU_BUSRAP1_RDDTACS RDDTACS) volatile
    {
        uint32_t curr = BUSRAP1;
     ...
     */
    inline EBU_BUSWCON1_LOCKCS get_BUSWCON1_LOCKCS() volatile
    {
     ...
     */
    inline EBU_BUSWCON1_AAP get_BUSWCON1_AAP() volatile
    {
     ...
     */
    inline EBU_BUSWCON1_BCGEN get_BUSWCON1_BCGEN() volatile
    {
     ...
     */
    inline void set_BUSWCON1_BCGEN(EBU_BUSWCON1_BCGEN value) volatile
    {
        uint32_t curr = BUSWCON1;
     ...
     */
    inline EBU_BUSWCON1_WAITINV get_BUSWCON1_WAITINV() volatile
    {
     ...
     */
    inline EBU_BUSWCON1_EBSE get_BUSWCON1_EBSE() volatile
    {
     ...
     */
    inline EBU_BUSWCON1_ECSE get_BUSWCON1_ECSE() volatile
    {
     ...
     */
    inline EBU_BUSWCON1_FBBMSEL get_BUSWCON1_FBBMSEL() volatile
    {
     ...
     */
    inline EBU_BUSWCON1_FETBLEN get_BUSWCON1_FETBLEN() volatile
    {
     ...
     */
    inline void set_BUSWCON1_FETBLEN(EBU_BUSWCON1_FETBLEN value) volatile
    {
        uint32_t curr = BUSWCON1;
     ...
     */
    inline void get_BUSWCON1(uint8_t &AGEN, EBU_BUSWCON1_LOCKCS &LOCKCS, EBU_BUSWCON1_AAP &AAP, uint8_t &WAIT, uint8_t &PORTW, EBU_BUSWCON1_BCGEN &BCGEN, EBU_BUSWCON1_WAITINV &WAITINV, EBU_BUSWCON1_EBSE &EBSE, EBU_BUSWCON1_ECSE &ECSE, bool &NAA, EBU_BUSWCON1_FBBMSEL &FBBMSEL, EBU_BUSWCON1_FETBLEN &FETBLEN) volatile
    {
        uint32_t curr = BUSWCON1;
     ...
     */
    inline void set_BUSWCON1(uint8_t AGEN, EBU_BUSWCON1_LOCKCS LOCKCS, EBU_BUSWCON1_AAP AAP, uint8_t WAIT, EBU_BUSWCON1_BCGEN BCGEN, EBU_BUSWCON1_WAITINV WAITINV, EBU_BUSWCON1_EBSE EBSE, EBU_BUSWCON1_ECSE ECSE, EBU_BUSWCON1_FBBMSEL FBBMSEL, EBU_BUSWCON1_FETBLEN FETBLEN) volatile
    {
        uint32_t curr = BUSWCON1;
     ...
     */
    inline EBU_BUSWAP1_ADDRC get_BUSWAP1_ADDRC() volatile
    {
     ...
     */
    inline void set_BUSWAP1_ADDRC(EBU_BUSWAP1_ADDRC value) volatile
    {
     ...
     */
    inline EBU_BUSWAP1_AHOLDC get_BUSWAP1_AHOLDC() volatile
    {
     ...
     */
    inline void set_BUSWAP1_AHOLDC(EBU_BUSWAP1_AHOLDC value) volatile
    {
        uint32_t curr = BUSWAP1;
     ...
     */
    inline EBU_BUSWAP1_CMDDELAY get_BUSWAP1_CMDDELAY() volatile
    {
     ...
     */
    inline void set_BUSWAP1_CMDDELAY(EBU_BUSWAP1_CMDDELAY value) volatile
    {
        uint32_t curr = BUSWAP1;
     ...
     */
    inline EBU_BUSWAP1_EXTDATA get_BUSWAP1_EXTDATA() volatile
    {
     ...
     */
    inline void set_BUSWAP1_EXTDATA(EBU_BUSWAP1_EXTDATA value) volatile
    {
        uint32_t curr = BUSWAP1;
     ...
     */
    inline EBU_BUSWAP1_EXTCLOCK get_BUSWAP1_EXTCLOCK() volatile
    {
     ...
     */
    inline void set_BUSWAP1_EXTCLOCK(EBU_BUSWAP1_EXTCLOCK value) volatile
    {
        uint32_t curr = BUSWAP1;
     ...
     */
    inline EBU_BUSWAP1_DATAC get_BUSWAP1_DATAC() volatile
    {
     ...
     */
    inline void set_BUSWAP1_DATAC(EBU_BUSWAP1_DATAC value) volatile
    {
        uint32_t curr = BUSWAP1;
     ...
     */
    inline EBU_BUSWAP1_WAITWRC get_BUSWAP1_WAITWRC() volatile
    {
     ...
     */
    inline void set_BUSWAP1_WAITWRC(EBU_BUSWAP1_WAITWRC value) volatile
    {
        uint32_t curr = BUSWAP1;
     ...
     */
    inline EBU_BUSWAP1_WRRECOVC get_BUSWAP1_WRRECOVC() volatile
    {
     ...
     */
    inline void set_BUSWAP1_WRRECOVC(EBU_BUSWAP1_WRRECOVC value) volatile
    {
        uint32_t curr = BUSWAP1;
     ...
     */
    inline EBU_BUSWAP1_WRDTACS get_BUSWAP1_WRDTACS() volatile
    {
     ...
     */
    inline void set_BUSWAP1_WRDTACS(EBU_BUSWAP1_WRDTACS value) volatile
    {
        uint32_t curr = BUSWAP1;
     ...
     */
    inline void get_BUSWAP1(EBU_BUSWAP1_ADDRC &ADDRC, EBU_BUSWAP1_AHOLDC &AHOLDC, EBU_BUSWAP1_CMDDELAY &CMDDELAY, EBU_BUSWAP1_EXTDATA &EXTDATA, EBU_BUSWAP1_EXTCLOCK &EXTCLOCK, EBU_BUSWAP1_DATAC &DATAC, EBU_BUSWAP1_WAITWRC &WAITWRC, EBU_BUSWAP1_WRRECOVC &WRRECOVC, EBU_BUSWAP1_WRDTACS &WRDTACS) volatile
    {
        uint32_t curr = BUSWAP1;
     ...
     */
    inline void set_BUSWAP1(EBU_BUSWAP1_ADDRC ADDRC, EBU_BUSWAP1_AHOLDC AHOLDC, EBU_BUSWAP1_CMDDELAY CMDDELAY, EBU_BUSWAP1_EXTDATA EXTDATA, EBU_BUSWAP1_EXTCLOCK EXTCLOCK, EBU_BUSWAP1_DATAC DATAC, EBU_BUSWAP1_WAITWRC WAITWRC, EBU_BUSWAP1_WRRECOVC WRRECOVC, EBU_BUSWAP1_WRDTACS WRDTACS) volatile
    {
        uint32_t curr = BUSWAP1;
     ...
     */
    inline EBU_BUSRCON2_AAP get_BUSRCON2_AAP() volatile
    {
     ...
     */
    inline EBU_BUSRCON2_BCGEN get_BUSRCON2_BCGEN() volatile
    {
     ...
     */
    inline void set_BUSRCON2_BCGEN(EBU_BUSRCON2_BCGEN value) volatile
    {
        uint32_t curr = BUSRCON2;
     ...
     */
    inline EBU_BUSRCON2_WAITINV get_BUSRCON2_WAITINV() volatile
    {
     ...
     */
    inline EBU_BUSRCON2_DBA get_BUSRCON2_DBA() volatile
    {
     ...
     */
    inline EBU_BUSRCON2_EBSE get_BUSRCON2_EBSE() volatile
    {
     ...
     */
    inline EBU_BUSRCON2_ECSE get_BUSRCON2_ECSE() volatile
    {
     ...
     */
    inline EBU_BUSRCON2_BFCMSEL get_BUSRCON2_BFCMSEL() volatile
    {
     ...
     */
    inline EBU_BUSRCON2_FDBKEN get_BUSRCON2_FDBKEN() volatile
    {
     ...
     */
    inline EBU_BUSRCON2_BFSSS get_BUSRCON2_BFSSS() volatile
    {
     ...
     */
    inline EBU_BUSRCON2_FBBMSEL get_BUSRCON2_FBBMSEL() volatile
    {
     ...
     */
    inline EBU_BUSRCON2_FETBLEN get_BUSRCON2_FETBLEN() volatile
    {
     ...
     */
    inline void set_BUSRCON2_FETBLEN(EBU_BUSRCON2_FETBLEN value) volatile
    {
        uint32_t curr = BUSRCON2;
     ...
     */
    inline void get_BUSRCON2(uint8_t &AGEN, EBU_BUSRCON2_AAP &AAP, uint8_t &WAIT, uint8_t &PORTW, EBU_BUSRCON2_BCGEN &BCGEN, EBU_BUSRCON2_WAITINV &WAITINV, EBU_BUSRCON2_DBA &DBA, EBU_BUSRCON2_EBSE &EBSE, EBU_BUSRCON2_ECSE &ECSE, bool &NAA, EBU_BUSRCON2_BFCMSEL &BFCMSEL, EBU_BUSRCON2_FDBKEN &FDBKEN, EBU_BUSRCON2_BFSSS &BFSSS, EBU_BUSRCON2_FBBMSEL &FBBMSEL, EBU_BUSRCON2_FETBLEN &FETBLEN) volatile
    {
        uint32_t curr = BUSRCON2;
     ...
     */
    inline void set_BUSRCON2(uint8_t AGEN, EBU_BUSRCON2_AAP AAP, uint8_t WAIT, uint8_t PORTW, EBU_BUSRCON2_BCGEN BCGEN, EBU_BUSRCON2_WAITINV WAITINV, EBU_BUSRCON2_DBA DBA, EBU_BUSRCON2_EBSE EBSE, EBU_BUSRCON2_ECSE ECSE, bool NAA, EBU_BUSRCON2_BFCMSEL BFCMSEL, EBU_BUSRCON2_FDBKEN FDBKEN, EBU_BUSRCON2_BFSSS BFSSS, EBU_BUSRCON2_FBBMSEL FBBMSEL, EBU_BUSRCON2_FETBLEN FETBLEN) volatile
    {
        uint32_t curr = BUSRCON2;
     ...
     */
    inline EBU_BUSRAP2_ADDRC get_BUSRAP2_ADDRC() volatile
    {
     ...
     */
    inline void set_BUSRAP2_ADDRC(EBU_BUSRAP2_ADDRC value) volatile
    {
     ...
     */
    inline EBU_BUSRAP2_AHOLDC get_BUSRAP2_AHOLDC() volatile
    {
     ...
     */
    inline void set_BUSRAP2_AHOLDC(EBU_BUSRAP2_AHOLDC value) volatile
    {
        uint32_t curr = BUSRAP2;
     ...
     */
    inline EBU_BUSRAP2_CMDDELAY get_BUSRAP2_CMDDELAY() volatile
    {
     ...
     */
    inline void set_BUSRAP2_CMDDELAY(EBU_BUSRAP2_CMDDELAY value) volatile
    {
        uint32_t curr = BUSRAP2;
     ...
     */
    inline EBU_BUSRAP2_EXTDATA get_BUSRAP2_EXTDATA() volatile
    {
     ...
     */
    inline void set_BUSRAP2_EXTDATA(EBU_BUSRAP2_EXTDATA value) volatile
    {
        uint32_t curr = BUSRAP2;
     ...
     */
    inline EBU_BUSRAP2_EXTCLOCK get_BUSRAP2_EXTCLOCK() volatile
    {
     ...
     */
    inline void set_BUSRAP2_EXTCLOCK(EBU_BUSRAP2_EXTCLOCK value) volatile
    {
        uint32_t curr = BUSRAP2;
     ...
     */
    inline EBU_BUSRAP2_WAITRDC get_BUSRAP2_WAITRDC() volatile
    {
     ...
     */
    inline void set_BUSRAP2_WAITRDC(EBU_BUSRAP2_WAITRDC value) volatile
    {
        uint32_t curr = BUSRAP2;
     ...
     */
    inline EBU_BUSRAP2_RDRECOVC get_BUSRAP2_RDRECOVC() volatile
    {
     ...
     */
    inline void set_BUSRAP2_RDRECOVC(EBU_BUSRAP2_RDRECOVC value) volatile
    {
        uint32_t curr = BUSRAP2;
     ...
     */
    inline EBU_BUSRAP2_RDDTACS get_BUSRAP2_RDDTACS() volatile
    {
     ...
     */
    inline void set_BUSRAP2_RDDTACS(EBU_BUSRAP2_RDDTACS value) volatile
    {
        uint32_t curr = BUSRAP2;
     ...
     */
    inline void get_BUSRAP2(EBU_BUSRAP2_ADDRC &ADDRC, EBU_BUSRAP2_AHOLDC &AHOLDC, EBU_BUSRAP2_CMDDELAY &CMDDELAY, EBU_BUSRAP2_EXTDATA &EXTDATA, EBU_BUSRAP2_EXTCLOCK &EXTCLOCK, uint8_t &DATAC, EBU_BUSRAP2_WAITRDC &WAITRDC, EBU_BUSRAP2_RDRECOVC &RDRECOVC, EBU_BUSRAP2_RDDTACS &RDDTACS) volatile
    {
        uint32_t curr = BUSRAP2;
     ...
     */
    inline void set_BUSRAP2(EBU_BUSRAP2_ADDRC ADDRC, EBU_BUSRAP2_AHOLDC AHOLDC, EBU_BUSRAP2_CMDDELAY CMDDELAY, EBU_BUSRAP2_EXTDATA EXTDATA, EBU_BUSRAP2_EXTCLOCK EXTCLOCK, uint8_t DATAC, EBU_BUSRAP2_WAITRDC WAITRDC, EBU_BUSRAP2_RDRECOVC RDRECOVC, EBU_BUSRAP2_RDDTACS RDDTACS) volatile
    {
        uint32_t curr = BUSRAP2;
     ...
     */
    inline EBU_BUSWCON2_LOCKCS get_BUSWCON2_LOCKCS() volatile
    {
     ...
     */
    inline EBU_BUSWCON2_AAP get_BUSWCON2_AAP() volatile
    {
     ...
     */
    inline EBU_BUSWCON2_BCGEN get_BUSWCON2_BCGEN() volatile
    {
     ...
     */
    inline void set_BUSWCON2_BCGEN(EBU_BUSWCON2_BCGEN value) volatile
    {
        uint32_t curr = BUSWCON2;
     ...
     */
    inline EBU_BUSWCON2_WAITINV get_BUSWCON2_WAITINV() volatile
    {
     ...
     */
    inline EBU_BUSWCON2_EBSE get_BUSWCON2_EBSE() volatile
    {
     ...
     */
    inline EBU_BUSWCON2_ECSE get_BUSWCON2_ECSE() volatile
    {
     ...
     */
    inline EBU_BUSWCON2_FBBMSEL get_BUSWCON2_FBBMSEL() volatile
    {
     ...
     */
    inline EBU_BUSWCON2_FETBLEN get_BUSWCON2_FETBLEN() volatile
    {
     ...
     */
    inline void set_BUSWCON2_FETBLEN(EBU_BUSWCON2_FETBLEN value) volatile
    {
        uint32_t curr = BUSWCON2;
     ...
     */
    inline void get_BUSWCON2(uint8_t &AGEN, EBU_BUSWCON2_LOCKCS &LOCKCS, EBU_BUSWCON2_AAP &AAP, uint8_t &WAIT, uint8_t &PORTW, EBU_BUSWCON2_BCGEN &BCGEN, EBU_BUSWCON2_WAITINV &WAITINV, EBU_BUSWCON2_EBSE &EBSE, EBU_BUSWCON2_ECSE &ECSE, bool &NAA, EBU_BUSWCON2_FBBMSEL &FBBMSEL, EBU_BUSWCON2_FETBLEN &FETBLEN) volatile
    {
        uint32_t curr = BUSWCON2;
     ...
     */
    inline void set_BUSWCON2(uint8_t AGEN, EBU_BUSWCON2_LOCKCS LOCKCS, EBU_BUSWCON2_AAP AAP, uint8_t WAIT, EBU_BUSWCON2_BCGEN BCGEN, EBU_BUSWCON2_WAITINV WAITINV, EBU_BUSWCON2_EBSE EBSE, EBU_BUSWCON2_ECSE ECSE, EBU_BUSWCON2_FBBMSEL FBBMSEL, EBU_BUSWCON2_FETBLEN FETBLEN) volatile
    {
        uint32_t curr = BUSWCON2;
     ...
     */
    inline EBU_BUSWAP2_ADDRC get_BUSWAP2_ADDRC() volatile
    {
     ...
     */
    inline void set_BUSWAP2_ADDRC(EBU_BUSWAP2_ADDRC value) volatile
    {
     ...
     */
    inline EBU_BUSWAP2_AHOLDC get_BUSWAP2_AHOLDC() volatile
    {
     ...
     */
    inline void set_BUSWAP2_AHOLDC(EBU_BUSWAP2_AHOLDC value) volatile
    {
        uint32_t curr = BUSWAP2;
     ...
     */
    inline EBU_BUSWAP2_CMDDELAY get_BUSWAP2_CMDDELAY() volatile
    {
     ...
     */
    inline void set_BUSWAP2_CMDDELAY(EBU_BUSWAP2_CMDDELAY value) volatile
    {
        uint32_t curr = BUSWAP2;
     ...
     */
    inline EBU_BUSWAP2_EXTDATA get_BUSWAP2_EXTDATA() volatile
    {
     ...
     */
    inline void set_BUSWAP2_EXTDATA(EBU_BUSWAP2_EXTDATA value) volatile
    {
        uint32_t curr = BUSWAP2;
     ...
     */
    inline EBU_BUSWAP2_EXTCLOCK get_BUSWAP2_EXTCLOCK() volatile
    {
     ...
     */
    inline void set_BUSWAP2_EXTCLOCK(EBU_BUSWAP2_EXTCLOCK value) volatile
    {
        uint32_t curr = BUSWAP2;
     ...
     */
    inline EBU_BUSWAP2_DATAC get_BUSWAP2_DATAC() volatile
    {
     ...
     */
    inline void set_BUSWAP2_DATAC(EBU_BUSWAP2_DATAC value) volatile
    {
        uint32_t curr = BUSWAP2;
     ...
     */
    inline EBU_BUSWAP2_WAITWRC get_BUSWAP2_WAITWRC() volatile
    {
     ...
     */
    inline void set_BUSWAP2_WAITWRC(EBU_BUSWAP2_WAITWRC value) volatile
    {
        uint32_t curr = BUSWAP2;
     ...
     */
    inline EBU_BUSWAP2_WRRECOVC get_BUSWAP2_WRRECOVC() volatile
    {
     ...
     */
    inline void set_BUSWAP2_WRRECOVC(EBU_BUSWAP2_WRRECOVC value) volatile
    {
        uint32_t curr = BUSWAP2;
     ...
     */
    inline EBU_BUSWAP2_WRDTACS get_BUSWAP2_WRDTACS() volatile
    {
     ...
     */
    inline void set_BUSWAP2_WRDTACS(EBU_BUSWAP2_WRDTACS value) volatile
    {
        uint32_t curr = BUSWAP2;
     ...
     */
    inline void get_BUSWAP2(EBU_BUSWAP2_ADDRC &ADDRC, EBU_BUSWAP2_AHOLDC &AHOLDC, EBU_BUSWAP2_CMDDELAY &CMDDELAY, EBU_BUSWAP2_EXTDATA &EXTDATA, EBU_BUSWAP2_EXTCLOCK &EXTCLOCK, EBU_BUSWAP2_DATAC &DATAC, EBU_BUSWAP2_WAITWRC &WAITWRC, EBU_BUSWAP2_WRRECOVC &WRRECOVC, EBU_BUSWAP2_WRDTACS &WRDTACS) volatile
    {
        uint32_t curr = BUSWAP2;
     ...
     */
    inline void set_BUSWAP2(EBU_BUSWAP2_ADDRC ADDRC, EBU_BUSWAP2_AHOLDC AHOLDC, EBU_BUSWAP2_CMDDELAY CMDDELAY, EBU_BUSWAP2_EXTDATA EXTDATA, EBU_BUSWAP2_EXTCLOCK EXTCLOCK, EBU_BUSWAP2_DATAC DATAC, EBU_BUSWAP2_WAITWRC WAITWRC, EBU_BUSWAP2_WRRECOVC WRRECOVC, EBU_BUSWAP2_WRDTACS WRDTACS) volatile
    {
        uint32_t curr = BUSWAP2;
     ...
     */
    inline EBU_BUSRCON3_AAP get_BUSRCON3_AAP() volatile
    {
     ...
     */
    inline EBU_BUSRCON3_BCGEN get_BUSRCON3_BCGEN() volatile
    {
     ...
     */
    inline void set_BUSRCON3_BCGEN(EBU_BUSRCON3_BCGEN value) volatile
    {
        uint32_t curr = BUSRCON3;
     ...
     */
    inline EBU_BUSRCON3_WAITINV get_BUSRCON3_WAITINV() volatile
    {
     ...
     */
    inline EBU_BUSRCON3_DBA get_BUSRCON3_DBA() volatile
    {
     ...
     */
    inline EBU_BUSRCON3_EBSE get_BUSRCON3_EBSE() volatile
    {
     ...
     */
    inline EBU_BUSRCON3_ECSE get_BUSRCON3_ECSE() volatile
    {
     ...
     */
    inline EBU_BUSRCON3_BFCMSEL get_BUSRCON3_BFCMSEL() volatile
    {
     ...
     */
    inline EBU_BUSRCON3_FDBKEN get_BUSRCON3_FDBKEN() volatile
    {
     ...
     */
    inline EBU_BUSRCON3_BFSSS get_BUSRCON3_BFSSS() volatile
    {
     ...
     */
    inline EBU_BUSRCON3_FBBMSEL get_BUSRCON3_FBBMSEL() volatile
    {
     ...
     */
    inline EBU_BUSRCON3_FETBLEN get_BUSRCON3_FETBLEN() volatile
    {
     ...
     */
    inline void set_BUSRCON3_FETBLEN(EBU_BUSRCON3_FETBLEN value) volatile
    {
        uint32_t curr = BUSRCON3;
     ...
     */
    inline EBU_BUSRAP3_ADDRC get_BUSRAP3_ADDRC() volatile
    {
     ...
     */
    inline void set_BUSRAP3_ADDRC(EBU_BUSRAP3_ADDRC value) volatile
    {
     ...
     */
    inline EBU_BUSRAP3_AHOLDC get_BUSRAP3_AHOLDC() volatile
    {
     ...
     */
    inline void set_BUSRAP3_AHOLDC(EBU_BUSRAP3_AHOLDC value) volatile
    {
        uint32_t curr = BUSRAP3;
     ...
     */
    inline EBU_BUSRAP3_CMDDELAY get_BUSRAP3_CMDDELAY() volatile
    {
     ...
     */
    inline void set_BUSRAP3_CMDDELAY(EBU_BUSRAP3_CMDDELAY value) volatile
    {
        uint32_t curr = BUSRAP3;
     ...
     */
    inline EBU_BUSRAP3_EXTDATA get_BUSRAP3_EXTDATA() volatile
    {
     ...
     */
    inline void set_BUSRAP3_EXTDATA(EBU_BUSRAP3_EXTDATA value) volatile
    {
        uint32_t curr = BUSRAP3;
     ...
     */
    inline EBU_BUSRAP3_EXTCLOCK get_BUSRAP3_EXTCLOCK() volatile
    {
     ...
     */
    inline void set_BUSRAP3_EXTCLOCK(EBU_BUSRAP3_EXTCLOCK value) volatile
    {
        uint32_t curr = BUSRAP3;
     ...
     */
    inline EBU_BUSRAP3_WAITRDC get_BUSRAP3_WAITRDC() volatile
    {
     ...
     */
    inline void set_BUSRAP3_WAITRDC(EBU_BUSRAP3_WAITRDC value) volatile
    {
        uint32_t curr = BUSRAP3;
     ...
     */
    inline EBU_BUSRAP3_RDRECOVC get_BUSRAP3_RDRECOVC() volatile
    {
     ...
     */
    inline void set_BUSRAP3_RDRECOVC(EBU_BUSRAP3_RDRECOVC value) volatile
    {
        uint32_t curr = BUSRAP3;
     ...
     */
    inline EBU_BUSRAP3_RDDTACS get_BUSRAP3_RDDTACS() volatile
    {
     ...
     */
    inline void set_BUSRAP3_RDDTACS(EBU_BUSRAP3_RDDTACS value) volatile
    {
        uint32_t curr = BUSRAP3;
     ...
     */
    inline void get_BUSRAP3(EBU_BUSRAP3_ADDRC &ADDRC, EBU_BUSRAP3_AHOLDC &AHOLDC, EBU_BUSRAP3_CMDDELAY &CMDDELAY, EBU_BUSRAP3_EXTDATA &EXTDATA, EBU_BUSRAP3_EXTCLOCK &EXTCLOCK, uint8_t &DATAC, EBU_BUSRAP3_WAITRDC &WAITRDC, EBU_BUSRAP3_RDRECOVC &RDRECOVC, EBU_BUSRAP3_RDDTACS &RDDTACS) volatile
    {
        uint32_t curr = BUSRAP3;
     ...
     */
    inline void set_BUSRAP3(EBU_BUSRAP3_ADDRC ADDRC, EBU_BUSRAP3_AHOLDC AHOLDC, EBU_BUSRAP3_CMDDELAY CMDDELAY, EBU_BUSRAP3_EXTDATA EXTDATA, EBU_BUSRAP3_EXTCLOCK EXTCLOCK, uint8_t DATAC, EBU_BUSRAP3_WAITRDC WAITRDC, EBU_BUSRAP3_RDRECOVC RDRECOVC, EBU_BUSRAP3_RDDTACS RDDTACS) volatile
    {
        uint32_t curr = BUSRAP3;
     ...
     */
    inline EBU_BUSWCON3_LOCKCS get_BUSWCON3_LOCKCS() volatile
    {
     ...
     */
    inline EBU_BUSWCON3_AAP get_BUSWCON3_AAP() volatile
    {
     ...
     */
    inline EBU_BUSWCON3_BCGEN get_BUSWCON3_BCGEN() volatile
    {
     ...
     */
    inline void set_BUSWCON3_BCGEN(EBU_BUSWCON3_BCGEN value) volatile
    {
        uint32_t curr = BUSWCON3;
     ...
     */
    inline EBU_BUSWCON3_WAITINV get_BUSWCON3_WAITINV() volatile
    {
     ...
     */
    inline EBU_BUSWCON3_EBSE get_BUSWCON3_EBSE() volatile
    {
     ...
     */
    inline EBU_BUSWCON3_ECSE get_BUSWCON3_ECSE() volatile
    {
     ...
     */
    inline EBU_BUSWCON3_FBBMSEL get_BUSWCON3_FBBMSEL() volatile
    {
     ...
     */
    inline EBU_BUSWCON3_FETBLEN get_BUSWCON3_FETBLEN() volatile
    {
     ...
     */
    inline void set_BUSWCON3_FETBLEN(EBU_BUSWCON3_FETBLEN value) volatile
    {
        uint32_t curr = BUSWCON3;
     ...
     */
    inline void get_BUSWCON3(uint8_t &AGEN, EBU_BUSWCON3_LOCKCS &LOCKCS, EBU_BUSWCON3_AAP &AAP, uint8_t &WAIT, uint8_t &PORTW, EBU_BUSWCON3_BCGEN &BCGEN, EBU_BUSWCON3_WAITINV &WAITINV, EBU_BUSWCON3_EBSE &EBSE, EBU_BUSWCON3_ECSE &ECSE, bool &NAA, EBU_BUSWCON3_FBBMSEL &FBBMSEL, EBU_BUSWCON3_FETBLEN &FETBLEN) volatile
    {
        uint32_t curr = BUSWCON3;
     ...
     */
    inline void set_BUSWCON3(uint8_t AGEN, EBU_BUSWCON3_LOCKCS LOCKCS, EBU_BUSWCON3_AAP AAP, uint8_t WAIT, EBU_BUSWCON3_BCGEN BCGEN, EBU_BUSWCON3_WAITINV WAITINV, EBU_BUSWCON3_EBSE EBSE, EBU_BUSWCON3_ECSE ECSE, EBU_BUSWCON3_FBBMSEL FBBMSEL, EBU_BUSWCON3_FETBLEN FETBLEN) volatile
    {
        uint32_t curr = BUSWCON3;
     ...
     */
    inline EBU_BUSWAP3_ADDRC get_BUSWAP3_ADDRC() volatile
    {
     ...
     */
    inline void set_BUSWAP3_ADDRC(EBU_BUSWAP3_ADDRC value) volatile
    {
     ...
     */
    inline EBU_BUSWAP3_AHOLDC get_BUSWAP3_AHOLDC() volatile
    {
     ...
     */
    inline void set_BUSWAP3_AHOLDC(EBU_BUSWAP3_AHOLDC value) volatile
    {
        uint32_t curr = BUSWAP3;
     ...
     */
    inline EBU_BUSWAP3_CMDDELAY get_BUSWAP3_CMDDELAY() volatile
    {
     ...
     */
    inline void set_BUSWAP3_CMDDELAY(EBU_BUSWAP3_CMDDELAY value) volatile
    {
        uint32_t curr = BUSWAP3;
     ...
     */
    inline EBU_BUSWAP3_EXTDATA get_BUSWAP3_EXTDATA() volatile
    {
     ...
     */
    inline void set_BUSWAP3_EXTDATA(EBU_BUSWAP3_EXTDATA value) volatile
    {
        uint32_t curr = BUSWAP3;
     ...
     */
    inline EBU_BUSWAP3_EXTCLOCK get_BUSWAP3_EXTCLOCK() volatile
    {
     ...
     */
    inline void set_BUSWAP3_EXTCLOCK(EBU_BUSWAP3_EXTCLOCK value) volatile
    {
        uint32_t curr = BUSWAP3;
     ...
     */
    inline EBU_BUSWAP3_DATAC get_BUSWAP3_DATAC() volatile
    {
     ...
     */
    inline void set_BUSWAP3_DATAC(EBU_BUSWAP3_DATAC value) volatile
    {
        uint32_t curr = BUSWAP3;
     ...
     */
    inline EBU_BUSWAP3_WAITWRC get_BUSWAP3_WAITWRC() volatile
    {
     ...
     */
    inline void set_BUSWAP3_WAITWRC(EBU_BUSWAP3_WAITWRC value) volatile
    {
        uint32_t curr = BUSWAP3;
     ...
     */
    inline EBU_BUSWAP3_WRRECOVC get_BUSWAP3_WRRECOVC() volatile
    {
     ...
     */
    inline void set_BUSWAP3_WRRECOVC(EBU_BUSWAP3_WRRECOVC value) volatile
    {
        uint32_t curr = BUSWAP3;
     ...
     */
    inline EBU_BUSWAP3_WRDTACS get_BUSWAP3_WRDTACS() volatile
    {
     ...
     */
    inline void set_BUSWAP3_WRDTACS(EBU_BUSWAP3_WRDTACS value) volatile
    {
        uint32_t curr = BUSWAP3;
     ...
     */
    inline void get_BUSWAP3(EBU_BUSWAP3_ADDRC &ADDRC, EBU_BUSWAP3_AHOLDC &AHOLDC, EBU_BUSWAP3_CMDDELAY &CMDDELAY, EBU_BUSWAP3_EXTDATA &EXTDATA, EBU_BUSWAP3_EXTCLOCK &EXTCLOCK, EBU_BUSWAP3_DATAC &DATAC, EBU_BUSWAP3_WAITWRC &WAITWRC, EBU_BUSWAP3_WRRECOVC &WRRECOVC, EBU_BUSWAP3_WRDTACS &WRDTACS) volatile
    {
        uint32_t curr = BUSWAP3;
     ...
     */
    inline void set_BUSWAP3(EBU_BUSWAP3_ADDRC ADDRC, EBU_BUSWAP3_AHOLDC AHOLDC, EBU_BUSWAP3_CMDDELAY CMDDELAY, EBU_BUSWAP3_EXTDATA EXTDATA, EBU_BUSWAP3_EXTCLOCK EXTCLOCK, EBU_BUSWAP3_DATAC DATAC, EBU_BUSWAP3_WAITWRC WAITWRC, EBU_BUSWAP3_WRRECOVC WRRECOVC, EBU_BUSWAP3_WRDTACS WRDTACS) volatile
    {
        uint32_t curr = BUSWAP3;
     ...
     */
    inline void get_SDRMCON(uint8_t &CRAS, uint8_t &CRFSH, uint8_t &CRSC, uint8_t &CRP, EBU_SDRMCON_AWIDTH &AWIDTH, uint8_t &CRCD, uint8_t &CRC, EBU_SDRMCON_ROWM &ROWM, EBU_SDRMCON_BANKM &BANKM, uint8_t &CRCE, EBU_SDRMCON_CLKDIS &CLKDIS, EBU_SDRMCON_PWR_MODE &PWR_MODE, EBU_SDRMCON_SDCMSEL &SDCMSEL) volatile
    {
        uint32_t curr = SDRMCON;
     ...
     */
    inline void set_SDRMCON(uint8_t CRAS, uint8_t CRFSH, uint8_t CRSC, uint8_t CRP, EBU_SDRMCON_AWIDTH AWIDTH, uint8_t CRCD, uint8_t CRC, EBU_SDRMCON_ROWM ROWM, EBU_SDRMCON_BANKM BANKM, uint8_t CRCE, EBU_SDRMCON_CLKDIS CLKDIS, EBU_SDRMCON_PWR_MODE PWR_MODE, EBU_SDRMCON_SDCMSEL SDCMSEL) volatile
    {
        uint32_t curr = SDRMCON;
     ...
     */
    inline void get_SDRMOD(EBU_SDRMOD_BURSTL &BURSTL, EBU_SDRMOD_BTYP &BTYP, EBU_SDRMOD_CASLAT &CASLAT, EBU_SDRMOD_OPMODE &OPMODE, uint16_t &XOPM, uint8_t &XBA) volatile
    {
        uint32_t curr = SDRMOD;
     ...
     */
    inline void set_SDRMOD(EBU_SDRMOD_BURSTL BURSTL, EBU_SDRMOD_BTYP BTYP, EBU_SDRMOD_CASLAT CASLAT, EBU_SDRMOD_OPMODE OPMODE, bool COLDSTART, uint16_t XOPM, uint8_t XBA) volatile
    {
        uint32_t curr = SDRMOD;
     ...
     */
    inline void get_SDRMREF(uint8_t &REFRESHC, uint8_t &REFRESHR, bool &SELFREXST, bool &SELFREX, bool &SELFRENST, bool &SELFREN, bool &AUTOSELFR, uint8_t &ERFSHC, uint8_t &SELFREX_DLY, bool &ARFSH, uint8_t &RES_DLY) volatile
    {
        uint32_t curr = SDRMREF;
     ...
     */
    inline void set_SDRMREF(uint8_t REFRESHC, uint8_t REFRESHR, bool SELFREX, bool SELFREN, bool AUTOSELFR, uint8_t ERFSHC, uint8_t SELFREX_DLY, bool ARFSH, uint8_t RES_DLY) volatile
    {
        uint32_t curr = SDRMREF;
     ...
     */
    inline void get_SDRSTAT(EBU_SDRSTAT_REFERR &REFERR, EBU_SDRSTAT_SDRMBUSY &SDRMBUSY, EBU_SDRSTAT_SDERR &SDERR) volatile
    {
