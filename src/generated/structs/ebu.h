...
struct [[gnu::packed]] ebu
{
     ...
     */
    inline bool get_CLC_DIV2ACK() volatile
    {
        return CLC & (1u << 21u);
    }
     ...
     */
    inline bool get_CLC_SYNCACK() volatile
    {
        return CLC & (1u << 20u);
    }
     ...
     * DIV2 Clocking Mode
     */
    inline bool get_CLC_DIV2() volatile
    {
        return CLC & (1u << 17u);
    }
     ...
     * EBU Clocking Mode
     */
    inline bool get_CLC_SYNC() volatile
    {
        return CLC & (1u << 16u);
    }
     ...
     */
    inline void get_CLC(EBU_CLC_EBUDIVACK &EBUDIVACK, bool &DIV2ACK,
                        bool &SYNCACK, EBU_CLC_EBUDIVACK &EBUDIV, bool &DIV2,
                        bool &SYNC, bool &DISS, bool &DISR) volatile
    {
        uint32_t curr = CLC;
     ...
     * (read-write) EBU Clock Control Register
     */
    inline void set_CLC(EBU_CLC_EBUDIVACK EBUDIV, bool DIV2, bool SYNC,
                        bool DISR) volatile
    {
        uint32_t curr = CLC;
     ...
     * ALE Mode
     */
    inline bool get_MODCON_ALE() volatile
    {
        return MODCON & (1u << 31u);
    }
     ...
     */
    inline bool get_MODCON_ARBSYNC() volatile
    {
        return MODCON & (1u << 5u);
    }
     ...
     */
    inline bool get_MODCON_EXTLOCK() volatile
    {
        return MODCON & (1u << 4u);
    }
     ...
     * SDRAM Tristate
     */
    inline bool get_MODCON_SDTRI() volatile
    {
        return MODCON & (1u << 2u);
    }
     ...
     */
    inline void get_MODCON(bool &ALE, bool &ACCSINHACK, bool &ACCSINH,
                           uint8_t &GLOBALCS, uint8_t &LOCKTIMEOUT,
                           EBU_MODCON_TIMEOUTC &TIMEOUTC,
                           EBU_MODCON_ARBMODE &ARBMODE, bool &ARBSYNC,
                           bool &EXTLOCK, bool &SDTRI, bool &LCKABRT,
                           bool &STS) volatile
    {
        uint32_t curr = MODCON;
     ...
     * (read-write) EBU Configuration Register
     */
    inline void set_MODCON(bool ALE, bool ACCSINH, uint8_t GLOBALCS,
                           uint8_t LOCKTIMEOUT, EBU_MODCON_TIMEOUTC TIMEOUTC,
                           EBU_MODCON_ARBMODE ARBMODE, bool ARBSYNC,
                           bool EXTLOCK, bool SDTRI) volatile
    {
        uint32_t curr = MODCON;
        ...
        curr &= ~(0b1u << 5u);
        curr |= (ARBSYNC & 0b1u) << 5u;
        curr &= ~(0b1u << 4u);
        curr |= (EXTLOCK & 0b1u) << 4u;
        curr &= ~(0b1u << 2u);
        curr |= (SDTRI & 0b1u) << 2u;
     ...
     */
    inline bool get_USERCON_ADVIO() volatile
    {
        return USERCON & (1u << 25u);
    }
     ...
     */
    inline void get_USERCON(bool &ADVIO, EBU_USERCON_ADDIO &ADDIO,
                            bool &DIP) volatile
    {
        uint32_t curr = USERCON;
     ...
     * (read-write) EBU Test/Control Configuration Register
     */
    inline void set_USERCON(bool ADVIO, EBU_USERCON_ADDIO ADDIO,
                            bool DIP) volatile
    {
        uint32_t curr = USERCON;
     ...
     */
    inline bool get_ADDRSEL0_WPROT() volatile
    {
        return ADDRSEL0 & (1u << 2u);
    }
     ...
     */
    inline bool get_ADDRSEL0_ALTENAB() volatile
    {
        return ADDRSEL0 & (1u << 1u);
    }
     ...
     */
    inline bool get_ADDRSEL0_REGENAB() volatile
    {
        return ADDRSEL0 & (1u << 0u);
    }
     ...
     */
    inline void get_ADDRSEL0(bool &WPROT, bool &ALTENAB,
                             bool &REGENAB) volatile
    {
     ...
     * (read-write) EBU Address Select Register 0
     */
    inline void set_ADDRSEL0(bool WPROT, bool ALTENAB, bool REGENAB) volatile
    {
        uint32_t curr = ADDRSEL0;
        ...
        curr |= (WPROT & 0b1u) << 2u;
        curr &= ~(0b1u << 1u);
        curr |= (ALTENAB & 0b1u) << 1u;
        curr &= ~(0b1u << 0u);
        curr |= (REGENAB & 0b1u) << 0u;
     ...
     * Memory Region Write Protect
     */
    inline bool get_ADDRSEL1_WPROT() volatile
    {
        return ADDRSEL1 & (1u << 2u);
    }
     ...
     * Alternate Region Enable
     */
    inline bool get_ADDRSEL1_ALTENAB() volatile
    {
        return ADDRSEL1 & (1u << 1u);
    }
     ...
     * Memory Region Enable
     */
    inline bool get_ADDRSEL1_REGENAB() volatile
    {
        return ADDRSEL1 & (1u << 0u);
    }
     ...
     */
    inline void get_ADDRSEL1(bool &WPROT, bool &ALTENAB,
                             bool &REGENAB) volatile
    {
     ...
     * (read-write) EBU Address Select Register 1
     */
    inline void set_ADDRSEL1(bool WPROT, bool ALTENAB, bool REGENAB) volatile
    {
        uint32_t curr = ADDRSEL1;
     ...
     * Memory Region Write Protect
     */
    inline bool get_ADDRSEL2_WPROT() volatile
    {
        return ADDRSEL2 & (1u << 2u);
    }
     ...
     * Alternate Region Enable
     */
    inline bool get_ADDRSEL2_ALTENAB() volatile
    {
        return ADDRSEL2 & (1u << 1u);
    }
     ...
     * Memory Region Enable
     */
    inline bool get_ADDRSEL2_REGENAB() volatile
    {
        return ADDRSEL2 & (1u << 0u);
    }
     ...
     */
    inline void get_ADDRSEL2(bool &WPROT, bool &ALTENAB,
                             bool &REGENAB) volatile
    {
     ...
     * (read-write) EBU Address Select Register 2
     */
    inline void set_ADDRSEL2(bool WPROT, bool ALTENAB, bool REGENAB) volatile
    {
        uint32_t curr = ADDRSEL2;
     ...
     * Memory Region Write Protect
     */
    inline bool get_ADDRSEL3_WPROT() volatile
    {
        return ADDRSEL3 & (1u << 2u);
    }
     ...
     * Alternate Region Enable
     */
    inline bool get_ADDRSEL3_ALTENAB() volatile
    {
        return ADDRSEL3 & (1u << 1u);
    }
     ...
     * Memory Region Enable
     */
    inline bool get_ADDRSEL3_REGENAB() volatile
    {
        return ADDRSEL3 & (1u << 0u);
    }
     ...
     */
    inline void get_ADDRSEL3(bool &WPROT, bool &ALTENAB,
                             bool &REGENAB) volatile
    {
     ...
     * (read-write) EBU Address Select Register 3
     */
    inline void set_ADDRSEL3(bool WPROT, bool ALTENAB, bool REGENAB) volatile
    {
        uint32_t curr = ADDRSEL3;
     ...
     */
    inline bool get_BUSRCON0_AAP() volatile
    {
        return BUSRCON0 & (1u << 26u);
    }
     ...
     */
    inline bool get_BUSRCON0_WAITINV() volatile
    {
        return BUSRCON0 & (1u << 19u);
    }
     ...
     */
    inline bool get_BUSRCON0_DBA() volatile
    {
        return BUSRCON0 & (1u << 18u);
    }
     ...
     */
    inline bool get_BUSRCON0_EBSE() volatile
    {
        return BUSRCON0 & (1u << 17u);
    }
     ...
     */
    inline bool get_BUSRCON0_ECSE() volatile
    {
        return BUSRCON0 & (1u << 16u);
    }
     ...
     */
    inline bool get_BUSRCON0_BFCMSEL() volatile
    {
        return BUSRCON0 & (1u << 6u);
    }
     ...
     */
    inline bool get_BUSRCON0_FDBKEN() volatile
    {
        return BUSRCON0 & (1u << 5u);
    }
     ...
     */
    inline bool get_BUSRCON0_BFSSS() volatile
    {
        return BUSRCON0 & (1u << 4u);
    }
     ...
     */
    inline bool get_BUSRCON0_FBBMSEL() volatile
    {
        return BUSRCON0 & (1u << 3u);
    }
     ...
     */
    inline void get_BUSRCON0(uint8_t &AGEN, bool &AAP, uint8_t &WAIT,
                             uint8_t &PORTW, EBU_BUSRCON0_BCGEN &BCGEN,
                             bool &WAITINV, bool &DBA, bool &EBSE, bool &ECSE,
                             bool &NAA, bool &BFCMSEL, bool &FDBKEN,
                             bool &BFSSS, bool &FBBMSEL,
     ...
     * (read-write) EBU Bus Configuration Register
     */
    inline void set_BUSRCON0(uint8_t AGEN, bool AAP, uint8_t WAIT,
                             uint8_t PORTW, EBU_BUSRCON0_BCGEN BCGEN,
                             bool WAITINV, bool DBA, bool EBSE, bool ECSE,
                             bool NAA, bool BFCMSEL, bool FDBKEN, bool BFSSS,
                             bool FBBMSEL,
                             EBU_BUSRCON0_FETBLEN FETBLEN) volatile
    {
        uint32_t curr = BUSRCON0;
        ...
        curr |= (NAA & 0b1u) << 7u;
        curr &= ~(0b1u << 6u);
        curr |= (BFCMSEL & 0b1u) << 6u;
        curr &= ~(0b1u << 5u);
        curr |= (FDBKEN & 0b1u) << 5u;
        curr &= ~(0b1u << 4u);
        curr |= (BFSSS & 0b1u) << 4u;
        curr &= ~(0b1u << 3u);
        curr |= (FBBMSEL & 0b1u) << 3u;
        curr &= ~(0b111u << 0u);
     ...
     * Lock Chip Select
     */
    inline bool get_BUSWCON0_LOCKCS() volatile
    {
        return BUSWCON0 & (1u << 27u);
    }
     ...
     * Asynchronous Address phase:
     */
    inline bool get_BUSWCON0_AAP() volatile
    {
        return BUSWCON0 & (1u << 26u);
    }
     ...
     * Reversed polarity at WAIT
     */
    inline bool get_BUSWCON0_WAITINV() volatile
    {
        return BUSWCON0 & (1u << 19u);
    }
     ...
     * Early Burst Signal Enable for Synchronous Burst
     */
    inline bool get_BUSWCON0_EBSE() volatile
    {
        return BUSWCON0 & (1u << 17u);
    }
     ...
     * Early Chip Select for Synchronous Burst
     */
    inline bool get_BUSWCON0_ECSE() volatile
    {
        return BUSWCON0 & (1u << 16u);
    }
     ...
     * Synchronous burst buffer mode select
     */
    inline bool get_BUSWCON0_FBBMSEL() volatile
    {
        return BUSWCON0 & (1u << 3u);
    }
     ...
     */
    inline void get_BUSWCON0(uint8_t &AGEN, bool &LOCKCS, bool &AAP,
                             uint8_t &WAIT, uint8_t &PORTW,
                             EBU_BUSRCON0_BCGEN &BCGEN, bool &WAITINV,
                             bool &EBSE, bool &ECSE, bool &NAA, bool &FBBMSEL,
                             EBU_BUSRCON0_FETBLEN &FETBLEN) volatile
    {
        uint32_t curr = BUSWCON0;
     ...
     * (read-write) EBU Bus Write Configuration Register
     */
    inline void set_BUSWCON0(uint8_t AGEN, bool LOCKCS, bool AAP, uint8_t WAIT,
                             EBU_BUSRCON0_BCGEN BCGEN, bool WAITINV, bool EBSE,
                             bool ECSE, bool FBBMSEL,
                             EBU_BUSRCON0_FETBLEN FETBLEN) volatile
    {
        uint32_t curr = BUSWCON0;
     ...
     * Asynchronous Address phase:
     */
    inline bool get_BUSRCON1_AAP() volatile
    {
        return BUSRCON1 & (1u << 26u);
    }
     ...
     * Reversed polarity at WAIT
     */
    inline bool get_BUSRCON1_WAITINV() volatile
    {
        return BUSRCON1 & (1u << 19u);
    }
     ...
     * Disable Burst Address Wrapping
     */
    inline bool get_BUSRCON1_DBA() volatile
    {
        return BUSRCON1 & (1u << 18u);
    }
     ...
     * Early Burst Signal Enable for Synchronous Burst
     */
    inline bool get_BUSRCON1_EBSE() volatile
    {
        return BUSRCON1 & (1u << 17u);
    }
     ...
     * Early Chip Select for Synchronous Burst
     */
    inline bool get_BUSRCON1_ECSE() volatile
    {
        return BUSRCON1 & (1u << 16u);
    }
     ...
     * Burst Flash Clock Mode Select
     */
    inline bool get_BUSRCON1_BFCMSEL() volatile
    {
        return BUSRCON1 & (1u << 6u);
    }
     ...
     * Burst FLASH Clock Feedback Enable
     */
    inline bool get_BUSRCON1_FDBKEN() volatile
    {
        return BUSRCON1 & (1u << 5u);
    }
     ...
     * Read Single Stage Synchronization:
     */
    inline bool get_BUSRCON1_BFSSS() volatile
    {
        return BUSRCON1 & (1u << 4u);
    }
     ...
     * Synchronous burst buffer mode select
     */
    inline bool get_BUSRCON1_FBBMSEL() volatile
    {
        return BUSRCON1 & (1u << 3u);
    }
     ...
     * (read-write) EBU Bus Configuration Register
     */
    inline void get_BUSRCON1(uint8_t &AGEN, bool &AAP, uint8_t &WAIT,
                             uint8_t &PORTW, EBU_BUSRCON0_BCGEN &BCGEN,
                             bool &WAITINV, bool &DBA, bool &EBSE, bool &ECSE,
                             bool &NAA, bool &BFCMSEL, bool &FDBKEN,
                             bool &BFSSS, bool &FBBMSEL,
     ...
     * (read-write) EBU Bus Configuration Register
     */
    inline void set_BUSRCON1(uint8_t AGEN, bool AAP, uint8_t WAIT,
                             uint8_t PORTW, EBU_BUSRCON0_BCGEN BCGEN,
                             bool WAITINV, bool DBA, bool EBSE, bool ECSE,
                             bool NAA, bool BFCMSEL, bool FDBKEN, bool BFSSS,
                             bool FBBMSEL,
     ...
     * Lock Chip Select
     */
    inline bool get_BUSWCON1_LOCKCS() volatile
    {
        return BUSWCON1 & (1u << 27u);
    }
     ...
     * Asynchronous Address phase:
     */
    inline bool get_BUSWCON1_AAP() volatile
    {
        return BUSWCON1 & (1u << 26u);
    }
     ...
     * Reversed polarity at WAIT
     */
    inline bool get_BUSWCON1_WAITINV() volatile
    {
        return BUSWCON1 & (1u << 19u);
    }
     ...
     * Early Burst Signal Enable for Synchronous Burst
     */
    inline bool get_BUSWCON1_EBSE() volatile
    {
        return BUSWCON1 & (1u << 17u);
    }
     ...
     * Early Chip Select for Synchronous Burst
     */
    inline bool get_BUSWCON1_ECSE() volatile
    {
        return BUSWCON1 & (1u << 16u);
    }
     ...
     * Synchronous burst buffer mode select
     */
    inline bool get_BUSWCON1_FBBMSEL() volatile
    {
        return BUSWCON1 & (1u << 3u);
    }
     ...
     * (read-write) EBU Bus Write Configuration Register
     */
    inline void get_BUSWCON1(uint8_t &AGEN, bool &LOCKCS, bool &AAP,
                             uint8_t &WAIT, uint8_t &PORTW,
                             EBU_BUSRCON0_BCGEN &BCGEN, bool &WAITINV,
                             bool &EBSE, bool &ECSE, bool &NAA, bool &FBBMSEL,
                             EBU_BUSRCON0_FETBLEN &FETBLEN) volatile
     ...
     * (read-write) EBU Bus Write Configuration Register
     */
    inline void set_BUSWCON1(uint8_t AGEN, bool LOCKCS, bool AAP, uint8_t WAIT,
                             EBU_BUSRCON0_BCGEN BCGEN, bool WAITINV, bool EBSE,
                             bool ECSE, bool FBBMSEL,
                             EBU_BUSRCON0_FETBLEN FETBLEN) volatile
    {
     ...
     * Asynchronous Address phase:
     */
    inline bool get_BUSRCON2_AAP() volatile
    {
        return BUSRCON2 & (1u << 26u);
    }
     ...
     * Reversed polarity at WAIT
     */
    inline bool get_BUSRCON2_WAITINV() volatile
    {
        return BUSRCON2 & (1u << 19u);
    }
     ...
     * Disable Burst Address Wrapping
     */
    inline bool get_BUSRCON2_DBA() volatile
    {
        return BUSRCON2 & (1u << 18u);
    }
     ...
     * Early Burst Signal Enable for Synchronous Burst
     */
    inline bool get_BUSRCON2_EBSE() volatile
    {
        return BUSRCON2 & (1u << 17u);
    }
     ...
     * Early Chip Select for Synchronous Burst
     */
    inline bool get_BUSRCON2_ECSE() volatile
    {
        return BUSRCON2 & (1u << 16u);
    }
     ...
     * Burst Flash Clock Mode Select
     */
    inline bool get_BUSRCON2_BFCMSEL() volatile
    {
        return BUSRCON2 & (1u << 6u);
    }
     ...
     * Burst FLASH Clock Feedback Enable
     */
    inline bool get_BUSRCON2_FDBKEN() volatile
    {
        return BUSRCON2 & (1u << 5u);
    }
     ...
     * Read Single Stage Synchronization:
     */
    inline bool get_BUSRCON2_BFSSS() volatile
    {
        return BUSRCON2 & (1u << 4u);
    }
     ...
     * Synchronous burst buffer mode select
     */
    inline bool get_BUSRCON2_FBBMSEL() volatile
    {
        return BUSRCON2 & (1u << 3u);
    }
     ...
     * (read-write) EBU Bus Configuration Register
     */
    inline void get_BUSRCON2(uint8_t &AGEN, bool &AAP, uint8_t &WAIT,
                             uint8_t &PORTW, EBU_BUSRCON0_BCGEN &BCGEN,
                             bool &WAITINV, bool &DBA, bool &EBSE, bool &ECSE,
                             bool &NAA, bool &BFCMSEL, bool &FDBKEN,
                             bool &BFSSS, bool &FBBMSEL,
     ...
     * (read-write) EBU Bus Configuration Register
     */
    inline void set_BUSRCON2(uint8_t AGEN, bool AAP, uint8_t WAIT,
                             uint8_t PORTW, EBU_BUSRCON0_BCGEN BCGEN,
                             bool WAITINV, bool DBA, bool EBSE, bool ECSE,
                             bool NAA, bool BFCMSEL, bool FDBKEN, bool BFSSS,
                             bool FBBMSEL,
     ...
     * Lock Chip Select
     */
    inline bool get_BUSWCON2_LOCKCS() volatile
    {
        return BUSWCON2 & (1u << 27u);
    }
     ...
     * Asynchronous Address phase:
     */
    inline bool get_BUSWCON2_AAP() volatile
    {
        return BUSWCON2 & (1u << 26u);
    }
     ...
     * Reversed polarity at WAIT
     */
    inline bool get_BUSWCON2_WAITINV() volatile
    {
        return BUSWCON2 & (1u << 19u);
    }
     ...
     * Early Burst Signal Enable for Synchronous Burst
     */
    inline bool get_BUSWCON2_EBSE() volatile
    {
        return BUSWCON2 & (1u << 17u);
    }
     ...
     * Early Chip Select for Synchronous Burst
     */
    inline bool get_BUSWCON2_ECSE() volatile
    {
        return BUSWCON2 & (1u << 16u);
    }
     ...
     * Synchronous burst buffer mode select
     */
    inline bool get_BUSWCON2_FBBMSEL() volatile
    {
        return BUSWCON2 & (1u << 3u);
    }
     ...
     * (read-write) EBU Bus Write Configuration Register
     */
    inline void get_BUSWCON2(uint8_t &AGEN, bool &LOCKCS, bool &AAP,
                             uint8_t &WAIT, uint8_t &PORTW,
                             EBU_BUSRCON0_BCGEN &BCGEN, bool &WAITINV,
                             bool &EBSE, bool &ECSE, bool &NAA, bool &FBBMSEL,
                             EBU_BUSRCON0_FETBLEN &FETBLEN) volatile
     ...
     * (read-write) EBU Bus Write Configuration Register
     */
    inline void set_BUSWCON2(uint8_t AGEN, bool LOCKCS, bool AAP, uint8_t WAIT,
                             EBU_BUSRCON0_BCGEN BCGEN, bool WAITINV, bool EBSE,
                             bool ECSE, bool FBBMSEL,
                             EBU_BUSRCON0_FETBLEN FETBLEN) volatile
    {
     ...
     * Asynchronous Address phase:
     */
    inline bool get_BUSRCON3_AAP() volatile
    {
        return BUSRCON3 & (1u << 26u);
    }
     ...
     * Reversed polarity at WAIT
     */
    inline bool get_BUSRCON3_WAITINV() volatile
    {
        return BUSRCON3 & (1u << 19u);
    }
     ...
     * Disable Burst Address Wrapping
     */
    inline bool get_BUSRCON3_DBA() volatile
    {
        return BUSRCON3 & (1u << 18u);
    }
     ...
     * Early Burst Signal Enable for Synchronous Burst
     */
    inline bool get_BUSRCON3_EBSE() volatile
    {
        return BUSRCON3 & (1u << 17u);
    }
     ...
     * Early Chip Select for Synchronous Burst
     */
    inline bool get_BUSRCON3_ECSE() volatile
    {
        return BUSRCON3 & (1u << 16u);
    }
     ...
     * Burst Flash Clock Mode Select
     */
    inline bool get_BUSRCON3_BFCMSEL() volatile
    {
        return BUSRCON3 & (1u << 6u);
    }
     ...
     * Burst FLASH Clock Feedback Enable
     */
    inline bool get_BUSRCON3_FDBKEN() volatile
    {
        return BUSRCON3 & (1u << 5u);
    }
     ...
     * Read Single Stage Synchronization:
     */
    inline bool get_BUSRCON3_BFSSS() volatile
    {
        return BUSRCON3 & (1u << 4u);
    }
     ...
     * Synchronous burst buffer mode select
     */
    inline bool get_BUSRCON3_FBBMSEL() volatile
    {
        return BUSRCON3 & (1u << 3u);
    }
     ...
     * (read-write) EBU Bus Configuration Register
     */
    inline void get_BUSRCON3(uint8_t &AGEN, bool &AAP, uint8_t &WAIT,
                             uint8_t &PORTW, EBU_BUSRCON0_BCGEN &BCGEN,
                             bool &WAITINV, bool &DBA, bool &EBSE, bool &ECSE,
                             bool &NAA, bool &BFCMSEL, bool &FDBKEN,
                             bool &BFSSS, bool &FBBMSEL,
     ...
     * (read-write) EBU Bus Configuration Register
     */
    inline void set_BUSRCON3(uint8_t AGEN, bool AAP, uint8_t WAIT,
                             uint8_t PORTW, EBU_BUSRCON0_BCGEN BCGEN,
                             bool WAITINV, bool DBA, bool EBSE, bool ECSE,
                             bool NAA, bool BFCMSEL, bool FDBKEN, bool BFSSS,
                             bool FBBMSEL,
     ...
     * Lock Chip Select
     */
    inline bool get_BUSWCON3_LOCKCS() volatile
    {
        return BUSWCON3 & (1u << 27u);
    }
     ...
     * Asynchronous Address phase:
     */
    inline bool get_BUSWCON3_AAP() volatile
    {
        return BUSWCON3 & (1u << 26u);
    }
     ...
     * Reversed polarity at WAIT
     */
    inline bool get_BUSWCON3_WAITINV() volatile
    {
        return BUSWCON3 & (1u << 19u);
    }
     ...
     * Early Burst Signal Enable for Synchronous Burst
     */
    inline bool get_BUSWCON3_EBSE() volatile
    {
        return BUSWCON3 & (1u << 17u);
    }
     ...
     * Early Chip Select for Synchronous Burst
     */
    inline bool get_BUSWCON3_ECSE() volatile
    {
        return BUSWCON3 & (1u << 16u);
    }
     ...
     * Synchronous burst buffer mode select
     */
    inline bool get_BUSWCON3_FBBMSEL() volatile
    {
        return BUSWCON3 & (1u << 3u);
    }
     ...
     * (read-write) EBU Bus Write Configuration Register
     */
    inline void get_BUSWCON3(uint8_t &AGEN, bool &LOCKCS, bool &AAP,
                             uint8_t &WAIT, uint8_t &PORTW,
                             EBU_BUSRCON0_BCGEN &BCGEN, bool &WAITINV,
                             bool &EBSE, bool &ECSE, bool &NAA, bool &FBBMSEL,
                             EBU_BUSRCON0_FETBLEN &FETBLEN) volatile
     ...
     * (read-write) EBU Bus Write Configuration Register
     */
    inline void set_BUSWCON3(uint8_t AGEN, bool LOCKCS, bool AAP, uint8_t WAIT,
                             EBU_BUSRCON0_BCGEN BCGEN, bool WAITINV, bool EBSE,
                             bool ECSE, bool FBBMSEL,
                             EBU_BUSRCON0_FETBLEN FETBLEN) volatile
    {
     ...
     */
    inline bool get_SDRMCON_CLKDIS() volatile
    {
        return SDRMCON & (1u << 28u);
    }
     ...
     */
    inline bool get_SDRMCON_SDCMSEL() volatile
    {
        return SDRMCON & (1u << 31u);
    }
    ...
    inline void get_SDRMCON(uint8_t &CRAS, uint8_t &CRFSH, uint8_t &CRSC,
                            ...
                            uint8_t &CRCE, bool &CLKDIS,
                            EBU_SDRMCON_PWR_MODE &PWR_MODE,
                            bool &SDCMSEL) volatile
    {
        uint32_t curr = SDRMCON;
    ...
    inline void set_SDRMCON(uint8_t CRAS, uint8_t CRFSH, uint8_t CRSC,
                            ...
                            EBU_SDRMCON_BANKM BANKM, uint8_t CRCE, bool CLKDIS,
                            EBU_SDRMCON_PWR_MODE PWR_MODE,
                            bool SDCMSEL) volatile
    {
        uint32_t curr = SDRMCON;
        ...
        curr &= ~(0b1u << 28u);
        curr |= (CLKDIS & 0b1u) << 28u;
        curr &= ~(0b11u << 29u);
        curr |= (std::to_underlying(PWR_MODE) & 0b11u) << 29u;
        curr &= ~(0b1u << 31u);
        curr |= (SDCMSEL & 0b1u) << 31u;
     ...
     * Burst type
     */
    inline bool get_SDRMOD_BTYP() volatile
    {
        return SDRMOD & (1u << 3u);
    }
     ...
     */
    inline void get_SDRMOD(EBU_SDRMOD_BURSTL &BURSTL, bool &BTYP,
     ...
     * (read-write) EBU SDRAM Mode Register
     */
    inline void set_SDRMOD(EBU_SDRMOD_BURSTL BURSTL, bool BTYP,
     ...
     * SDRAM Refresh Error
     */
    inline bool get_SDRSTAT_REFERR() volatile
    {
        return SDRSTAT & (1u << 0u);
    }
     ...
     * SDRAM Busy
     */
    inline bool get_SDRSTAT_SDRMBUSY() volatile
    {
        return SDRSTAT & (1u << 1u);
    }
     ...
     * SDRAM read error
     */
    inline bool get_SDRSTAT_SDERR() volatile
    {
        return SDRSTAT & (1u << 2u);
    }

    /**
     * Get all of SDRSTAT's bit fields.
     *
     * (read-only) EBU SDRAM Status Register
     */
    inline void get_SDRSTAT(bool &REFERR, bool &SDRMBUSY, bool &SDERR) volatile
    {
