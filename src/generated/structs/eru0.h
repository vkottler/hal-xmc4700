...
struct [[gnu::packed]] eru0
{
     ...
     * Get EXICON's NA bit.
     */
    inline ERU0_EXICON_NB get_EXICON_NA(std::size_t index) volatile
    {
        return ERU0_EXICON_NB(EXICON[index] & (1u << 10u));
    }
     ...
     * Get EXICON's RE bit.
     */
    inline ERU0_EXICON_FE get_EXICON_RE(std::size_t index) volatile
    {
        return ERU0_EXICON_FE(EXICON[index] & (1u << 2u));
    }
     ...
     */
    inline void get_EXICON(std::size_t index, ERU0_EXICON_NB &NB,
                           ERU0_EXICON_NB &NA, ERU0_EXICON_SS &SS,
                           ERU0_EXICON_FL &FL, ERU0_EXICON_OCS &OCS,
                           ERU0_EXICON_FE &FE, ERU0_EXICON_FE &RE,
                           ERU0_EXICON_LD &LD, ERU0_EXICON_PE &PE) volatile
    {
        uint32_t curr = EXICON[index];

        NB = ERU0_EXICON_NB(curr & (1u << 11u));
        NA = ERU0_EXICON_NB(curr & (1u << 10u));
     ...
     */
    inline void set_EXICON(std::size_t index, ERU0_EXICON_NB NB,
                           ERU0_EXICON_NB NA, ERU0_EXICON_SS SS,
                           ERU0_EXICON_FL FL, ERU0_EXICON_OCS OCS,
                           ERU0_EXICON_FE FE, ERU0_EXICON_FE RE,
                           ERU0_EXICON_LD LD, ERU0_EXICON_PE PE) volatile
     ...
     */
    inline ERU0_EXOCON_IPEN3 get_EXOCON_IPEN2(std::size_t index) volatile
    {
        return ERU0_EXOCON_IPEN3(EXOCON[index] & (1u << 14u));
    }
     ...
     */
    inline ERU0_EXOCON_IPEN3 get_EXOCON_IPEN1(std::size_t index) volatile
    {
        return ERU0_EXOCON_IPEN3(EXOCON[index] & (1u << 13u));
    }
     ...
     */
    inline ERU0_EXOCON_IPEN3 get_EXOCON_IPEN0(std::size_t index) volatile
    {
        return ERU0_EXOCON_IPEN3(EXOCON[index] & (1u << 12u));
    }
     ...
     */
    inline ERU0_EXICON_PE get_EXOCON_GEEN(std::size_t index) volatile
    {
        return ERU0_EXICON_PE(EXOCON[index] & (1u << 2u));
    }
     ...
     */
    inline void get_EXOCON(std::size_t index, ERU0_EXOCON_IPEN3 &IPEN3,
                           ERU0_EXOCON_IPEN3 &IPEN2, ERU0_EXOCON_IPEN3 &IPEN1,
                           ERU0_EXOCON_IPEN3 &IPEN0, ERU0_EXOCON_GP &GP,
                           ERU0_EXOCON_PDR &PDR, ERU0_EXICON_PE &GEEN,
                           ERU0_EXOCON_ISS &ISS) volatile
    {
        uint32_t curr = EXOCON[index];

        IPEN3 = ERU0_EXOCON_IPEN3(curr & (1u << 15u));
        IPEN2 = ERU0_EXOCON_IPEN3(curr & (1u << 14u));
        IPEN1 = ERU0_EXOCON_IPEN3(curr & (1u << 13u));
        IPEN0 = ERU0_EXOCON_IPEN3(curr & (1u << 12u));
        GP = ERU0_EXOCON_GP((curr >> 4u) & 0b11u);
        PDR = ERU0_EXOCON_PDR(curr & (1u << 3u));
        GEEN = ERU0_EXICON_PE(curr & (1u << 2u));
     ...
     */
    inline void set_EXOCON(std::size_t index, ERU0_EXOCON_IPEN3 IPEN3,
                           ERU0_EXOCON_IPEN3 IPEN2, ERU0_EXOCON_IPEN3 IPEN1,
                           ERU0_EXOCON_IPEN3 IPEN0, ERU0_EXOCON_GP GP,
                           ERU0_EXICON_PE GEEN, ERU0_EXOCON_ISS ISS) volatile
    {
        uint32_t curr = EXOCON[index];
