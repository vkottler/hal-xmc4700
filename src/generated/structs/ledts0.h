...
struct [[gnu::packed]] ledts0
{
     ...
     */
    inline bool get_GLOBCTL_ITP_EN() volatile
    {
        return GLOBCTL & (1u << 15u);
    }
     ...
     */
    inline bool get_GLOBCTL_ITF_EN() volatile
    {
        return GLOBCTL & (1u << 14u);
    }
     ...
     */
    inline bool get_GLOBCTL_ITS_EN() volatile
    {
        return GLOBCTL & (1u << 13u);
    }
     ...
     */
    inline bool get_GLOBCTL_FENVAL() volatile
    {
        return GLOBCTL & (1u << 12u);
    }
     ...
     */
    inline bool get_GLOBCTL_SUSCFG() volatile
    {
        return GLOBCTL & (1u << 8u);
    }
     ...
     */
    inline bool get_GLOBCTL_ENSYNC() volatile
    {
        return GLOBCTL & (1u << 3u);
    }
     ...
     */
    inline bool get_GLOBCTL_CMTR() volatile
    {
        return GLOBCTL & (1u << 2u);
    }
     ...
     */
    inline void get_GLOBCTL(uint16_t &CLK_PS, bool &ITP_EN, bool &ITF_EN,
                            bool &ITS_EN, bool &FENVAL,
                            LEDTS0_GLOBCTL_MASKVAL &MASKVAL, bool &SUSCFG,
                            bool &ENSYNC, bool &CMTR, bool &LD_EN,
                            bool &TS_EN) volatile
    {
        uint32_t curr = GLOBCTL;
     ...
     * (read-write) Global Control Register
     */
    inline void set_GLOBCTL(uint16_t CLK_PS, bool ITP_EN, bool ITF_EN,
                            bool ITS_EN, bool FENVAL,
                            LEDTS0_GLOBCTL_MASKVAL MASKVAL, bool SUSCFG,
                            bool ENSYNC, bool CMTR, bool LD_EN,
                            bool TS_EN) volatile
    {
        ...
        curr &= ~(0b1u << 15u);
        curr |= (ITP_EN & 0b1u) << 15u;
        curr &= ~(0b1u << 14u);
        curr |= (ITF_EN & 0b1u) << 14u;
        curr &= ~(0b1u << 13u);
        curr |= (ITS_EN & 0b1u) << 13u;
        curr &= ~(0b1u << 12u);
        curr |= (FENVAL & 0b1u) << 12u;
        curr &= ~(0b111u << 9u);
     ...
     */
    inline bool get_FNCTL_COLLEV() volatile
    {
        return FNCTL & (1u << 28u);
    }
     ...
     */
    inline bool get_FNCTL_TSCTRSAT() volatile
    {
        return FNCTL & (1u << 24u);
    }
     ...
     */
    inline bool get_FNCTL_TSCTRR() volatile
    {
        return FNCTL & (1u << 23u);
    }
     ...
     */
    inline bool get_FNCTL_TSCCMP() volatile
    {
        return FNCTL & (1u << 20u);
    }
     ...
     */
    inline bool get_FNCTL_EPULL() volatile
    {
        return FNCTL & (1u << 4u);
    }
     ...
     */
    inline bool get_FNCTL_PADTSW() volatile
    {
        return FNCTL & (1u << 3u);
    }
     ...
     */
    inline void get_FNCTL(LEDTS0_FNCTL_NR_LEDCOL &NR_LEDCOL, bool &COLLEV,
                          LEDTS0_FNCTL_NR_TSIN &NR_TSIN, bool &TSCTRSAT,
                          bool &TSCTRR, LEDTS0_FNCTL_TSOEXT &TSOEXT,
                          bool &TSCCMP, LEDTS0_FNCTL_ACCCNT &ACCCNT,
                          uint8_t &FNCOL, bool &EPULL, bool &PADTSW,
     ...
     * (read-write) Function Control Register
     */
    inline void set_FNCTL(LEDTS0_FNCTL_NR_LEDCOL NR_LEDCOL, bool COLLEV,
                          LEDTS0_FNCTL_NR_TSIN NR_TSIN, bool TSCTRSAT,
                          bool TSCTRR, LEDTS0_FNCTL_TSOEXT TSOEXT, bool TSCCMP,
                          LEDTS0_FNCTL_ACCCNT ACCCNT, bool EPULL, bool PADTSW,
                          LEDTS0_FNCTL_PADT PADT) volatile
    {
        uint32_t curr = FNCTL;
        ...
        curr &= ~(0b1u << 28u);
        curr |= (COLLEV & 0b1u) << 28u;
        curr &= ~(0b111u << 25u);
        curr |= (std::to_underlying(NR_TSIN) & 0b111u) << 25u;
        curr &= ~(0b1u << 24u);
        curr |= (TSCTRSAT & 0b1u) << 24u;
        curr &= ~(0b1u << 23u);
        curr |= (TSCTRR & 0b1u) << 23u;
        curr &= ~(0b11u << 21u);
        curr |= (std::to_underlying(TSOEXT) & 0b11u) << 21u;
        curr &= ~(0b1u << 20u);
        curr |= (TSCCMP & 0b1u) << 20u;
        curr &= ~(0b1111u << 16u);
     ...
     */
    inline bool get_EVFR_TSCTROVF() volatile
    {
        return EVFR & (1u << 3u);
    }
     ...
     */
    inline void get_EVFR(bool &TSCTROVF, bool &TPF, bool &TFF,
                         bool &TSF) volatile
    {
        uint32_t curr = EVFR;
     ...
     * (read-write) Event Flag Register
     */
    inline void set_EVFR(bool CTPF, bool CTFF, bool CTSF) volatile
    {
        uint32_t curr = EVFR;
