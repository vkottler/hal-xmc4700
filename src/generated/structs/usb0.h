...
struct [[gnu::packed]] usb0
{
     ...
     */
    inline USB0_GAHBCFG_PTxFEmpLvl get_GAHBCFG_NPTxFEmpLvl() volatile
    {
        return USB0_GAHBCFG_PTxFEmpLvl(GAHBCFG & (1u << 7u));
    }
    ...
    inline void get_GAHBCFG(USB0_GAHBCFG_AHBSingle &AHBSingle,
                            ...
                            USB0_GAHBCFG_PTxFEmpLvl &NPTxFEmpLvl,
                            ...
                            USB0_GAHBCFG_GlblIntrMsk &GlblIntrMsk) volatile
    {
        ...
        NPTxFEmpLvl = USB0_GAHBCFG_PTxFEmpLvl(curr & (1u << 7u));
