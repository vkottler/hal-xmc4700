...
struct [[gnu::packed]] usb0
{
     ...
     * OTG Version
     */
    inline bool get_GOTGCTL_OTGVer() volatile
    {
        return GOTGCTL & (1u << 20u);
    }
     ...
     * B-Session Valid
     */
    inline bool get_GOTGCTL_BSesVld() volatile
    {
        return GOTGCTL & (1u << 19u);
    }
     ...
     * A-Session Valid
     */
    inline bool get_GOTGCTL_ASesVId() volatile
    {
        return GOTGCTL & (1u << 18u);
    }
     ...
     */
    inline bool get_GOTGCTL_DbncTime() volatile
    {
        return GOTGCTL & (1u << 17u);
    }
     ...
     * Connector ID Status
     */
    inline bool get_GOTGCTL_ConlDSts() volatile
    {
        return GOTGCTL & (1u << 16u);
    }
     ...
     * Device HNP Enabled
     */
    inline bool get_GOTGCTL_DevHNPEn() volatile
    {
        return GOTGCTL & (1u << 11u);
    }
     ...
     * Host Set HNP Enable
     */
    inline bool get_GOTGCTL_HstSetHNPEn() volatile
    {
        return GOTGCTL & (1u << 10u);
    }
     ...
     * HNP Request
     */
    inline bool get_GOTGCTL_HNPReq() volatile
    {
        return GOTGCTL & (1u << 9u);
    }
     ...
     */
    inline bool get_GOTGCTL_HstNegScs() volatile
    {
        return GOTGCTL & (1u << 8u);
    }
     ...
     */
    inline bool get_GOTGCTL_BvalidOvVal() volatile
    {
        return GOTGCTL & (1u << 7u);
    }
     ...
     */
    inline bool get_GOTGCTL_BvalidOvEn() volatile
    {
        return GOTGCTL & (1u << 6u);
    }
     ...
     */
    inline bool get_GOTGCTL_AvalidOvVal() volatile
    {
        return GOTGCTL & (1u << 5u);
    }
     ...
     */
    inline bool get_GOTGCTL_AvalidOvEn() volatile
    {
        return GOTGCTL & (1u << 4u);
    }
     ...
     */
    inline bool get_GOTGCTL_VbvalidOvVal() volatile
    {
        return GOTGCTL & (1u << 3u);
    }
     ...
     */
    inline bool get_GOTGCTL_VbvalidOvEn() volatile
    {
        return GOTGCTL & (1u << 2u);
    }
     ...
     * Session Request
     */
    inline bool get_GOTGCTL_SesReq() volatile
    {
        return GOTGCTL & (1u << 1u);
    }
     ...
     */
    inline bool get_GOTGCTL_SesReqScs() volatile
    {
        return GOTGCTL & (1u << 0u);
    }
     ...
     */
    inline void get_GOTGCTL(bool &OTGVer, bool &BSesVld, bool &ASesVId,
                            bool &DbncTime, bool &ConlDSts, bool &DevHNPEn,
                            bool &HstSetHNPEn, bool &HNPReq, bool &HstNegScs,
                            bool &BvalidOvVal, bool &BvalidOvEn,
                            bool &AvalidOvVal, bool &AvalidOvEn,
                            bool &VbvalidOvVal, bool &VbvalidOvEn,
                            bool &SesReq, bool &SesReqScs) volatile
    {
        ...
        BSesVld = curr & (1u << 19u);
        ASesVId = curr & (1u << 18u);
        DbncTime = curr & (1u << 17u);
        ConlDSts = curr & (1u << 16u);
        DevHNPEn = curr & (1u << 11u);
        HstSetHNPEn = curr & (1u << 10u);
        HNPReq = curr & (1u << 9u);
        HstNegScs = curr & (1u << 8u);
        BvalidOvVal = curr & (1u << 7u);
        BvalidOvEn = curr & (1u << 6u);
        AvalidOvVal = curr & (1u << 5u);
        AvalidOvEn = curr & (1u << 4u);
        VbvalidOvVal = curr & (1u << 3u);
        VbvalidOvEn = curr & (1u << 2u);
        SesReq = curr & (1u << 1u);
        SesReqScs = curr & (1u << 0u);
    }
     ...
     * (read-write) Control and Status Register
     */
    inline void set_GOTGCTL(bool OTGVer, bool DevHNPEn, bool HstSetHNPEn,
                            bool HNPReq, bool BvalidOvVal, bool BvalidOvEn,
                            bool AvalidOvVal, bool AvalidOvEn,
                            bool VbvalidOvVal, bool VbvalidOvEn,
                            bool SesReq) volatile
    {
        uint32_t curr = GOTGCTL;

        curr &= ~(0b1u << 20u);
        curr |= (OTGVer & 0b1u) << 20u;
        curr &= ~(0b1u << 11u);
        curr |= (DevHNPEn & 0b1u) << 11u;
        curr &= ~(0b1u << 10u);
        curr |= (HstSetHNPEn & 0b1u) << 10u;
        curr &= ~(0b1u << 9u);
        curr |= (HNPReq & 0b1u) << 9u;
        curr &= ~(0b1u << 7u);
        curr |= (BvalidOvVal & 0b1u) << 7u;
        curr &= ~(0b1u << 6u);
        curr |= (BvalidOvEn & 0b1u) << 6u;
        curr &= ~(0b1u << 5u);
        curr |= (AvalidOvVal & 0b1u) << 5u;
        curr &= ~(0b1u << 4u);
        curr |= (AvalidOvEn & 0b1u) << 4u;
        curr &= ~(0b1u << 3u);
        curr |= (VbvalidOvVal & 0b1u) << 3u;
        curr &= ~(0b1u << 2u);
        curr |= (VbvalidOvEn & 0b1u) << 2u;
        curr &= ~(0b1u << 1u);
        curr |= (SesReq & 0b1u) << 1u;
     ...
     *
     * (read-write) OTG Interrupt Register
     */
     ...
     * AHB Single Support
     */
    inline bool get_GAHBCFG_AHBSingle() volatile
    {
        return GAHBCFG & (1u << 23u);
    }
     ...
     */
    inline bool get_GAHBCFG_PTxFEmpLvl() volatile
    {
        return GAHBCFG & (1u << 8u);
    }
     ...
     */
    inline bool get_GAHBCFG_NPTxFEmpLvl() volatile
    {
        return GAHBCFG & (1u << 7u);
    }
     ...
     * DMA Enable
     */
    inline bool get_GAHBCFG_DMAEn() volatile
    {
        return GAHBCFG & (1u << 5u);
    }
     ...
     */
    inline bool get_GAHBCFG_GlblIntrMsk() volatile
    {
        return GAHBCFG & (1u << 0u);
    }
     ...
     *
     * (read-write) AHB Configuration Register
     */
    inline void get_GAHBCFG(bool &AHBSingle, bool &PTxFEmpLvl,
                            bool &NPTxFEmpLvl, bool &DMAEn,
                            USB0_GAHBCFG_HBstLen &HBstLen,
                            bool &GlblIntrMsk) volatile
    {
        uint32_t curr = GAHBCFG;

        AHBSingle = curr & (1u << 23u);
        PTxFEmpLvl = curr & (1u << 8u);
        NPTxFEmpLvl = curr & (1u << 7u);
        DMAEn = curr & (1u << 5u);
        HBstLen = USB0_GAHBCFG_HBstLen((curr >> 1u) & 0b1111u);
        GlblIntrMsk = curr & (1u << 0u);
    }
     ...
     * (read-write) AHB Configuration Register
     */
    inline void set_GAHBCFG(bool AHBSingle, bool PTxFEmpLvl, bool NPTxFEmpLvl,
                            bool DMAEn, USB0_GAHBCFG_HBstLen HBstLen,
                            bool GlblIntrMsk) volatile
    {
        uint32_t curr = GAHBCFG;

        curr &= ~(0b1u << 23u);
        curr |= (AHBSingle & 0b1u) << 23u;
        curr &= ~(0b1u << 8u);
        curr |= (PTxFEmpLvl & 0b1u) << 8u;
        curr &= ~(0b1u << 7u);
        curr |= (NPTxFEmpLvl & 0b1u) << 7u;
        curr &= ~(0b1u << 5u);
        curr |= (DMAEn & 0b1u) << 5u;
        curr &= ~(0b1111u << 1u);
        curr |= (std::to_underlying(HBstLen) & 0b1111u) << 1u;
        curr &= ~(0b1u << 0u);
        curr |= (GlblIntrMsk & 0b1u) << 0u;
     ...
     * Force Device Mode
     */
    inline bool get_GUSBCFG_ForceDevMode() volatile
    {
        return GUSBCFG & (1u << 30u);
    }
     ...
     * Force Host Mode
     */
    inline bool get_GUSBCFG_ForceHstMode() volatile
    {
        return GUSBCFG & (1u << 29u);
    }
     ...
     * Tx End Delay
     */
    inline bool get_GUSBCFG_TxEndDelay() volatile
    {
        return GUSBCFG & (1u << 28u);
    }
     ...
     */
    inline bool get_GUSBCFG_OtgI2CSel() volatile
    {
        return GUSBCFG & (1u << 16u);
    }
     ...
     * HNP-Capable
     */
    inline bool get_GUSBCFG_HNPCap() volatile
    {
        return GUSBCFG & (1u << 9u);
    }
     ...
     * SRP-Capable
     */
    inline bool get_GUSBCFG_SRPCap() volatile
    {
        return GUSBCFG & (1u << 8u);
    }
     ...
     */
    inline bool get_GUSBCFG_PHYSel() volatile
    {
        return GUSBCFG & (1u << 6u);
    }
     ...
     *
     * (read-write) USB Configuration Register
     */
    inline void get_GUSBCFG(bool &CTP, bool &ForceDevMode, bool &ForceHstMode,
                            bool &TxEndDelay, bool &OtgI2CSel,
                            uint8_t &USBTrdTim, bool &HNPCap, bool &SRPCap,
                            bool &PHYSel, uint8_t &TOutCal) volatile
    {
        uint32_t curr = GUSBCFG;

        CTP = curr & (1u << 31u);
        ForceDevMode = curr & (1u << 30u);
        ForceHstMode = curr & (1u << 29u);
        TxEndDelay = curr & (1u << 28u);
        OtgI2CSel = curr & (1u << 16u);
     ...
     * (read-write) USB Configuration Register
     */
    inline void set_GUSBCFG(bool CTP, bool ForceDevMode, bool ForceHstMode,
                            bool TxEndDelay, bool OtgI2CSel, uint8_t USBTrdTim,
                            bool HNPCap, bool SRPCap, uint8_t TOutCal) volatile
    {
        uint32_t curr = GUSBCFG;
        ...
        curr |= (CTP & 0b1u) << 31u;
        curr &= ~(0b1u << 30u);
        curr |= (ForceDevMode & 0b1u) << 30u;
        curr &= ~(0b1u << 29u);
        curr |= (ForceHstMode & 0b1u) << 29u;
        curr &= ~(0b1u << 28u);
        curr |= (TxEndDelay & 0b1u) << 28u;
        curr &= ~(0b1u << 16u);
        curr |= (OtgI2CSel & 0b1u) << 16u;
        curr &= ~(0b1111u << 10u);
     ...
     */
    inline bool get_GINTSTS_HOSTMODE_CurMod() volatile
    {
        return GINTSTS_HOSTMODE & (1u << 0u);
    }

    /**
     * Get all of GINTSTS_HOSTMODE's bit fields.
     *
     * (read-write) Interrupt Register [HOSTMODE]
     */
    inline void get_GINTSTS_HOSTMODE(bool &WkUpInt, bool &SessReqInt,
                                     bool &DisconnInt, bool &ConIDStsChng,
                                     bool &PTxFEmp, bool &HChInt, bool &PrtInt,
                                     bool &incomplP, bool &RxFLvl, bool &Sof,
                                     bool &OTGInt, bool &ModeMis,
                                     bool &CurMod) volatile
    {
     ...
     * Current Mode of Operation
     */
    inline bool get_GINTSTS_DEVICEMODE_CurMod() volatile
    {
        return GINTSTS_DEVICEMODE & (1u << 0u);
    }
     ...
     *
     * (read-write) Interrupt Mask Register [HOSTMODE]
     */
     ...
     *
     * (read-only) Receive Status Read and Pop Register [DEVICEMODE]
     */
     ...
     *
     * (read-write) Non-Periodic Transmit FIFO Size Register [HOSTMODE]
     */
     ...
     *
     * (read-only) Non-Periodic Transmit FIFO/Queue Status Register
     */
     ...
     *
     * (read-write) USB Module Identification Register
     */
     ...
     *
     * (read-write) Global DFIFO Software Config Register
     */
     ...
     *
     * (read-write) Host Periodic Transmit FIFO Size Register
     */
     ...
     *
     * (read-write) Device IN Endpoint Transmit FIFO Size Register
     */
     ...
     * FS-Only Support
     */
    inline bool get_HCFG_FSLSSupp() volatile
    {
        return HCFG & (1u << 2u);
    }
     ...
     * Reload Control
     */
    inline bool get_HFIR_HFIRRldCtrl() volatile
    {
        return HFIR & (1u << 16u);
    }
     ...
     *
     * (read-write) Host Frame Interval Register
     */
    inline void get_HFIR(bool &HFIRRldCtrl, uint16_t &FrInt) volatile
    {
        uint32_t curr = HFIR;

        HFIRRldCtrl = curr & (1u << 16u);
     ...
     * (read-write) Host Frame Interval Register
     */
    inline void set_HFIR(bool HFIRRldCtrl, uint16_t FrInt) volatile
    {
        uint32_t curr = HFIR;

        curr &= ~(0b1u << 16u);
        curr |= (HFIRRldCtrl & 0b1u) << 16u;
        curr &= ~(0b1111111111111111u << 0u);
     ...
     *
     * (read-write) Host Frame Number/Frame Time Remaining Register
     */
     ...
     *
     * (read-write) Host Periodic Transmit FIFO/ Queue Status Register
     */
     ...
     * Port Power
     */
    inline bool get_HPRT_PrtPwr() volatile
    {
        return HPRT & (1u << 12u);
    }
     ...
     * Port Reset
     */
    inline bool get_HPRT_PrtRst() volatile
    {
        return HPRT & (1u << 8u);
    }
     ...
     * Port Suspend
     */
    inline bool get_HPRT_PrtSusp() volatile
    {
        return HPRT & (1u << 7u);
    }
     ...
     * Port Resume
     */
    inline bool get_HPRT_PrtRes() volatile
    {
        return HPRT & (1u << 6u);
    }
     ...
     */
    inline bool get_HPRT_PrtOvrCurrAct() volatile
    {
        return HPRT & (1u << 4u);
    }
     ...
     * Port Enable
     */
    inline bool get_HPRT_PrtEna() volatile
    {
        return HPRT & (1u << 2u);
    }
     ...
     * Port Connect Status
     */
    inline bool get_HPRT_PrtConnSts() volatile
    {
        return HPRT & (1u << 0u);
    }
     ...
     *
     * (read-write) Host Port Control and Status Register
     */
    inline void get_HPRT(USB0_HPRT_PrtSpd &PrtSpd, bool &PrtPwr,
                         uint8_t &PrtLnSts, bool &PrtRst, bool &PrtSusp,
                         bool &PrtRes, bool &PrtOvrCurrChng,
                         bool &PrtOvrCurrAct, bool &PrtEnChng, bool &PrtEna,
                         bool &PrtConnDet, bool &PrtConnSts) volatile
    {
        uint32_t curr = HPRT;
        ...
        PrtOvrCurrAct = curr & (1u << 4u);
        PrtEnChng = curr & (1u << 3u);
        PrtEna = curr & (1u << 2u);
        PrtConnDet = curr & (1u << 1u);
        PrtConnSts = curr & (1u << 0u);
    }
     ...
     * (read-write) Host Port Control and Status Register
     */
    inline void set_HPRT(bool PrtPwr, bool PrtRst, bool PrtSusp, bool PrtRes,
                         bool PrtOvrCurrChng, bool PrtEnChng, bool PrtEna,
                         bool PrtConnDet) volatile
    {
        uint32_t curr = HPRT;

        curr &= ~(0b1u << 12u);
        curr |= (PrtPwr & 0b1u) << 12u;
        curr &= ~(0b1u << 8u);
        curr |= (PrtRst & 0b1u) << 8u;
        curr &= ~(0b1u << 7u);
        curr |= (PrtSusp & 0b1u) << 7u;
        curr &= ~(0b1u << 6u);
        curr |= (PrtRes & 0b1u) << 6u;
        curr &= ~(0b1u << 5u);
     ...
     */
    inline bool get_DCFG_NZStsOUTHShk() volatile
    {
        return DCFG & (1u << 2u);
    }
     ...
     */
    inline bool get_DCTL_EnContOnBNA() volatile
    {
        return DCTL & (1u << 17u);
    }
     ...
     *
     * Ignore frame number for isochronous endpoints in case of Scatter/Gather
     * DMA
     */
    inline bool get_DCTL_IgnrFrmNum() volatile
    {
        return DCTL & (1u << 15u);
    }
     ...
     */
    inline bool get_DCTL_GOUTNakSts() volatile
    {
        return DCTL & (1u << 3u);
    }
     ...
     */
    inline bool get_DCTL_GNPINNakSts() volatile
    {
        return DCTL & (1u << 2u);
    }
     ...
     * Soft Disconnect
     */
    inline bool get_DCTL_SftDiscon() volatile
    {
        return DCTL & (1u << 1u);
    }
     ...
     *
     * (read-write) Device Control Register
     */
    inline void get_DCTL(bool &EnContOnBNA, bool &NakOnBble, bool &IgnrFrmNum,
                         USB0_DCTL_GMC &GMC, bool &GOUTNakSts,
                         bool &GNPINNakSts, bool &SftDiscon,
                         bool &RmtWkUpSig) volatile
    {
        uint32_t curr = DCTL;

        EnContOnBNA = curr & (1u << 17u);
        NakOnBble = curr & (1u << 16u);
        IgnrFrmNum = curr & (1u << 15u);
        GMC = USB0_DCTL_GMC((curr >> 13u) & 0b11u);
        GOUTNakSts = curr & (1u << 3u);
        GNPINNakSts = curr & (1u << 2u);
        SftDiscon = curr & (1u << 1u);
     ...
     * (read-write) Device Control Register
     */
    inline void set_DCTL(bool EnContOnBNA, bool NakOnBble, bool IgnrFrmNum,
                         USB0_DCTL_GMC GMC, bool CGOUTNak, bool SGOUTNak,
                         bool CGNPInNak, bool SGNPInNak, bool SftDiscon,
                         bool RmtWkUpSig) volatile
    {
        uint32_t curr = DCTL;

        curr &= ~(0b1u << 17u);
        curr |= (EnContOnBNA & 0b1u) << 17u;
        curr &= ~(0b1u << 16u);
        curr |= (NakOnBble & 0b1u) << 16u;
        curr &= ~(0b1u << 15u);
        curr |= (IgnrFrmNum & 0b1u) << 15u;
        curr &= ~(0b11u << 13u);
     ...
     *
     * (read-write) Device IN Endpoint Common Interrupt Mask Register
     */
     ...
     *
     * (read-write) Device OUT Endpoint Common Interrupt Mask Register
     */
     ...
     *
     * (read-write) Device All Endpoints Interrupt Mask Register
     */
     ...
     *
     * (read-write) Power and Clock Gating Control Register
     */
