...
struct [[gnu::packed]] scu_osc
{
     ...
     */
    inline void get_OSCHPCTRL(uint8_t &OSCVAL, SCU_OSC_OSCHPCTRL_MODE &MODE, SCU_OSC_OSCHPCTRL_GAINSEL &GAINSEL, SCU_OSC_OSCHPCTRL_SHBY &SHBY, SCU_OSC_OSCHPCTRL_X1DEN &X1DEN) volatile
    {
        uint32_t curr = OSCHPCTRL;
     ...
     */
    inline void set_OSCHPCTRL(uint8_t OSCVAL, SCU_OSC_OSCHPCTRL_MODE MODE, SCU_OSC_OSCHPCTRL_GAINSEL GAINSEL, SCU_OSC_OSCHPCTRL_SHBY SHBY, SCU_OSC_OSCHPCTRL_X1DEN X1DEN) volatile
    {
        uint32_t curr = OSCHPCTRL;
