...
struct [[gnu::packed]] can
{
     ...
     */
    inline bool get_LIST_EMPTY(std::size_t index) volatile
    {
        return LIST[index] & (1u << 24u);
    }
     ...
     */
    inline void get_LIST(std::size_t index, bool &EMPTY, uint8_t &SIZE,
                         uint8_t &END, uint8_t &BEGIN) volatile
    {
     ...
     * Result Busy Flag
     */
    inline bool get_PANCTR_RBUSY() volatile
    {
        return PANCTR & (1u << 9u);
    }
     ...
     * Panel Busy Flag
     */
    inline bool get_PANCTR_BUSY() volatile
    {
        return PANCTR & (1u << 8u);
    }
     ...
     */
    inline void get_PANCTR(uint8_t &PANAR2, uint8_t &PANAR1, bool &RBUSY,
                           bool &BUSY, uint8_t &PANCMD) volatile
    {
        uint32_t curr = PANCTR;
