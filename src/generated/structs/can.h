...
struct [[gnu::packed]] can
{
     ...
     */
    inline void get_ID(uint16_t &MOD_NUMBER, CAN_ID_MOD_TYPE &MOD_TYPE, uint8_t &MOD_REV) volatile
    {
        uint32_t curr = ID;
     ...
     */
    inline void get_LIST(std::size_t index, CAN_LIST_EMPTY &EMPTY, uint8_t &SIZE, uint8_t &END, uint8_t &BEGIN) volatile
    {
     ...
     */
    inline void get_PANCTR(uint8_t &PANAR2, uint8_t &PANAR1, CAN_PANCTR_RBUSY &RBUSY, CAN_PANCTR_BUSY &BUSY, uint8_t &PANCMD) volatile
    {
        uint32_t curr = PANCTR;
     ...
     */
    inline void set_PANCTR(uint8_t PANAR2, uint8_t PANAR1, uint8_t PANCMD) volatile
    {
        uint32_t curr = PANCTR;
