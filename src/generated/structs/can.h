...
struct [[gnu::packed]] can
{
     ...
     *
     * (read-write) CAN Clock Control Register
     */
     ...
     * Module Type
     */
    inline CAN_ID_MOD_TYPE get_ID_MOD_TYPE() volatile
    {
     ...
     */
    inline void get_ID(uint16_t &MOD_NUMBER, CAN_ID_MOD_TYPE &MOD_TYPE,
     ...
     * Divider Mode
     */
    inline uint8_t get_FDR_DM() volatile
    {
     ...
     * Divider Mode
     */
    inline void set_FDR_DM(uint8_t value) volatile
    {
        uint32_t curr = FDR;
     ...
     *
     * (read-write) CAN Fractional Divider Register
     */
    inline void get_FDR(uint8_t &DM, uint16_t &STEP) volatile
    {
        uint32_t curr = FDR;
     ...
     * (read-write) CAN Fractional Divider Register
     */
    inline void set_FDR(uint8_t DM, uint16_t STEP) volatile
    {
        uint32_t curr = FDR;
     ...
     */
    inline CAN_LIST_EMPTY get_LIST_EMPTY(std::size_t index) volatile
    {
     ...
     * List Size
     */
    inline uint8_t get_LIST_SIZE(std::size_t index) volatile
    {
     ...
     * List End
     */
    inline uint8_t get_LIST_END(std::size_t index) volatile
    {
     ...
     * List Begin
     */
    inline uint8_t get_LIST_BEGIN(std::size_t index) volatile
    {
     ...
     *
     * (read-only) List Register
     */
    inline void get_LIST(std::size_t index, CAN_LIST_EMPTY &EMPTY,
                         uint8_t &SIZE, uint8_t &END, uint8_t &BEGIN) volatile
    {
     ...
     * Message Pending
     */
    inline uint32_t get_MSPND_PND(std::size_t index) volatile
    {
     ...
     * Message Pending
     */
    inline void set_MSPND_PND(std::size_t index, uint32_t value) volatile
    {
     ...
     */
    inline uint8_t get_MSID_INDEX(std::size_t index) volatile
    {
     ...
     * Message Index Mask
     */
    inline uint32_t get_MSIMASK_IM() volatile
    {
     ...
     * Message Index Mask
     */
    inline void set_MSIMASK_IM(uint32_t value) volatile
    {
     ...
     * Panel Argument 2
     */
    inline uint8_t get_PANCTR_PANAR2() volatile
    {
     ...
     * Panel Argument 2
     */
    inline void set_PANCTR_PANAR2(uint8_t value) volatile
    {
     ...
     * Panel Argument 1
     */
    inline uint8_t get_PANCTR_PANAR1() volatile
    {
     ...
     * Panel Argument 1
     */
    inline void set_PANCTR_PANAR1(uint8_t value) volatile
    {
        uint32_t curr = PANCTR;
     ...
     * Result Busy Flag
     */
    inline CAN_PANCTR_RBUSY get_PANCTR_RBUSY() volatile
    {
     ...
     * Panel Busy Flag
     */
    inline CAN_PANCTR_BUSY get_PANCTR_BUSY() volatile
    {
     ...
     * Panel Command
     */
    inline uint8_t get_PANCTR_PANCMD() volatile
    {
     ...
     * Panel Command
     */
    inline void set_PANCTR_PANCMD(uint8_t value) volatile
    {
        uint32_t curr = PANCTR;
     ...
     *
     * (read-write) Panel Control Register
     */
    inline void get_PANCTR(uint8_t &PANAR2, uint8_t &PANAR1,
                           CAN_PANCTR_RBUSY &RBUSY, CAN_PANCTR_BUSY &BUSY,
                           uint8_t &PANCMD) volatile
    {
        uint32_t curr = PANCTR;
     ...
     * (read-write) Panel Control Register
     */
    inline void set_PANCTR(uint8_t PANAR2, uint8_t PANAR1,
                           uint8_t PANCMD) volatile
    {
        uint32_t curr = PANCTR;
     ...
     */
    inline uint8_t get_MCR_MPSEL() volatile
    {
     ...
     * Message Pending Selector
     */
    inline void set_MCR_MPSEL(uint8_t value) volatile
    {
        uint32_t curr = MCR;
     ...
     */
    inline CAN_MCR_CLKSEL get_MCR_CLKSEL() volatile
    {
     ...
     * Baud Rate Logic Clock Select
     */
    inline void set_MCR_CLKSEL(CAN_MCR_CLKSEL value) volatile
    {
        uint32_t curr = MCR;
     ...
     */
    inline void get_MCR(uint8_t &MPSEL, CAN_MCR_CLKSEL &CLKSEL) volatile
    {
        uint32_t curr = MCR;
     ...
     * (read-write) Module Control Register
     */
    inline void set_MCR(uint8_t MPSEL, CAN_MCR_CLKSEL CLKSEL) volatile
    {
        uint32_t curr = MCR;
     ...
     * Interrupt Trigger
     */
    inline void set_MITR_IT(uint8_t value) volatile
    {
        uint32_t curr = MITR;
