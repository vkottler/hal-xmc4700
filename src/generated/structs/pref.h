...
struct [[gnu::packed]] pref
{
     ...
     * Get PCON's IBYP bit.
     */
    inline PREF_PCON_IBYP get_PCON_IBYP() volatile
    {
     ...
     */
    inline void get_PCON(PREF_PCON_DBYP &DBYP, PREF_PCON_IBYP &IBYP) volatile
    {
        uint32_t curr = PCON;
     ...
     */
    inline void set_PCON(PREF_PCON_DBYP DBYP, PREF_PCON_IINV IINV, PREF_PCON_IBYP IBYP) volatile
    {
        uint32_t curr = PCON;
