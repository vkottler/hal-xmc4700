...
struct [[gnu::packed]] flash0
{
     ...
     * Get FSR's VER bit.
     */
    inline FLASH0_FSR_VER get_FSR_VER()
    {
     ...
     * Get FSR's SLM bit.
     */
    inline FLASH0_FSR_SLM get_FSR_SLM()
    {
     ...
     */
    inline FLASH0_FSR_WPRODIS1 get_FSR_WPRODIS1()
    {
     ...
     */
    inline FLASH0_FSR_WPRODIS0 get_FSR_WPRODIS0()
    {
     ...
     */
    inline FLASH0_FSR_WPROIN2 get_FSR_WPROIN2()
    {
     ...
     */
    inline FLASH0_FSR_WPROIN1 get_FSR_WPROIN1()
    {
     ...
     */
    inline FLASH0_FSR_WPROIN0 get_FSR_WPROIN0()
    {
     ...
     */
    inline FLASH0_FSR_RPRODIS get_FSR_RPRODIS()
    {
     ...
     */
    inline FLASH0_FSR_RPROIN get_FSR_RPROIN()
    {
     ...
     * Get FSR's PROIN bit.
     */
    inline FLASH0_FSR_PROIN get_FSR_PROIN()
    {
     ...
     */
    inline FLASH0_FSR_PFDBER get_FSR_PFDBER()
    {
     ...
     */
    inline FLASH0_FSR_PFSBER get_FSR_PFSBER()
    {
     ...
     * Get FSR's PROER bit.
     */
    inline FLASH0_FSR_PROER get_FSR_PROER()
    {
     ...
     * Get FSR's SQER bit.
     */
    inline FLASH0_FSR_SQER get_FSR_SQER()
    {
     ...
     */
    inline FLASH0_FSR_PFOPER get_FSR_PFOPER()
    {
     ...
     */
    inline FLASH0_FSR_PFPAGE get_FSR_PFPAGE()
    {
     ...
     * Get FSR's ERASE bit.
     */
    inline FLASH0_FSR_ERASE get_FSR_ERASE()
    {
     ...
     * Get FSR's PROG bit.
     */
    inline FLASH0_FSR_PROG get_FSR_PROG()
    {
     ...
     * Get FSR's PBUSY bit.
     */
    inline FLASH0_FSR_PBUSY get_FSR_PBUSY()
    {
     ...
     */
    inline void get_FSR(FLASH0_FSR_VER &VER, FLASH0_FSR_SLM &SLM, FLASH0_FSR_WPRODIS1 &WPRODIS1, FLASH0_FSR_WPRODIS0 &WPRODIS0, FLASH0_FSR_WPROIN2 &WPROIN2, FLASH0_FSR_WPROIN1 &WPROIN1, FLASH0_FSR_WPROIN0 &WPROIN0, FLASH0_FSR_RPRODIS &RPRODIS, FLASH0_FSR_RPROIN &RPROIN, FLASH0_FSR_PROIN &PROIN, FLASH0_FSR_PFDBER &PFDBER, FLASH0_FSR_PFSBER &PFSBER, FLASH0_FSR_PROER &PROER, FLASH0_FSR_SQER &SQER, FLASH0_FSR_PFOPER &PFOPER, FLASH0_FSR_PFPAGE &PFPAGE, FLASH0_FSR_ERASE &ERASE, FLASH0_FSR_PROG &PROG, bool &FABUSY, FLASH0_FSR_PBUSY &PBUSY)
    {
        uint32_t curr = FSR;
     ...
     * Get FCON's EOBM bit.
     */
    inline FLASH0_FCON_EOBM get_FCON_EOBM()
    {
     ...
     */
    inline FLASH0_FCON_PFDBERM get_FCON_PFDBERM()
    {
     ...
     */
    inline FLASH0_FCON_PFSBERM get_FCON_PFSBERM()
    {
     ...
     */
    inline FLASH0_FCON_PROERM get_FCON_PROERM()
    {
     ...
     */
    inline FLASH0_FCON_SQERM get_FCON_SQERM()
    {
     ...
     */
    inline FLASH0_FCON_VOPERM get_FCON_VOPERM()
    {
     ...
     * Get FCON's DDF bit.
     */
    inline FLASH0_FCON_DDF get_FCON_DDF()
    {
     ...
     * Get FCON's DCF bit.
     */
    inline FLASH0_FCON_DCF get_FCON_DCF()
    {
     ...
     * Get FCON's RPA bit.
     */
    inline FLASH0_FCON_RPA get_FCON_RPA()
    {
     ...
     */
    inline FLASH0_FCON_SLEEP get_FCON_SLEEP()
    {
     ...
     */
    inline FLASH0_FCON_ESLDIS get_FCON_ESLDIS()
    {
     ...
     * Get FCON's IDLE bit.
     */
    inline FLASH0_FCON_IDLE get_FCON_IDLE()
    {
     ...
     */
    inline FLASH0_FCON_WSECPF get_FCON_WSECPF()
    {
     ...
     */
    inline FLASH0_FCON_WSPFLASH get_FCON_WSPFLASH()
    {
     ...
     */
    inline void get_FCON(FLASH0_FCON_EOBM &EOBM, FLASH0_FCON_PFDBERM &PFDBERM, FLASH0_FCON_PFSBERM &PFSBERM, FLASH0_FCON_PROERM &PROERM, FLASH0_FCON_SQERM &SQERM, FLASH0_FCON_VOPERM &VOPERM, FLASH0_FCON_DDF &DDF, FLASH0_FCON_DCF &DCF, FLASH0_FCON_RPA &RPA, FLASH0_FCON_SLEEP &SLEEP, FLASH0_FCON_ESLDIS &ESLDIS, FLASH0_FCON_IDLE &IDLE, FLASH0_FCON_WSECPF &WSECPF, FLASH0_FCON_WSPFLASH &WSPFLASH)
    {
        uint32_t curr = FCON;
        ...
        DCF = FLASH0_FCON_DCF(curr & (1u << 17u));
     ...
     */
    inline void set_FCON(FLASH0_FCON_EOBM EOBM, FLASH0_FCON_PFDBERM PFDBERM, FLASH0_FCON_PFSBERM PFSBERM, FLASH0_FCON_PROERM PROERM, FLASH0_FCON_SQERM SQERM, FLASH0_FCON_VOPERM VOPERM, FLASH0_FCON_DDF DDF, FLASH0_FCON_DCF DCF, FLASH0_FCON_SLEEP SLEEP, FLASH0_FCON_ESLDIS ESLDIS, FLASH0_FCON_IDLE IDLE, FLASH0_FCON_WSECPF WSECPF, FLASH0_FCON_WSPFLASH WSPFLASH)
    {
        uint32_t curr = FCON;
     ...
     */
    inline FLASH0_MARP_TRAPDIS get_MARP_TRAPDIS()
    {
     ...
     */
    inline FLASH0_MARP_MARGIN get_MARP_MARGIN()
    {
     ...
     */
    inline void get_MARP(FLASH0_MARP_TRAPDIS &TRAPDIS, FLASH0_MARP_MARGIN &MARGIN)
    {
        uint32_t curr = MARP;
     ...
     */
    inline void set_MARP(FLASH0_MARP_TRAPDIS TRAPDIS, FLASH0_MARP_MARGIN MARGIN)
    {
        uint32_t curr = MARP;
     ...
     */
    inline FLASH0_PROCON0_RPRO get_PROCON0_RPRO()
    {
     ...
     */
    inline FLASH0_PROCON0_S14_S15L get_PROCON0_S14_S15L()
    {
     ...
     */
    inline FLASH0_PROCON0_S12_S13L get_PROCON0_S12_S13L()
    {
     ...
     */
    inline FLASH0_PROCON0_S10_S11L get_PROCON0_S10_S11L()
    {
     ...
     */
    inline FLASH0_PROCON0_S9L get_PROCON0_S9L()
    {
     ...
     */
    inline FLASH0_PROCON0_S8L get_PROCON0_S8L()
    {
     ...
     */
    inline FLASH0_PROCON0_S7L get_PROCON0_S7L()
    {
     ...
     */
    inline FLASH0_PROCON0_S6L get_PROCON0_S6L()
    {
     ...
     */
    inline FLASH0_PROCON0_S5L get_PROCON0_S5L()
    {
     ...
     */
    inline FLASH0_PROCON0_S4L get_PROCON0_S4L()
    {
     ...
     */
    inline FLASH0_PROCON0_S3L get_PROCON0_S3L()
    {
     ...
     */
    inline FLASH0_PROCON0_S2L get_PROCON0_S2L()
    {
     ...
     */
    inline FLASH0_PROCON0_S1L get_PROCON0_S1L()
    {
     ...
     */
    inline FLASH0_PROCON0_S0L get_PROCON0_S0L()
    {
     ...
     */
    inline void get_PROCON0(FLASH0_PROCON0_RPRO &RPRO, FLASH0_PROCON0_S14_S15L &S14_S15L, FLASH0_PROCON0_S12_S13L &S12_S13L, FLASH0_PROCON0_S10_S11L &S10_S11L, FLASH0_PROCON0_S9L &S9L, FLASH0_PROCON0_S8L &S8L, FLASH0_PROCON0_S7L &S7L, FLASH0_PROCON0_S6L &S6L, FLASH0_PROCON0_S5L &S5L, FLASH0_PROCON0_S4L &S4L, FLASH0_PROCON0_S3L &S3L, FLASH0_PROCON0_S2L &S2L, FLASH0_PROCON0_S1L &S1L, FLASH0_PROCON0_S0L &S0L)
    {
        ...
        S8L = FLASH0_PROCON0_S8L(curr & (1u << 8u));
        S7L = FLASH0_PROCON0_S7L(curr & (1u << 7u));
        S6L = FLASH0_PROCON0_S6L(curr & (1u << 6u));
        S5L = FLASH0_PROCON0_S5L(curr & (1u << 5u));
        S4L = FLASH0_PROCON0_S4L(curr & (1u << 4u));
        S3L = FLASH0_PROCON0_S3L(curr & (1u << 3u));
        S2L = FLASH0_PROCON0_S2L(curr & (1u << 2u));
        S1L = FLASH0_PROCON0_S1L(curr & (1u << 1u));
        S0L = FLASH0_PROCON0_S0L(curr & (1u << 0u));
    }

    /**
     * Get PROCON1's PSR bit.
     */
    inline FLASH0_PROCON1_PSR get_PROCON1_PSR()
    {
     ...
     */
    inline FLASH0_PROCON1_S14_S15L get_PROCON1_S14_S15L()
    {
     ...
     */
    inline FLASH0_PROCON1_S12_S13L get_PROCON1_S12_S13L()
    {
     ...
     */
    inline FLASH0_PROCON1_S10_S11L get_PROCON1_S10_S11L()
    {
     ...
     */
    inline FLASH0_PROCON1_S9L get_PROCON1_S9L()
    {
     ...
     */
    inline FLASH0_PROCON1_S8L get_PROCON1_S8L()
    {
     ...
     */
    inline FLASH0_PROCON1_S7L get_PROCON1_S7L()
    {
     ...
     */
    inline FLASH0_PROCON1_S6L get_PROCON1_S6L()
    {
     ...
     */
    inline FLASH0_PROCON1_S5L get_PROCON1_S5L()
    {
     ...
     */
    inline FLASH0_PROCON1_S4L get_PROCON1_S4L()
    {
     ...
     */
    inline FLASH0_PROCON1_S3L get_PROCON1_S3L()
    {
     ...
     */
    inline FLASH0_PROCON1_S2L get_PROCON1_S2L()
    {
     ...
     */
    inline FLASH0_PROCON1_S1L get_PROCON1_S1L()
    {
     ...
     */
    inline FLASH0_PROCON1_S0L get_PROCON1_S0L()
    {
     ...
     */
    inline void get_PROCON1(FLASH0_PROCON1_PSR &PSR, FLASH0_PROCON1_S14_S15L &S14_S15L, FLASH0_PROCON1_S12_S13L &S12_S13L, FLASH0_PROCON1_S10_S11L &S10_S11L, FLASH0_PROCON1_S9L &S9L, FLASH0_PROCON1_S8L &S8L, FLASH0_PROCON1_S7L &S7L, FLASH0_PROCON1_S6L &S6L, FLASH0_PROCON1_S5L &S5L, FLASH0_PROCON1_S4L &S4L, FLASH0_PROCON1_S3L &S3L, FLASH0_PROCON1_S2L &S2L, FLASH0_PROCON1_S1L &S1L, FLASH0_PROCON1_S0L &S0L)
    {
        uint32_t curr = PROCON1;

        PSR = FLASH0_PROCON1_PSR(curr & (1u << 16u));
        S14_S15L = FLASH0_PROCON1_S14_S15L(curr & (1u << 12u));
        S12_S13L = FLASH0_PROCON1_S12_S13L(curr & (1u << 11u));
        S10_S11L = FLASH0_PROCON1_S10_S11L(curr & (1u << 10u));
        S9L = FLASH0_PROCON1_S9L(curr & (1u << 9u));
        S8L = FLASH0_PROCON1_S8L(curr & (1u << 8u));
        S7L = FLASH0_PROCON1_S7L(curr & (1u << 7u));
        S6L = FLASH0_PROCON1_S6L(curr & (1u << 6u));
        S5L = FLASH0_PROCON1_S5L(curr & (1u << 5u));
        S4L = FLASH0_PROCON1_S4L(curr & (1u << 4u));
        S3L = FLASH0_PROCON1_S3L(curr & (1u << 3u));
        S2L = FLASH0_PROCON1_S2L(curr & (1u << 2u));
        S1L = FLASH0_PROCON1_S1L(curr & (1u << 1u));
        S0L = FLASH0_PROCON1_S0L(curr & (1u << 0u));
    }

    /**
     * Get PROCON2's S14_S15ROM bit.
     */
    inline FLASH0_PROCON2_S14_S15ROM get_PROCON2_S14_S15ROM()
    {
     ...
     */
    inline FLASH0_PROCON2_S12_S13ROM get_PROCON2_S12_S13ROM()
    {
     ...
     */
    inline FLASH0_PROCON2_S10_S11ROM get_PROCON2_S10_S11ROM()
    {
     ...
     */
    inline FLASH0_PROCON2_S9ROM get_PROCON2_S9ROM()
    {
     ...
     */
    inline FLASH0_PROCON2_S8ROM get_PROCON2_S8ROM()
    {
     ...
     */
    inline FLASH0_PROCON2_S7ROM get_PROCON2_S7ROM()
    {
     ...
     */
    inline FLASH0_PROCON2_S6ROM get_PROCON2_S6ROM()
    {
     ...
     */
    inline FLASH0_PROCON2_S5ROM get_PROCON2_S5ROM()
    {
     ...
     */
    inline FLASH0_PROCON2_S4ROM get_PROCON2_S4ROM()
    {
     ...
     */
    inline FLASH0_PROCON2_S3ROM get_PROCON2_S3ROM()
    {
     ...
     */
    inline FLASH0_PROCON2_S2ROM get_PROCON2_S2ROM()
    {
     ...
     */
    inline FLASH0_PROCON2_S1ROM get_PROCON2_S1ROM()
    {
     ...
     */
    inline FLASH0_PROCON2_S0ROM get_PROCON2_S0ROM()
    {
     ...
     */
    inline void get_PROCON2(FLASH0_PROCON2_S14_S15ROM &S14_S15ROM, FLASH0_PROCON2_S12_S13ROM &S12_S13ROM, FLASH0_PROCON2_S10_S11ROM &S10_S11ROM, FLASH0_PROCON2_S9ROM &S9ROM, FLASH0_PROCON2_S8ROM &S8ROM, FLASH0_PROCON2_S7ROM &S7ROM, FLASH0_PROCON2_S6ROM &S6ROM, FLASH0_PROCON2_S5ROM &S5ROM, FLASH0_PROCON2_S4ROM &S4ROM, FLASH0_PROCON2_S3ROM &S3ROM, FLASH0_PROCON2_S2ROM &S2ROM, FLASH0_PROCON2_S1ROM &S1ROM, FLASH0_PROCON2_S0ROM &S0ROM)
    {
        ...
        S8ROM = FLASH0_PROCON2_S8ROM(curr & (1u << 8u));
        S7ROM = FLASH0_PROCON2_S7ROM(curr & (1u << 7u));
        S6ROM = FLASH0_PROCON2_S6ROM(curr & (1u << 6u));
        S5ROM = FLASH0_PROCON2_S5ROM(curr & (1u << 5u));
        S4ROM = FLASH0_PROCON2_S4ROM(curr & (1u << 4u));
        S3ROM = FLASH0_PROCON2_S3ROM(curr & (1u << 3u));
        S2ROM = FLASH0_PROCON2_S2ROM(curr & (1u << 2u));
        S1ROM = FLASH0_PROCON2_S1ROM(curr & (1u << 1u));
        S0ROM = FLASH0_PROCON2_S0ROM(curr & (1u << 0u));
    }
};
