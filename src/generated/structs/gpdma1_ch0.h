...
#include "../enums/GPDMA1_CH0_CFGL_LOCK_B_L.h"
#include "../enums/GPDMA1_CH0_CFGL_LOCK_CH_L.h"
#include "../enums/GPDMA1_CH0_CFGL_SRC_HS_POL.h"
#include "../enums/GPDMA1_CH0_CTLL_DINC.h"
#include "../enums/GPDMA1_CH0_CTLL_SINC.h"
...
struct [[gnu::packed]] gpdma1_ch0
{
     ...
     */
    inline GPDMA1_CH0_CTLL_DINC get_CTLL_DINC()
    {
     ...
     */
    inline void set_CTLL_DINC(GPDMA1_CH0_CTLL_DINC value)
    {
        uint32_t curr = CTLL;
     ...
     */
    inline GPDMA1_CH0_CTLL_SINC get_CTLL_SINC()
    {
        return GPDMA1_CH0_CTLL_SINC((CTLL >> 9u) & 0b11u);
    }

    /**
     * Set CTLL's SINC field.
     */
    inline void set_CTLL_SINC(GPDMA1_CH0_CTLL_SINC value)
    {
        uint32_t curr = CTLL;
     ...
     */
    inline void get_CTLL(bool &INT_EN, uint8_t &DST_TR_WIDTH, uint8_t &SRC_TR_WIDTH, GPDMA1_CH0_CTLL_DINC &DINC, GPDMA1_CH0_CTLL_SINC &SINC, uint8_t &DEST_MSIZE, uint8_t &SRC_MSIZE, uint8_t &TT_FC)
    {
        uint32_t curr = CTLL;
        ...
        SINC = GPDMA1_CH0_CTLL_SINC((curr >> 9u) & 0b11u);
     ...
     */
    inline void set_CTLL(bool INT_EN, uint8_t DST_TR_WIDTH, uint8_t SRC_TR_WIDTH, GPDMA1_CH0_CTLL_DINC DINC, GPDMA1_CH0_CTLL_SINC SINC, uint8_t DEST_MSIZE, uint8_t SRC_MSIZE, uint8_t TT_FC)
    {
        uint32_t curr = CTLL;
     ...
     */
    inline GPDMA1_CH0_CFGL_CH_SUSP get_CFGL_CH_SUSP()
    {
     ...
     */
    inline GPDMA1_CH0_CFGL_FIFO_EMPTY get_CFGL_FIFO_EMPTY()
    {
     ...
     */
    inline GPDMA1_CH0_CFGL_HS_SEL_DST get_CFGL_HS_SEL_DST()
    {
     ...
     */
    inline GPDMA1_CH0_CFGL_HS_SEL_SRC get_CFGL_HS_SEL_SRC()
    {
     ...
     */
    inline GPDMA1_CH0_CFGL_LOCK_CH_L get_CFGL_LOCK_CH_L()
    {
     ...
     */
    inline void set_CFGL_LOCK_CH_L(GPDMA1_CH0_CFGL_LOCK_CH_L value)
    {
        uint32_t curr = CFGL;
     ...
     */
    inline GPDMA1_CH0_CFGL_LOCK_B_L get_CFGL_LOCK_B_L()
    {
        return GPDMA1_CH0_CFGL_LOCK_B_L((CFGL >> 14u) & 0b11u);
    }

    /**
     * Set CFGL's LOCK_B_L field.
     */
    inline void set_CFGL_LOCK_B_L(GPDMA1_CH0_CFGL_LOCK_B_L value)
    {
        uint32_t curr = CFGL;
     ...
     */
    inline GPDMA1_CH0_CFGL_DST_HS_POL get_CFGL_DST_HS_POL()
    {
     ...
     */
    inline GPDMA1_CH0_CFGL_SRC_HS_POL get_CFGL_SRC_HS_POL()
    {
        return GPDMA1_CH0_CFGL_SRC_HS_POL(CFGL & (1u << 19u));
    }
     ...
     */
    inline void get_CFGL(uint8_t &CH_PRIOR, GPDMA1_CH0_CFGL_CH_SUSP &CH_SUSP, GPDMA1_CH0_CFGL_FIFO_EMPTY &FIFO_EMPTY, GPDMA1_CH0_CFGL_HS_SEL_DST &HS_SEL_DST, GPDMA1_CH0_CFGL_HS_SEL_SRC &HS_SEL_SRC, GPDMA1_CH0_CFGL_LOCK_CH_L &LOCK_CH_L, GPDMA1_CH0_CFGL_LOCK_B_L &LOCK_B_L, bool &LOCK_CH, bool &LOCK_B, GPDMA1_CH0_CFGL_DST_HS_POL &DST_HS_POL, GPDMA1_CH0_CFGL_SRC_HS_POL &SRC_HS_POL, uint16_t &MAX_ABRST)
    {
        uint32_t curr = CFGL;
        ...
        LOCK_B_L = GPDMA1_CH0_CFGL_LOCK_B_L((curr >> 14u) & 0b11u);
        LOCK_CH = curr & (1u << 16u);
        LOCK_B = curr & (1u << 17u);
        DST_HS_POL = GPDMA1_CH0_CFGL_DST_HS_POL(curr & (1u << 18u));
        SRC_HS_POL = GPDMA1_CH0_CFGL_SRC_HS_POL(curr & (1u << 19u));
     ...
     */
    inline void set_CFGL(uint8_t CH_PRIOR, GPDMA1_CH0_CFGL_CH_SUSP CH_SUSP, GPDMA1_CH0_CFGL_HS_SEL_DST HS_SEL_DST, GPDMA1_CH0_CFGL_HS_SEL_SRC HS_SEL_SRC, GPDMA1_CH0_CFGL_LOCK_CH_L LOCK_CH_L, GPDMA1_CH0_CFGL_LOCK_B_L LOCK_B_L, bool LOCK_CH, bool LOCK_B, GPDMA1_CH0_CFGL_DST_HS_POL DST_HS_POL, GPDMA1_CH0_CFGL_SRC_HS_POL SRC_HS_POL, uint16_t MAX_ABRST)
    {
        uint32_t curr = CFGL;
     ...
     */
    inline GPDMA1_CH0_CFGH_FCMODE get_CFGH_FCMODE()
    {
     ...
     */
    inline GPDMA1_CH0_CFGH_FIFO_MODE get_CFGH_FIFO_MODE()
    {
     ...
     */
    inline void get_CFGH(GPDMA1_CH0_CFGH_FCMODE &FCMODE, GPDMA1_CH0_CFGH_FIFO_MODE &FIFO_MODE, uint8_t &PROTCTL, uint8_t &SRC_PER, uint8_t &DEST_PER)
    {
        uint32_t curr = CFGH;
     ...
     */
    inline void set_CFGH(GPDMA1_CH0_CFGH_FCMODE FCMODE, GPDMA1_CH0_CFGH_FIFO_MODE FIFO_MODE, uint8_t PROTCTL, uint8_t SRC_PER, uint8_t DEST_PER)
    {
        uint32_t curr = CFGH;
...
static volatile gpdma1_ch0 *const GPDMA1_CH0 = reinterpret_cast<gpdma1_ch0 *>(0x50018000);

static volatile gpdma1_ch0 *const GPDMA1_CH1 = reinterpret_cast<gpdma1_ch0 *>(0x50018058);

static volatile gpdma1_ch0 *const GPDMA1_CH2 = reinterpret_cast<gpdma1_ch0 *>(0x500180B0);

static volatile gpdma1_ch0 *const GPDMA1_CH3 = reinterpret_cast<gpdma1_ch0 *>(0x50018108);
