...
struct [[gnu::packed]] vadc
{
     ...
     */
    inline void get_CLC(VADC_CLC_EDIS &EDIS, VADC_CLC_DISS &DISS, VADC_CLC_DISR &DISR) volatile
    {
        uint32_t curr = CLC;
     ...
     */
    inline void get_OCS(VADC_OCS_SUSSTA &SUSSTA, VADC_OCS_SUS &SUS, VADC_OCS_TGB &TGB, VADC_OCS_TGS &TGS) volatile
    {
        uint32_t curr = OCS;
     ...
     */
    inline void set_OCS(bool SUS_P, VADC_OCS_SUS SUS, bool TG_P, VADC_OCS_TGB TGB, VADC_OCS_TGS TGS) volatile
    {
        uint32_t curr = OCS;
     ...
     */
    inline VADC_GLOBCFG_DPCAL2 get_GLOBCFG_DPCAL2() volatile
    {
     ...
     */
    inline VADC_GLOBCFG_DPCAL1 get_GLOBCFG_DPCAL1() volatile
    {
     ...
     */
    inline VADC_GLOBCFG_DPCAL0 get_GLOBCFG_DPCAL0() volatile
    {
     ...
     */
    inline void get_GLOBCFG(VADC_GLOBCFG_DPCAL3 &DPCAL3, VADC_GLOBCFG_DPCAL2 &DPCAL2, VADC_GLOBCFG_DPCAL1 &DPCAL1, VADC_GLOBCFG_DPCAL0 &DPCAL0, VADC_GLOBCFG_DIVD &DIVD, VADC_GLOBCFG_DCMSB &DCMSB, VADC_GLOBCFG_DIVA &DIVA) volatile
    {
        uint32_t curr = GLOBCFG;
     ...
     */
    inline void set_GLOBCFG(VADC_GLOBCFG_SUCAL SUCAL, VADC_GLOBCFG_DPCAL3 DPCAL3, VADC_GLOBCFG_DPCAL2 DPCAL2, VADC_GLOBCFG_DPCAL1 DPCAL1, VADC_GLOBCFG_DPCAL0 DPCAL0, VADC_GLOBCFG_DIVWC DIVWC, VADC_GLOBCFG_DIVD DIVD, VADC_GLOBCFG_DCMSB DCMSB, VADC_GLOBCFG_DIVA DIVA) volatile
    {
        uint32_t curr = GLOBCFG;
     ...
     */
    inline void set_GLOBICLASS_CME(std::size_t index, VADC_GLOBICLASS_CME value) volatile
    {
     ...
     */
    inline VADC_GLOBICLASS_CMS get_GLOBICLASS_CMS(std::size_t index) volatile
    {
     ...
     */
    inline void set_GLOBICLASS_CMS(std::size_t index, VADC_GLOBICLASS_CMS value) volatile
    {
        uint32_t curr = GLOBICLASS[index];
     ...
     */
    inline void get_GLOBICLASS(std::size_t index, VADC_GLOBICLASS_CME &CME, uint8_t &STCE, VADC_GLOBICLASS_CMS &CMS, uint8_t &STCS) volatile
    {
        uint32_t curr = GLOBICLASS[index];
     ...
     */
    inline void set_GLOBICLASS(std::size_t index, VADC_GLOBICLASS_CME CME, uint8_t STCE, VADC_GLOBICLASS_CMS CMS, uint8_t STCS) volatile
    {
        uint32_t curr = GLOBICLASS[index];
     ...
     */
    inline void get_GLOBBOUND(uint16_t &BOUNDARY1, uint16_t &BOUNDARY0) volatile
    {
        uint32_t curr = GLOBBOUND;
     ...
     */
    inline void get_GLOBEFLAG(VADC_GLOBEFLAG_REVGLB &REVGLB, VADC_GLOBEFLAG_SEVGLB &SEVGLB) volatile
    {
     ...
     */
    inline void set_GLOBEFLAG(VADC_GLOBEFLAG_REVGLBCLR REVGLBCLR, VADC_GLOBEFLAG_SEVGLBCLR SEVGLBCLR, VADC_GLOBEFLAG_REVGLB REVGLB, VADC_GLOBEFLAG_SEVGLB SEVGLB) volatile
    {
        uint32_t curr = GLOBEFLAG;
     ...
     */
    inline VADC_GLOBEVNP_SEV0NP get_GLOBEVNP_SEV0NP() volatile
    {
     ...
     */
    inline void set_GLOBEVNP_SEV0NP(VADC_GLOBEVNP_SEV0NP value) volatile
    {
        uint32_t curr = GLOBEVNP;
     ...
     */
    inline void get_GLOBEVNP(VADC_GLOBEVNP_REV0NP &REV0NP, VADC_GLOBEVNP_SEV0NP &SEV0NP) volatile
    {
        uint32_t curr = GLOBEVNP;
     ...
     */
    inline void set_GLOBEVNP(VADC_GLOBEVNP_REV0NP REV0NP, VADC_GLOBEVNP_SEV0NP SEV0NP) volatile
    {
        uint32_t curr = GLOBEVNP;
     ...
     */
    inline void get_GLOBTF(VADC_GLOBTF_PDD &PDD, VADC_GLOBTF_CDSEL &CDSEL, VADC_GLOBTF_CDEN &CDEN, uint8_t &CDGR) volatile
    {
        uint32_t curr = GLOBTF;
     ...
     */
    inline void set_GLOBTF(VADC_GLOBTF_MDWC MDWC, VADC_GLOBTF_PDD PDD, VADC_GLOBTF_CDWC CDWC, VADC_GLOBTF_CDSEL CDSEL, VADC_GLOBTF_CDEN CDEN, uint8_t CDGR) volatile
    {
        uint32_t curr = GLOBTF;
     ...
     */
    inline VADC_BRSSEL_CHSELG6 get_BRSSEL_CHSELG6(std::size_t index) volatile
    {
     ...
     */
    inline VADC_BRSSEL_CHSELG5 get_BRSSEL_CHSELG5(std::size_t index) volatile
    {
     ...
     */
    inline VADC_BRSSEL_CHSELG4 get_BRSSEL_CHSELG4(std::size_t index) volatile
    {
     ...
     */
    inline VADC_BRSSEL_CHSELG3 get_BRSSEL_CHSELG3(std::size_t index) volatile
    {
     ...
     */
    inline VADC_BRSSEL_CHSELG2 get_BRSSEL_CHSELG2(std::size_t index) volatile
    {
     ...
     */
    inline VADC_BRSSEL_CHSELG1 get_BRSSEL_CHSELG1(std::size_t index) volatile
    {
     ...
     */
    inline VADC_BRSSEL_CHSELG0 get_BRSSEL_CHSELG0(std::size_t index) volatile
    {
     ...
     */
    inline void get_BRSSEL(std::size_t index, VADC_BRSSEL_CHSELG7 &CHSELG7, VADC_BRSSEL_CHSELG6 &CHSELG6, VADC_BRSSEL_CHSELG5 &CHSELG5, VADC_BRSSEL_CHSELG4 &CHSELG4, VADC_BRSSEL_CHSELG3 &CHSELG3, VADC_BRSSEL_CHSELG2 &CHSELG2, VADC_BRSSEL_CHSELG1 &CHSELG1, VADC_BRSSEL_CHSELG0 &CHSELG0) volatile
    {
     ...
     */
    inline void set_BRSSEL(std::size_t index, VADC_BRSSEL_CHSELG7 CHSELG7, VADC_BRSSEL_CHSELG6 CHSELG6, VADC_BRSSEL_CHSELG5 CHSELG5, VADC_BRSSEL_CHSELG4 CHSELG4, VADC_BRSSEL_CHSELG3 CHSELG3, VADC_BRSSEL_CHSELG2 CHSELG2, VADC_BRSSEL_CHSELG1 CHSELG1, VADC_BRSSEL_CHSELG0 CHSELG0) volatile
    {
        uint32_t curr = BRSSEL[index];
     ...
     */
    inline VADC_BRSPND_CHPNDG6 get_BRSPND_CHPNDG6(std::size_t index) volatile
    {
     ...
     */
    inline VADC_BRSPND_CHPNDG5 get_BRSPND_CHPNDG5(std::size_t index) volatile
    {
     ...
     */
    inline VADC_BRSPND_CHPNDG4 get_BRSPND_CHPNDG4(std::size_t index) volatile
    {
     ...
     */
    inline VADC_BRSPND_CHPNDG3 get_BRSPND_CHPNDG3(std::size_t index) volatile
    {
     ...
     */
    inline VADC_BRSPND_CHPNDG2 get_BRSPND_CHPNDG2(std::size_t index) volatile
    {
     ...
     */
    inline VADC_BRSPND_CHPNDG1 get_BRSPND_CHPNDG1(std::size_t index) volatile
    {
     ...
     */
    inline VADC_BRSPND_CHPNDG0 get_BRSPND_CHPNDG0(std::size_t index) volatile
    {
     ...
     */
    inline void get_BRSPND(std::size_t index, VADC_BRSPND_CHPNDG7 &CHPNDG7, VADC_BRSPND_CHPNDG6 &CHPNDG6, VADC_BRSPND_CHPNDG5 &CHPNDG5, VADC_BRSPND_CHPNDG4 &CHPNDG4, VADC_BRSPND_CHPNDG3 &CHPNDG3, VADC_BRSPND_CHPNDG2 &CHPNDG2, VADC_BRSPND_CHPNDG1 &CHPNDG1, VADC_BRSPND_CHPNDG0 &CHPNDG0) volatile
    {
     ...
     */
    inline void set_BRSPND(std::size_t index, VADC_BRSPND_CHPNDG7 CHPNDG7, VADC_BRSPND_CHPNDG6 CHPNDG6, VADC_BRSPND_CHPNDG5 CHPNDG5, VADC_BRSPND_CHPNDG4 CHPNDG4, VADC_BRSPND_CHPNDG3 CHPNDG3, VADC_BRSPND_CHPNDG2 CHPNDG2, VADC_BRSPND_CHPNDG1 CHPNDG1, VADC_BRSPND_CHPNDG0 CHPNDG0) volatile
    {
        uint32_t curr = BRSPND[index];
     ...
     */
    inline void get_BRSCTRL(bool &GTLVL, uint8_t &GTSEL, VADC_BRSCTRL_XTMODE &XTMODE, bool &XTLVL, uint8_t &XTSEL, VADC_BRSCTRL_SRCRESREG &SRCRESREG) volatile
    {
        uint32_t curr = BRSCTRL;
     ...
     */
    inline void set_BRSCTRL(VADC_BRSCTRL_GTWC GTWC, uint8_t GTSEL, VADC_BRSCTRL_XTWC XTWC, VADC_BRSCTRL_XTMODE XTMODE, uint8_t XTSEL, VADC_BRSCTRL_SRCRESREG SRCRESREG) volatile
    {
        uint32_t curr = BRSCTRL;
     ...
     */
    inline void get_BRSMR(VADC_BRSMR_RPTDIS &RPTDIS, VADC_BRSMR_REQGT &REQGT, VADC_BRSMR_LDM &LDM, VADC_BRSMR_SCAN &SCAN, VADC_BRSMR_ENSI &ENSI, VADC_BRSMR_ENTR &ENTR, VADC_BRSMR_ENGT &ENGT) volatile
    {
        uint32_t curr = BRSMR;
     ...
     */
    inline void set_BRSMR(VADC_BRSMR_RPTDIS RPTDIS, VADC_BRSMR_LDEV LDEV, VADC_BRSMR_CLRPND CLRPND, VADC_BRSMR_LDM LDM, VADC_BRSMR_SCAN SCAN, VADC_BRSMR_ENSI ENSI, VADC_BRSMR_ENTR ENTR, VADC_BRSMR_ENGT ENGT) volatile
    {
        uint32_t curr = BRSMR;
     ...
     */
    inline void get_GLOBRCR(VADC_GLOBRCR_SRGEN &SRGEN, VADC_GLOBRCR_WFR &WFR, VADC_GLOBRCR_DRCTR &DRCTR) volatile
    {
        uint32_t curr = GLOBRCR;
     ...
     */
    inline void set_GLOBRCR(VADC_GLOBRCR_SRGEN SRGEN, VADC_GLOBRCR_WFR WFR, VADC_GLOBRCR_DRCTR DRCTR) volatile
    {
        uint32_t curr = GLOBRCR;
     ...
     */
    inline void get_GLOBRES(VADC_GLOBRES_VF &VF, VADC_GLOBRES_FCR &FCR, uint8_t &CRS, uint8_t &EMUX, uint8_t &CHNR, uint8_t &GNR, uint16_t &RESULT) volatile
    {
        uint32_t curr = GLOBRES;
     ...
     */
    inline VADC_GLOBRESD_VF get_GLOBRESD_VF() volatile
    {
     ...
     */
    inline VADC_GLOBRESD_FCR get_GLOBRESD_FCR() volatile
    {
     ...
     */
    inline void get_GLOBRESD(VADC_GLOBRESD_VF &VF, VADC_GLOBRESD_FCR &FCR, uint8_t &CRS, uint8_t &EMUX, uint8_t &CHNR, uint8_t &GNR, uint16_t &RESULT) volatile
    {
        uint32_t curr = GLOBRESD;
     ...
     */
    inline void set_GLOBRESD(VADC_GLOBRESD_VF VF, uint16_t RESULT) volatile
    {
        uint32_t curr = GLOBRESD;
