...
struct [[gnu::packed]] vadc
{
    ...
    uint32_t GLOBICLASS[GLOBICLASS_length];                            /*!< (read-write) Input Class Register, Global */
    ...
    uint32_t BRSSEL[BRSSEL_length];                                    /*!< (read-write) Background Request Source Channel Select Register */
    ...
    uint32_t BRSPND[BRSPND_length];                                    /*!< (read-write) Background Request Source Pending Register */
    static constexpr std::size_t reserved_padding10_length = 12;
    const uint32_t reserved_padding10[reserved_padding10_length] = {};
    uint32_t BRSCTRL;                                                  /*!< (read-write) Background Request Source Control Register */
    uint32_t BRSMR;                                                    /*!< (read-write) Background Request Source Mode Register */
     ...
     * Get CLC's EDIS bit.
     */
    inline VADC_CLC_EDIS get_CLC_EDIS()
    {
     ...
     * Get CLC's DISS bit.
     */
    inline VADC_CLC_DISS get_CLC_DISS()
    {
     ...
     * Get CLC's DISR bit.
     */
    inline VADC_CLC_DISR get_CLC_DISR()
    {
     ...
     */
    inline void get_CLC(VADC_CLC_EDIS &EDIS, VADC_CLC_DISS &DISS, VADC_CLC_DISR &DISR)
    {
        uint32_t curr = CLC;
     ...
     */
    inline void set_CLC(VADC_CLC_EDIS EDIS, VADC_CLC_DISR DISR)
    {
        uint32_t curr = CLC;
     ...
     */
    inline VADC_OCS_SUSSTA get_OCS_SUSSTA()
    {
     ...
     * Get OCS's SUS field.
     */
    inline VADC_OCS_SUS get_OCS_SUS()
    {
     ...
     * Get OCS's TGB bit.
     */
    inline VADC_OCS_TGB get_OCS_TGB()
    {
     ...
     * Get OCS's TGS field.
     */
    inline VADC_OCS_TGS get_OCS_TGS()
    {
     ...
     */
    inline void get_OCS(VADC_OCS_SUSSTA &SUSSTA, VADC_OCS_SUS &SUS, VADC_OCS_TGB &TGB, VADC_OCS_TGS &TGS)
    {
        uint32_t curr = OCS;
     ...
     */
    inline void set_OCS(bool SUS_P, VADC_OCS_SUS SUS, bool TG_P, VADC_OCS_TGB TGB, VADC_OCS_TGS TGS)
    {
        uint32_t curr = OCS;
     ...
     */
    inline VADC_GLOBCFG_DPCAL3 get_GLOBCFG_DPCAL3()
    {
     ...
     */
    inline VADC_GLOBCFG_DPCAL2 get_GLOBCFG_DPCAL2()
    {
     ...
     */
    inline VADC_GLOBCFG_DPCAL1 get_GLOBCFG_DPCAL1()
    {
     ...
     */
    inline VADC_GLOBCFG_DPCAL0 get_GLOBCFG_DPCAL0()
    {
     ...
     */
    inline VADC_GLOBCFG_DIVD get_GLOBCFG_DIVD()
    {
     ...
     */
    inline VADC_GLOBCFG_DCMSB get_GLOBCFG_DCMSB()
    {
     ...
     */
    inline VADC_GLOBCFG_DIVA get_GLOBCFG_DIVA()
    {
     ...
     */
    inline void get_GLOBCFG(VADC_GLOBCFG_DPCAL3 &DPCAL3, VADC_GLOBCFG_DPCAL2 &DPCAL2, VADC_GLOBCFG_DPCAL1 &DPCAL1, VADC_GLOBCFG_DPCAL0 &DPCAL0, VADC_GLOBCFG_DIVD &DIVD, VADC_GLOBCFG_DCMSB &DCMSB, VADC_GLOBCFG_DIVA &DIVA)
    {
        uint32_t curr = GLOBCFG;

        DPCAL3 = VADC_GLOBCFG_DPCAL3(curr & (1u << 19u));
        DPCAL2 = VADC_GLOBCFG_DPCAL2(curr & (1u << 18u));
        DPCAL1 = VADC_GLOBCFG_DPCAL1(curr & (1u << 17u));
        DPCAL0 = VADC_GLOBCFG_DPCAL0(curr & (1u << 16u));
     ...
     */
    inline void set_GLOBCFG(VADC_GLOBCFG_SUCAL SUCAL, VADC_GLOBCFG_DPCAL3 DPCAL3, VADC_GLOBCFG_DPCAL2 DPCAL2, VADC_GLOBCFG_DPCAL1 DPCAL1, VADC_GLOBCFG_DPCAL0 DPCAL0, VADC_GLOBCFG_DIVWC DIVWC, VADC_GLOBCFG_DIVD DIVD, VADC_GLOBCFG_DCMSB DCMSB, VADC_GLOBCFG_DIVA DIVA)
    {
        uint32_t curr = GLOBCFG;
     ...
     */
    inline VADC_GLOBICLASS_CME get_GLOBICLASS_CME(std::size_t index)
    {
     ...
     */
    inline void set_GLOBICLASS_CME(std::size_t index, VADC_GLOBICLASS_CME value)
    {
     ...
     */
    inline uint8_t get_GLOBICLASS_STCE(std::size_t index)
    {
     ...
     */
    inline VADC_GLOBICLASS_CMS get_GLOBICLASS_CMS(std::size_t index)
    {
     ...
     */
    inline void set_GLOBICLASS_CMS(std::size_t index, VADC_GLOBICLASS_CMS value)
    {
        uint32_t curr = GLOBICLASS[index];
     ...
     */
    inline uint8_t get_GLOBICLASS_STCS(std::size_t index)
    {
     ...
     */
    inline void get_GLOBICLASS(std::size_t index, VADC_GLOBICLASS_CME &CME, uint8_t &STCE, VADC_GLOBICLASS_CMS &CMS, uint8_t &STCS)
    {
        uint32_t curr = GLOBICLASS[index];

        CME = VADC_GLOBICLASS_CME((curr >> 24u) & 0b111u);
        STCE = (curr >> 16u) & 0b11111u;
        CMS = VADC_GLOBICLASS_CMS((curr >> 8u) & 0b111u);
     ...
     */
    inline void set_GLOBICLASS(std::size_t index, VADC_GLOBICLASS_CME CME, uint8_t STCE, VADC_GLOBICLASS_CMS CMS, uint8_t STCS)
    {
        uint32_t curr = GLOBICLASS[index];
     ...
     */
    inline uint16_t get_GLOBBOUND_BOUNDARY1()
    {
     ...
     */
    inline uint16_t get_GLOBBOUND_BOUNDARY0()
    {
     ...
     */
    inline void get_GLOBBOUND(uint16_t &BOUNDARY1, uint16_t &BOUNDARY0)
    {
        uint32_t curr = GLOBBOUND;
     ...
     */
    inline void set_GLOBBOUND(uint16_t BOUNDARY1, uint16_t BOUNDARY0)
    {
        uint32_t curr = GLOBBOUND;
     ...
     */
    inline VADC_GLOBEFLAG_REVGLB get_GLOBEFLAG_REVGLB()
    {
     ...
     */
    inline VADC_GLOBEFLAG_SEVGLB get_GLOBEFLAG_SEVGLB()
    {
     ...
     */
    inline void get_GLOBEFLAG(VADC_GLOBEFLAG_REVGLB &REVGLB, VADC_GLOBEFLAG_SEVGLB &SEVGLB)
    {
     ...
     */
    inline void set_GLOBEFLAG(VADC_GLOBEFLAG_REVGLBCLR REVGLBCLR, VADC_GLOBEFLAG_SEVGLBCLR SEVGLBCLR, VADC_GLOBEFLAG_REVGLB REVGLB, VADC_GLOBEFLAG_SEVGLB SEVGLB)
    {
        uint32_t curr = GLOBEFLAG;
     ...
     */
    inline VADC_GLOBEVNP_REV0NP get_GLOBEVNP_REV0NP()
    {
     ...
     */
    inline VADC_GLOBEVNP_SEV0NP get_GLOBEVNP_SEV0NP()
    {
     ...
     */
    inline void get_GLOBEVNP(VADC_GLOBEVNP_REV0NP &REV0NP, VADC_GLOBEVNP_SEV0NP &SEV0NP)
    {
        uint32_t curr = GLOBEVNP;

        REV0NP = VADC_GLOBEVNP_REV0NP((curr >> 16u) & 0b1111u);
        SEV0NP = VADC_GLOBEVNP_SEV0NP((curr >> 0u) & 0b1111u);
    }

    /**
     * Set all of GLOBEVNP's bit fields.
     */
    inline void set_GLOBEVNP(VADC_GLOBEVNP_REV0NP REV0NP, VADC_GLOBEVNP_SEV0NP SEV0NP)
    {
        uint32_t curr = GLOBEVNP;
     ...
     */
    inline VADC_GLOBTF_PDD get_GLOBTF_PDD()
    {
     ...
     */
    inline VADC_GLOBTF_CDSEL get_GLOBTF_CDSEL()
    {
     ...
     */
    inline VADC_GLOBTF_CDEN get_GLOBTF_CDEN()
    {
     ...
     */
    inline uint8_t get_GLOBTF_CDGR()
    {
     ...
     */
    inline void get_GLOBTF(VADC_GLOBTF_PDD &PDD, VADC_GLOBTF_CDSEL &CDSEL, VADC_GLOBTF_CDEN &CDEN, uint8_t &CDGR)
    {
        uint32_t curr = GLOBTF;
     ...
     */
    inline void set_GLOBTF(VADC_GLOBTF_MDWC MDWC, VADC_GLOBTF_PDD PDD, VADC_GLOBTF_CDWC CDWC, VADC_GLOBTF_CDSEL CDSEL, VADC_GLOBTF_CDEN CDEN, uint8_t CDGR)
    {
        uint32_t curr = GLOBTF;
     ...
     */
    inline VADC_BRSSEL_CHSELG7 get_BRSSEL_CHSELG7(std::size_t index)
    {
     ...
     */
    inline VADC_BRSSEL_CHSELG6 get_BRSSEL_CHSELG6(std::size_t index)
    {
     ...
     */
    inline VADC_BRSSEL_CHSELG5 get_BRSSEL_CHSELG5(std::size_t index)
    {
     ...
     */
    inline VADC_BRSSEL_CHSELG4 get_BRSSEL_CHSELG4(std::size_t index)
    {
     ...
     */
    inline VADC_BRSSEL_CHSELG3 get_BRSSEL_CHSELG3(std::size_t index)
    {
     ...
     */
    inline VADC_BRSSEL_CHSELG2 get_BRSSEL_CHSELG2(std::size_t index)
    {
     ...
     */
    inline VADC_BRSSEL_CHSELG1 get_BRSSEL_CHSELG1(std::size_t index)
    {
     ...
     */
    inline VADC_BRSSEL_CHSELG0 get_BRSSEL_CHSELG0(std::size_t index)
    {
     ...
     */
    inline void get_BRSSEL(std::size_t index, VADC_BRSSEL_CHSELG7 &CHSELG7, VADC_BRSSEL_CHSELG6 &CHSELG6, VADC_BRSSEL_CHSELG5 &CHSELG5, VADC_BRSSEL_CHSELG4 &CHSELG4, VADC_BRSSEL_CHSELG3 &CHSELG3, VADC_BRSSEL_CHSELG2 &CHSELG2, VADC_BRSSEL_CHSELG1 &CHSELG1, VADC_BRSSEL_CHSELG0 &CHSELG0)
    {
        uint32_t curr = BRSSEL[index];

        CHSELG7 = VADC_BRSSEL_CHSELG7(curr & (1u << 7u));
        CHSELG6 = VADC_BRSSEL_CHSELG6(curr & (1u << 6u));
        CHSELG5 = VADC_BRSSEL_CHSELG5(curr & (1u << 5u));
        CHSELG4 = VADC_BRSSEL_CHSELG4(curr & (1u << 4u));
        CHSELG3 = VADC_BRSSEL_CHSELG3(curr & (1u << 3u));
        CHSELG2 = VADC_BRSSEL_CHSELG2(curr & (1u << 2u));
        CHSELG1 = VADC_BRSSEL_CHSELG1(curr & (1u << 1u));
        CHSELG0 = VADC_BRSSEL_CHSELG0(curr & (1u << 0u));
    }

    /**
     * Set all of BRSSEL's bit fields.
     */
    inline void set_BRSSEL(std::size_t index, VADC_BRSSEL_CHSELG7 CHSELG7, VADC_BRSSEL_CHSELG6 CHSELG6, VADC_BRSSEL_CHSELG5 CHSELG5, VADC_BRSSEL_CHSELG4 CHSELG4, VADC_BRSSEL_CHSELG3 CHSELG3, VADC_BRSSEL_CHSELG2 CHSELG2, VADC_BRSSEL_CHSELG1 CHSELG1, VADC_BRSSEL_CHSELG0 CHSELG0)
    {
        uint32_t curr = BRSSEL[index];
     ...
     */
    inline VADC_BRSPND_CHPNDG7 get_BRSPND_CHPNDG7(std::size_t index)
    {
     ...
     */
    inline VADC_BRSPND_CHPNDG6 get_BRSPND_CHPNDG6(std::size_t index)
    {
     ...
     */
    inline VADC_BRSPND_CHPNDG5 get_BRSPND_CHPNDG5(std::size_t index)
    {
     ...
     */
    inline VADC_BRSPND_CHPNDG4 get_BRSPND_CHPNDG4(std::size_t index)
    {
     ...
     */
    inline VADC_BRSPND_CHPNDG3 get_BRSPND_CHPNDG3(std::size_t index)
    {
     ...
     */
    inline VADC_BRSPND_CHPNDG2 get_BRSPND_CHPNDG2(std::size_t index)
    {
     ...
     */
    inline VADC_BRSPND_CHPNDG1 get_BRSPND_CHPNDG1(std::size_t index)
    {
     ...
     */
    inline VADC_BRSPND_CHPNDG0 get_BRSPND_CHPNDG0(std::size_t index)
    {
     ...
     */
    inline void get_BRSPND(std::size_t index, VADC_BRSPND_CHPNDG7 &CHPNDG7, VADC_BRSPND_CHPNDG6 &CHPNDG6, VADC_BRSPND_CHPNDG5 &CHPNDG5, VADC_BRSPND_CHPNDG4 &CHPNDG4, VADC_BRSPND_CHPNDG3 &CHPNDG3, VADC_BRSPND_CHPNDG2 &CHPNDG2, VADC_BRSPND_CHPNDG1 &CHPNDG1, VADC_BRSPND_CHPNDG0 &CHPNDG0)
    {
        uint32_t curr = BRSPND[index];

        CHPNDG7 = VADC_BRSPND_CHPNDG7(curr & (1u << 7u));
        CHPNDG6 = VADC_BRSPND_CHPNDG6(curr & (1u << 6u));
        CHPNDG5 = VADC_BRSPND_CHPNDG5(curr & (1u << 5u));
        CHPNDG4 = VADC_BRSPND_CHPNDG4(curr & (1u << 4u));
        CHPNDG3 = VADC_BRSPND_CHPNDG3(curr & (1u << 3u));
        CHPNDG2 = VADC_BRSPND_CHPNDG2(curr & (1u << 2u));
        CHPNDG1 = VADC_BRSPND_CHPNDG1(curr & (1u << 1u));
        CHPNDG0 = VADC_BRSPND_CHPNDG0(curr & (1u << 0u));
    }

    /**
     * Set all of BRSPND's bit fields.
     */
    inline void set_BRSPND(std::size_t index, VADC_BRSPND_CHPNDG7 CHPNDG7, VADC_BRSPND_CHPNDG6 CHPNDG6, VADC_BRSPND_CHPNDG5 CHPNDG5, VADC_BRSPND_CHPNDG4 CHPNDG4, VADC_BRSPND_CHPNDG3 CHPNDG3, VADC_BRSPND_CHPNDG2 CHPNDG2, VADC_BRSPND_CHPNDG1 CHPNDG1, VADC_BRSPND_CHPNDG0 CHPNDG0)
    {
        uint32_t curr = BRSPND[index];
     ...
     */
    inline uint8_t get_BRSCTRL_GTSEL()
    {
     ...
     */
    inline VADC_BRSCTRL_XTMODE get_BRSCTRL_XTMODE()
    {
     ...
     */
    inline uint8_t get_BRSCTRL_XTSEL()
    {
     ...
     */
    inline VADC_BRSCTRL_SRCRESREG get_BRSCTRL_SRCRESREG()
    {
     ...
     */
    inline void get_BRSCTRL(bool &GTLVL, uint8_t &GTSEL, VADC_BRSCTRL_XTMODE &XTMODE, bool &XTLVL, uint8_t &XTSEL, VADC_BRSCTRL_SRCRESREG &SRCRESREG)
    {
        uint32_t curr = BRSCTRL;
     ...
     */
    inline void set_BRSCTRL(VADC_BRSCTRL_GTWC GTWC, uint8_t GTSEL, VADC_BRSCTRL_XTWC XTWC, VADC_BRSCTRL_XTMODE XTMODE, uint8_t XTSEL, VADC_BRSCTRL_SRCRESREG SRCRESREG)
    {
        uint32_t curr = BRSCTRL;
     ...
     */
    inline VADC_BRSMR_RPTDIS get_BRSMR_RPTDIS()
    {
     ...
     */
    inline VADC_BRSMR_REQGT get_BRSMR_REQGT()
    {
     ...
     * Get BRSMR's LDM bit.
     */
    inline VADC_BRSMR_LDM get_BRSMR_LDM()
    {
     ...
     */
    inline VADC_BRSMR_SCAN get_BRSMR_SCAN()
    {
     ...
     */
    inline VADC_BRSMR_ENSI get_BRSMR_ENSI()
    {
     ...
     */
    inline VADC_BRSMR_ENTR get_BRSMR_ENTR()
    {
     ...
     */
    inline VADC_BRSMR_ENGT get_BRSMR_ENGT()
    {
     ...
     */
    inline void get_BRSMR(VADC_BRSMR_RPTDIS &RPTDIS, VADC_BRSMR_REQGT &REQGT, VADC_BRSMR_LDM &LDM, VADC_BRSMR_SCAN &SCAN, VADC_BRSMR_ENSI &ENSI, VADC_BRSMR_ENTR &ENTR, VADC_BRSMR_ENGT &ENGT)
    {
        uint32_t curr = BRSMR;
     ...
     */
    inline void set_BRSMR(VADC_BRSMR_RPTDIS RPTDIS, VADC_BRSMR_LDEV LDEV, VADC_BRSMR_CLRPND CLRPND, VADC_BRSMR_LDM LDM, VADC_BRSMR_SCAN SCAN, VADC_BRSMR_ENSI ENSI, VADC_BRSMR_ENTR ENTR, VADC_BRSMR_ENGT ENGT)
    {
        uint32_t curr = BRSMR;
     ...
     */
    inline VADC_GLOBRCR_SRGEN get_GLOBRCR_SRGEN()
    {
     ...
     */
    inline VADC_GLOBRCR_WFR get_GLOBRCR_WFR()
    {
     ...
     */
    inline VADC_GLOBRCR_DRCTR get_GLOBRCR_DRCTR()
    {
     ...
     */
    inline void get_GLOBRCR(VADC_GLOBRCR_SRGEN &SRGEN, VADC_GLOBRCR_WFR &WFR, VADC_GLOBRCR_DRCTR &DRCTR)
    {
        uint32_t curr = GLOBRCR;
     ...
     */
    inline void set_GLOBRCR(VADC_GLOBRCR_SRGEN SRGEN, VADC_GLOBRCR_WFR WFR, VADC_GLOBRCR_DRCTR DRCTR)
    {
        uint32_t curr = GLOBRCR;
     ...
     */
    inline VADC_GLOBRES_VF get_GLOBRES_VF()
    {
     ...
     */
    inline VADC_GLOBRES_FCR get_GLOBRES_FCR()
    {
     ...
     */
    inline uint8_t get_GLOBRES_CRS()
    {
     ...
     */
    inline uint8_t get_GLOBRES_EMUX()
    {
     ...
     */
    inline uint8_t get_GLOBRES_CHNR()
    {
     ...
     */
    inline uint8_t get_GLOBRES_GNR()
    {
     ...
     */
    inline uint16_t get_GLOBRES_RESULT()
    {
     ...
     */
    inline void get_GLOBRES(VADC_GLOBRES_VF &VF, VADC_GLOBRES_FCR &FCR, uint8_t &CRS, uint8_t &EMUX, uint8_t &CHNR, uint8_t &GNR, uint16_t &RESULT)
    {
        uint32_t curr = GLOBRES;
     ...
     */
    inline void set_GLOBRES(VADC_GLOBRES_VF VF, uint16_t RESULT)
    {
        uint32_t curr = GLOBRES;
     ...
     */
    inline VADC_GLOBRESD_VF get_GLOBRESD_VF()
    {
     ...
     */
    inline VADC_GLOBRESD_FCR get_GLOBRESD_FCR()
    {
     ...
     */
    inline uint8_t get_GLOBRESD_CRS()
    {
     ...
     */
    inline uint8_t get_GLOBRESD_EMUX()
    {
     ...
     */
    inline uint8_t get_GLOBRESD_CHNR()
    {
     ...
     */
    inline uint8_t get_GLOBRESD_GNR()
    {
     ...
     */
    inline uint16_t get_GLOBRESD_RESULT()
    {
     ...
     */
    inline void get_GLOBRESD(VADC_GLOBRESD_VF &VF, VADC_GLOBRESD_FCR &FCR, uint8_t &CRS, uint8_t &EMUX, uint8_t &CHNR, uint8_t &GNR, uint16_t &RESULT)
    {
        uint32_t curr = GLOBRESD;

        VF = VADC_GLOBRESD_VF(curr & (1u << 31u));
        FCR = VADC_GLOBRESD_FCR(curr & (1u << 30u));
        CRS = (curr >> 28u) & 0b11u;
        EMUX = (curr >> 25u) & 0b111u;
        CHNR = (curr >> 20u) & 0b11111u;
        GNR = (curr >> 16u) & 0b1111u;
     ...
     */
    inline void set_GLOBRESD(VADC_GLOBRESD_VF VF, uint16_t RESULT)
    {
        uint32_t curr = GLOBRESD;
     ...
     */
    inline uint8_t get_EMUXSEL_EMUXGRP1()
    {
     ...
     */
    inline uint8_t get_EMUXSEL_EMUXGRP0()
    {
     ...
     */
    inline void get_EMUXSEL(uint8_t &EMUXGRP1, uint8_t &EMUXGRP0)
    {
        uint32_t curr = EMUXSEL;
     ...
     */
    inline void set_EMUXSEL(uint8_t EMUXGRP1, uint8_t EMUXGRP0)
    {
        uint32_t curr = EMUXSEL;
