...
#include "../enums/CAN_MO_MOFCR_RXIE.h"
#include "../enums/CAN_MO_MOFCR_RXTOE.h"
#include "../enums/CAN_MO_MOFCR_TXIE.h"
#include "../enums/CAN_MO_MOIPR_RXINP.h"
...
#include "../enums/CAN_MO_MOSTAT_TXEN0.h"
...
struct [[gnu::packed]] CAN_MO
{
    ...
    union
    {
        ...
        const uint32_t MOSTAT = {}; /* (read-only) Message Object Status Register */
    };
    uint32_t MOFCR;   /*!< (read-write) Message Object Function Control Register */
    uint32_t MOFGPR;  /*!< (read-write) Message Object FIFO/Gateway Pointer Register */
    uint32_t MOIPR;   /*!< (read-write) Message Object Interrupt Pointer Register */
    uint32_t MOAMR;   /*!< (read-write) Message Object Acceptance Mask Register */
     ...
     */
    inline CAN_MO_MOFCR_TXIE get_MOFCR_TXIE()
    {
        return CAN_MO_MOFCR_TXIE(MOFCR & (1u << 17u));
    }
     ...
     */
    inline CAN_MO_MOFCR_RXIE get_MOFCR_RXIE()
    {
        return CAN_MO_MOFCR_RXIE(MOFCR & (1u << 16u));
    }
     ...
     */
    inline void get_MOFCR(uint8_t &DLC, bool &STT, bool &SDT, CAN_MO_MOFCR_RMM &RMM, CAN_MO_MOFCR_FRREN &FRREN, CAN_MO_MOFCR_OVIE &OVIE, CAN_MO_MOFCR_TXIE &TXIE, CAN_MO_MOFCR_RXIE &RXIE, CAN_MO_MOFCR_DATC &DATC, CAN_MO_MOFCR_DLCC &DLCC, CAN_MO_MOFCR_IDC &IDC, CAN_MO_MOFCR_GDFS &GDFS, CAN_MO_MOFCR_RXTOE &RXTOE, CAN_MO_MOFCR_MMC &MMC)
    {
        uint32_t curr = MOFCR;
        ...
        TXIE = CAN_MO_MOFCR_TXIE(curr & (1u << 17u));
        RXIE = CAN_MO_MOFCR_RXIE(curr & (1u << 16u));
     ...
     */
    inline void set_MOFCR(uint8_t DLC, bool STT, bool SDT, CAN_MO_MOFCR_RMM RMM, CAN_MO_MOFCR_FRREN FRREN, CAN_MO_MOFCR_OVIE OVIE, CAN_MO_MOFCR_TXIE TXIE, CAN_MO_MOFCR_RXIE RXIE, CAN_MO_MOFCR_DATC DATC, CAN_MO_MOFCR_DLCC DLCC, CAN_MO_MOFCR_IDC IDC, CAN_MO_MOFCR_GDFS GDFS, CAN_MO_MOFCR_RXTOE RXTOE, CAN_MO_MOFCR_MMC MMC)
    {
        uint32_t curr = MOFCR;
     ...
     */
    inline void get_MOFGPR(uint8_t &SEL, uint8_t &CUR, uint8_t &TOP, uint8_t &BOT)
    {
        uint32_t curr = MOFGPR;
     ...
     */
    inline CAN_MO_MOIPR_RXINP get_MOIPR_RXINP()
    {
        return CAN_MO_MOIPR_RXINP((MOIPR >> 0u) & 0b1111u);
    }

    /**
     * Set MOIPR's RXINP field.
     */
    inline void set_MOIPR_RXINP(CAN_MO_MOIPR_RXINP value)
    {
        uint32_t curr = MOIPR;
     ...
     */
    inline void get_MOIPR(uint16_t &CFCVAL, uint8_t &MPN, CAN_MO_MOIPR_TXINP &TXINP, CAN_MO_MOIPR_RXINP &RXINP)
    {
        uint32_t curr = MOIPR;
        ...
        RXINP = CAN_MO_MOIPR_RXINP((curr >> 0u) & 0b1111u);
    }

    /**
     * Set all of MOIPR's bit fields.
     */
    inline void set_MOIPR(uint16_t CFCVAL, uint8_t MPN, CAN_MO_MOIPR_TXINP TXINP, CAN_MO_MOIPR_RXINP RXINP)
    {
        uint32_t curr = MOIPR;
     ...
     */
    inline void get_MODATAL(uint8_t &DB3, uint8_t &DB2, uint8_t &DB1, uint8_t &DB0)
    {
        uint32_t curr = MODATAL;
     ...
     */
    inline void get_MODATAH(uint8_t &DB7, uint8_t &DB6, uint8_t &DB5, uint8_t &DB4)
    {
        uint32_t curr = MODATAH;
     ...
     */
    inline void get_MOAR(CAN_MO_MOAR_PRI &PRI, CAN_MO_MOAR_IDE &IDE, uint32_t &ID)
    {
        uint32_t curr = MOAR;
     ...
     */
    inline void set_MOCTR(bool SETDIR, bool RESDIR, bool SETTXEN1, bool RESTXEN1, bool SETTXEN0, bool RESTXEN0, bool SETTXRQ, bool RESTXRQ, bool SETRXEN, bool RESRXEN, bool SETRTSEL, bool RESRTSEL, bool SETMSGVAL, bool RESMSGVAL, bool SETMSGLST, bool RESMSGLST, bool SETNEWDAT, bool RESNEWDAT, bool SETRXUPD, bool RESRXUPD, bool SETTXPND, bool RESTXPND, bool SETRXPND, bool RESRXPND)
    {
        uint32_t curr = MOCTR;
     ...
     */
    inline CAN_MO_MOSTAT_TXEN0 get_MOSTAT_TXEN0()
    {
        return CAN_MO_MOSTAT_TXEN0(MOSTAT & (1u << 9u));
    }
     ...
     */
    inline void get_MOSTAT(uint8_t &PNEXT, uint8_t &PPREV, uint8_t &LIST, CAN_MO_MOSTAT_DIR &DIR, CAN_MO_MOSTAT_TXEN1 &TXEN1, CAN_MO_MOSTAT_TXEN0 &TXEN0, CAN_MO_MOSTAT_TXRQ &TXRQ, CAN_MO_MOSTAT_RXEN &RXEN, CAN_MO_MOSTAT_RTSEL &RTSEL, CAN_MO_MOSTAT_MSGVAL &MSGVAL, CAN_MO_MOSTAT_MSGLST &MSGLST, CAN_MO_MOSTAT_NEWDAT &NEWDAT, CAN_MO_MOSTAT_RXUPD &RXUPD, CAN_MO_MOSTAT_TXPND &TXPND, CAN_MO_MOSTAT_RXPND &RXPND)
    {
        ...
        TXEN0 = CAN_MO_MOSTAT_TXEN0(curr & (1u << 9u));
