...
struct [[gnu::packed]] CAN_MO
{
     ...
     * Get MOFCR's RMM bit.
     */
    CAN_MO_MOFCR_RMM get_MOFCR_RMM()
    {
     ...
     */
    CAN_MO_MOFCR_FRREN get_MOFCR_FRREN()
    {
     ...
     */
    CAN_MO_MOFCR_OVIE get_MOFCR_OVIE()
    {
     ...
     */
    CAN_MO_MOFCR_TXIE get_MOFCR_TXIE()
    {
     ...
     */
    CAN_MO_MOFCR_RXIE get_MOFCR_RXIE()
    {
     ...
     */
    CAN_MO_MOFCR_DATC get_MOFCR_DATC()
    {
     ...
     */
    CAN_MO_MOFCR_DLCC get_MOFCR_DLCC()
    {
     ...
     * Get MOFCR's IDC bit.
     */
    CAN_MO_MOFCR_IDC get_MOFCR_IDC()
    {
     ...
     */
    CAN_MO_MOFCR_GDFS get_MOFCR_GDFS()
    {
     ...
     */
    CAN_MO_MOFCR_RXTOE get_MOFCR_RXTOE()
    {
     ...
     */
    CAN_MO_MOFCR_MMC get_MOFCR_MMC()
    {
     ...
     */
    CAN_MO_MOIPR_TXINP get_MOIPR_TXINP()
    {
     ...
     */
    CAN_MO_MOIPR_RXINP get_MOIPR_RXINP()
    {
     ...
     */
    CAN_MO_MOAMR_MIDE get_MOAMR_MIDE()
    {
     ...
     * Get MOCTR's DIR bit.
     */
    CAN_MO_MOSTAT_DIR get_MOSTAT_DIR()
    {
     ...
     */
    CAN_MO_MOSTAT_TXEN1 get_MOSTAT_TXEN1()
    {
     ...
     */
    CAN_MO_MOSTAT_TXEN0 get_MOSTAT_TXEN0()
    {
     ...
     */
    CAN_MO_MOSTAT_TXRQ get_MOSTAT_TXRQ()
    {
     ...
     */
    CAN_MO_MOSTAT_RXEN get_MOSTAT_RXEN()
    {
     ...
     */
    CAN_MO_MOSTAT_RTSEL get_MOSTAT_RTSEL()
    {
     ...
     */
    CAN_MO_MOSTAT_MSGVAL get_MOSTAT_MSGVAL()
    {
     ...
     */
    CAN_MO_MOSTAT_MSGLST get_MOSTAT_MSGLST()
    {
     ...
     */
    CAN_MO_MOSTAT_NEWDAT get_MOSTAT_NEWDAT()
    {
     ...
     */
    CAN_MO_MOSTAT_RXUPD get_MOSTAT_RXUPD()
    {
     ...
     */
    CAN_MO_MOSTAT_TXPND get_MOSTAT_TXPND()
    {
     ...
     */
    CAN_MO_MOSTAT_RXPND get_MOSTAT_RXPND()
    {
