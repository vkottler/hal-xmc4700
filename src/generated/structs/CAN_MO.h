...
struct [[gnu::packed]] CAN_MO
{
     ...
     */
    inline void get_MOFCR(uint8_t &DLC, bool &STT, bool &SDT, bool &RMM,
                          bool &FRREN, bool &OVIE, bool &TXIE, bool &RXIE,
                          bool &DATC, bool &DLCC, bool &IDC, bool &GDFS,
                          bool &RXTOE, CAN_MO_MOFCR_MMC &MMC)
    {
        uint32_t curr = MOFCR;
     ...
     * (read-write) Message Object Function Control Register
     */
    inline void set_MOFCR(uint8_t DLC, bool STT, bool SDT, bool RMM,
                          bool FRREN, bool OVIE, bool TXIE, bool RXIE,
                          bool DATC, bool DLCC, bool IDC, bool GDFS,
                          bool RXTOE, CAN_MO_MOFCR_MMC MMC)
    {
     ...
     */
    inline void get_MOAMR(bool &MIDE, uint32_t &AM)
    {
        uint32_t curr = MOAMR;
     ...
     * (read-write) Message Object Acceptance Mask Register
     */
    inline void set_MOAMR(bool MIDE, uint32_t AM)
    {
        uint32_t curr = MOAMR;
     ...
     */
    inline void get_MOAR(CAN_MO_MOAR_PRI &PRI, bool &IDE, uint32_t &ID)
    {
        uint32_t curr = MOAR;
     ...
     * (read-write) Message Object Arbitration Register
     */
    inline void set_MOAR(CAN_MO_MOAR_PRI PRI, bool IDE, uint32_t ID)
    {
        uint32_t curr = MOAR;
     ...
     * Message Direction
     */
    inline bool get_MOSTAT_DIR()
    {
        return MOSTAT & (1u << 11u);
    }
     ...
     * Transmit Enable 1
     */
    inline bool get_MOSTAT_TXEN1()
    {
        return MOSTAT & (1u << 10u);
    }
     ...
     * (write-only) Message Object Control Register
     */
    inline void get_MOSTAT(uint8_t &PNEXT, uint8_t &PPREV, uint8_t &LIST,
                           bool &DIR, bool &TXEN1, bool &TXEN0, bool &TXRQ,
                           bool &RXEN, bool &RTSEL, bool &MSGVAL, bool &MSGLST,
                           bool &NEWDAT, bool &RXUPD, bool &TXPND, bool &RXPND)
    {
