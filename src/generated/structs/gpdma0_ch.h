...
static volatile gpdma0_ch *const GPDMA0_CH0 =
    reinterpret_cast<gpdma0_ch *>(0x50014000);

static volatile gpdma0_ch *const GPDMA0_CH1 =
    reinterpret_cast<gpdma0_ch *>(0x50014058);
