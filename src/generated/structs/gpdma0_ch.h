 ...
 */
struct [[gnu::packed]] gpdma0_ch
{
    /* Constant attributes. */
    static constexpr uint16_t id = 1;       /*!< gpdma0_ch's identifier. */
    static constexpr std::size_t size = 84; /*!< gpdma0_ch's size in bytes. */
     ...
     */
    GPDMA0_CH0_CTLL_DINC get_CTLL_DINC()
    {
     ...
     */
    GPDMA0_CH0_CTLL_SINC get_CTLL_SINC()
    {
     ...
     */
    GPDMA0_CH0_CTLL_SRC_GATHER_EN get_CTLL_SRC_GATHER_EN()
    {
     ...
     */
    GPDMA0_CH0_CTLL_DST_SCATTER_EN get_CTLL_DST_SCATTER_EN()
    {
     ...
     */
    GPDMA0_CH0_CFGL_CH_SUSP get_CFGL_CH_SUSP()
    {
     ...
     */
    GPDMA0_CH0_CFGL_FIFO_EMPTY get_CFGL_FIFO_EMPTY()
    {
     ...
     */
    GPDMA0_CH0_CFGL_HS_SEL_DST get_CFGL_HS_SEL_DST()
    {
     ...
     */
    GPDMA0_CH0_CFGL_HS_SEL_SRC get_CFGL_HS_SEL_SRC()
    {
     ...
     */
    GPDMA0_CH0_CFGL_LOCK_CH_L get_CFGL_LOCK_CH_L()
    {
     ...
     */
    GPDMA0_CH0_CFGL_LOCK_B_L get_CFGL_LOCK_B_L()
    {
     ...
     */
    GPDMA0_CH0_CFGL_DST_HS_POL get_CFGL_DST_HS_POL()
    {
     ...
     */
    GPDMA0_CH0_CFGL_SRC_HS_POL get_CFGL_SRC_HS_POL()
    {
     ...
     */
    GPDMA0_CH0_CFGH_FCMODE get_CFGH_FCMODE()
    {
     ...
     */
    GPDMA0_CH0_CFGH_FIFO_MODE get_CFGH_FIFO_MODE()
    {
...
static_assert(sizeof(gpdma0_ch) == gpdma0_ch::size);

static volatile gpdma0_ch *const GPDMA0_CH0 = reinterpret_cast<gpdma0_ch *>(0x50014000);

static volatile gpdma0_ch *const GPDMA0_CH1 = reinterpret_cast<gpdma0_ch *>(0x50014058);
