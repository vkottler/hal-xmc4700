...
struct [[gnu::packed]] wdt
{
     ...
     */
    inline void get_CTR(uint8_t &SPW, bool &DSP, bool &PRE, bool &ENB)
    {
        uint32_t curr = CTR;
     ...
     */
    inline void set_CTR(uint8_t SPW, bool DSP, bool PRE, bool ENB)
    {
        uint32_t curr = CTR;
