 ...
 * Flexible CRC Engine
 */
struct [[gnu::packed]] fce_ke
{
    /* Constant attributes. */
    static constexpr uint16_t id = 1;       /*!< fce_ke's identifier. */
    static constexpr std::size_t size = 32; /*!< fce_ke's size in bytes. */
     ...
     */
    FCE_KE0_CFG_REFOUT get_CFG_REFOUT()
    {
     ...
     * Get CFG's REFIN bit.
     */
    FCE_KE0_CFG_REFIN get_CFG_REFIN()
    {
...
static_assert(sizeof(fce_ke) == fce_ke::size);

static volatile fce_ke *const FCE_KE0 = reinterpret_cast<fce_ke *>(0x50020020);

static volatile fce_ke *const FCE_KE1 = reinterpret_cast<fce_ke *>(0x50020040);

static volatile fce_ke *const FCE_KE2 = reinterpret_cast<fce_ke *>(0x50020060);

static volatile fce_ke *const FCE_KE3 = reinterpret_cast<fce_ke *>(0x50020080);
