...
struct [[gnu::packed]] pba0
{
     ...
     */
    inline PBA0_STS_WERR get_STS_WERR() volatile
    {
     ...
     * Bufferable Write Access Error
     */
    inline void set_STS_WERR() volatile
    {
        STS |= 1u << 0u;
    }
     ...
     * Bufferable Write Access Error
     */
    inline void clear_STS_WERR() volatile
    {
        STS &= ~(1u << 0u);
    }
     ...
     * Bufferable Write Access Error
     */
    inline void toggle_STS_WERR() volatile
    {
        STS ^= 1u << 0u;
    }
     ...
     * Write Error Address
     */
    inline uint32_t get_WADDR_WADDR() volatile
    {
