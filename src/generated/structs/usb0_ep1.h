...
struct [[gnu::packed]] usb0_ep1
{
     ...
     * NAK Status
     */
    inline bool get_DIEPCTL_ISOCONT_NAKSts() volatile
    {
        return DIEPCTL_ISOCONT & (1u << 17u);
    }
     ...
     * Even/Odd Frame
     */
    inline bool get_DIEPCTL_ISOCONT_EO_FrNum() volatile
    {
        return DIEPCTL_ISOCONT & (1u << 16u);
    }
     ...
     */
    inline void get_DIEPCTL_ISOCONT(bool &EPEna, bool &EPDis, uint8_t &TxFNum,
                                    bool &Stall, bool &Snp,
                                    USB0_EP1_DIEPCTL_ISOCONT_EPType &EPType,
                                    bool &NAKSts, bool &EO_FrNum,
     ...
     * NAK Status
     */
    inline bool get_DIEPCTL_INTBULK_NAKSts() volatile
    {
        return DIEPCTL_INTBULK & (1u << 17u);
    }
     ...
     * Endpoint Data PID
     */
    inline bool get_DIEPCTL_INTBULK_DPID() volatile
    {
        return DIEPCTL_INTBULK & (1u << 16u);
    }
    ...
    inline void get_DIEPCTL_INTBULK(bool &EPEna, bool &EPDis, uint8_t &TxFNum,
                                    bool &Stall, bool &Snp,
                                    USB0_EP1_DIEPCTL_ISOCONT_EPType &EPType,
                                    bool &NAKSts, bool &DPID, bool &USBActEP,
     ...
     * NAK Status
     */
    inline bool get_DOEPCTL_ISOCONT_NAKSts() volatile
    {
        return DOEPCTL_ISOCONT & (1u << 17u);
    }
     ...
     * Even/Odd Frame
     */
    inline bool get_DOEPCTL_ISOCONT_EO_FrNum() volatile
    {
        return DOEPCTL_ISOCONT & (1u << 16u);
    }
     ...
     * (read-write) Device Endpoint Control Register [ISOCONT]
     */
    inline void get_DOEPCTL_ISOCONT(bool &EPEna, bool &EPDis, uint8_t &TxFNum,
                                    bool &Stall, bool &Snp,
                                    USB0_EP1_DIEPCTL_ISOCONT_EPType &EPType,
                                    bool &NAKSts, bool &EO_FrNum,
                                    bool &USBActEP, uint16_t &MPS) volatile
     ...
     * NAK Status
     */
    inline bool get_DOEPCTL_INTBULK_NAKSts() volatile
    {
        return DOEPCTL_INTBULK & (1u << 17u);
    }
     ...
     * Endpoint Data PID
     */
    inline bool get_DOEPCTL_INTBULK_DPID() volatile
    {
        return DOEPCTL_INTBULK & (1u << 16u);
    }
