...
struct [[gnu::packed]] dlr
{
     ...
     */
    inline void get_OVRSTAT(bool &LN11, bool &LN10, bool &LN9, bool &LN8, bool &LN7, bool &LN6, bool &LN5, bool &LN4, bool &LN3, bool &LN2, bool &LN1, bool &LN0)
    {
     ...
     */
    inline void set_OVRCLR(bool LN11, bool LN10, bool LN9, bool LN8, bool LN7, bool LN6, bool LN5, bool LN4, bool LN3, bool LN2, bool LN1, bool LN0)
    {
     ...
     */
    inline void get_SRSEL0(uint8_t &RS7, uint8_t &RS6, uint8_t &RS5, uint8_t &RS4, uint8_t &RS3, uint8_t &RS2, uint8_t &RS1, uint8_t &RS0)
    {
        uint32_t curr = SRSEL0;
     ...
     */
    inline void set_SRSEL0(uint8_t RS7, uint8_t RS6, uint8_t RS5, uint8_t RS4, uint8_t RS3, uint8_t RS2, uint8_t RS1, uint8_t RS0)
    {
        uint32_t curr = SRSEL0;
     ...
     */
    inline uint8_t get_SRSEL1_RS11()
    {
     ...
     */
    inline uint8_t get_SRSEL1_RS10()
    {
     ...
     */
    inline void get_SRSEL1(uint8_t &RS11, uint8_t &RS10, uint8_t &RS9, uint8_t &RS8)
    {
        uint32_t curr = SRSEL1;
     ...
     */
    inline void set_SRSEL1(uint8_t RS11, uint8_t RS10, uint8_t RS9, uint8_t RS8)
    {
        uint32_t curr = SRSEL1;
     ...
     * Get LNEN's LN11 bit.
     */
    inline DLR_LNEN_LN11 get_LNEN_LN11()
    {
     ...
     * Get LNEN's LN10 bit.
     */
    inline DLR_LNEN_LN10 get_LNEN_LN10()
    {
     ...
     * Get LNEN's LN9 bit.
     */
    inline DLR_LNEN_LN9 get_LNEN_LN9()
    {
     ...
     * Get LNEN's LN8 bit.
     */
    inline DLR_LNEN_LN8 get_LNEN_LN8()
    {
     ...
     * Get LNEN's LN7 bit.
     */
    inline DLR_LNEN_LN7 get_LNEN_LN7()
    {
     ...
     * Get LNEN's LN6 bit.
     */
    inline DLR_LNEN_LN6 get_LNEN_LN6()
    {
     ...
     * Get LNEN's LN5 bit.
     */
    inline DLR_LNEN_LN5 get_LNEN_LN5()
    {
     ...
     * Get LNEN's LN4 bit.
     */
    inline DLR_LNEN_LN4 get_LNEN_LN4()
    {
     ...
     * Get LNEN's LN3 bit.
     */
    inline DLR_LNEN_LN3 get_LNEN_LN3()
    {
     ...
     * Get LNEN's LN2 bit.
     */
    inline DLR_LNEN_LN2 get_LNEN_LN2()
    {
     ...
     * Get LNEN's LN1 bit.
     */
    inline DLR_LNEN_LN1 get_LNEN_LN1()
    {
     ...
     * Get LNEN's LN0 bit.
     */
    inline DLR_LNEN_LN0 get_LNEN_LN0()
    {
     ...
     */
    inline void get_LNEN(DLR_LNEN_LN11 &LN11, DLR_LNEN_LN10 &LN10, DLR_LNEN_LN9 &LN9, DLR_LNEN_LN8 &LN8, DLR_LNEN_LN7 &LN7, DLR_LNEN_LN6 &LN6, DLR_LNEN_LN5 &LN5, DLR_LNEN_LN4 &LN4, DLR_LNEN_LN3 &LN3, DLR_LNEN_LN2 &LN2, DLR_LNEN_LN1 &LN1, DLR_LNEN_LN0 &LN0)
    {
        uint32_t curr = LNEN;
     ...
     */
    inline void set_LNEN(DLR_LNEN_LN11 LN11, DLR_LNEN_LN10 LN10, DLR_LNEN_LN9 LN9, DLR_LNEN_LN8 LN8, DLR_LNEN_LN7 LN7, DLR_LNEN_LN6 LN6, DLR_LNEN_LN5 LN5, DLR_LNEN_LN4 LN4, DLR_LNEN_LN3 LN3, DLR_LNEN_LN2 LN2, DLR_LNEN_LN1 LN1, DLR_LNEN_LN0 LN0)
    {
        uint32_t curr = LNEN;
