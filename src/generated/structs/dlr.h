...
struct [[gnu::packed]] dlr
{
     ...
     * Line 11 Enable
     */
    inline bool get_LNEN_LN11() volatile
    {
        return LNEN & (1u << 11u);
    }
     ...
     * Line 10 Enable
     */
    inline bool get_LNEN_LN10() volatile
    {
        return LNEN & (1u << 10u);
    }
     ...
     * Line 9 Enable
     */
    inline bool get_LNEN_LN9() volatile
    {
        return LNEN & (1u << 9u);
    }
     ...
     * Line 8 Enable
     */
    inline bool get_LNEN_LN8() volatile
    {
        return LNEN & (1u << 8u);
    }
     ...
     * Line 7 Enable
     */
    inline bool get_LNEN_LN7() volatile
    {
        return LNEN & (1u << 7u);
    }
     ...
     * Line 6 Enable
     */
    inline bool get_LNEN_LN6() volatile
    {
        return LNEN & (1u << 6u);
    }
     ...
     * Line 5 Enable
     */
    inline bool get_LNEN_LN5() volatile
    {
        return LNEN & (1u << 5u);
    }
     ...
     * Line 4 Enable
     */
    inline bool get_LNEN_LN4() volatile
    {
        return LNEN & (1u << 4u);
    }
     ...
     * Line 3 Enable
     */
    inline bool get_LNEN_LN3() volatile
    {
        return LNEN & (1u << 3u);
    }
     ...
     * Line 2 Enable
     */
    inline bool get_LNEN_LN2() volatile
    {
        return LNEN & (1u << 2u);
    }
     ...
     * Line 1 Enable
     */
    inline bool get_LNEN_LN1() volatile
    {
        return LNEN & (1u << 1u);
    }
     ...
     * Line 0 Enable
     */
    inline bool get_LNEN_LN0() volatile
    {
        return LNEN & (1u << 0u);
    }
     ...
     */
    inline void get_LNEN(bool &LN11, bool &LN10, bool &LN9, bool &LN8,
                         bool &LN7, bool &LN6, bool &LN5, bool &LN4, bool &LN3,
                         bool &LN2, bool &LN1, bool &LN0) volatile
    {
        uint32_t curr = LNEN;
     ...
     * (read-write) Line Enable
     */
    inline void set_LNEN(bool LN11, bool LN10, bool LN9, bool LN8, bool LN7,
                         bool LN6, bool LN5, bool LN4, bool LN3, bool LN2,
                         bool LN1, bool LN0) volatile
    {
        uint32_t curr = LNEN;
