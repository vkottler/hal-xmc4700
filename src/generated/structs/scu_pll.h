...
struct [[gnu::packed]] scu_pll
{
     ...
     */
    inline SCU_PLL_PLLSTAT_K1RDY get_PLLSTAT_K1RDY() volatile
    {
     ...
     */
    inline void get_PLLSTAT(SCU_PLL_PLLSTAT_PLLSP &PLLSP, SCU_PLL_PLLSTAT_PLLHV &PLLHV, SCU_PLL_PLLSTAT_PLLLV &PLLLV, SCU_PLL_PLLSTAT_BY &BY, SCU_PLL_PLLSTAT_K2RDY &K2RDY, SCU_PLL_PLLSTAT_K1RDY &K1RDY, SCU_PLL_PLLSTAT_VCOLOCK &VCOLOCK, SCU_PLL_PLLSTAT_PWDSTAT &PWDSTAT, SCU_PLL_PLLSTAT_VCOBYST &VCOBYST) volatile
    {
     ...
     */
    inline void get_PLLCON0(SCU_PLL_PLLCON0_FOTR &FOTR, SCU_PLL_PLLCON0_AOTREN &AOTREN, SCU_PLL_PLLCON0_OSCRES &OSCRES, SCU_PLL_PLLCON0_PLLPWD &PLLPWD, SCU_PLL_PLLCON0_OSCDISCDIS &OSCDISCDIS, SCU_PLL_PLLCON0_FINDIS &FINDIS, SCU_PLL_PLLCON0_VCOTR &VCOTR, SCU_PLL_PLLCON0_VCOPWD &VCOPWD, SCU_PLL_PLLCON0_VCOBYP &VCOBYP) volatile
    {
     ...
     */
    inline void set_PLLCON0(SCU_PLL_PLLCON0_FOTR FOTR, SCU_PLL_PLLCON0_AOTREN AOTREN, bool RESLD, SCU_PLL_PLLCON0_OSCRES OSCRES, SCU_PLL_PLLCON0_PLLPWD PLLPWD, SCU_PLL_PLLCON0_OSCDISCDIS OSCDISCDIS, SCU_PLL_PLLCON0_FINDIS FINDIS, SCU_PLL_PLLCON0_VCOTR VCOTR, SCU_PLL_PLLCON0_VCOPWD VCOPWD, SCU_PLL_PLLCON0_VCOBYP VCOBYP) volatile
    {
        uint32_t curr = PLLCON0;
     ...
     */
    inline void get_PLLCON1(uint8_t &PDIV, uint8_t &K2DIV, uint8_t &NDIV, uint8_t &K1DIV) volatile
    {
        uint32_t curr = PLLCON1;
     ...
     */
    inline void set_PLLCON1(uint8_t PDIV, uint8_t K2DIV, uint8_t NDIV, uint8_t K1DIV) volatile
    {
        uint32_t curr = PLLCON1;
     ...
     */
    inline SCU_PLL_PLLCON2_PINSEL get_PLLCON2_PINSEL() volatile
    {
     ...
     */
    inline void get_PLLCON2(SCU_PLL_PLLCON2_K1INSEL &K1INSEL, SCU_PLL_PLLCON2_PINSEL &PINSEL) volatile
    {
     ...
     */
    inline void set_PLLCON2(SCU_PLL_PLLCON2_K1INSEL K1INSEL, SCU_PLL_PLLCON2_PINSEL PINSEL) volatile
    {
        uint32_t curr = PLLCON2;
     ...
     */
    inline SCU_PLL_USBPLLSTAT_VCOLOCKED get_USBPLLSTAT_VCOLOCKED() volatile
    {
     ...
     */
    inline SCU_PLL_USBPLLSTAT_BY get_USBPLLSTAT_BY() volatile
    {
     ...
     */
    inline SCU_PLL_USBPLLSTAT_PWDSTAT get_USBPLLSTAT_PWDSTAT() volatile
    {
     ...
     */
    inline void get_USBPLLSTAT(SCU_PLL_USBPLLSTAT_VCOLOCKED &VCOLOCKED, SCU_PLL_USBPLLSTAT_BY &BY, SCU_PLL_USBPLLSTAT_VCOLOCK &VCOLOCK, SCU_PLL_USBPLLSTAT_PWDSTAT &PWDSTAT, SCU_PLL_USBPLLSTAT_VCOBYST &VCOBYST) volatile
    {
     ...
     */
    inline SCU_PLL_USBPLLCON_PLLPWD get_USBPLLCON_PLLPWD() volatile
    {
     ...
     */
    inline SCU_PLL_USBPLLCON_OSCDISCDIS get_USBPLLCON_OSCDISCDIS() volatile
    {
     ...
     */
    inline SCU_PLL_USBPLLCON_FINDIS get_USBPLLCON_FINDIS() volatile
    {
     ...
     */
    inline SCU_PLL_USBPLLCON_VCOTR get_USBPLLCON_VCOTR() volatile
    {
     ...
     */
    inline SCU_PLL_USBPLLCON_VCOBYP get_USBPLLCON_VCOBYP() volatile
    {
     ...
     */
    inline void get_USBPLLCON(uint8_t &PDIV, SCU_PLL_USBPLLCON_PLLPWD &PLLPWD, uint8_t &NDIV, SCU_PLL_USBPLLCON_OSCDISCDIS &OSCDISCDIS, SCU_PLL_USBPLLCON_FINDIS &FINDIS, SCU_PLL_USBPLLCON_VCOTR &VCOTR, SCU_PLL_USBPLLCON_VCOPWD &VCOPWD, SCU_PLL_USBPLLCON_VCOBYP &VCOBYP) volatile
    {
        uint32_t curr = USBPLLCON;
     ...
     */
    inline void set_USBPLLCON(uint8_t PDIV, bool RESLD, SCU_PLL_USBPLLCON_PLLPWD PLLPWD, uint8_t NDIV, SCU_PLL_USBPLLCON_OSCDISCDIS OSCDISCDIS, SCU_PLL_USBPLLCON_FINDIS FINDIS, SCU_PLL_USBPLLCON_VCOTR VCOTR, SCU_PLL_USBPLLCON_VCOPWD VCOPWD, SCU_PLL_USBPLLCON_VCOBYP VCOBYP) volatile
    {
        uint32_t curr = USBPLLCON;
