...
struct [[gnu::packed]] port14
{
    ...
    inline void get_PDISC(bool &PDIS15, bool &PDIS14, bool &PDIS13,
                          bool &PDIS12, bool &PDIS9, bool &PDIS8, bool &PDIS7,
                          bool &PDIS6, bool &PDIS5, bool &PDIS4, bool &PDIS3,
                          bool &PDIS2, bool &PDIS1, bool &PDIS0) volatile
    {
        uint32_t curr = PDISC;
     ...
     * (read-write) Port 14 Pin Function Decision Control Register
     */
    inline void set_PDISC(bool PDIS15, bool PDIS14, bool PDIS13, bool PDIS12,
                          ...
                          bool PDIS1, bool PDIS0) volatile
    {
        ...
        curr &= ~(0b1u << 15u);
        curr |= (PDIS15 & 0b1u) << 15u;
        curr &= ~(0b1u << 14u);
        curr |= (PDIS14 & 0b1u) << 14u;
        curr &= ~(0b1u << 13u);
        curr |= (PDIS13 & 0b1u) << 13u;
        curr &= ~(0b1u << 12u);
        curr |= (PDIS12 & 0b1u) << 12u;
        curr &= ~(0b1u << 9u);
        curr |= (PDIS9 & 0b1u) << 9u;
        curr &= ~(0b1u << 8u);
        curr |= (PDIS8 & 0b1u) << 8u;
