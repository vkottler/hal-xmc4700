...
struct [[gnu::packed]] scu_general
{
    ...
    static constexpr std::size_t size =
        208; /*!< scu_general's size in bytes. */
    ...
    uint32_t
        DTSCON; /*!< (read-write) Die Temperature Sensor Control Register */
    const uint32_t DTSSTAT =
        {}; /*!< (read-only) Die Temperature Sensor Status Register */
    ...
    uint32_t
        G0ORCEN; /*!< (read-write) Out of Range Comparator Enable Register 0 */
    uint32_t
        G1ORCEN; /*!< (read-write) Out of Range Comparator Enable Register 1 */
    static constexpr std::size_t reserved_padding5_length = 7;
    const uint32_t reserved_padding5[reserved_padding5_length] = {};
    const uint32_t MIRRSTS =
        {}; /*!< (read-only) Mirror Write Status Register */
    uint32_t
        RMACR; /*!< (read-write) Retention Memory Access Control Register */
...
static volatile scu_general *const SCU_GENERAL =
    reinterpret_cast<scu_general *>(0x50004000);
