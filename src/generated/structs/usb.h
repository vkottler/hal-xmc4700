...
#include "../enums/USB_HCCHAR_ChEna.h"
#include "../enums/USB_HCCHAR_EPDir.h"
#include "../enums/USB_HCCHAR_EPType.h"
#include "../enums/USB_HCCHAR_MC_EC.h"
#include "../enums/USB_HCCHAR_OddFrm.h"
#include "../enums/USB_HCDMA_SCATGATHER_CTD.h"
#include "../enums/USB_HCTSIZ_BUFFERMODE_Pid.h"
#include "../enums/USB_HCTSIZ_SCATGATHER_Pid.h"
...
struct [[gnu::packed]] usb
{
    ...
    static constexpr std::size_t size = 32; /*!< usb's size in bytes. */
     ...
     */
    USB_HCCHAR_ChEna get_HCCHAR_ChEna()
    {
        return USB_HCCHAR_ChEna(HCCHAR & (1u << 31u));
    }
     ...
     */
    USB_HCCHAR_OddFrm get_HCCHAR_OddFrm()
    {
        return USB_HCCHAR_OddFrm(HCCHAR & (1u << 29u));
    }
     ...
     */
    USB_HCCHAR_MC_EC get_HCCHAR_MC_EC()
    {
        return USB_HCCHAR_MC_EC((HCCHAR >> 20u) & 0b11u);
    }

    /**
     * Set HCCHAR's MC_EC field.
     */
    inline void set_HCCHAR_MC_EC(USB_HCCHAR_MC_EC value)
    {
        uint32_t curr = HCCHAR;
     ...
     */
    USB_HCCHAR_EPType get_HCCHAR_EPType()
    {
        return USB_HCCHAR_EPType((HCCHAR >> 18u) & 0b11u);
    }

    /**
     * Set HCCHAR's EPType field.
     */
    inline void set_HCCHAR_EPType(USB_HCCHAR_EPType value)
    {
        uint32_t curr = HCCHAR;
     ...
     */
    USB_HCCHAR_EPDir get_HCCHAR_EPDir()
    {
        return USB_HCCHAR_EPDir(HCCHAR & (1u << 15u));
    }
     ...
     */
    USB_HCTSIZ_BUFFERMODE_Pid get_HCTSIZ_BUFFERMODE_Pid()
    {
        return USB_HCTSIZ_BUFFERMODE_Pid((HCTSIZ_BUFFERMODE >> 29u) & 0b11u);
    }

    /**
     * Set HCTSIZ_BUFFERMODE's Pid field.
     */
    inline void set_HCTSIZ_BUFFERMODE_Pid(USB_HCTSIZ_BUFFERMODE_Pid value)
    {
     ...
     * Get HCTSIZ_BUFFERMODE's Pid field.
     */
    USB_HCTSIZ_SCATGATHER_Pid get_HCTSIZ_SCATGATHER_Pid()
    {
        return USB_HCTSIZ_SCATGATHER_Pid((HCTSIZ_SCATGATHER >> 29u) & 0b11u);
    }

    /**
     * Set HCTSIZ_BUFFERMODE's Pid field.
     */
    inline void set_HCTSIZ_SCATGATHER_Pid(USB_HCTSIZ_SCATGATHER_Pid value)
    {
     ...
     */
    USB_HCDMA_SCATGATHER_CTD get_HCDMA_SCATGATHER_CTD()
    {
        return USB_HCDMA_SCATGATHER_CTD((HCDMA_SCATGATHER >> 3u) & 0b111111u);
    }

    /**
     * Set HCDMA_BUFFERMODE's CTD field.
     */
    inline void set_HCDMA_SCATGATHER_CTD(USB_HCDMA_SCATGATHER_CTD value)
    {
        uint32_t curr = HCDMA_SCATGATHER;
...
static volatile usb *const USB0_CH0 = reinterpret_cast<usb *>(0x50040500);

static volatile usb *const USB0_EP1 = reinterpret_cast<usb *>(0x50040920);

static volatile usb *const USB0_EP0 = reinterpret_cast<usb *>(0x50040900);

static volatile usb *const USB0 = reinterpret_cast<usb *>(0x50040000);

static volatile usb *const USB0_EP2 = reinterpret_cast<usb *>(0x50040940);

static volatile usb *const USB0_EP3 = reinterpret_cast<usb *>(0x50040960);

static volatile usb *const USB0_EP4 = reinterpret_cast<usb *>(0x50040980);

static volatile usb *const USB0_EP5 = reinterpret_cast<usb *>(0x500409A0);

static volatile usb *const USB0_EP6 = reinterpret_cast<usb *>(0x500409C0);

static volatile usb *const USB0_CH1 = reinterpret_cast<usb *>(0x50040520);

static volatile usb *const USB0_CH2 = reinterpret_cast<usb *>(0x50040540);

static volatile usb *const USB0_CH3 = reinterpret_cast<usb *>(0x50040560);

static volatile usb *const USB0_CH4 = reinterpret_cast<usb *>(0x50040580);

static volatile usb *const USB0_CH5 = reinterpret_cast<usb *>(0x500405A0);

static volatile usb *const USB0_CH6 = reinterpret_cast<usb *>(0x500405C0);

static volatile usb *const USB0_CH7 = reinterpret_cast<usb *>(0x500405E0);

static volatile usb *const USB0_CH8 = reinterpret_cast<usb *>(0x50040600);

static volatile usb *const USB0_CH9 = reinterpret_cast<usb *>(0x50040620);

static volatile usb *const USB0_CH10 = reinterpret_cast<usb *>(0x50040640);

static volatile usb *const USB0_CH11 = reinterpret_cast<usb *>(0x50040660);

static volatile usb *const USB0_CH12 = reinterpret_cast<usb *>(0x50040680);

static volatile usb *const USB0_CH13 = reinterpret_cast<usb *>(0x500406A0);
