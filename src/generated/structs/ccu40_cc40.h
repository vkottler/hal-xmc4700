...
struct [[gnu::packed]] ccu40_cc40
{
    ...
    inline void get_INS(
        ...
        CCU40_CC40_INS_LPF2M &LPF0M, bool &EV2LM, bool &EV1LM, bool &EV0LM,
    ...
    inline void set_INS(CCU40_CC40_INS_LPF2M LPF2M, CCU40_CC40_INS_LPF2M LPF1M,
                        CCU40_CC40_INS_LPF2M LPF0M, bool EV2LM, bool EV1LM,
                        bool EV0LM, CCU40_CC40_INS_EV2EM EV2EM,
                        CCU40_CC40_INS_EV2EM EV1EM, CCU40_CC40_INS_EV2EM EV0EM,
                        CCU40_CC40_INS_EV2IS EV2IS, CCU40_CC40_INS_EV2IS EV1IS,
     ...
     */
    inline void get_TCST(bool &CDIR, bool &TRB) volatile
    {
        uint32_t curr = TCST;
     ...
     */
    inline bool get_TC_MCME() volatile
    {
        return TC & (1u << 25u);
    }
     ...
     * TRAP enable
     */
    inline bool get_TC_TRAPE() volatile
    {
        return TC & (1u << 17u);
    }
     ...
     */
    inline void get_TC(bool &MCME, bool &EMT, bool &EMS, bool &TRPSW,
                       bool &TRPSE, bool &TRAPE, bool &FPE, bool &DIM,
                       CCU40_CC40_TC_DITHE &DITHE, bool &CCS, bool &SCE,
                       bool &STRM, CCU40_CC40_TC_ENDM &ENDM,
                       CCU40_CC40_TC_CAPC &CAPC, bool &ECM, bool &CMOD,
     ...
     * (read-write) Slice Timer Control
     */
    inline void set_TC(bool MCME, bool EMT, bool EMS, bool TRPSW, bool TRPSE,
                       bool TRAPE, bool FPE, bool DIM,
                       CCU40_CC40_TC_DITHE DITHE, bool CCS, bool SCE,
                       bool STRM, CCU40_CC40_TC_ENDM ENDM,
                       CCU40_CC40_TC_CAPC CAPC, bool ECM, bool CLST, bool TSSM,
                       bool TCM) volatile
    {
        uint32_t curr = TC;
     ...
     */
    inline bool get_PSL_PSL() volatile
    {
        return PSL & (1u << 0u);
    }
     ...
     */
    inline bool get_INTS_CMDS() volatile
    {
        return INTS & (1u << 3u);
    }
     ...
     */
    inline bool get_INTS_CMUS() volatile
    {
        return INTS & (1u << 2u);
    }
     ...
     */
    inline bool get_INTE_CMDE() volatile
    {
        return INTE & (1u << 3u);
    }
     ...
     */
    inline bool get_INTE_CMUE() volatile
    {
        return INTE & (1u << 2u);
    }
     ...
     */
    inline void get_INTE(bool &E2AE, bool &E1AE, bool &E0AE, bool &CMDE,
                         bool &CMUE, bool &OME, bool &PME) volatile
    {
        uint32_t curr = INTE;
     ...
     * (read-write) Interrupt Enable Control
     */
    inline void set_INTE(bool E2AE, bool E1AE, bool E0AE, bool CMDE, bool CMUE,
                         bool OME, bool PME) volatile
    {
        uint32_t curr = INTE;
     ...
     */
    inline void get_ECRD0(bool &LCV, bool &FFL, CCU40_CC40_SRS_E2SR &VPTR,
                          CCU40_CC40_SRS_E2SR &SPTR, uint8_t &FPCV,
     ...
     */
    inline void get_ECRD1(bool &LCV, bool &FFL, CCU40_CC40_SRS_E2SR &VPTR,
                          CCU40_CC40_SRS_E2SR &SPTR, uint8_t &FPCV,
                          uint16_t &CAPV) volatile
    {
        uint32_t curr = ECRD1;
