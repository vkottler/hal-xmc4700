...
{
    /* Constant attributes. */
    static constexpr std::size_t size = 192; /*!< ccu40_cc40's size in bytes. */
     ...
     */
    inline CCU40_CC40_INS_LPF1M get_INS_LPF1M() volatile
    {
     ...
     */
    inline void set_INS_LPF1M(CCU40_CC40_INS_LPF1M value) volatile
    {
        uint32_t curr = INS;
     ...
     */
    inline CCU40_CC40_INS_LPF0M get_INS_LPF0M() volatile
    {
     ...
     */
    inline void set_INS_LPF0M(CCU40_CC40_INS_LPF0M value) volatile
    {
        uint32_t curr = INS;
     ...
     * Get INS's EV1LM bit.
     */
    inline CCU40_CC40_INS_EV1LM get_INS_EV1LM() volatile
    {
     ...
     * Get INS's EV0LM bit.
     */
    inline CCU40_CC40_INS_EV0LM get_INS_EV0LM() volatile
    {
     ...
     */
    inline CCU40_CC40_INS_EV1EM get_INS_EV1EM() volatile
    {
     ...
     */
    inline void set_INS_EV1EM(CCU40_CC40_INS_EV1EM value) volatile
    {
        uint32_t curr = INS;
     ...
     */
    inline CCU40_CC40_INS_EV0EM get_INS_EV0EM() volatile
    {
     ...
     */
    inline void set_INS_EV0EM(CCU40_CC40_INS_EV0EM value) volatile
    {
        uint32_t curr = INS;
     ...
     */
    inline CCU40_CC40_INS_EV1IS get_INS_EV1IS() volatile
    {
     ...
     */
    inline void set_INS_EV1IS(CCU40_CC40_INS_EV1IS value) volatile
    {
        uint32_t curr = INS;
     ...
     */
    inline CCU40_CC40_INS_EV0IS get_INS_EV0IS() volatile
    {
     ...
     */
    inline void set_INS_EV0IS(CCU40_CC40_INS_EV0IS value) volatile
    {
        uint32_t curr = INS;
     ...
     */
    inline void get_INS(CCU40_CC40_INS_LPF2M &LPF2M, CCU40_CC40_INS_LPF1M &LPF1M, CCU40_CC40_INS_LPF0M &LPF0M, CCU40_CC40_INS_EV2LM &EV2LM, CCU40_CC40_INS_EV1LM &EV1LM, CCU40_CC40_INS_EV0LM &EV0LM, CCU40_CC40_INS_EV2EM &EV2EM, CCU40_CC40_INS_EV1EM &EV1EM, CCU40_CC40_INS_EV0EM &EV0EM, CCU40_CC40_INS_EV2IS &EV2IS, CCU40_CC40_INS_EV1IS &EV1IS, CCU40_CC40_INS_EV0IS &EV0IS) volatile
    {
        uint32_t curr = INS;

        LPF2M = CCU40_CC40_INS_LPF2M((curr >> 29u) & 0b11u);
        LPF1M = CCU40_CC40_INS_LPF1M((curr >> 27u) & 0b11u);
        LPF0M = CCU40_CC40_INS_LPF0M((curr >> 25u) & 0b11u);
        EV2LM = CCU40_CC40_INS_EV2LM(curr & (1u << 24u));
        EV1LM = CCU40_CC40_INS_EV1LM(curr & (1u << 23u));
        EV0LM = CCU40_CC40_INS_EV0LM(curr & (1u << 22u));
        EV2EM = CCU40_CC40_INS_EV2EM((curr >> 20u) & 0b11u);
        EV1EM = CCU40_CC40_INS_EV1EM((curr >> 18u) & 0b11u);
        EV0EM = CCU40_CC40_INS_EV0EM((curr >> 16u) & 0b11u);
        EV2IS = CCU40_CC40_INS_EV2IS((curr >> 8u) & 0b1111u);
        EV1IS = CCU40_CC40_INS_EV1IS((curr >> 4u) & 0b1111u);
        EV0IS = CCU40_CC40_INS_EV0IS((curr >> 0u) & 0b1111u);
    }

    /**
     * Set all of INS's bit fields.
     */
    inline void set_INS(CCU40_CC40_INS_LPF2M LPF2M, CCU40_CC40_INS_LPF1M LPF1M, CCU40_CC40_INS_LPF0M LPF0M, CCU40_CC40_INS_EV2LM EV2LM, CCU40_CC40_INS_EV1LM EV1LM, CCU40_CC40_INS_EV0LM EV0LM, CCU40_CC40_INS_EV2EM EV2EM, CCU40_CC40_INS_EV1EM EV1EM, CCU40_CC40_INS_EV0EM EV0EM, CCU40_CC40_INS_EV2IS EV2IS, CCU40_CC40_INS_EV1IS EV1IS, CCU40_CC40_INS_EV0IS EV0IS) volatile
    {
        uint32_t curr = INS;
     ...
     * Get CMC's UDS field.
     */
    inline CCU40_CC40_CMC_UDS get_CMC_UDS() volatile
    {
     ...
     * Set CMC's UDS field.
     */
    inline void set_CMC_UDS(CCU40_CC40_CMC_UDS value) volatile
    {
        uint32_t curr = CMC;
     ...
     */
    inline CCU40_CC40_CMC_GATES get_CMC_GATES() volatile
    {
     ...
     */
    inline void set_CMC_GATES(CCU40_CC40_CMC_GATES value) volatile
    {
        uint32_t curr = CMC;
     ...
     */
    inline CCU40_CC40_CMC_CAP1S get_CMC_CAP1S() volatile
    {
     ...
     */
    inline void set_CMC_CAP1S(CCU40_CC40_CMC_CAP1S value) volatile
    {
        uint32_t curr = CMC;
     ...
     */
    inline CCU40_CC40_CMC_CAP0S get_CMC_CAP0S() volatile
    {
     ...
     */
    inline void set_CMC_CAP0S(CCU40_CC40_CMC_CAP0S value) volatile
    {
        uint32_t curr = CMC;
     ...
     */
    inline CCU40_CC40_CMC_ENDS get_CMC_ENDS() volatile
    {
     ...
     */
    inline void set_CMC_ENDS(CCU40_CC40_CMC_ENDS value) volatile
    {
        uint32_t curr = CMC;
     ...
     */
    inline CCU40_CC40_CMC_STRTS get_CMC_STRTS() volatile
    {
     ...
     */
    inline void set_CMC_STRTS(CCU40_CC40_CMC_STRTS value) volatile
    {
        uint32_t curr = CMC;
     ...
     */
    inline void get_CMC(CCU40_CC40_CMC_TCE &TCE, uint8_t &MOS, CCU40_CC40_CMC_TS &TS, CCU40_CC40_CMC_OFS &OFS, CCU40_CC40_CMC_CNTS &CNTS, uint8_t &LDS, CCU40_CC40_CMC_UDS &UDS, CCU40_CC40_CMC_GATES &GATES, CCU40_CC40_CMC_CAP1S &CAP1S, CCU40_CC40_CMC_CAP0S &CAP0S, CCU40_CC40_CMC_ENDS &ENDS, CCU40_CC40_CMC_STRTS &STRTS) volatile
    {
        uint32_t curr = CMC;
        ...
        LDS = (curr >> 12u) & 0b11u;
        UDS = CCU40_CC40_CMC_UDS((curr >> 10u) & 0b11u);
        GATES = CCU40_CC40_CMC_GATES((curr >> 8u) & 0b11u);
        CAP1S = CCU40_CC40_CMC_CAP1S((curr >> 6u) & 0b11u);
        CAP0S = CCU40_CC40_CMC_CAP0S((curr >> 4u) & 0b11u);
        ENDS = CCU40_CC40_CMC_ENDS((curr >> 2u) & 0b11u);
        STRTS = CCU40_CC40_CMC_STRTS((curr >> 0u) & 0b11u);
    }

    /**
     * Set all of CMC's bit fields.
     */
    inline void set_CMC(CCU40_CC40_CMC_TCE TCE, uint8_t MOS, CCU40_CC40_CMC_TS TS, CCU40_CC40_CMC_OFS OFS, CCU40_CC40_CMC_CNTS CNTS, uint8_t LDS, CCU40_CC40_CMC_UDS UDS, CCU40_CC40_CMC_GATES GATES, CCU40_CC40_CMC_CAP1S CAP1S, CCU40_CC40_CMC_CAP0S CAP0S, CCU40_CC40_CMC_ENDS ENDS, CCU40_CC40_CMC_STRTS STRTS) volatile
    {
        uint32_t curr = CMC;
     ...
     */
    inline void get_TCST(CCU40_CC40_TCST_CDIR &CDIR, CCU40_CC40_TCST_TRB &TRB) volatile
    {
        uint32_t curr = TCST;
     ...
     * Get TC's MCME bit.
     */
    inline CCU40_CC40_TC_MCME get_TC_MCME() volatile
    {
     ...
     * Get TC's FPE bit.
     */
    inline CCU40_CC40_TC_FPE get_TC_FPE() volatile
    {
     ...
     * Get TC's TSSM bit.
     */
    inline CCU40_CC40_TC_TSSM get_TC_TSSM() volatile
    {
     ...
     */
    inline void get_TC(CCU40_CC40_TC_MCME &MCME, CCU40_CC40_TC_EMT &EMT, CCU40_CC40_TC_EMS &EMS, CCU40_CC40_TC_TRPSW &TRPSW, CCU40_CC40_TC_TRPSE &TRPSE, CCU40_CC40_TC_TRAPE &TRAPE, CCU40_CC40_TC_FPE &FPE, CCU40_CC40_TC_DIM &DIM, CCU40_CC40_TC_DITHE &DITHE, CCU40_CC40_TC_CCS &CCS, CCU40_CC40_TC_SCE &SCE, CCU40_CC40_TC_STRM &STRM, CCU40_CC40_TC_ENDM &ENDM, CCU40_CC40_TC_CAPC &CAPC, CCU40_CC40_TC_ECM &ECM, CCU40_CC40_TC_CMOD &CMOD, bool &CLST, CCU40_CC40_TC_TSSM &TSSM, CCU40_CC40_TC_TCM &TCM) volatile
    {
        uint32_t curr = TC;

        MCME = CCU40_CC40_TC_MCME(curr & (1u << 25u));
        ...
        FPE = CCU40_CC40_TC_FPE(curr & (1u << 16u));
        ...
        CLST = curr & (1u << 2u);
        TSSM = CCU40_CC40_TC_TSSM(curr & (1u << 1u));
     ...
     */
    inline void set_TC(CCU40_CC40_TC_MCME MCME, CCU40_CC40_TC_EMT EMT, CCU40_CC40_TC_EMS EMS, CCU40_CC40_TC_TRPSW TRPSW, CCU40_CC40_TC_TRPSE TRPSE, CCU40_CC40_TC_TRAPE TRAPE, CCU40_CC40_TC_FPE FPE, CCU40_CC40_TC_DIM DIM, CCU40_CC40_TC_DITHE DITHE, CCU40_CC40_TC_CCS CCS, CCU40_CC40_TC_SCE SCE, CCU40_CC40_TC_STRM STRM, CCU40_CC40_TC_ENDM ENDM, CCU40_CC40_TC_CAPC CAPC, CCU40_CC40_TC_ECM ECM, bool CLST, CCU40_CC40_TC_TSSM TSSM, CCU40_CC40_TC_TCM TCM) volatile
    {
        uint32_t curr = TC;
     ...
     */
    inline void get_C0V(CCU40_CC40_C0V_FFL &FFL, uint8_t &FPCV, uint16_t &CAPTV) volatile
    {
        uint32_t curr = C0V;
     ...
     * Get C1V's FFL bit.
     */
    inline CCU40_CC40_C1V_FFL get_C1V_FFL() volatile
    {
     ...
     */
    inline void get_C1V(CCU40_CC40_C1V_FFL &FFL, uint8_t &FPCV, uint16_t &CAPTV) volatile
    {
        uint32_t curr = C1V;

        FFL = CCU40_CC40_C1V_FFL(curr & (1u << 20u));
        FPCV = (curr >> 16u) & 0b1111u;
        CAPTV = (curr >> 0u) & 0b1111111111111111u;
    }
     ...
     * Get C2V's FFL bit.
     */
    inline CCU40_CC40_C2V_FFL get_C2V_FFL() volatile
    {
     ...
     */
    inline void get_C2V(CCU40_CC40_C2V_FFL &FFL, uint8_t &FPCV, uint16_t &CAPTV) volatile
    {
        uint32_t curr = C2V;

        FFL = CCU40_CC40_C2V_FFL(curr & (1u << 20u));
        FPCV = (curr >> 16u) & 0b1111u;
        CAPTV = (curr >> 0u) & 0b1111111111111111u;
    }
     ...
     * Get C3V's FFL bit.
     */
    inline CCU40_CC40_C3V_FFL get_C3V_FFL() volatile
    {
     ...
     */
    inline void get_C3V(CCU40_CC40_C3V_FFL &FFL, uint8_t &FPCV, uint16_t &CAPTV) volatile
    {
        uint32_t curr = C3V;

        FFL = CCU40_CC40_C3V_FFL(curr & (1u << 20u));
        FPCV = (curr >> 16u) & 0b1111u;
        CAPTV = (curr >> 0u) & 0b1111111111111111u;
    }
     ...
     * Get INTS's E1AS bit.
     */
    inline CCU40_CC40_INTS_E1AS get_INTS_E1AS() volatile
    {
     ...
     * Get INTS's E0AS bit.
     */
    inline CCU40_CC40_INTS_E0AS get_INTS_E0AS() volatile
    {
     ...
     * Get INTS's CMDS bit.
     */
    inline CCU40_CC40_INTS_CMDS get_INTS_CMDS() volatile
    {
     ...
     * Get INTS's CMUS bit.
     */
    inline CCU40_CC40_INTS_CMUS get_INTS_CMUS() volatile
    {
     ...
     * Get INTS's OMDS bit.
     */
    inline CCU40_CC40_INTS_OMDS get_INTS_OMDS() volatile
    {
     ...
     * Get INTS's PMUS bit.
     */
    inline CCU40_CC40_INTS_PMUS get_INTS_PMUS() volatile
    {
     ...
     */
    inline void get_INTS(bool &TRPF, CCU40_CC40_INTS_E2AS &E2AS, CCU40_CC40_INTS_E1AS &E1AS, CCU40_CC40_INTS_E0AS &E0AS, CCU40_CC40_INTS_CMDS &CMDS, CCU40_CC40_INTS_CMUS &CMUS, CCU40_CC40_INTS_OMDS &OMDS, CCU40_CC40_INTS_PMUS &PMUS) volatile
    {
        uint32_t curr = INTS;

        TRPF = curr & (1u << 11u);
        E2AS = CCU40_CC40_INTS_E2AS(curr & (1u << 10u));
        E1AS = CCU40_CC40_INTS_E1AS(curr & (1u << 9u));
        E0AS = CCU40_CC40_INTS_E0AS(curr & (1u << 8u));
        CMDS = CCU40_CC40_INTS_CMDS(curr & (1u << 3u));
        CMUS = CCU40_CC40_INTS_CMUS(curr & (1u << 2u));
        OMDS = CCU40_CC40_INTS_OMDS(curr & (1u << 1u));
        PMUS = CCU40_CC40_INTS_PMUS(curr & (1u << 0u));
    }

    /**
     * Get INTE's E2AE bit.
     */
    inline CCU40_CC40_INTE_E2AE get_INTE_E2AE() volatile
    {
     ...
     * Get INTE's E1AE bit.
     */
    inline CCU40_CC40_INTE_E1AE get_INTE_E1AE() volatile
    {
     ...
     * Get INTE's E0AE bit.
     */
    inline CCU40_CC40_INTE_E0AE get_INTE_E0AE() volatile
    {
     ...
     * Get INTE's CMDE bit.
     */
    inline CCU40_CC40_INTE_CMDE get_INTE_CMDE() volatile
    {
     ...
     * Get INTE's CMUE bit.
     */
    inline CCU40_CC40_INTE_CMUE get_INTE_CMUE() volatile
    {
     ...
     * Get INTE's OME bit.
     */
    inline CCU40_CC40_INTE_OME get_INTE_OME() volatile
    {
     ...
     * Get INTE's PME bit.
     */
    inline CCU40_CC40_INTE_PME get_INTE_PME() volatile
    {
     ...
     */
    inline void get_INTE(CCU40_CC40_INTE_E2AE &E2AE, CCU40_CC40_INTE_E1AE &E1AE, CCU40_CC40_INTE_E0AE &E0AE, CCU40_CC40_INTE_CMDE &CMDE, CCU40_CC40_INTE_CMUE &CMUE, CCU40_CC40_INTE_OME &OME, CCU40_CC40_INTE_PME &PME) volatile
    {
        uint32_t curr = INTE;

        E2AE = CCU40_CC40_INTE_E2AE(curr & (1u << 10u));
        E1AE = CCU40_CC40_INTE_E1AE(curr & (1u << 9u));
        E0AE = CCU40_CC40_INTE_E0AE(curr & (1u << 8u));
        CMDE = CCU40_CC40_INTE_CMDE(curr & (1u << 3u));
        CMUE = CCU40_CC40_INTE_CMUE(curr & (1u << 2u));
        OME = CCU40_CC40_INTE_OME(curr & (1u << 1u));
        PME = CCU40_CC40_INTE_PME(curr & (1u << 0u));
    }

    /**
     * Set all of INTE's bit fields.
     */
    inline void set_INTE(CCU40_CC40_INTE_E2AE E2AE, CCU40_CC40_INTE_E1AE E1AE, CCU40_CC40_INTE_E0AE E0AE, CCU40_CC40_INTE_CMDE CMDE, CCU40_CC40_INTE_CMUE CMUE, CCU40_CC40_INTE_OME OME, CCU40_CC40_INTE_PME PME) volatile
    {
        uint32_t curr = INTE;
     ...
     */
    inline CCU40_CC40_SRS_E1SR get_SRS_E1SR() volatile
    {
     ...
     */
    inline void set_SRS_E1SR(CCU40_CC40_SRS_E1SR value) volatile
    {
        uint32_t curr = SRS;
     ...
     */
    inline CCU40_CC40_SRS_E0SR get_SRS_E0SR() volatile
    {
     ...
     */
    inline void set_SRS_E0SR(CCU40_CC40_SRS_E0SR value) volatile
    {
        uint32_t curr = SRS;
     ...
     */
    inline CCU40_CC40_SRS_CMSR get_SRS_CMSR() volatile
    {
     ...
     */
    inline void set_SRS_CMSR(CCU40_CC40_SRS_CMSR value) volatile
    {
        uint32_t curr = SRS;
     ...
     */
    inline CCU40_CC40_SRS_POSR get_SRS_POSR() volatile
    {
     ...
     */
    inline void set_SRS_POSR(CCU40_CC40_SRS_POSR value) volatile
    {
        uint32_t curr = SRS;
     ...
     */
    inline void get_SRS(CCU40_CC40_SRS_E2SR &E2SR, CCU40_CC40_SRS_E1SR &E1SR, CCU40_CC40_SRS_E0SR &E0SR, CCU40_CC40_SRS_CMSR &CMSR, CCU40_CC40_SRS_POSR &POSR) volatile
    {
        uint32_t curr = SRS;

        E2SR = CCU40_CC40_SRS_E2SR((curr >> 12u) & 0b11u);
        E1SR = CCU40_CC40_SRS_E1SR((curr >> 10u) & 0b11u);
        E0SR = CCU40_CC40_SRS_E0SR((curr >> 8u) & 0b11u);
        CMSR = CCU40_CC40_SRS_CMSR((curr >> 2u) & 0b11u);
        POSR = CCU40_CC40_SRS_POSR((curr >> 0u) & 0b11u);
    }

    /**
     * Set all of SRS's bit fields.
     */
    inline void set_SRS(CCU40_CC40_SRS_E2SR E2SR, CCU40_CC40_SRS_E1SR E1SR, CCU40_CC40_SRS_E0SR E0SR, CCU40_CC40_SRS_CMSR CMSR, CCU40_CC40_SRS_POSR POSR) volatile
    {
        uint32_t curr = SRS;
     ...
     */
    inline void set_SWS(bool STRPF, bool SE2A, bool SE1A, bool SE0A, bool SCMD, bool SCMU, bool SOM, bool SPM) volatile
    {
        uint32_t curr = SWS;
     ...
     */
    inline void set_SWR(bool RTRPF, bool RE2A, bool RE1A, bool RE0A, bool RCMD, bool RCMU, bool ROM, bool RPM) volatile
    {
        uint32_t curr = SWR;
     ...
     */
    inline CCU40_CC40_ECRD0_VPTR get_ECRD0_VPTR() volatile
    {
     ...
     */
    inline CCU40_CC40_ECRD0_SPTR get_ECRD0_SPTR() volatile
    {
     ...
     */
    inline void get_ECRD0(CCU40_CC40_ECRD0_LCV &LCV, CCU40_CC40_ECRD0_FFL &FFL, CCU40_CC40_ECRD0_VPTR &VPTR, CCU40_CC40_ECRD0_SPTR &SPTR, uint8_t &FPCV, uint16_t &CAPV) volatile
    {
        uint32_t curr = ECRD0;

        LCV = CCU40_CC40_ECRD0_LCV(curr & (1u << 25u));
        FFL = CCU40_CC40_ECRD0_FFL(curr & (1u << 24u));
        VPTR = CCU40_CC40_ECRD0_VPTR((curr >> 22u) & 0b11u);
        SPTR = CCU40_CC40_ECRD0_SPTR((curr >> 20u) & 0b11u);
        FPCV = (curr >> 16u) & 0b1111u;
     ...
     * Get ECRD1's LCV bit.
     */
    inline CCU40_CC40_ECRD1_LCV get_ECRD1_LCV() volatile
    {
     ...
     * Get ECRD1's FFL bit.
     */
    inline CCU40_CC40_ECRD1_FFL get_ECRD1_FFL() volatile
    {
     ...
     */
    inline CCU40_CC40_ECRD1_VPTR get_ECRD1_VPTR() volatile
    {
     ...
     */
    inline CCU40_CC40_ECRD1_SPTR get_ECRD1_SPTR() volatile
    {
     ...
     */
    inline void get_ECRD1(CCU40_CC40_ECRD1_LCV &LCV, CCU40_CC40_ECRD1_FFL &FFL, CCU40_CC40_ECRD1_VPTR &VPTR, CCU40_CC40_ECRD1_SPTR &SPTR, uint8_t &FPCV, uint16_t &CAPV) volatile
    {
        uint32_t curr = ECRD1;

        LCV = CCU40_CC40_ECRD1_LCV(curr & (1u << 25u));
        FFL = CCU40_CC40_ECRD1_FFL(curr & (1u << 24u));
        VPTR = CCU40_CC40_ECRD1_VPTR((curr >> 22u) & 0b11u);
        SPTR = CCU40_CC40_ECRD1_SPTR((curr >> 20u) & 0b11u);
        FPCV = (curr >> 16u) & 0b1111u;
        CAPV = (curr >> 0u) & 0b1111111111111111u;
    }
};
...
static volatile ccu40_cc40 *const CCU40_CC40 = reinterpret_cast<ccu40_cc40 *>(0x4000C100);

static volatile ccu40_cc40 *const CCU40_CC41 = reinterpret_cast<ccu40_cc40 *>(0x4000C200);

static volatile ccu40_cc40 *const CCU40_CC42 = reinterpret_cast<ccu40_cc40 *>(0x4000C300);

static volatile ccu40_cc40 *const CCU40_CC43 = reinterpret_cast<ccu40_cc40 *>(0x4000C400);

static volatile ccu40_cc40 *const CCU41_CC40 = reinterpret_cast<ccu40_cc40 *>(0x40010100);

static volatile ccu40_cc40 *const CCU41_CC41 = reinterpret_cast<ccu40_cc40 *>(0x40010200);

static volatile ccu40_cc40 *const CCU41_CC42 = reinterpret_cast<ccu40_cc40 *>(0x40010300);

static volatile ccu40_cc40 *const CCU41_CC43 = reinterpret_cast<ccu40_cc40 *>(0x40010400);

static volatile ccu40_cc40 *const CCU42_CC40 = reinterpret_cast<ccu40_cc40 *>(0x40014100);

static volatile ccu40_cc40 *const CCU42_CC41 = reinterpret_cast<ccu40_cc40 *>(0x40014200);

static volatile ccu40_cc40 *const CCU42_CC42 = reinterpret_cast<ccu40_cc40 *>(0x40014300);

static volatile ccu40_cc40 *const CCU42_CC43 = reinterpret_cast<ccu40_cc40 *>(0x40014400);

static volatile ccu40_cc40 *const CCU43_CC40 = reinterpret_cast<ccu40_cc40 *>(0x48004100);

static volatile ccu40_cc40 *const CCU43_CC41 = reinterpret_cast<ccu40_cc40 *>(0x48004200);

static volatile ccu40_cc40 *const CCU43_CC42 = reinterpret_cast<ccu40_cc40 *>(0x48004300);

static volatile ccu40_cc40 *const CCU43_CC43 = reinterpret_cast<ccu40_cc40 *>(0x48004400);
