...
struct [[gnu::packed]] scu_power
{
     ...
     */
    inline SCU_POWER_PWRSTAT_USBPUWQ get_PWRSTAT_USBPUWQ()
    {
     ...
     */
    inline SCU_POWER_PWRSTAT_USBOTGEN get_PWRSTAT_USBOTGEN()
    {
     ...
     */
    inline SCU_POWER_PWRSTAT_USBPHYPDQ get_PWRSTAT_USBPHYPDQ()
    {
     ...
     */
    inline SCU_POWER_PWRSTAT_HIBEN get_PWRSTAT_HIBEN()
    {
     ...
     */
    inline void get_PWRSTAT(SCU_POWER_PWRSTAT_USBPUWQ &USBPUWQ, SCU_POWER_PWRSTAT_USBOTGEN &USBOTGEN, SCU_POWER_PWRSTAT_USBPHYPDQ &USBPHYPDQ, SCU_POWER_PWRSTAT_HIBEN &HIBEN)
    {
        uint32_t curr = PWRSTAT;

        USBPUWQ = SCU_POWER_PWRSTAT_USBPUWQ(curr & (1u << 18u));
        USBOTGEN = SCU_POWER_PWRSTAT_USBOTGEN(curr & (1u << 17u));
        USBPHYPDQ = SCU_POWER_PWRSTAT_USBPHYPDQ(curr & (1u << 16u));
     ...
     */
    inline void set_PWRSET(SCU_POWER_PWRSET_USBPUWQ USBPUWQ, SCU_POWER_PWRSET_USBOTGEN USBOTGEN, SCU_POWER_PWRSET_USBPHYPDQ USBPHYPDQ, SCU_POWER_PWRSET_HIB HIB)
    {
     ...
     */
    inline void set_PWRCLR(SCU_POWER_PWRCLR_USBPUWQ USBPUWQ, SCU_POWER_PWRCLR_USBOTGEN USBOTGEN, SCU_POWER_PWRCLR_USBPHYPDQ USBPHYPDQ, SCU_POWER_PWRCLR_HIB HIB)
    {
     ...
     */
    inline SCU_POWER_EVRSTAT_OV13 get_EVRSTAT_OV13()
    {
     ...
     */
    inline uint8_t get_EVRVADCSTAT_VADC33V()
    {
     ...
     */
    inline uint8_t get_EVRVADCSTAT_VADC13V()
    {
     ...
     */
    inline void get_EVRVADCSTAT(uint8_t &VADC33V, uint8_t &VADC13V)
    {
     ...
     */
    inline uint8_t get_PWRMON_INTV()
    {
     ...
     */
    inline uint8_t get_PWRMON_THRS()
    {
     ...
     */
    inline void get_PWRMON(bool &ENB, uint8_t &INTV, uint8_t &THRS)
    {
        uint32_t curr = PWRMON;
     ...
     */
    inline void set_PWRMON(bool ENB, uint8_t INTV, uint8_t THRS)
    {
        uint32_t curr = PWRMON;
