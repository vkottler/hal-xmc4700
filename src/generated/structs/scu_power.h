...
struct [[gnu::packed]] scu_power
{
     ...
     */
    inline SCU_POWER_PWRSTAT_USBPHYPDQ get_PWRSTAT_USBPHYPDQ() volatile
    {
     ...
     */
    inline void get_PWRSTAT(SCU_POWER_PWRSTAT_USBPUWQ &USBPUWQ, SCU_POWER_PWRSTAT_USBOTGEN &USBOTGEN, SCU_POWER_PWRSTAT_USBPHYPDQ &USBPHYPDQ, SCU_POWER_PWRSTAT_HIBEN &HIBEN) volatile
    {
     ...
     */
    inline void set_PWRSET(SCU_POWER_PWRSET_USBPUWQ USBPUWQ, SCU_POWER_PWRSET_USBOTGEN USBOTGEN, SCU_POWER_PWRSET_USBPHYPDQ USBPHYPDQ, SCU_POWER_PWRSET_HIB HIB) volatile
    {
     ...
     */
    inline void set_PWRCLR(SCU_POWER_PWRCLR_USBPUWQ USBPUWQ, SCU_POWER_PWRCLR_USBOTGEN USBOTGEN, SCU_POWER_PWRCLR_USBPHYPDQ USBPHYPDQ, SCU_POWER_PWRCLR_HIB HIB) volatile
    {
