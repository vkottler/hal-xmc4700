...
#include "../enums/POSIF_MCMF_MSS.h"
#include "../enums/POSIF_PCONF_DSEL.h"
#include "../enums/POSIF_PCONF_EWIE.h"
#include "../enums/POSIF_PCONF_EWIL.h"
#include "../enums/POSIF_PCONF_EWIS.h"
#include "../enums/POSIF_PCONF_FSEL.h"
#include "../enums/POSIF_PCONF_INSEL0.h"
#include "../enums/POSIF_PCONF_INSEL1.h"
#include "../enums/POSIF_PCONF_INSEL2.h"
#include "../enums/POSIF_PCONF_LPC.h"
#include "../enums/POSIF_PCONF_MCUE.h"
#include "../enums/POSIF_PCONF_MSES.h"
#include "../enums/POSIF_PCONF_MSETS.h"
#include "../enums/POSIF_PCONF_MSYNS.h"
#include "../enums/POSIF_PCONF_QDCM.h"
#include "../enums/POSIF_PCONF_SPES.h"
#include "../enums/POSIF_PFLGE_CHESEL.h"
#include "../enums/POSIF_PFLGE_CNTSEL.h"
#include "../enums/POSIF_PFLGE_DIRSEL.h"
#include "../enums/POSIF_PFLGE_ECHE.h"
#include "../enums/POSIF_PFLGE_ECNT.h"
#include "../enums/POSIF_PFLGE_EDIR.h"
#include "../enums/POSIF_PFLGE_EERR.h"
#include "../enums/POSIF_PFLGE_EHIE.h"
#include "../enums/POSIF_PFLGE_EINDX.h"
#include "../enums/POSIF_PFLGE_EMST.h"
#include "../enums/POSIF_PFLGE_EPCLK.h"
#include "../enums/POSIF_PFLGE_ERRSEL.h"
#include "../enums/POSIF_PFLGE_EWHE.h"
#include "../enums/POSIF_PFLGE_HIESEL.h"
#include "../enums/POSIF_PFLGE_INDSEL.h"
#include "../enums/POSIF_PFLGE_MSTSEL.h"
#include "../enums/POSIF_PFLGE_PCLSEL.h"
#include "../enums/POSIF_PFLGE_WHESEL.h"
#include "../enums/POSIF_PFLG_CHES.h"
#include "../enums/POSIF_PFLG_CNTS.h"
#include "../enums/POSIF_PFLG_DIRS.h"
#include "../enums/POSIF_PFLG_ERRS.h"
#include "../enums/POSIF_PFLG_HIES.h"
#include "../enums/POSIF_PFLG_INDXS.h"
#include "../enums/POSIF_PFLG_MSTS.h"
#include "../enums/POSIF_PFLG_PCLKS.h"
#include "../enums/POSIF_PFLG_WHES.h"
#include "../enums/POSIF_PRUN_RB.h"
#include "../enums/POSIF_PSUS_MSUS.h"
#include "../enums/POSIF_PSUS_QSUS.h"
#include "../enums/POSIF_QDC_DVAL.h"
#include "../enums/POSIF_QDC_ICM.h"
#include "../enums/POSIF_QDC_PALS.h"
#include "../enums/POSIF_QDC_PBLS.h"
#include "../enums/POSIF_QDC_PHS.h"
...
struct [[gnu::packed]] posif
{
     ...
     */
    POSIF_PCONF_LPC get_PCONF_LPC()
    {
        return POSIF_PCONF_LPC((PCONF >> 28u) & 0b111u);
    }

    /**
     * Set PCONF's LPC field.
     */
    inline void set_PCONF_LPC(POSIF_PCONF_LPC value)
    {
        uint32_t curr = PCONF;
     ...
     */
    POSIF_PCONF_EWIL get_PCONF_EWIL()
    {
        return POSIF_PCONF_EWIL(PCONF & (1u << 27u));
    }
     ...
     */
    POSIF_PCONF_EWIE get_PCONF_EWIE()
    {
        return POSIF_PCONF_EWIE(PCONF & (1u << 26u));
    }
     ...
     */
    POSIF_PCONF_EWIS get_PCONF_EWIS()
    {
        return POSIF_PCONF_EWIS((PCONF >> 24u) & 0b11u);
    }

    /**
     * Set PCONF's EWIS field.
     */
    inline void set_PCONF_EWIS(POSIF_PCONF_EWIS value)
    {
        uint32_t curr = PCONF;
     ...
     */
    POSIF_PCONF_MSYNS get_PCONF_MSYNS()
    {
        return POSIF_PCONF_MSYNS((PCONF >> 22u) & 0b11u);
    }

    /**
     * Set PCONF's MSYNS field.
     */
    inline void set_PCONF_MSYNS(POSIF_PCONF_MSYNS value)
    {
        uint32_t curr = PCONF;
     ...
     */
    POSIF_PCONF_MSES get_PCONF_MSES()
    {
        return POSIF_PCONF_MSES(PCONF & (1u << 21u));
    }
     ...
     */
    POSIF_PCONF_MSETS get_PCONF_MSETS()
    {
        return POSIF_PCONF_MSETS((PCONF >> 18u) & 0b111u);
    }

    /**
     * Set PCONF's MSETS field.
     */
    inline void set_PCONF_MSETS(POSIF_PCONF_MSETS value)
    {
        uint32_t curr = PCONF;
     ...
     */
    POSIF_PCONF_SPES get_PCONF_SPES()
    {
        return POSIF_PCONF_SPES(PCONF & (1u << 17u));
    }
     ...
     */
    POSIF_PCONF_DSEL get_PCONF_DSEL()
    {
        return POSIF_PCONF_DSEL(PCONF & (1u << 16u));
    }
     ...
     */
    POSIF_PCONF_INSEL2 get_PCONF_INSEL2()
    {
        return POSIF_PCONF_INSEL2((PCONF >> 12u) & 0b11u);
    }

    /**
     * Set PCONF's INSEL2 field.
     */
    inline void set_PCONF_INSEL2(POSIF_PCONF_INSEL2 value)
    {
        uint32_t curr = PCONF;
     ...
     */
    POSIF_PCONF_INSEL1 get_PCONF_INSEL1()
    {
        return POSIF_PCONF_INSEL1((PCONF >> 10u) & 0b11u);
    }

    /**
     * Set PCONF's INSEL1 field.
     */
    inline void set_PCONF_INSEL1(POSIF_PCONF_INSEL1 value)
    {
        uint32_t curr = PCONF;
     ...
     */
    POSIF_PCONF_INSEL0 get_PCONF_INSEL0()
    {
        return POSIF_PCONF_INSEL0((PCONF >> 8u) & 0b11u);
    }

    /**
     * Set PCONF's INSEL0 field.
     */
    inline void set_PCONF_INSEL0(POSIF_PCONF_INSEL0 value)
    {
        uint32_t curr = PCONF;
     ...
     */
    POSIF_PCONF_MCUE get_PCONF_MCUE()
    {
        return POSIF_PCONF_MCUE(PCONF & (1u << 5u));
    }
     ...
     */
    POSIF_PCONF_QDCM get_PCONF_QDCM()
    {
        return POSIF_PCONF_QDCM(PCONF & (1u << 2u));
    }
     ...
     */
    POSIF_PCONF_FSEL get_PCONF_FSEL()
    {
        return POSIF_PCONF_FSEL((PCONF >> 0u) & 0b11u);
    }

    /**
     * Set PCONF's FSEL field.
     */
    inline void set_PCONF_FSEL(POSIF_PCONF_FSEL value)
    {
        uint32_t curr = PCONF;
     ...
     */
    POSIF_PSUS_MSUS get_PSUS_MSUS()
    {
        return POSIF_PSUS_MSUS((PSUS >> 2u) & 0b11u);
    }

    /**
     * Set PSUS's MSUS field.
     */
    inline void set_PSUS_MSUS(POSIF_PSUS_MSUS value)
    {
        uint32_t curr = PSUS;
     ...
     */
    POSIF_PSUS_QSUS get_PSUS_QSUS()
    {
        return POSIF_PSUS_QSUS((PSUS >> 0u) & 0b11u);
    }

    /**
     * Set PSUS's QSUS field.
     */
    inline void set_PSUS_QSUS(POSIF_PSUS_QSUS value)
    {
        uint32_t curr = PSUS;
     ...
     * Get PRUN's RB bit.
     */
    POSIF_PRUN_RB get_PRUN_RB()
    {
        return POSIF_PRUN_RB(PRUN & (1u << 0u));
    }
     ...
     * Get MCMF's MSS bit.
     */
    POSIF_MCMF_MSS get_MCMF_MSS()
    {
        return POSIF_MCMF_MSS(MCMF & (1u << 0u));
    }

    /**
     * Get QDC's DVAL bit.
     */
    POSIF_QDC_DVAL get_QDC_DVAL()
    {
        return POSIF_QDC_DVAL(QDC & (1u << 8u));
    }

    /**
     * Get QDC's ICM field.
     */
    POSIF_QDC_ICM get_QDC_ICM()
    {
        return POSIF_QDC_ICM((QDC >> 4u) & 0b11u);
    }

    /**
     * Set QDC's ICM field.
     */
    inline void set_QDC_ICM(POSIF_QDC_ICM value)
    {
        uint32_t curr = QDC;
     ...
     * Get QDC's PHS bit.
     */
    POSIF_QDC_PHS get_QDC_PHS()
    {
        return POSIF_QDC_PHS(QDC & (1u << 2u));
    }
     ...
     * Get QDC's PBLS bit.
     */
    POSIF_QDC_PBLS get_QDC_PBLS()
    {
        return POSIF_QDC_PBLS(QDC & (1u << 1u));
    }
     ...
     * Get QDC's PALS bit.
     */
    POSIF_QDC_PALS get_QDC_PALS()
    {
        return POSIF_QDC_PALS(QDC & (1u << 0u));
    }
     ...
     */
    POSIF_PFLG_PCLKS get_PFLG_PCLKS()
    {
        return POSIF_PFLG_PCLKS(PFLG & (1u << 12u));
    }

    /**
     * Get PFLG's DIRS bit.
     */
    POSIF_PFLG_DIRS get_PFLG_DIRS()
    {
        return POSIF_PFLG_DIRS(PFLG & (1u << 11u));
    }

    /**
     * Get PFLG's CNTS bit.
     */
    POSIF_PFLG_CNTS get_PFLG_CNTS()
    {
        return POSIF_PFLG_CNTS(PFLG & (1u << 10u));
    }

    /**
     * Get PFLG's ERRS bit.
     */
    POSIF_PFLG_ERRS get_PFLG_ERRS()
    {
        return POSIF_PFLG_ERRS(PFLG & (1u << 9u));
    }

    /**
     * Get PFLG's INDXS bit.
     */
    POSIF_PFLG_INDXS get_PFLG_INDXS()
    {
        return POSIF_PFLG_INDXS(PFLG & (1u << 8u));
    }

    /**
     * Get PFLG's MSTS bit.
     */
    POSIF_PFLG_MSTS get_PFLG_MSTS()
    {
        return POSIF_PFLG_MSTS(PFLG & (1u << 4u));
    }

    /**
     * Get PFLG's HIES bit.
     */
    POSIF_PFLG_HIES get_PFLG_HIES()
    {
        return POSIF_PFLG_HIES(PFLG & (1u << 2u));
    }

    /**
     * Get PFLG's WHES bit.
     */
    POSIF_PFLG_WHES get_PFLG_WHES()
    {
        return POSIF_PFLG_WHES(PFLG & (1u << 1u));
    }

    /**
     * Get PFLG's CHES bit.
     */
    POSIF_PFLG_CHES get_PFLG_CHES()
    {
        return POSIF_PFLG_CHES(PFLG & (1u << 0u));
    }

    /**
     * Get PFLGE's PCLSEL bit.
     */
    POSIF_PFLGE_PCLSEL get_PFLGE_PCLSEL()
    {
        return POSIF_PFLGE_PCLSEL(PFLGE & (1u << 28u));
    }
     ...
     */
    POSIF_PFLGE_DIRSEL get_PFLGE_DIRSEL()
    {
        return POSIF_PFLGE_DIRSEL(PFLGE & (1u << 27u));
    }
     ...
     */
    POSIF_PFLGE_CNTSEL get_PFLGE_CNTSEL()
    {
        return POSIF_PFLGE_CNTSEL(PFLGE & (1u << 26u));
    }
     ...
     */
    POSIF_PFLGE_ERRSEL get_PFLGE_ERRSEL()
    {
        return POSIF_PFLGE_ERRSEL(PFLGE & (1u << 25u));
    }
     ...
     */
    POSIF_PFLGE_INDSEL get_PFLGE_INDSEL()
    {
        return POSIF_PFLGE_INDSEL(PFLGE & (1u << 24u));
    }
     ...
     */
    POSIF_PFLGE_MSTSEL get_PFLGE_MSTSEL()
    {
        return POSIF_PFLGE_MSTSEL(PFLGE & (1u << 20u));
    }
     ...
     */
    POSIF_PFLGE_HIESEL get_PFLGE_HIESEL()
    {
        return POSIF_PFLGE_HIESEL(PFLGE & (1u << 18u));
    }
     ...
     */
    POSIF_PFLGE_WHESEL get_PFLGE_WHESEL()
    {
        return POSIF_PFLGE_WHESEL(PFLGE & (1u << 17u));
    }
     ...
     */
    POSIF_PFLGE_CHESEL get_PFLGE_CHESEL()
    {
        return POSIF_PFLGE_CHESEL(PFLGE & (1u << 16u));
    }
     ...
     */
    POSIF_PFLGE_EPCLK get_PFLGE_EPCLK()
    {
        return POSIF_PFLGE_EPCLK(PFLGE & (1u << 12u));
    }
     ...
     */
    POSIF_PFLGE_EDIR get_PFLGE_EDIR()
    {
        return POSIF_PFLGE_EDIR(PFLGE & (1u << 11u));
    }
     ...
     */
    POSIF_PFLGE_ECNT get_PFLGE_ECNT()
    {
        return POSIF_PFLGE_ECNT(PFLGE & (1u << 10u));
    }
     ...
     */
    POSIF_PFLGE_EERR get_PFLGE_EERR()
    {
        return POSIF_PFLGE_EERR(PFLGE & (1u << 9u));
    }
     ...
     */
    POSIF_PFLGE_EINDX get_PFLGE_EINDX()
    {
        return POSIF_PFLGE_EINDX(PFLGE & (1u << 8u));
    }
     ...
     */
    POSIF_PFLGE_EMST get_PFLGE_EMST()
    {
        return POSIF_PFLGE_EMST(PFLGE & (1u << 4u));
    }
     ...
     */
    POSIF_PFLGE_EHIE get_PFLGE_EHIE()
    {
        return POSIF_PFLGE_EHIE(PFLGE & (1u << 2u));
    }
     ...
     */
    POSIF_PFLGE_EWHE get_PFLGE_EWHE()
    {
        return POSIF_PFLGE_EWHE(PFLGE & (1u << 1u));
    }
     ...
     */
    POSIF_PFLGE_ECHE get_PFLGE_ECHE()
    {
        return POSIF_PFLGE_ECHE(PFLGE & (1u << 0u));
    }
